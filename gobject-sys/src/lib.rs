// This file was generated by gir (787b7c7) from gir-files (11e0e6d)
// DO NOT EDIT
...
extern "C" {
    ...
    pub fn g_object_bind_property_full(source: gpointer, source_property: *const c_char, target: gpointer, target_property: *const c_char, flags: GBindingFlags, transform_to: GBindingTransformFunc, transform_from: GBindingTransformFunc, user_data: gpointer, notify: glib::GDestroyNotify) -> *mut GBinding;
    ...
    pub fn g_signal_connect_closure_by_id(instance: gpointer, signal_id: c_uint, detail: glib::GQuark, closure: *mut GClosure, after: gboolean) -> c_ulong;
    ...
    pub fn g_signal_emit(instance: gpointer, signal_id: c_uint, detail: glib::GQuark, ...);
    pub fn g_signal_emit_by_name(instance: gpointer, detailed_signal: *const c_char, ...);
    //pub fn g_signal_emit_valist(instance: gpointer, signal_id: c_uint, detail: glib::GQuark, var_args: [Unsupported type va_list]);
    ...
    pub fn g_signal_handler_find(instance: gpointer, mask: GSignalMatchType, signal_id: c_uint, detail: glib::GQuark, closure: *mut GClosure, func: gpointer, data: gpointer) -> c_ulong;
    ...
    pub fn g_signal_handlers_block_matched(instance: gpointer, mask: GSignalMatchType, signal_id: c_uint, detail: glib::GQuark, closure: *mut GClosure, func: gpointer, data: gpointer) -> c_uint;
    pub fn g_signal_handlers_destroy(instance: gpointer);
    pub fn g_signal_handlers_disconnect_matched(instance: gpointer, mask: GSignalMatchType, signal_id: c_uint, detail: glib::GQuark, closure: *mut GClosure, func: gpointer, data: gpointer) -> c_uint;
    pub fn g_signal_handlers_unblock_matched(instance: gpointer, mask: GSignalMatchType, signal_id: c_uint, detail: glib::GQuark, closure: *mut GClosure, func: gpointer, data: gpointer) -> c_uint;
    pub fn g_signal_has_handler_pending(instance: gpointer, signal_id: c_uint, detail: glib::GQuark, may_be_blocked: gboolean) -> gboolean;
    ...
    pub fn g_signal_stop_emission(instance: gpointer, signal_id: c_uint, detail: glib::GQuark);
