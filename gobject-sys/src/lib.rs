...
//pub const G_TYPE_FLAG_RESERVED_ID_BIT: Unknown rust type: "Type" = 1;
...
//pub type GVaClosureMarshal = Option<unsafe extern "C" fn(*mut GClosure, *mut GValue, gpointer, [Unsupported type va_list], gpointer, c_int, *mut GType)>;
...
pub struct GInitiallyUnownedClass {
    pub g_type_class: GTypeClass,
    construct_properties: *mut glib_ffi::GSList,
...
extern "C" {
    ...
    //pub fn g_cclosure_marshal_BOOLEAN__BOXED_BOXEDv(closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_BOOLEAN__FLAGSv  (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_STRING__OBJECT_POINTERv(closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__BOOLEANv   (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__BOXEDv     (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__CHARv      (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__DOUBLEv    (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__ENUMv      (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__FLAGSv     (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__FLOATv     (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__INTv       (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__LONGv      (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__OBJECTv    (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__PARAMv     (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__POINTERv   (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__STRINGv    (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__UCHARv     (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__UINT_POINTERv(closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    //pub fn g_cclosure_marshal_VOID__UINTv      (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__ULONGv     (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__VARIANTv   (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_VOID__VOIDv      (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    //pub fn g_cclosure_marshal_generic_va       (closure: *mut GClosure, return_value: *mut GValue, instance: gpointer, args_list: [Unsupported type va_list], marshal_data: gpointer, n_params: c_int, param_types: *mut GType);
    ...
    pub fn g_param_spec_pool_list_owned        (pool: *mut GParamSpecPool, owner_type: GType) -> *mut glib_ffi::GList;
    ...
    pub fn g_value_dup_variant                 (value: *const GValue) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_value_get_uchar                   (value: *const GValue) -> c_char;
    ...
    pub fn g_value_get_variant                 (value: *const GValue) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_value_set_uchar                   (value: *mut GValue, v_uchar: c_char);
    ...
    pub fn g_value_set_variant                 (value: *mut GValue, variant: *mut glib_ffi::GVariant);
    ...
    pub fn g_value_take_variant                (value: *mut GValue, variant: *mut glib_ffi::GVariant);
    ...
    pub fn g_value_array_sort                  (value_array: *mut GValueArray, compare_func: glib_ffi::GCompareFunc) -> *mut GValueArray;
    pub fn g_value_array_sort_with_data        (value_array: *mut GValueArray, compare_func: glib_ffi::GCompareDataFunc, user_data: gpointer) -> *mut GValueArray;
    ...
    //pub fn g_object_new_valist                 (object_type: GType, first_property_name: *const c_char, var_args: [Unsupported type va_list]) -> *mut GObject;
    pub fn g_object_newv                       (object_type: GType, n_parameters: c_uint, parameters: *mut GParameter) -> gpointer;
    ...
    pub fn g_object_bind_property              (source: gpointer, source_property: *const c_char, target: gpointer, target_property: *const c_char, flags: GBindingFlags) -> *mut GBinding;
    pub fn g_object_bind_property_full         (source: gpointer, source_property: *const c_char, target: gpointer, target_property: *const c_char, flags: GBindingFlags, transform_to: GBindingTransformFunc, transform_from: GBindingTransformFunc, user_data: gpointer, notify: glib_ffi::GDestroyNotify) -> *mut GBinding;
    pub fn g_object_bind_property_with_closures(source: gpointer, source_property: *const c_char, target: gpointer, target_property: *const c_char, flags: GBindingFlags, transform_to: *mut GClosure, transform_from: *mut GClosure) -> *mut GBinding;
    #[cfg(gobject_2_34)]
    pub fn g_object_dup_data                   (object: *mut GObject, key: *const c_char, dup_func: glib_ffi::GDuplicateFunc, user_data: gpointer) -> gpointer;
    #[cfg(gobject_2_34)]
    pub fn g_object_dup_qdata                  (object: *mut GObject, quark: glib_ffi::GQuark, dup_func: glib_ffi::GDuplicateFunc, user_data: gpointer) -> gpointer;
    ...
    pub fn g_object_get_qdata                  (object: *mut GObject, quark: glib_ffi::GQuark) -> gpointer;
    //pub fn g_object_get_valist                 (object: *mut GObject, first_property_name: *const c_char, var_args: [Unsupported type va_list]);
    ...
    #[cfg(gobject_2_34)]
    pub fn g_object_replace_data               (object: *mut GObject, key: *const c_char, oldval: gpointer, newval: gpointer, destroy: glib_ffi::GDestroyNotify, old_destroy: *mut glib_ffi::GDestroyNotify) -> gboolean;
    #[cfg(gobject_2_34)]
    pub fn g_object_replace_qdata              (object: *mut GObject, quark: glib_ffi::GQuark, oldval: gpointer, newval: gpointer, destroy: glib_ffi::GDestroyNotify, old_destroy: *mut glib_ffi::GDestroyNotify) -> gboolean;
    pub fn g_object_run_dispose                (object: *mut GObject);
    pub fn g_object_set_data                   (object: *mut GObject, key: *const c_char, data: gpointer);
    pub fn g_object_set_data_full              (object: *mut GObject, key: *const c_char, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    pub fn g_object_set_property               (object: *mut GObject, property_name: *const c_char, value: *const GValue);
    pub fn g_object_set_qdata                  (object: *mut GObject, quark: glib_ffi::GQuark, data: gpointer);
    pub fn g_object_set_qdata_full             (object: *mut GObject, quark: glib_ffi::GQuark, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    //pub fn g_object_set_valist                 (object: *mut GObject, first_property_name: *const c_char, var_args: [Unsupported type va_list]);
    pub fn g_object_steal_data                 (object: *mut GObject, key: *const c_char) -> gpointer;
    pub fn g_object_steal_qdata                (object: *mut GObject, quark: glib_ffi::GQuark) -> gpointer;
    ...
    pub fn g_param_spec_get_qdata              (pspec: *mut GParamSpec, quark: glib_ffi::GQuark) -> gpointer;
    ...
    pub fn g_param_spec_set_qdata              (pspec: *mut GParamSpec, quark: glib_ffi::GQuark, data: gpointer);
    pub fn g_param_spec_set_qdata_full         (pspec: *mut GParamSpec, quark: glib_ffi::GQuark, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    pub fn g_param_spec_sink                   (pspec: *mut GParamSpec);
    pub fn g_param_spec_steal_qdata            (pspec: *mut GParamSpec, quark: glib_ffi::GQuark) -> gpointer;
    ...
    pub fn g_param_spec_variant                (name: *const c_char, nick: *const c_char, blurb: *const c_char, type_: *const glib_ffi::GVariantType, default_value: *mut glib_ffi::GVariant, flags: GParamFlags) -> *mut GParamSpec;
    ...
    pub fn g_signal_add_emission_hook          (signal_id: c_uint, detail: glib_ffi::GQuark, hook_func: GSignalEmissionHook, hook_data: gpointer, data_destroy: glib_ffi::GDestroyNotify) -> c_ulong;
    ...
    pub fn g_signal_connect_closure            (instance: gpointer, detailed_signal: *const c_char, closure: *mut GClosure, after: gboolean) -> c_ulong;
    pub fn g_signal_connect_closure_by_id      (instance: gpointer, signal_id: c_uint, detail: glib_ffi::GQuark, closure: *mut GClosure, after: gboolean) -> c_ulong;
    pub fn g_signal_connect_data               (instance: gpointer, detailed_signal: *const c_char, c_handler: GCallback, data: gpointer, destroy_data: GClosureNotify, connect_flags: GConnectFlags) -> c_ulong;
    ...
    pub fn g_signal_emit                       (instance: gpointer, signal_id: c_uint, detail: glib_ffi::GQuark, ...);
    pub fn g_signal_emit_by_name               (instance: gpointer, detailed_signal: *const c_char, ...);
    //pub fn g_signal_emit_valist                (instance: gpointer, signal_id: c_uint, detail: glib_ffi::GQuark, var_args: [Unsupported type va_list]);
    pub fn g_signal_emitv                      (instance_and_params: *mut GValue, signal_id: c_uint, detail: glib_ffi::GQuark, return_value: *mut GValue);
    pub fn g_signal_get_invocation_hint        (instance: gpointer) -> *mut GSignalInvocationHint;
    pub fn g_signal_handler_block              (instance: gpointer, handler_id: c_ulong);
    pub fn g_signal_handler_disconnect         (instance: gpointer, handler_id: c_ulong);
    pub fn g_signal_handler_find               (instance: gpointer, mask: GSignalMatchType, signal_id: c_uint, detail: glib_ffi::GQuark, closure: *mut GClosure, func: gpointer, data: gpointer) -> c_ulong;
    pub fn g_signal_handler_is_connected       (instance: gpointer, handler_id: c_ulong) -> gboolean;
    pub fn g_signal_handler_unblock            (instance: gpointer, handler_id: c_ulong);
    pub fn g_signal_handlers_block_matched     (instance: gpointer, mask: GSignalMatchType, signal_id: c_uint, detail: glib_ffi::GQuark, closure: *mut GClosure, func: gpointer, data: gpointer) -> c_uint;
    pub fn g_signal_handlers_destroy           (instance: gpointer);
    pub fn g_signal_handlers_disconnect_matched(instance: gpointer, mask: GSignalMatchType, signal_id: c_uint, detail: glib_ffi::GQuark, closure: *mut GClosure, func: gpointer, data: gpointer) -> c_uint;
    pub fn g_signal_handlers_unblock_matched   (instance: gpointer, mask: GSignalMatchType, signal_id: c_uint, detail: glib_ffi::GQuark, closure: *mut GClosure, func: gpointer, data: gpointer) -> c_uint;
    pub fn g_signal_has_handler_pending        (instance: gpointer, signal_id: c_uint, detail: glib_ffi::GQuark, may_be_blocked: gboolean) -> gboolean;
    ...
    //pub fn g_signal_new_valist                 (signal_name: *const c_char, itype: GType, signal_flags: GSignalFlags, class_closure: *mut GClosure, accumulator: GSignalAccumulator, accu_data: gpointer, c_marshaller: GSignalCMarshaller, return_type: GType, n_params: c_uint, args: [Unsupported type va_list]) -> c_uint;
    ...
    pub fn g_signal_parse_name                 (detailed_signal: *const c_char, itype: GType, signal_id_p: *mut c_uint, detail_p: *mut glib_ffi::GQuark, force_detail_quark: gboolean) -> gboolean;
    ...
    //#[cfg(gobject_2_32)]
    //pub fn g_signal_set_va_marshaller          (signal_id: c_uint, instance_type: GType, va_marshaller: GSignalCVaMarshaller);
    pub fn g_signal_stop_emission              (instance: gpointer, signal_id: c_uint, detail: glib_ffi::GQuark);
    pub fn g_signal_stop_emission_by_name      (instance: gpointer, detailed_signal: *const c_char);
    pub fn g_signal_type_cclosure_new          (itype: GType, struct_offset: c_uint) -> *mut GClosure;
    pub fn g_source_set_closure                (source: *mut glib_ffi::GSource, closure: *mut GClosure);
    pub fn g_source_set_dummy_callback         (source: *mut glib_ffi::GSource);
    ...
    pub fn g_type_get_qdata                    (type_: GType, quark: glib_ffi::GQuark) -> gpointer;
    #[cfg(gobject_2_36)]
    ...
    pub fn g_type_qname                        (type_: GType) -> glib_ffi::GQuark;
    ...
    pub fn g_type_set_qdata                    (type_: GType, quark: glib_ffi::GQuark, data: gpointer);
