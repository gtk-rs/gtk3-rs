...
pub const G_BINDING_DEFAULT: GBindingFlags = GBindingFlags::DEFAULT;
pub const G_BINDING_BIDIRECTIONAL: GBindingFlags = GBindingFlags::BIDIRECTIONAL;
pub const G_BINDING_SYNC_CREATE: GBindingFlags = GBindingFlags::SYNC_CREATE;
pub const G_BINDING_INVERT_BOOLEAN: GBindingFlags = GBindingFlags::INVERT_BOOLEAN;
...
pub const G_CONNECT_AFTER: GConnectFlags = GConnectFlags::AFTER;
pub const G_CONNECT_SWAPPED: GConnectFlags = GConnectFlags::SWAPPED;
...
pub const G_PARAM_READABLE: GParamFlags = GParamFlags::READABLE;
pub const G_PARAM_WRITABLE: GParamFlags = GParamFlags::WRITABLE;
pub const G_PARAM_READWRITE: GParamFlags = GParamFlags::READWRITE;
pub const G_PARAM_CONSTRUCT: GParamFlags = GParamFlags::CONSTRUCT;
pub const G_PARAM_CONSTRUCT_ONLY: GParamFlags = GParamFlags::CONSTRUCT_ONLY;
pub const G_PARAM_LAX_VALIDATION: GParamFlags = GParamFlags::LAX_VALIDATION;
pub const G_PARAM_STATIC_NAME: GParamFlags = GParamFlags::PRIVATE;
pub const G_PARAM_PRIVATE: GParamFlags = GParamFlags::PRIVATE;
pub const G_PARAM_STATIC_NICK: GParamFlags = GParamFlags::STATIC_NICK;
pub const G_PARAM_STATIC_BLURB: GParamFlags = GParamFlags::STATIC_BLURB;
pub const G_PARAM_EXPLICIT_NOTIFY: GParamFlags = GParamFlags::EXPLICIT_NOTIFY;
pub const G_PARAM_DEPRECATED: GParamFlags = GParamFlags::DEPRECATED;
...
pub const G_SIGNAL_RUN_FIRST: GSignalFlags = GSignalFlags::RUN_FIRST;
pub const G_SIGNAL_RUN_LAST: GSignalFlags = GSignalFlags::RUN_LAST;
pub const G_SIGNAL_RUN_CLEANUP: GSignalFlags = GSignalFlags::RUN_CLEANUP;
pub const G_SIGNAL_NO_RECURSE: GSignalFlags = GSignalFlags::NO_RECURSE;
pub const G_SIGNAL_DETAILED: GSignalFlags = GSignalFlags::DETAILED;
pub const G_SIGNAL_ACTION: GSignalFlags = GSignalFlags::ACTION;
pub const G_SIGNAL_NO_HOOKS: GSignalFlags = GSignalFlags::NO_HOOKS;
pub const G_SIGNAL_MUST_COLLECT: GSignalFlags = GSignalFlags::MUST_COLLECT;
pub const G_SIGNAL_DEPRECATED: GSignalFlags = GSignalFlags::DEPRECATED;
...
pub const G_SIGNAL_MATCH_ID: GSignalMatchType = GSignalMatchType::ID;
pub const G_SIGNAL_MATCH_DETAIL: GSignalMatchType = GSignalMatchType::DETAIL;
pub const G_SIGNAL_MATCH_CLOSURE: GSignalMatchType = GSignalMatchType::CLOSURE;
pub const G_SIGNAL_MATCH_FUNC: GSignalMatchType = GSignalMatchType::FUNC;
pub const G_SIGNAL_MATCH_DATA: GSignalMatchType = GSignalMatchType::DATA;
pub const G_SIGNAL_MATCH_UNBLOCKED: GSignalMatchType = GSignalMatchType::UNBLOCKED;
...
pub const G_TYPE_DEBUG_NONE: GTypeDebugFlags = GTypeDebugFlags::NONE;
pub const G_TYPE_DEBUG_OBJECTS: GTypeDebugFlags = GTypeDebugFlags::OBJECTS;
pub const G_TYPE_DEBUG_SIGNALS: GTypeDebugFlags = GTypeDebugFlags::SIGNALS;
pub const G_TYPE_DEBUG_INSTANCE_COUNT: GTypeDebugFlags = GTypeDebugFlags::INSTANCE_COUNT;
pub const G_TYPE_DEBUG_MASK: GTypeDebugFlags = GTypeDebugFlags::MASK;

bitflags! {
    #[repr(C)]
    pub struct GTypeFlags: c_uint {
        const ABSTRACT = 16;
        const VALUE_ABSTRACT = 32;
    }
}
pub const G_TYPE_FLAG_ABSTRACT: GTypeFlags = GTypeFlags::ABSTRACT;
pub const G_TYPE_FLAG_VALUE_ABSTRACT: GTypeFlags = GTypeFlags::VALUE_ABSTRACT;

bitflags! {
    #[repr(C)]
    pub struct GTypeFundamentalFlags: c_uint {
        const CLASSED = 1;
        const INSTANTIATABLE = 2;
        const DERIVABLE = 4;
        const DEEP_DERIVABLE = 8;
    }
}
pub const G_TYPE_FLAG_CLASSED: GTypeFundamentalFlags = GTypeFundamentalFlags::CLASSED;
pub const G_TYPE_FLAG_INSTANTIATABLE: GTypeFundamentalFlags = GTypeFundamentalFlags::INSTANTIATABLE;
pub const G_TYPE_FLAG_DERIVABLE: GTypeFundamentalFlags = GTypeFundamentalFlags::DERIVABLE;
pub const G_TYPE_FLAG_DEEP_DERIVABLE: GTypeFundamentalFlags = GTypeFundamentalFlags::DEEP_DERIVABLE;
...
impl ::std::fmt::Debug for GCClosure {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GCClosure @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GClosure {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GClosure @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GClosureNotifyData {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GClosureNotifyData @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GEnumClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GEnumClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GEnumValue {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GEnumValue @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GFlagsClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GFlagsClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GFlagsValue {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GFlagsValue @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GInitiallyUnownedClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GInitiallyUnownedClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GInterfaceInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GInterfaceInfo @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GObjectClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GObjectClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GObjectConstructParam {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GObjectConstructParam @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GParamSpecClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GParamSpecClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GParamSpecPool {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GParamSpecPool @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GParamSpecTypeInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GParamSpecTypeInfo @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GParameter {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GParameter @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GSignalInvocationHint {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GSignalInvocationHint @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GSignalQuery {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GSignalQuery @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypeClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypeClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypeFundamentalInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypeFundamentalInfo @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypeInfo {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypeInfo @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypeInstance {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypeInstance @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypeInterface {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypeInterface @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypeModuleClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypeModuleClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypePluginClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypePluginClass @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypeQuery {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypeQuery @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GTypeValueTable {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GTypeValueTable @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GValue {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GValue @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GValueArray {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GValueArray @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GWeakRef {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GWeakRef @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GBinding {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        write!(f, "GBinding @ {:?}", self as *const _)
    }
}
...
impl ::std::fmt::Debug for GParamSpec {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GParamSpec @ {:?}", self as *const _))
         ...
         .field("_nick", &self._nick)
         .field("_blurb", &self._blurb)
         .field("qdata", &self.qdata)
         .field("ref_count", &self.ref_count)
