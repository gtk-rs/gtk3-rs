...
pub fn getenv<K: AsRef<OsStr>>(variable_name: K) -> Option<OsString> {
    #[cfg(not(windows))]
    use crate::ffi::g_getenv;
    #[cfg(windows)]
    use crate::ffi::g_getenv_utf8 as g_getenv;
...
pub fn setenv<K: AsRef<OsStr>, V: AsRef<OsStr>>(
    ...
    #[cfg(not(windows))]
    use crate::ffi::g_setenv;
    #[cfg(windows)]
    use crate::ffi::g_setenv_utf8 as g_setenv;
...
pub fn unsetenv<K: AsRef<OsStr>>(variable_name: K) {
    #[cfg(not(windows))]
    use crate::ffi::g_unsetenv;
    #[cfg(windows)]
    use crate::ffi::g_unsetenv_utf8 as g_unsetenv;
...
pub fn get_user_name() -> Option<OsString> {
    ...
    use crate::ffi::g_get_user_name;
    #[cfg(all(windows, target_arch = "x86"))]
    use crate::ffi::g_get_user_name_utf8 as g_get_user_name;
...
pub fn get_real_name() -> Option<OsString> {
    #[cfg(not(all(windows, target_arch = "x86")))]
    use crate::ffi::g_get_real_name;
    #[cfg(all(windows, target_arch = "x86"))]
    use crate::ffi::g_get_real_name_utf8 as g_get_real_name;
...
pub fn get_current_dir() -> Option<PathBuf> {
    #[cfg(not(windows))]
    use crate::ffi::g_get_current_dir;
    #[cfg(windows)]
    use crate::ffi::g_get_current_dir_utf8 as g_get_current_dir;
...
pub fn filename_to_uri<P: AsRef<Path>>(
    ...
    #[cfg(not(windows))]
    use crate::ffi::g_filename_to_uri;
    #[cfg(windows)]
    use crate::ffi::g_filename_to_uri_utf8 as g_filename_to_uri;
...
pub fn filename_from_uri(uri: &str) -> Result<(std::path::PathBuf, Option<GString>), Error> {
    #[cfg(not(windows))]
    use crate::ffi::g_filename_from_uri;
    #[cfg(windows)]
    use crate::ffi::g_filename_from_uri_utf8 as g_filename_from_uri;
...
pub fn find_program_in_path<P: AsRef<Path>>(program: P) -> Option<PathBuf> {
    #[cfg(not(all(windows, target_arch = "x86")))]
    use crate::ffi::g_find_program_in_path;
    #[cfg(all(windows, target_arch = "x86"))]
    use crate::ffi::g_find_program_in_path_utf8 as g_find_program_in_path;
...
pub fn get_home_dir() -> Option<std::path::PathBuf> {
    #[cfg(not(all(windows, target_arch = "x86")))]
    use crate::ffi::g_get_home_dir;
    #[cfg(all(windows, target_arch = "x86"))]
    use crate::ffi::g_get_home_dir_utf8 as g_get_home_dir;
...
pub fn get_tmp_dir() -> Option<std::path::PathBuf> {
    #[cfg(not(all(windows, target_arch = "x86")))]
    use crate::ffi::g_get_tmp_dir;
    #[cfg(all(windows, target_arch = "x86"))]
    use crate::ffi::g_get_tmp_dir_utf8 as g_get_tmp_dir;
...
pub fn mkstemp<P: AsRef<std::path::Path>>(tmpl: P) -> i32 {
    #[cfg(not(windows))]
    use crate::ffi::g_mkstemp;
    #[cfg(windows)]
    use crate::ffi::g_mkstemp_utf8 as g_mkstemp;
