...
extern "C" {
    ...
    pub fn g_data_input_stream_read_byte       (stream: *mut GDataInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> c_char;
    ...
    pub fn g_data_output_stream_put_byte       (stream: *mut GDataOutputStream, data: c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
