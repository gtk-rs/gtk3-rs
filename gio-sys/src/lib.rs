...
#[repr(C)]
pub struct GAppLaunchContext(c_void);
#[repr(C)]
pub struct GApplication(c_void);
#[repr(C)]
pub struct GApplicationCommandLine(c_void);
#[repr(C)]
pub struct GBufferedInputStream(c_void);
#[repr(C)]
pub struct GBufferedOutputStream(c_void);
#[repr(C)]
...
#[repr(C)]
pub struct GConverterInputStream(c_void);
#[repr(C)]
pub struct GConverterOutputStream(c_void);
#[repr(C)]
...
#[repr(C)]
pub struct GDBusInterfaceSkeleton(c_void);
#[repr(C)]
...
#[repr(C)]
pub struct GDBusObjectManagerClient(c_void);
#[repr(C)]
pub struct GDBusObjectManagerServer(c_void);
#[repr(C)]
pub struct GDBusObjectProxy(c_void);
#[repr(C)]
pub struct GDBusObjectSkeleton(c_void);
#[repr(C)]
pub struct GDBusProxy(c_void);
#[repr(C)]
pub struct GDBusServer(c_void);
#[repr(C)]
pub struct GDataInputStream(c_void);
#[repr(C)]
pub struct GDataOutputStream(c_void);
#[repr(C)]
pub struct GDesktopAppInfo(c_void);
#[repr(C)]
pub struct GEmblem(c_void);
#[repr(C)]
pub struct GEmblemedIcon(c_void);
#[repr(C)]
pub struct GFileEnumerator(c_void);
#[repr(C)]
pub struct GFileIOStream(c_void);
#[repr(C)]
pub struct GFileIcon(c_void);
#[repr(C)]
pub struct GFileInfo(c_void);
#[repr(C)]
pub struct GFileInputStream(c_void);
#[repr(C)]
pub struct GFileMonitor(c_void);
#[repr(C)]
pub struct GFileOutputStream(c_void);
#[repr(C)]
pub struct GFilenameCompleter(c_void);
#[repr(C)]
pub struct GFilterInputStream(c_void);
#[repr(C)]
pub struct GFilterOutputStream(c_void);
#[repr(C)]
pub struct GIOModule(c_void);
#[repr(C)]
pub struct GIOStream(c_void);
#[repr(C)]
pub struct GInetAddress(c_void);
#[repr(C)]
pub struct GInetAddressMask(c_void);
#[repr(C)]
pub struct GInetSocketAddress(c_void);
#[repr(C)]
pub struct GInputStream(c_void);
#[repr(C)]
pub struct GListStore(c_void);
#[repr(C)]
pub struct GMemoryInputStream(c_void);
#[repr(C)]
pub struct GMemoryOutputStream(c_void);
#[repr(C)]
pub struct GMenu(c_void);
#[repr(C)]
pub struct GMenuAttributeIter(c_void);
#[repr(C)]
pub struct GMenuItem(c_void);
#[repr(C)]
pub struct GMenuLinkIter(c_void);
#[repr(C)]
pub struct GMenuModel(c_void);
#[repr(C)]
pub struct GMountOperation(c_void);
#[repr(C)]
pub struct GNativeVolumeMonitor(c_void);
#[repr(C)]
pub struct GNetworkAddress(c_void);
#[repr(C)]
pub struct GNetworkService(c_void);
#[repr(C)]
pub struct GNotification(c_void);
#[repr(C)]
pub struct GOutputStream(c_void);
#[repr(C)]
pub struct GPermission(c_void);
#[repr(C)]
pub struct GPropertyAction(c_void);
#[repr(C)]
pub struct GProxyAddress(c_void);
#[repr(C)]
pub struct GProxyAddressEnumerator(c_void);
#[repr(C)]
pub struct GResolver(c_void);
#[repr(C)]
pub struct GSettings(c_void);
#[repr(C)]
pub struct GSimpleAction(c_void);
#[repr(C)]
pub struct GSimpleActionGroup(c_void);
#[repr(C)]
...
#[repr(C)]
pub struct GSimpleProxyResolver(c_void);
#[repr(C)]
pub struct GSocket(c_void);
#[repr(C)]
pub struct GSocketAddress(c_void);
#[repr(C)]
pub struct GSocketAddressEnumerator(c_void);
#[repr(C)]
pub struct GSocketClient(c_void);
#[repr(C)]
pub struct GSocketConnection(c_void);
#[repr(C)]
pub struct GSocketControlMessage(c_void);
#[repr(C)]
pub struct GSocketListener(c_void);
#[repr(C)]
pub struct GSocketService(c_void);
#[repr(C)]
...
#[repr(C)]
pub struct GTcpConnection(c_void);
#[repr(C)]
pub struct GTcpWrapperConnection(c_void);
#[repr(C)]
pub struct GTestDBus(c_void);
#[repr(C)]
pub struct GThemedIcon(c_void);
#[repr(C)]
pub struct GThreadedSocketService(c_void);
#[repr(C)]
pub struct GTlsCertificate(c_void);
#[repr(C)]
pub struct GTlsConnection(c_void);
#[repr(C)]
pub struct GTlsDatabase(c_void);
#[repr(C)]
pub struct GTlsInteraction(c_void);
#[repr(C)]
pub struct GTlsPassword(c_void);
#[repr(C)]
pub struct GUnixConnection(c_void);
#[repr(C)]
pub struct GUnixCredentialsMessage(c_void);
#[repr(C)]
pub struct GUnixFDList(c_void);
#[repr(C)]
pub struct GUnixFDMessage(c_void);
#[repr(C)]
pub struct GUnixInputStream(c_void);
#[repr(C)]
pub struct GUnixMountMonitor(c_void);
#[repr(C)]
pub struct GUnixOutputStream(c_void);
#[repr(C)]
pub struct GUnixSocketAddress(c_void);
#[repr(C)]
pub struct GVfs(c_void);
#[repr(C)]
pub struct GVolumeMonitor(c_void);
#[repr(C)]
...
extern "C" {
    ...
    //pub fn g_dbus_method_invocation_return_error_valist(invocation: *mut GDBusMethodInvocation, domain: glib::GQuark, code: c_int, format: *const c_char, var_args: [Unsupported type va_list]);
    ...
    pub fn g_dbus_object_manager_client_new_for_bus_sync(bus_type: GBusType, flags: GDBusObjectManagerClientFlags, name: *const c_char, object_path: *const c_char, get_proxy_type_func: GDBusProxyTypeFunc, get_proxy_type_user_data: gpointer, get_proxy_type_destroy_notify: glib::GDestroyNotify, cancellable: *mut GCancellable, error: *mut *mut glib::GError) -> *mut GDBusObjectManager;
    pub fn g_dbus_object_manager_client_new_sync(connection: *mut GDBusConnection, flags: GDBusObjectManagerClientFlags, name: *const c_char, object_path: *const c_char, get_proxy_type_func: GDBusProxyTypeFunc, get_proxy_type_user_data: gpointer, get_proxy_type_destroy_notify: glib::GDestroyNotify, cancellable: *mut GCancellable, error: *mut *mut glib::GError) -> *mut GDBusObjectManager;
    ...
    //#[cfg(gio_2_40)]
    //pub fn g_output_stream_vprintf(stream: *mut GOutputStream, bytes_written: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib::GError, format: *const c_char, args: [Unsupported type va_list]) -> gboolean;
    ...
    //pub fn g_simple_async_result_set_error_va(simple: *mut GSimpleAsyncResult, domain: glib::GQuark, code: c_int, format: *const c_char, args: [Unsupported type va_list]);
    ...
    pub fn g_tls_file_database_new(anchors: *const c_char, error: *mut *mut glib::GError) -> *mut GTlsDatabase;
