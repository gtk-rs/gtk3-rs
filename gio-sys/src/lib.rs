...
pub type GAsyncReadyCallback = Option<unsafe extern "C" fn(*mut gobject_ffi::GObject, *mut GAsyncResult, gpointer)>;
...
pub type GDBusInterfaceGetPropertyFunc = Option<unsafe extern "C" fn(*mut GDBusConnection, *const c_char, *const c_char, *const c_char, *const c_char, *mut *mut glib_ffi::GError, gpointer) -> *mut glib_ffi::GVariant>;
pub type GDBusInterfaceMethodCallFunc = Option<unsafe extern "C" fn(*mut GDBusConnection, *const c_char, *const c_char, *const c_char, *const c_char, *mut glib_ffi::GVariant, *mut GDBusMethodInvocation, gpointer)>;
pub type GDBusInterfaceSetPropertyFunc = Option<unsafe extern "C" fn(*mut GDBusConnection, *const c_char, *const c_char, *const c_char, *const c_char, *mut glib_ffi::GVariant, *mut *mut glib_ffi::GError, gpointer) -> gboolean>;
...
pub type GDBusSignalCallback = Option<unsafe extern "C" fn(*mut GDBusConnection, *const c_char, *const c_char, *const c_char, *const c_char, *mut glib_ffi::GVariant, gpointer)>;
...
pub type GDesktopAppLaunchCallback = Option<unsafe extern "C" fn(*mut GDesktopAppInfo, glib_ffi::GPid, gpointer)>;
...
pub type GPollableSourceFunc = Option<unsafe extern "C" fn(*mut gobject_ffi::GObject, gpointer) -> gboolean>;
pub type GReallocFunc = Option<unsafe extern "C" fn(gpointer, size_t) -> gpointer>;
pub type GSettingsBindGetMapping = Option<unsafe extern "C" fn(*mut gobject_ffi::GValue, *mut glib_ffi::GVariant, gpointer) -> gboolean>;
pub type GSettingsBindSetMapping = Option<unsafe extern "C" fn(*const gobject_ffi::GValue, *const glib_ffi::GVariantType, gpointer) -> *mut glib_ffi::GVariant>;
pub type GSettingsGetMapping = Option<unsafe extern "C" fn(*mut glib_ffi::GVariant, *mut gpointer, gpointer) -> gboolean>;
pub type GSimpleAsyncThreadFunc = Option<unsafe extern "C" fn(*mut GSimpleAsyncResult, *mut gobject_ffi::GObject, *mut GCancellable)>;
pub type GSocketSourceFunc = Option<unsafe extern "C" fn(*mut GSocket, glib_ffi::GIOCondition, gpointer) -> gboolean>;
...
pub struct GActionEntry {
    ...
    pub activate: Option<unsafe extern "C" fn(*mut GSimpleAction, *mut glib_ffi::GVariant, gpointer)>,
    pub parameter_type: *const c_char,
    pub state: *const c_char,
    pub change_state: Option<unsafe extern "C" fn(*mut GSimpleAction, *mut glib_ffi::GVariant, gpointer)>,
    padding: [size_t; 3],
}
...
pub struct GActionGroupInterface {
    ...
    pub get_action_parameter_type: Option<unsafe extern "C" fn(*mut GActionGroup, *const c_char) -> *const glib_ffi::GVariantType>,
    pub get_action_state_type: Option<unsafe extern "C" fn(*mut GActionGroup, *const c_char) -> *const glib_ffi::GVariantType>,
    pub get_action_state_hint: Option<unsafe extern "C" fn(*mut GActionGroup, *const c_char) -> *mut glib_ffi::GVariant>,
    pub get_action_state: Option<unsafe extern "C" fn(*mut GActionGroup, *const c_char) -> *mut glib_ffi::GVariant>,
    pub change_action_state: Option<unsafe extern "C" fn(*mut GActionGroup, *const c_char, *mut glib_ffi::GVariant)>,
    pub activate_action: Option<unsafe extern "C" fn(*mut GActionGroup, *const c_char, *mut glib_ffi::GVariant)>,
    ...
    pub action_state_changed: Option<unsafe extern "C" fn(*mut GActionGroup, *const c_char, *mut glib_ffi::GVariant)>,
    pub query_action: Option<unsafe extern "C" fn(*mut GActionGroup, *const c_char, *mut gboolean, *mut *const glib_ffi::GVariantType, *mut *const glib_ffi::GVariantType, *mut *mut glib_ffi::GVariant, *mut *mut glib_ffi::GVariant) -> gboolean>,
}
...
pub struct GActionInterface {
    ...
    pub get_parameter_type: Option<unsafe extern "C" fn(*mut GAction) -> *const glib_ffi::GVariantType>,
    pub get_state_type: Option<unsafe extern "C" fn(*mut GAction) -> *const glib_ffi::GVariantType>,
    pub get_state_hint: Option<unsafe extern "C" fn(*mut GAction) -> *mut glib_ffi::GVariant>,
    pub get_enabled: Option<unsafe extern "C" fn(*mut GAction) -> gboolean>,
    pub get_state: Option<unsafe extern "C" fn(*mut GAction) -> *mut glib_ffi::GVariant>,
    pub change_state: Option<unsafe extern "C" fn(*mut GAction, *mut glib_ffi::GVariant)>,
    pub activate: Option<unsafe extern "C" fn(*mut GAction, *mut glib_ffi::GVariant)>,
}
...
pub struct GAppInfoIface {
    ...
    pub launch: Option<unsafe extern "C" fn(*mut GAppInfo, *mut glib_ffi::GList, *mut GAppLaunchContext, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub launch_uris: Option<unsafe extern "C" fn(*mut GAppInfo, *mut glib_ffi::GList, *mut GAppLaunchContext, *mut *mut glib_ffi::GError) -> gboolean>,
    pub should_show: Option<unsafe extern "C" fn(*mut GAppInfo) -> gboolean>,
    pub set_as_default_for_type: Option<unsafe extern "C" fn(*mut GAppInfo, *const c_char, *mut *mut glib_ffi::GError) -> gboolean>,
    pub set_as_default_for_extension: Option<unsafe extern "C" fn(*mut GAppInfo, *const c_char, *mut *mut glib_ffi::GError) -> gboolean>,
    pub add_supports_type: Option<unsafe extern "C" fn(*mut GAppInfo, *const c_char, *mut *mut glib_ffi::GError) -> gboolean>,
    pub can_remove_supports_type: Option<unsafe extern "C" fn(*mut GAppInfo) -> gboolean>,
    pub remove_supports_type: Option<unsafe extern "C" fn(*mut GAppInfo, *const c_char, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub set_as_last_used_for_type: Option<unsafe extern "C" fn(*mut GAppInfo, *const c_char, *mut *mut glib_ffi::GError) -> gboolean>,
...
pub struct GAppLaunchContextClass {
    ...
    pub get_display: Option<unsafe extern "C" fn(*mut GAppLaunchContext, *mut GAppInfo, *mut glib_ffi::GList) -> *mut c_char>,
    pub get_startup_notify_id: Option<unsafe extern "C" fn(*mut GAppLaunchContext, *mut GAppInfo, *mut glib_ffi::GList) -> *mut c_char>,
    pub launch_failed: Option<unsafe extern "C" fn(*mut GAppLaunchContext, *const c_char)>,
    pub launched: Option<unsafe extern "C" fn(*mut GAppLaunchContext, *mut GAppInfo, *mut glib_ffi::GVariant)>,
...
#[repr(C)]
pub struct GAppLaunchContextPrivate;
...
pub struct GApplicationClass {
    ...
    pub before_emit: Option<unsafe extern "C" fn(*mut GApplication, *mut glib_ffi::GVariant)>,
    pub after_emit: Option<unsafe extern "C" fn(*mut GApplication, *mut glib_ffi::GVariant)>,
    pub add_platform_data: Option<unsafe extern "C" fn(*mut GApplication, *mut glib_ffi::GVariantBuilder)>,
    ...
    pub dbus_register: Option<unsafe extern "C" fn(*mut GApplication, *mut GDBusConnection, *const c_char, *mut *mut glib_ffi::GError) -> gboolean>,
    pub dbus_unregister: Option<unsafe extern "C" fn(*mut GApplication, *mut GDBusConnection, *const c_char)>,
    pub handle_local_options: Option<unsafe extern "C" fn(*mut GApplication, *mut glib_ffi::GVariantDict) -> c_int>,
    padding: [gpointer; 8],
}
...
#[repr(C)]
pub struct GApplicationCommandLinePrivate;

#[repr(C)]
pub struct GApplicationPrivate;
...
pub struct GAsyncInitableIface {
    ...
    pub init_finish: Option<unsafe extern "C" fn(*mut GAsyncInitable, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
}
...
pub struct GAsyncResultIface {
    ...
    pub get_source_object: Option<unsafe extern "C" fn(*mut GAsyncResult) -> *mut gobject_ffi::GObject>,
...
pub struct GBufferedInputStreamClass {
    ...
    pub fill: Option<unsafe extern "C" fn(*mut GBufferedInputStream, ssize_t, *mut GCancellable, *mut *mut glib_ffi::GError) -> ssize_t>,
    ...
    pub fill_finish: Option<unsafe extern "C" fn(*mut GBufferedInputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> ssize_t>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GBufferedInputStreamPrivate;
...
#[repr(C)]
pub struct GBufferedOutputStreamPrivate;
...
#[repr(C)]
pub struct GCancellablePrivate;
...
pub struct GConverterIface {
    pub g_iface: gobject_ffi::GTypeInterface,
    pub convert: Option<unsafe extern "C" fn(*mut GConverter, *mut u8, size_t, *mut c_void, size_t, GConverterFlags, *mut size_t, *mut size_t, *mut *mut glib_ffi::GError) -> GConverterResult>,
...
#[repr(C)]
pub struct GConverterInputStreamPrivate;
...
#[repr(C)]
pub struct GConverterOutputStreamPrivate;

#[repr(C)]
pub struct GCredentialsClass;
...
pub struct GDBusInterfaceSkeletonClass {
    ...
    pub get_properties: Option<unsafe extern "C" fn(*mut GDBusInterfaceSkeleton) -> *mut glib_ffi::GVariant>,
...
#[repr(C)]
pub struct GDBusInterfaceSkeletonPrivate;
...
pub struct GDBusObjectIface {
    ...
    pub get_interfaces: Option<unsafe extern "C" fn(*mut GDBusObject) -> *mut glib_ffi::GList>,
...
pub struct GDBusObjectManagerClientClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub interface_proxy_signal: Option<unsafe extern "C" fn(*mut GDBusObjectManagerClient, *mut GDBusObjectProxy, *mut GDBusProxy, *const c_char, *const c_char, *mut glib_ffi::GVariant)>,
    pub interface_proxy_properties_changed: Option<unsafe extern "C" fn(*mut GDBusObjectManagerClient, *mut GDBusObjectProxy, *mut GDBusProxy, *mut glib_ffi::GVariant, *const *const c_char)>,
    padding: [gpointer; 8],
}

#[repr(C)]
pub struct GDBusObjectManagerClientPrivate;

#[repr(C)]
pub struct GDBusObjectManagerIface {
    pub parent_iface: gobject_ffi::GTypeInterface,
    pub get_object_path: Option<unsafe extern "C" fn(*mut GDBusObjectManager) -> *const c_char>,
    pub get_objects: Option<unsafe extern "C" fn(*mut GDBusObjectManager) -> *mut glib_ffi::GList>,
...
#[repr(C)]
pub struct GDBusObjectManagerServerPrivate;
...
#[repr(C)]
pub struct GDBusObjectProxyPrivate;
...
#[repr(C)]
pub struct GDBusObjectSkeletonPrivate;
...
pub struct GDBusProxyClass {
    parent_class: gobject_ffi::GObjectClass,
    pub g_properties_changed: Option<unsafe extern "C" fn(*mut GDBusProxy, *mut glib_ffi::GVariant, *const *const c_char)>,
    pub g_signal: Option<unsafe extern "C" fn(*mut GDBusProxy, *const c_char, *const c_char, *mut glib_ffi::GVariant)>,
    padding: [gpointer; 32],
}

#[repr(C)]
pub struct GDBusProxyPrivate;
...
#[repr(C)]
pub struct GDataInputStreamPrivate;
...
#[repr(C)]
pub struct GDataOutputStreamPrivate;
...
pub struct GDriveIface {
    ...
    pub get_volumes: Option<unsafe extern "C" fn(*mut GDrive) -> *mut glib_ffi::GList>,
    ...
    pub eject_finish: Option<unsafe extern "C" fn(*mut GDrive, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub poll_for_media: Option<unsafe extern "C" fn(*mut GDrive, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub poll_for_media_finish: Option<unsafe extern "C" fn(*mut GDrive, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub start_finish: Option<unsafe extern "C" fn(*mut GDrive, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub stop_finish: Option<unsafe extern "C" fn(*mut GDrive, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub eject_with_operation_finish: Option<unsafe extern "C" fn(*mut GDrive, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
...
#[repr(C)]
pub struct GEmblemedIconPrivate;
...
pub struct GFileEnumeratorClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub next_file: Option<unsafe extern "C" fn(*mut GFileEnumerator, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    pub close_fn: Option<unsafe extern "C" fn(*mut GFileEnumerator, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub next_files_finish: Option<unsafe extern "C" fn(*mut GFileEnumerator, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    pub close_async: Option<unsafe extern "C" fn(*mut GFileEnumerator, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub close_finish: Option<unsafe extern "C" fn(*mut GFileEnumerator, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GFileEnumeratorPrivate;
...
pub struct GFileIOStreamClass {
    ...
    pub seek: Option<unsafe extern "C" fn(*mut GFileIOStream, i64, glib_ffi::GSeekType, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub can_truncate: Option<unsafe extern "C" fn(*mut GFileIOStream) -> gboolean>,
    pub truncate_fn: Option<unsafe extern "C" fn(*mut GFileIOStream, i64, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub query_info: Option<unsafe extern "C" fn(*mut GFileIOStream, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    ...
    pub query_info_finish: Option<unsafe extern "C" fn(*mut GFileIOStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
...
#[repr(C)]
pub struct GFileIOStreamPrivate;

#[repr(C)]
pub struct GFileIconClass;
...
pub struct GFileIface {
    ...
    pub get_child_for_display_name: Option<unsafe extern "C" fn(*mut GFile, *const c_char, *mut *mut glib_ffi::GError) -> *mut GFile>,
    pub enumerate_children: Option<unsafe extern "C" fn(*mut GFile, *const c_char, GFileQueryInfoFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileEnumerator>,
    ...
    pub enumerate_children_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileEnumerator>,
    pub query_info: Option<unsafe extern "C" fn(*mut GFile, *const c_char, GFileQueryInfoFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    ...
    pub query_info_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    pub query_filesystem_info: Option<unsafe extern "C" fn(*mut GFile, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    ...
    pub query_filesystem_info_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    pub find_enclosing_mount: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GMount>,
    pub find_enclosing_mount_async: Option<unsafe extern "C" fn(*mut GFile, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub find_enclosing_mount_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GMount>,
    pub set_display_name: Option<unsafe extern "C" fn(*mut GFile, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFile>,
    ...
    pub set_display_name_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFile>,
    pub query_settable_attributes: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileAttributeInfoList>,
    ...
    pub query_writable_namespaces: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileAttributeInfoList>,
    ...
    pub set_attribute: Option<unsafe extern "C" fn(*mut GFile, *const c_char, GFileAttributeType, gpointer, GFileQueryInfoFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub set_attributes_from_info: Option<unsafe extern "C" fn(*mut GFile, *mut GFileInfo, GFileQueryInfoFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub set_attributes_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut GFileInfo, *mut *mut glib_ffi::GError) -> gboolean>,
    pub read_fn: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileInputStream>,
    pub read_async: Option<unsafe extern "C" fn(*mut GFile, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub read_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileInputStream>,
    pub append_to: Option<unsafe extern "C" fn(*mut GFile, GFileCreateFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileOutputStream>,
    ...
    pub append_to_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileOutputStream>,
    pub create: Option<unsafe extern "C" fn(*mut GFile, GFileCreateFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileOutputStream>,
    ...
    pub create_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileOutputStream>,
    pub replace: Option<unsafe extern "C" fn(*mut GFile, *const c_char, gboolean, GFileCreateFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileOutputStream>,
    ...
    pub replace_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileOutputStream>,
    pub delete_file: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub delete_file_async: Option<unsafe extern "C" fn(*mut GFile, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub delete_file_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub trash: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub trash_async: Option<unsafe extern "C" fn(*mut GFile, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub trash_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub make_directory: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub make_directory_async: Option<unsafe extern "C" fn(*mut GFile, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub make_directory_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub make_symbolic_link: Option<unsafe extern "C" fn(*mut GFile, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub _make_symbolic_link_async: Option<unsafe extern "C" fn()>,
    pub _make_symbolic_link_finish: Option<unsafe extern "C" fn()>,
    pub copy: Option<unsafe extern "C" fn(*mut GFile, *mut GFile, GFileCopyFlags, *mut GCancellable, GFileProgressCallback, gpointer, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub copy_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub move_: Option<unsafe extern "C" fn(*mut GFile, *mut GFile, GFileCopyFlags, *mut GCancellable, GFileProgressCallback, gpointer, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub mount_mountable_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFile>,
    ...
    pub unmount_mountable_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub eject_mountable: Option<unsafe extern "C" fn(*mut GFile, GMountUnmountFlags, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub eject_mountable_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub mount_enclosing_volume_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub monitor_dir: Option<unsafe extern "C" fn(*mut GFile, GFileMonitorFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileMonitor>,
    pub monitor_file: Option<unsafe extern "C" fn(*mut GFile, GFileMonitorFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileMonitor>,
    pub open_readwrite: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileIOStream>,
    pub open_readwrite_async: Option<unsafe extern "C" fn(*mut GFile, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub open_readwrite_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileIOStream>,
    pub create_readwrite: Option<unsafe extern "C" fn(*mut GFile, GFileCreateFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileIOStream>,
    ...
    pub create_readwrite_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileIOStream>,
    pub replace_readwrite: Option<unsafe extern "C" fn(*mut GFile, *const c_char, gboolean, GFileCreateFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileIOStream>,
    ...
    pub replace_readwrite_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileIOStream>,
    ...
    pub start_mountable_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub stop_mountable_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub unmount_mountable_with_operation_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub eject_mountable_with_operation_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub poll_mountable: Option<unsafe extern "C" fn(*mut GFile, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub poll_mountable_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub measure_disk_usage: Option<unsafe extern "C" fn(*mut GFile, GFileMeasureFlags, *mut GCancellable, GFileMeasureProgressCallback, gpointer, *mut u64, *mut u64, *mut u64, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub measure_disk_usage_finish: Option<unsafe extern "C" fn(*mut GFile, *mut GAsyncResult, *mut u64, *mut u64, *mut u64, *mut *mut glib_ffi::GError) -> gboolean>,
}

#[repr(C)]
pub struct GFileInfoClass;
...
pub struct GFileInputStreamClass {
    ...
    pub seek: Option<unsafe extern "C" fn(*mut GFileInputStream, i64, glib_ffi::GSeekType, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub query_info: Option<unsafe extern "C" fn(*mut GFileInputStream, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    ...
    pub query_info_finish: Option<unsafe extern "C" fn(*mut GFileInputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GFileInputStreamPrivate;
...
#[repr(C)]
pub struct GFileMonitorPrivate;
...
pub struct GFileOutputStreamClass {
    ...
    pub seek: Option<unsafe extern "C" fn(*mut GFileOutputStream, i64, glib_ffi::GSeekType, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub can_truncate: Option<unsafe extern "C" fn(*mut GFileOutputStream) -> gboolean>,
    pub truncate_fn: Option<unsafe extern "C" fn(*mut GFileOutputStream, i64, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub query_info: Option<unsafe extern "C" fn(*mut GFileOutputStream, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
    ...
    pub query_info_finish: Option<unsafe extern "C" fn(*mut GFileOutputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GFileInfo>,
...
#[repr(C)]
pub struct GFileOutputStreamPrivate;
...
#[repr(C)]
pub struct GIOExtension;

#[repr(C)]
pub struct GIOExtensionPoint;

#[repr(C)]
pub struct GIOModuleClass;

#[repr(C)]
pub struct GIOModuleScope;

#[repr(C)]
pub struct GIOSchedulerJob;

#[repr(C)]
pub struct GIOStreamAdapter;
...
pub struct GIOStreamClass {
    ...
    pub close_fn: Option<unsafe extern "C" fn(*mut GIOStream, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub close_async: Option<unsafe extern "C" fn(*mut GIOStream, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub close_finish: Option<unsafe extern "C" fn(*mut GIOStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
pub struct GIconIface {
    ...
    pub to_tokens: Option<unsafe extern "C" fn(*mut GIcon, *mut glib_ffi::GPtrArray, *mut c_int) -> gboolean>,
    pub from_tokens: Option<unsafe extern "C" fn(*mut *mut c_char, c_int, c_int, *mut *mut glib_ffi::GError) -> *mut GIcon>,
    pub serialize: Option<unsafe extern "C" fn(*mut GIcon) -> *mut glib_ffi::GVariant>,
}
...
#[repr(C)]
pub struct GInetAddressMaskPrivate;

#[repr(C)]
pub struct GInetAddressPrivate;
...
#[repr(C)]
pub struct GInetSocketAddressPrivate;

#[repr(C)]
pub struct GInitableIface {
    pub g_iface: gobject_ffi::GTypeInterface,
    pub init: Option<unsafe extern "C" fn(*mut GInitable, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
}

#[repr(C)]
pub struct GInputStreamClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub read_fn: Option<unsafe extern "C" fn(*mut GInputStream, *mut c_void, size_t, *mut GCancellable, *mut *mut glib_ffi::GError) -> ssize_t>,
    pub skip: Option<unsafe extern "C" fn(*mut GInputStream, size_t, *mut GCancellable, *mut *mut glib_ffi::GError) -> ssize_t>,
    pub close_fn: Option<unsafe extern "C" fn(*mut GInputStream, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub read_finish: Option<unsafe extern "C" fn(*mut GInputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> ssize_t>,
    pub skip_async: Option<unsafe extern "C" fn(*mut GInputStream, size_t, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub skip_finish: Option<unsafe extern "C" fn(*mut GInputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> ssize_t>,
    pub close_async: Option<unsafe extern "C" fn(*mut GInputStream, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub close_finish: Option<unsafe extern "C" fn(*mut GInputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GInputStreamPrivate;
...
pub struct GLoadableIconIface {
    pub g_iface: gobject_ffi::GTypeInterface,
    pub load: Option<unsafe extern "C" fn(*mut GLoadableIcon, c_int, *mut *mut c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GInputStream>,
    pub load_async: Option<unsafe extern "C" fn(*mut GLoadableIcon, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub load_finish: Option<unsafe extern "C" fn(*mut GLoadableIcon, *mut GAsyncResult, *mut *mut c_char, *mut *mut glib_ffi::GError) -> *mut GInputStream>,
}
...
#[repr(C)]
pub struct GMemoryInputStreamPrivate;
...
#[repr(C)]
pub struct GMemoryOutputStreamPrivate;

#[repr(C)]
pub struct GMenuAttributeIterClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub get_next: Option<unsafe extern "C" fn(*mut GMenuAttributeIter, *mut *const c_char, *mut *mut glib_ffi::GVariant) -> gboolean>,
}

#[repr(C)]
pub struct GMenuAttributeIterPrivate;
...
#[repr(C)]
pub struct GMenuLinkIterPrivate;
...
pub struct GMenuModelClass {
    ...
    pub get_item_attributes: Option<unsafe extern "C" fn(*mut GMenuModel, c_int, *mut *mut glib_ffi::GHashTable)>,
    pub iterate_item_attributes: Option<unsafe extern "C" fn(*mut GMenuModel, c_int) -> *mut GMenuAttributeIter>,
    pub get_item_attribute_value: Option<unsafe extern "C" fn(*mut GMenuModel, c_int, *const c_char, *const glib_ffi::GVariantType) -> *mut glib_ffi::GVariant>,
    pub get_item_links: Option<unsafe extern "C" fn(*mut GMenuModel, c_int, *mut *mut glib_ffi::GHashTable)>,
...
pub struct GMountIface {
    ...
    pub unmount_finish: Option<unsafe extern "C" fn(*mut GMount, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub eject: Option<unsafe extern "C" fn(*mut GMount, GMountUnmountFlags, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub eject_finish: Option<unsafe extern "C" fn(*mut GMount, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub remount_finish: Option<unsafe extern "C" fn(*mut GMount, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub guess_content_type: Option<unsafe extern "C" fn(*mut GMount, gboolean, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub guess_content_type_finish: Option<unsafe extern "C" fn(*mut GMount, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut *mut c_char>,
    pub guess_content_type_sync: Option<unsafe extern "C" fn(*mut GMount, gboolean, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut *mut c_char>,
    ...
    pub unmount_with_operation_finish: Option<unsafe extern "C" fn(*mut GMount, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub eject_with_operation_finish: Option<unsafe extern "C" fn(*mut GMount, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
...
pub struct GMountOperationClass {
    ...
    pub show_processes: Option<unsafe extern "C" fn(*mut GMountOperation, *const c_char, *mut glib_ffi::GArray, *const c_char)>,
...
#[repr(C)]
pub struct GMountOperationPrivate;
...
#[repr(C)]
pub struct GNetworkAddressPrivate;

#[repr(C)]
pub struct GNetworkMonitorInterface {
    pub g_iface: gobject_ffi::GTypeInterface,
    pub network_changed: Option<unsafe extern "C" fn(*mut GNetworkMonitor, gboolean)>,
    pub can_reach: Option<unsafe extern "C" fn(*mut GNetworkMonitor, *mut GSocketConnectable, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub can_reach_finish: Option<unsafe extern "C" fn(*mut GNetworkMonitor, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
}
...
#[repr(C)]
pub struct GNetworkServicePrivate;
...
pub struct GOutputStreamClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub write_fn: Option<unsafe extern "C" fn(*mut GOutputStream, *mut u8, size_t, *mut GCancellable, *mut *mut glib_ffi::GError) -> ssize_t>,
    pub splice: Option<unsafe extern "C" fn(*mut GOutputStream, *mut GInputStream, GOutputStreamSpliceFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> ssize_t>,
    pub flush: Option<unsafe extern "C" fn(*mut GOutputStream, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub close_fn: Option<unsafe extern "C" fn(*mut GOutputStream, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub write_finish: Option<unsafe extern "C" fn(*mut GOutputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> ssize_t>,
    ...
    pub splice_finish: Option<unsafe extern "C" fn(*mut GOutputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> ssize_t>,
    pub flush_async: Option<unsafe extern "C" fn(*mut GOutputStream, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub flush_finish: Option<unsafe extern "C" fn(*mut GOutputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub close_async: Option<unsafe extern "C" fn(*mut GOutputStream, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub close_finish: Option<unsafe extern "C" fn(*mut GOutputStream, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GOutputStreamPrivate;
...
pub struct GPermissionClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub acquire: Option<unsafe extern "C" fn(*mut GPermission, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub acquire_async: Option<unsafe extern "C" fn(*mut GPermission, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub acquire_finish: Option<unsafe extern "C" fn(*mut GPermission, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub release: Option<unsafe extern "C" fn(*mut GPermission, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub release_async: Option<unsafe extern "C" fn(*mut GPermission, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub release_finish: Option<unsafe extern "C" fn(*mut GPermission, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub reserved: [gpointer; 16],
}

#[repr(C)]
pub struct GPermissionPrivate;
...
pub struct GPollableInputStreamInterface {
    ...
    pub create_source: Option<unsafe extern "C" fn(*mut GPollableInputStream, *mut GCancellable) -> *mut glib_ffi::GSource>,
    pub read_nonblocking: Option<unsafe extern "C" fn(*mut GPollableInputStream, *mut u8, size_t, *mut *mut glib_ffi::GError) -> ssize_t>,
}
...
pub struct GPollableOutputStreamInterface {
    ...
    pub create_source: Option<unsafe extern "C" fn(*mut GPollableOutputStream, *mut GCancellable) -> *mut glib_ffi::GSource>,
    pub write_nonblocking: Option<unsafe extern "C" fn(*mut GPollableOutputStream, *mut u8, size_t, *mut *mut glib_ffi::GError) -> ssize_t>,
}
...
#[repr(C)]
pub struct GProxyAddressEnumeratorPrivate;

#[repr(C)]
pub struct GProxyAddressPrivate;

#[repr(C)]
pub struct GProxyInterface {
    pub g_iface: gobject_ffi::GTypeInterface,
    pub connect: Option<unsafe extern "C" fn(*mut GProxy, *mut GIOStream, *mut GProxyAddress, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GIOStream>,
    ...
    pub connect_finish: Option<unsafe extern "C" fn(*mut GProxy, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GIOStream>,
...
pub struct GProxyResolverInterface {
    ...
    pub lookup: Option<unsafe extern "C" fn(*mut GProxyResolver, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut *mut c_char>,
    pub lookup_async: Option<unsafe extern "C" fn(*mut GProxyResolver, *const c_char, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub lookup_finish: Option<unsafe extern "C" fn(*mut GProxyResolver, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut *mut c_char>,
}

#[repr(C)]
pub struct GRemoteActionGroupInterface {
    pub g_iface: gobject_ffi::GTypeInterface,
    pub activate_action_full: Option<unsafe extern "C" fn(*mut GRemoteActionGroup, *const c_char, *mut glib_ffi::GVariant, *mut glib_ffi::GVariant)>,
    pub change_action_state_full: Option<unsafe extern "C" fn(*mut GRemoteActionGroup, *const c_char, *mut glib_ffi::GVariant, *mut glib_ffi::GVariant)>,
}
...
pub struct GResolverClass {
    ...
    pub lookup_by_name: Option<unsafe extern "C" fn(*mut GResolver, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    ...
    pub lookup_by_name_finish: Option<unsafe extern "C" fn(*mut GResolver, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    pub lookup_by_address: Option<unsafe extern "C" fn(*mut GResolver, *mut GInetAddress, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut c_char>,
    ...
    pub lookup_by_address_finish: Option<unsafe extern "C" fn(*mut GResolver, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut c_char>,
    pub lookup_service: Option<unsafe extern "C" fn(*mut GResolver, *const c_char, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    ...
    pub lookup_service_finish: Option<unsafe extern "C" fn(*mut GResolver, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    pub lookup_records: Option<unsafe extern "C" fn(*mut GResolver, *const c_char, GResolverRecordType, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    ...
    pub lookup_records_finish: Option<unsafe extern "C" fn(*mut GResolver, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
    pub _g_reserved5: Option<unsafe extern "C" fn()>,
    pub _g_reserved6: Option<unsafe extern "C" fn()>,
}
...
pub struct GSeekableIface {
    ...
    pub seek: Option<unsafe extern "C" fn(*mut GSeekable, i64, glib_ffi::GSeekType, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub can_truncate: Option<unsafe extern "C" fn(*mut GSeekable) -> gboolean>,
    pub truncate_fn: Option<unsafe extern "C" fn(*mut GSeekable, i64, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
}
...
pub struct GSettingsClass {
    ...
    pub writable_change_event: Option<unsafe extern "C" fn(*mut GSettings, glib_ffi::GQuark) -> gboolean>,
    pub change_event: Option<unsafe extern "C" fn(*mut GSettings, *const glib_ffi::GQuark, c_int) -> gboolean>,
    pub padding: [gpointer; 20],
}

#[repr(C)]
pub struct GSettingsPrivate;
...
#[repr(C)]
pub struct GSimpleActionGroupPrivate;

#[repr(C)]
pub struct GSimpleAsyncResultClass;
...
#[repr(C)]
pub struct GSimpleProxyResolverPrivate;
...
pub struct GSocketAddressClass {
    ...
    pub to_native: Option<unsafe extern "C" fn(*mut GSocketAddress, gpointer, size_t, *mut *mut glib_ffi::GError) -> gboolean>,
}

#[repr(C)]
pub struct GSocketAddressEnumeratorClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub next: Option<unsafe extern "C" fn(*mut GSocketAddressEnumerator, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GSocketAddress>,
    pub next_async: Option<unsafe extern "C" fn(*mut GSocketAddressEnumerator, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub next_finish: Option<unsafe extern "C" fn(*mut GSocketAddressEnumerator, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GSocketAddress>,
}
...
#[repr(C)]
pub struct GSocketClientPrivate;
...
#[repr(C)]
pub struct GSocketConnectionPrivate;
...
#[repr(C)]
pub struct GSocketControlMessagePrivate;
...
#[repr(C)]
pub struct GSocketListenerPrivate;

#[repr(C)]
pub struct GSocketPrivate;

#[repr(C)]
pub struct GSocketServiceClass {
    pub parent_class: GSocketListenerClass,
    pub incoming: Option<unsafe extern "C" fn(*mut GSocketService, *mut GSocketConnection, *mut gobject_ffi::GObject) -> gboolean>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GSocketServicePrivate;
...
#[repr(C)]
pub struct GTcpConnectionPrivate;
...
#[repr(C)]
pub struct GTcpWrapperConnectionPrivate;

#[repr(C)]
pub struct GThemedIconClass;

#[repr(C)]
pub struct GThreadedSocketServiceClass {
    pub parent_class: GSocketServiceClass,
    pub run: Option<unsafe extern "C" fn(*mut GThreadedSocketService, *mut GSocketConnection, *mut gobject_ffi::GObject) -> gboolean>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GThreadedSocketServicePrivate;
...
#[repr(C)]
pub struct GTlsCertificatePrivate;
...
pub struct GTlsConnectionClass {
    ...
    pub handshake: Option<unsafe extern "C" fn(*mut GTlsConnection, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    pub handshake_async: Option<unsafe extern "C" fn(*mut GTlsConnection, c_int, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub handshake_finish: Option<unsafe extern "C" fn(*mut GTlsConnection, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    padding: [gpointer; 8],
}

#[repr(C)]
pub struct GTlsConnectionPrivate;

#[repr(C)]
pub struct GTlsDatabaseClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub verify_chain: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut GTlsCertificate, *const c_char, *mut GSocketConnectable, *mut GTlsInteraction, GTlsDatabaseVerifyFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> GTlsCertificateFlags>,
    ...
    pub verify_chain_finish: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> GTlsCertificateFlags>,
    pub create_certificate_handle: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut GTlsCertificate) -> *mut c_char>,
    pub lookup_certificate_for_handle: Option<unsafe extern "C" fn(*mut GTlsDatabase, *const c_char, *mut GTlsInteraction, GTlsDatabaseLookupFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GTlsCertificate>,
    ...
    pub lookup_certificate_for_handle_finish: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GTlsCertificate>,
    pub lookup_certificate_issuer: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut GTlsCertificate, *mut GTlsInteraction, GTlsDatabaseLookupFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut GTlsCertificate>,
    ...
    pub lookup_certificate_issuer_finish: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut GTlsCertificate>,
    pub lookup_certificates_issued_by: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut glib_ffi::GByteArray, *mut GTlsInteraction, GTlsDatabaseLookupFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    pub lookup_certificates_issued_by_async: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut glib_ffi::GByteArray, *mut GTlsInteraction, GTlsDatabaseLookupFlags, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub lookup_certificates_issued_by_finish: Option<unsafe extern "C" fn(*mut GTlsDatabase, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList>,
    padding: [gpointer; 16],
}

#[repr(C)]
pub struct GTlsDatabasePrivate;
...
pub struct GTlsInteractionClass {
    parent_class: gobject_ffi::GObjectClass,
    pub ask_password: Option<unsafe extern "C" fn(*mut GTlsInteraction, *mut GTlsPassword, *mut GCancellable, *mut *mut glib_ffi::GError) -> GTlsInteractionResult>,
    ...
    pub ask_password_finish: Option<unsafe extern "C" fn(*mut GTlsInteraction, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> GTlsInteractionResult>,
    pub request_certificate: Option<unsafe extern "C" fn(*mut GTlsInteraction, *mut GTlsConnection, GTlsCertificateRequestFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> GTlsInteractionResult>,
    ...
    pub request_certificate_finish: Option<unsafe extern "C" fn(*mut GTlsInteraction, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> GTlsInteractionResult>,
    padding: [gpointer; 21],
}

#[repr(C)]
pub struct GTlsInteractionPrivate;

#[repr(C)]
pub struct GTlsPasswordClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub get_value: Option<unsafe extern "C" fn(*mut GTlsPassword, *mut size_t) -> *const u8>,
    pub set_value: Option<unsafe extern "C" fn(*mut GTlsPassword, *mut u8, ssize_t, glib_ffi::GDestroyNotify)>,
    pub get_default_warning: Option<unsafe extern "C" fn(*mut GTlsPassword) -> *const c_char>,
    padding: [gpointer; 4],
}

#[repr(C)]
pub struct GTlsPasswordPrivate;
...
#[repr(C)]
pub struct GUnixConnectionPrivate;
...
#[repr(C)]
pub struct GUnixCredentialsMessagePrivate;
...
#[repr(C)]
pub struct GUnixFDMessagePrivate;
...
#[repr(C)]
pub struct GUnixInputStreamPrivate;

#[repr(C)]
pub struct GUnixMountEntry;

#[repr(C)]
pub struct GUnixMountMonitorClass;
...
#[repr(C)]
pub struct GUnixOutputStreamPrivate;
...
#[repr(C)]
pub struct GUnixSocketAddressPrivate;
...
pub struct GVfsClass {
    ...
    pub local_file_add_info: Option<unsafe extern "C" fn(*mut GVfs, *const c_char, u64, *mut GFileAttributeMatcher, *mut GFileInfo, *mut GCancellable, *mut gpointer, *mut glib_ffi::GDestroyNotify)>,
    pub add_writable_namespaces: Option<unsafe extern "C" fn(*mut GVfs, *mut GFileAttributeInfoList)>,
    pub local_file_set_attributes: Option<unsafe extern "C" fn(*mut GVfs, *const c_char, *mut GFileInfo, GFileQueryInfoFlags, *mut GCancellable, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub deserialize_icon: Option<unsafe extern "C" fn(*mut GVfs, *mut glib_ffi::GVariant) -> *mut GIcon>,
    pub _g_reserved1: Option<unsafe extern "C" fn()>,
    pub _g_reserved2: Option<unsafe extern "C" fn()>,
    pub _g_reserved3: Option<unsafe extern "C" fn()>,
    pub _g_reserved4: Option<unsafe extern "C" fn()>,
...
pub struct GVolumeIface {
    ...
    pub mount_finish: Option<unsafe extern "C" fn(*mut GVolume, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    pub eject: Option<unsafe extern "C" fn(*mut GVolume, GMountUnmountFlags, *mut GCancellable, GAsyncReadyCallback, gpointer)>,
    pub eject_finish: Option<unsafe extern "C" fn(*mut GVolume, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub eject_with_operation_finish: Option<unsafe extern "C" fn(*mut GVolume, *mut GAsyncResult, *mut *mut glib_ffi::GError) -> gboolean>,
...
pub struct GVolumeMonitorClass {
    ...
    pub get_connected_drives: Option<unsafe extern "C" fn(*mut GVolumeMonitor) -> *mut glib_ffi::GList>,
    pub get_volumes: Option<unsafe extern "C" fn(*mut GVolumeMonitor) -> *mut glib_ffi::GList>,
    pub get_mounts: Option<unsafe extern "C" fn(*mut GVolumeMonitor) -> *mut glib_ffi::GList>,
...
extern "C" {
    ...
    pub fn g_dbus_interface_info_generate_xml  (info: *mut GDBusInterfaceInfo, indent: c_uint, string_builder: *mut glib_ffi::GString);
    ...
    pub fn g_dbus_node_info_new_for_xml        (xml_data: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GDBusNodeInfo;
    pub fn g_dbus_node_info_generate_xml       (info: *mut GDBusNodeInfo, indent: c_uint, string_builder: *mut glib_ffi::GString);
    ...
    pub fn g_io_extension_ref_class            (extension: *mut GIOExtension) -> *mut gobject_ffi::GTypeClass;
    ...
    pub fn g_io_extension_point_get_extensions (extension_point: *mut GIOExtensionPoint) -> *mut glib_ffi::GList;
    ...
    // GIOSchedulerJob
    //=========================================================================
    pub fn g_io_scheduler_job_send_to_mainloop (job: *mut GIOSchedulerJob, func: glib_ffi::GSourceFunc, user_data: gpointer, notify: glib_ffi::GDestroyNotify) -> gboolean;
    pub fn g_io_scheduler_job_send_to_mainloop_async(job: *mut GIOSchedulerJob, func: glib_ffi::GSourceFunc, user_data: gpointer, notify: glib_ffi::GDestroyNotify);
    ...
    #[cfg(gio_2_32)]
    pub fn g_resource_new_from_data            (data: *mut glib_ffi::GBytes, error: *mut *mut glib_ffi::GError) -> *mut GResource;
    #[cfg(gio_2_32)]
    pub fn g_resource_enumerate_children       (resource: *mut GResource, path: *const c_char, lookup_flags: GResourceLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut *mut c_char;
    #[cfg(gio_2_32)]
    pub fn g_resource_get_info                 (resource: *mut GResource, path: *const c_char, lookup_flags: GResourceLookupFlags, size: *mut size_t, flags: *mut u32, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_32)]
    pub fn g_resource_lookup_data              (resource: *mut GResource, path: *const c_char, lookup_flags: GResourceLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GBytes;
    #[cfg(gio_2_32)]
    pub fn g_resource_open_stream              (resource: *mut GResource, path: *const c_char, lookup_flags: GResourceLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut GInputStream;
    #[cfg(gio_2_32)]
    pub fn g_resource_ref                      (resource: *mut GResource) -> *mut GResource;
    #[cfg(gio_2_32)]
    pub fn g_resource_unref                    (resource: *mut GResource);
    #[cfg(gio_2_32)]
    pub fn g_resource_load                     (filename: *mut c_char, error: *mut *mut glib_ffi::GError) -> *mut GResource;
    ...
    #[cfg(gio_2_40)]
    pub fn g_settings_schema_key_get_default_value(key: *mut GSettingsSchemaKey) -> *mut glib_ffi::GVariant;
    #[cfg(gio_2_34)]
    ...
    #[cfg(gio_2_40)]
    pub fn g_settings_schema_key_get_range     (key: *mut GSettingsSchemaKey) -> *mut glib_ffi::GVariant;
    #[cfg(gio_2_34)]
    pub fn g_settings_schema_key_get_summary   (key: *mut GSettingsSchemaKey) -> *const c_char;
    #[cfg(gio_2_40)]
    pub fn g_settings_schema_key_get_value_type(key: *mut GSettingsSchemaKey) -> *const glib_ffi::GVariantType;
    #[cfg(gio_2_40)]
    pub fn g_settings_schema_key_range_check   (key: *mut GSettingsSchemaKey, value: *mut glib_ffi::GVariant) -> gboolean;
    #[cfg(gio_2_40)]
    ...
    #[cfg(gio_2_32)]
    pub fn g_settings_schema_source_new_from_directory(directory: *const c_char, parent: *mut GSettingsSchemaSource, trusted: gboolean, error: *mut *mut glib_ffi::GError) -> *mut GSettingsSchemaSource;
    #[cfg(gio_2_40)]
    ...
    pub fn g_srv_target_list_sort              (targets: *mut glib_ffi::GList) -> *mut glib_ffi::GList;
    ...
    pub fn g_app_launch_context_get_display    (context: *mut GAppLaunchContext, info: *mut GAppInfo, files: *mut glib_ffi::GList) -> *mut c_char;
    #[cfg(gio_2_32)]
    pub fn g_app_launch_context_get_environment(context: *mut GAppLaunchContext) -> *mut *mut c_char;
    pub fn g_app_launch_context_get_startup_notify_id(context: *mut GAppLaunchContext, info: *mut GAppInfo, files: *mut glib_ffi::GList) -> *mut c_char;
    ...
    #[cfg(gio_2_42)]
    pub fn g_application_add_main_option       (application: *mut GApplication, long_name: *const c_char, short_name: c_char, flags: glib_ffi::GOptionFlags, arg: glib_ffi::GOptionArg, description: *const c_char, arg_description: *const c_char);
    #[cfg(gio_2_40)]
    pub fn g_application_add_main_option_entries(application: *mut GApplication, entries: *mut glib_ffi::GOptionEntry);
    #[cfg(gio_2_40)]
    pub fn g_application_add_option_group      (application: *mut GApplication, group: *mut glib_ffi::GOptionGroup);
    #[cfg(gio_2_44)]
    ...
    pub fn g_application_register              (application: *mut GApplication, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_40)]
    pub fn g_application_command_line_get_options_dict(cmdline: *mut GApplicationCommandLine) -> *mut glib_ffi::GVariantDict;
    pub fn g_application_command_line_get_platform_data(cmdline: *mut GApplicationCommandLine) -> *mut glib_ffi::GVariant;
    #[cfg(gio_2_34)]
    ...
    pub fn g_buffered_input_stream_fill        (stream: *mut GBufferedInputStream, count: ssize_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    ...
    pub fn g_buffered_input_stream_fill_finish (stream: *mut GBufferedInputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> ssize_t;
    ...
    pub fn g_buffered_input_stream_read_byte   (stream: *mut GBufferedInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> c_int;
    ...
    #[cfg(gio_2_38)]
    pub fn g_bytes_icon_new                    (bytes: *mut glib_ffi::GBytes) -> *mut GIcon;
    #[cfg(gio_2_38)]
    pub fn g_bytes_icon_get_bytes              (icon: *mut GBytesIcon) -> *mut glib_ffi::GBytes;
    ...
    pub fn g_cancellable_connect               (cancellable: *mut GCancellable, callback: gobject_ffi::GCallback, data: gpointer, data_destroy_func: glib_ffi::GDestroyNotify) -> c_ulong;
    ...
    pub fn g_cancellable_make_pollfd           (cancellable: *mut GCancellable, pollfd: *mut glib_ffi::GPollFD) -> gboolean;
    ...
    pub fn g_cancellable_set_error_if_cancelled(cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_cancellable_source_new            (cancellable: *mut GCancellable) -> *mut glib_ffi::GSource;

    //=========================================================================
    // GCharsetConverter
    //=========================================================================
    pub fn g_charset_converter_get_type        () -> GType;
    pub fn g_charset_converter_new             (to_charset: *const c_char, from_charset: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GCharsetConverter;
    ...
    #[cfg(gio_2_36)]
    pub fn g_credentials_get_unix_pid          (credentials: *mut GCredentials, error: *mut *mut glib_ffi::GError) -> c_int;
    pub fn g_credentials_get_unix_user         (credentials: *mut GCredentials, error: *mut *mut glib_ffi::GError) -> c_uint;
    pub fn g_credentials_is_same_user          (credentials: *mut GCredentials, other_credentials: *mut GCredentials, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_credentials_set_native            (credentials: *mut GCredentials, native_type: GCredentialsType, native: gpointer);
    pub fn g_credentials_set_unix_user         (credentials: *mut GCredentials, uid: c_uint, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_dbus_connection_new_finish        (res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GDBusConnection;
    pub fn g_dbus_connection_new_for_address_finish(res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GDBusConnection;
    pub fn g_dbus_connection_new_for_address_sync(address: *const c_char, flags: GDBusConnectionFlags, observer: *mut GDBusAuthObserver, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusConnection;
    pub fn g_dbus_connection_new_sync          (stream: *mut GIOStream, guid: *const c_char, flags: GDBusConnectionFlags, observer: *mut GDBusAuthObserver, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusConnection;
    ...
    pub fn g_dbus_connection_add_filter        (connection: *mut GDBusConnection, filter_function: GDBusMessageFilterFunction, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify) -> c_uint;
    pub fn g_dbus_connection_call              (connection: *mut GDBusConnection, bus_name: *const c_char, object_path: *const c_char, interface_name: *const c_char, method_name: *const c_char, parameters: *mut glib_ffi::GVariant, reply_type: *const glib_ffi::GVariantType, flags: GDBusCallFlags, timeout_msec: c_int, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_dbus_connection_call_finish       (connection: *mut GDBusConnection, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GVariant;
    pub fn g_dbus_connection_call_sync         (connection: *mut GDBusConnection, bus_name: *const c_char, object_path: *const c_char, interface_name: *const c_char, method_name: *const c_char, parameters: *mut glib_ffi::GVariant, reply_type: *const glib_ffi::GVariantType, flags: GDBusCallFlags, timeout_msec: c_int, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_dbus_connection_call_with_unix_fd_list_finish(connection: *mut GDBusConnection, out_fd_list: *mut *mut GUnixFDList, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GVariant;
    pub fn g_dbus_connection_call_with_unix_fd_list_sync(connection: *mut GDBusConnection, bus_name: *const c_char, object_path: *const c_char, interface_name: *const c_char, method_name: *const c_char, parameters: *mut glib_ffi::GVariant, reply_type: *const glib_ffi::GVariantType, flags: GDBusCallFlags, timeout_msec: c_int, fd_list: *mut GUnixFDList, out_fd_list: *mut *mut GUnixFDList, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_dbus_connection_close_finish      (connection: *mut GDBusConnection, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_dbus_connection_close_sync        (connection: *mut GDBusConnection, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_dbus_connection_emit_signal       (connection: *mut GDBusConnection, destination_bus_name: *const c_char, object_path: *const c_char, interface_name: *const c_char, signal_name: *const c_char, parameters: *mut glib_ffi::GVariant, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_32)]
    pub fn g_dbus_connection_export_action_group(connection: *mut GDBusConnection, object_path: *const c_char, action_group: *mut GActionGroup, error: *mut *mut glib_ffi::GError) -> c_uint;
    #[cfg(gio_2_32)]
    pub fn g_dbus_connection_export_menu_model (connection: *mut GDBusConnection, object_path: *const c_char, menu: *mut GMenuModel, error: *mut *mut glib_ffi::GError) -> c_uint;
    ...
    pub fn g_dbus_connection_flush_finish      (connection: *mut GDBusConnection, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_dbus_connection_flush_sync        (connection: *mut GDBusConnection, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_dbus_connection_register_object   (connection: *mut GDBusConnection, object_path: *const c_char, interface_info: *mut GDBusInterfaceInfo, vtable: *const GDBusInterfaceVTable, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify, error: *mut *mut glib_ffi::GError) -> c_uint;
    pub fn g_dbus_connection_register_subtree  (connection: *mut GDBusConnection, object_path: *const c_char, vtable: *const GDBusSubtreeVTable, flags: GDBusSubtreeFlags, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify, error: *mut *mut glib_ffi::GError) -> c_uint;
    pub fn g_dbus_connection_remove_filter     (connection: *mut GDBusConnection, filter_id: c_uint);
    pub fn g_dbus_connection_send_message      (connection: *mut GDBusConnection, message: *mut GDBusMessage, flags: GDBusSendMessageFlags, out_serial: *mut Volatile<u32>, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_dbus_connection_send_message_with_reply_finish(connection: *mut GDBusConnection, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GDBusMessage;
    pub fn g_dbus_connection_send_message_with_reply_sync(connection: *mut GDBusConnection, message: *mut GDBusMessage, flags: GDBusSendMessageFlags, timeout_msec: c_int, out_serial: *mut Volatile<u32>, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusMessage;
    pub fn g_dbus_connection_set_exit_on_close (connection: *mut GDBusConnection, exit_on_close: gboolean);
    pub fn g_dbus_connection_signal_subscribe  (connection: *mut GDBusConnection, sender: *const c_char, interface_name: *const c_char, member: *const c_char, object_path: *const c_char, arg0: *const c_char, flags: GDBusSignalFlags, callback: GDBusSignalCallback, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify) -> c_uint;
    ...
    pub fn g_dbus_interface_skeleton_export    (interface_: *mut GDBusInterfaceSkeleton, connection: *mut GDBusConnection, object_path: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_32)]
    pub fn g_dbus_interface_skeleton_get_connections(interface_: *mut GDBusInterfaceSkeleton) -> *mut glib_ffi::GList;
    ...
    pub fn g_dbus_interface_skeleton_get_properties(interface_: *mut GDBusInterfaceSkeleton) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_dbus_message_new_from_blob        (blob: *mut u8, blob_len: size_t, capabilities: GDBusCapabilityFlags, error: *mut *mut glib_ffi::GError) -> *mut GDBusMessage;
    ...
    pub fn g_dbus_message_bytes_needed         (blob: *mut u8, blob_len: size_t, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_dbus_message_copy                 (message: *mut GDBusMessage, error: *mut *mut glib_ffi::GError) -> *mut GDBusMessage;
    pub fn g_dbus_message_get_arg0             (message: *mut GDBusMessage) -> *const c_char;
    pub fn g_dbus_message_get_body             (message: *mut GDBusMessage) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_dbus_message_get_header           (message: *mut GDBusMessage, header_field: GDBusMessageHeaderField) -> *mut glib_ffi::GVariant;
    ...
    //pub fn g_dbus_message_new_method_error_valist(method_call_message: *mut GDBusMessage, error_name: *const c_char, error_message_format: *const c_char, var_args: [Unsupported type va_list]) -> *mut GDBusMessage;
    ...
    pub fn g_dbus_message_set_body             (message: *mut GDBusMessage, body: *mut glib_ffi::GVariant);
    ...
    pub fn g_dbus_message_set_header           (message: *mut GDBusMessage, header_field: GDBusMessageHeaderField, value: *mut glib_ffi::GVariant);
    ...
    pub fn g_dbus_message_to_blob              (message: *mut GDBusMessage, out_size: *mut size_t, capabilities: GDBusCapabilityFlags, error: *mut *mut glib_ffi::GError) -> *mut u8;
    pub fn g_dbus_message_to_gerror            (message: *mut GDBusMessage, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_dbus_method_invocation_get_parameters(invocation: *mut GDBusMethodInvocation) -> *mut glib_ffi::GVariant;
    #[cfg(gio_2_38)]
    ...
    pub fn g_dbus_method_invocation_return_error(invocation: *mut GDBusMethodInvocation, domain: glib_ffi::GQuark, code: c_int, format: *const c_char, ...);
    pub fn g_dbus_method_invocation_return_error_literal(invocation: *mut GDBusMethodInvocation, domain: glib_ffi::GQuark, code: c_int, message: *const c_char);
    //pub fn g_dbus_method_invocation_return_error_valist(invocation: *mut GDBusMethodInvocation, domain: glib_ffi::GQuark, code: c_int, format: *const c_char, var_args: [Unsupported type va_list]);
    pub fn g_dbus_method_invocation_return_gerror(invocation: *mut GDBusMethodInvocation, error: *const glib_ffi::GError);
    pub fn g_dbus_method_invocation_return_value(invocation: *mut GDBusMethodInvocation, parameters: *mut glib_ffi::GVariant);
    pub fn g_dbus_method_invocation_return_value_with_unix_fd_list(invocation: *mut GDBusMethodInvocation, parameters: *mut glib_ffi::GVariant, fd_list: *mut GUnixFDList);
    pub fn g_dbus_method_invocation_take_error (invocation: *mut GDBusMethodInvocation, error: *mut glib_ffi::GError);

    //=========================================================================
    // GDBusObjectManagerClient
    //=========================================================================
    pub fn g_dbus_object_manager_client_get_type() -> GType;
    pub fn g_dbus_object_manager_client_new_finish(res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GDBusObjectManager;
    pub fn g_dbus_object_manager_client_new_for_bus_finish(res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GDBusObjectManager;
    pub fn g_dbus_object_manager_client_new_for_bus_sync(bus_type: GBusType, flags: GDBusObjectManagerClientFlags, name: *const c_char, object_path: *const c_char, get_proxy_type_func: GDBusProxyTypeFunc, get_proxy_type_user_data: gpointer, get_proxy_type_destroy_notify: glib_ffi::GDestroyNotify, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusObjectManager;
    pub fn g_dbus_object_manager_client_new_sync(connection: *mut GDBusConnection, flags: GDBusObjectManagerClientFlags, name: *const c_char, object_path: *const c_char, get_proxy_type_func: GDBusProxyTypeFunc, get_proxy_type_user_data: gpointer, get_proxy_type_destroy_notify: glib_ffi::GDestroyNotify, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusObjectManager;
    pub fn g_dbus_object_manager_client_new    (connection: *mut GDBusConnection, flags: GDBusObjectManagerClientFlags, name: *const c_char, object_path: *const c_char, get_proxy_type_func: GDBusProxyTypeFunc, get_proxy_type_user_data: gpointer, get_proxy_type_destroy_notify: glib_ffi::GDestroyNotify, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_dbus_object_manager_client_new_for_bus(bus_type: GBusType, flags: GDBusObjectManagerClientFlags, name: *const c_char, object_path: *const c_char, get_proxy_type_func: GDBusProxyTypeFunc, get_proxy_type_user_data: gpointer, get_proxy_type_destroy_notify: glib_ffi::GDestroyNotify, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    ...
    pub fn g_dbus_proxy_new_finish             (res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GDBusProxy;
    pub fn g_dbus_proxy_new_for_bus_finish     (res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GDBusProxy;
    pub fn g_dbus_proxy_new_for_bus_sync       (bus_type: GBusType, flags: GDBusProxyFlags, info: *mut GDBusInterfaceInfo, name: *const c_char, object_path: *const c_char, interface_name: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusProxy;
    pub fn g_dbus_proxy_new_sync               (connection: *mut GDBusConnection, flags: GDBusProxyFlags, info: *mut GDBusInterfaceInfo, name: *const c_char, object_path: *const c_char, interface_name: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusProxy;
    ...
    pub fn g_dbus_proxy_call                   (proxy: *mut GDBusProxy, method_name: *const c_char, parameters: *mut glib_ffi::GVariant, flags: GDBusCallFlags, timeout_msec: c_int, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_dbus_proxy_call_finish            (proxy: *mut GDBusProxy, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GVariant;
    pub fn g_dbus_proxy_call_sync              (proxy: *mut GDBusProxy, method_name: *const c_char, parameters: *mut glib_ffi::GVariant, flags: GDBusCallFlags, timeout_msec: c_int, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GVariant;
    pub fn g_dbus_proxy_call_with_unix_fd_list (proxy: *mut GDBusProxy, method_name: *const c_char, parameters: *mut glib_ffi::GVariant, flags: GDBusCallFlags, timeout_msec: c_int, fd_list: *mut GUnixFDList, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_dbus_proxy_call_with_unix_fd_list_finish(proxy: *mut GDBusProxy, out_fd_list: *mut *mut GUnixFDList, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GVariant;
    pub fn g_dbus_proxy_call_with_unix_fd_list_sync(proxy: *mut GDBusProxy, method_name: *const c_char, parameters: *mut glib_ffi::GVariant, flags: GDBusCallFlags, timeout_msec: c_int, fd_list: *mut GUnixFDList, out_fd_list: *mut *mut GUnixFDList, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GVariant;
    pub fn g_dbus_proxy_get_cached_property    (proxy: *mut GDBusProxy, property_name: *const c_char) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_dbus_proxy_set_cached_property    (proxy: *mut GDBusProxy, property_name: *const c_char, value: *mut glib_ffi::GVariant);
    ...
    pub fn g_dbus_server_new_sync              (address: *const c_char, flags: GDBusServerFlags, guid: *const c_char, observer: *mut GDBusAuthObserver, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusServer;
    ...
    pub fn g_data_input_stream_read_byte       (stream: *mut GDataInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> c_uchar;
    pub fn g_data_input_stream_read_int16      (stream: *mut GDataInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> i16;
    pub fn g_data_input_stream_read_int32      (stream: *mut GDataInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> i32;
    pub fn g_data_input_stream_read_int64      (stream: *mut GDataInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> i64;
    pub fn g_data_input_stream_read_line       (stream: *mut GDataInputStream, length: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut u8;
    ...
    pub fn g_data_input_stream_read_line_finish(stream: *mut GDataInputStream, result: *mut GAsyncResult, length: *mut size_t, error: *mut *mut glib_ffi::GError) -> *mut u8;
    pub fn g_data_input_stream_read_line_finish_utf8(stream: *mut GDataInputStream, result: *mut GAsyncResult, length: *mut size_t, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    pub fn g_data_input_stream_read_line_utf8  (stream: *mut GDataInputStream, length: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    pub fn g_data_input_stream_read_uint16     (stream: *mut GDataInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> u16;
    pub fn g_data_input_stream_read_uint32     (stream: *mut GDataInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> u32;
    pub fn g_data_input_stream_read_uint64     (stream: *mut GDataInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> u64;
    pub fn g_data_input_stream_read_until      (stream: *mut GDataInputStream, stop_chars: *const c_char, length: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    ...
    pub fn g_data_input_stream_read_until_finish(stream: *mut GDataInputStream, result: *mut GAsyncResult, length: *mut size_t, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    pub fn g_data_input_stream_read_upto       (stream: *mut GDataInputStream, stop_chars: *const c_char, stop_chars_len: ssize_t, length: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    ...
    pub fn g_data_input_stream_read_upto_finish(stream: *mut GDataInputStream, result: *mut GAsyncResult, length: *mut size_t, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    ...
    pub fn g_data_output_stream_put_byte       (stream: *mut GDataOutputStream, data: c_uchar, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_data_output_stream_put_int16      (stream: *mut GDataOutputStream, data: i16, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_data_output_stream_put_int32      (stream: *mut GDataOutputStream, data: i32, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_data_output_stream_put_int64      (stream: *mut GDataOutputStream, data: i64, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_data_output_stream_put_string     (stream: *mut GDataOutputStream, str: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_data_output_stream_put_uint16     (stream: *mut GDataOutputStream, data: u16, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_data_output_stream_put_uint32     (stream: *mut GDataOutputStream, data: u32, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_data_output_stream_put_uint64     (stream: *mut GDataOutputStream, data: u64, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_desktop_app_info_new_from_keyfile (key_file: *mut glib_ffi::GKeyFile) -> *mut GDesktopAppInfo;
    #[cfg(gio_2_42)]
    pub fn g_desktop_app_info_get_implementations(interface: *const c_char) -> *mut glib_ffi::GList;
    ...
    pub fn g_desktop_app_info_launch_uris_as_manager(appinfo: *mut GDesktopAppInfo, uris: *mut glib_ffi::GList, launch_context: *mut GAppLaunchContext, spawn_flags: glib_ffi::GSpawnFlags, user_setup: glib_ffi::GSpawnChildSetupFunc, user_setup_data: gpointer, pid_callback: GDesktopAppLaunchCallback, pid_callback_data: gpointer, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_38)]
    ...
    pub fn g_emblemed_icon_get_emblems         (emblemed: *mut GEmblemedIcon) -> *mut glib_ffi::GList;
    ...
    pub fn g_file_enumerator_close             (enumerator: *mut GFileEnumerator, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_enumerator_close_finish      (enumerator: *mut GFileEnumerator, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_36)]
    ...
    #[cfg(gio_2_44)]
    pub fn g_file_enumerator_iterate           (direnum: *mut GFileEnumerator, out_info: *mut *mut GFileInfo, out_child: *mut *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_enumerator_next_file         (enumerator: *mut GFileEnumerator, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_file_enumerator_next_files_finish (enumerator: *mut GFileEnumerator, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    ...
    pub fn g_file_io_stream_query_info         (stream: *mut GFileIOStream, attributes: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_file_io_stream_query_info_finish  (stream: *mut GFileIOStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_file_info_get_attribute_object    (info: *mut GFileInfo, attribute: *const c_char) -> *mut gobject_ffi::GObject;
    ...
    #[cfg(gio_2_36)]
    pub fn g_file_info_get_deletion_date       (info: *mut GFileInfo) -> *mut glib_ffi::GDateTime;
    ...
    pub fn g_file_info_get_modification_time   (info: *mut GFileInfo, result: *mut glib_ffi::GTimeVal);
    ...
    pub fn g_file_info_set_attribute_object    (info: *mut GFileInfo, attribute: *const c_char, attr_value: *mut gobject_ffi::GObject);
    ...
    pub fn g_file_info_set_modification_time   (info: *mut GFileInfo, mtime: *mut glib_ffi::GTimeVal);
    ...
    pub fn g_file_input_stream_query_info      (stream: *mut GFileInputStream, attributes: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_file_input_stream_query_info_finish(stream: *mut GFileInputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_file_output_stream_query_info     (stream: *mut GFileOutputStream, attributes: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_file_output_stream_query_info_finish(stream: *mut GFileOutputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_io_stream_splice_finish           (result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_io_stream_clear_pending           (stream: *mut GIOStream);
    pub fn g_io_stream_close                   (stream: *mut GIOStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_io_stream_close_finish            (stream: *mut GIOStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_io_stream_set_pending             (stream: *mut GIOStream, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_32)]
    pub fn g_inet_address_mask_new             (addr: *mut GInetAddress, length: c_uint, error: *mut *mut glib_ffi::GError) -> *mut GInetAddressMask;
    #[cfg(gio_2_32)]
    pub fn g_inet_address_mask_new_from_string (mask_string: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GInetAddressMask;
    #[cfg(gio_2_32)]
    ...
    pub fn g_input_stream_close                (stream: *mut GInputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_input_stream_close_finish         (stream: *mut GInputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_input_stream_read                 (stream: *mut GInputStream, buffer: *mut u8, count: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_input_stream_read_all             (stream: *mut GInputStream, buffer: *mut u8, count: size_t, bytes_read: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_44)]
    ...
    #[cfg(gio_2_44)]
    pub fn g_input_stream_read_all_finish      (stream: *mut GInputStream, result: *mut GAsyncResult, bytes_read: *mut size_t, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_34)]
    pub fn g_input_stream_read_bytes           (stream: *mut GInputStream, count: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GBytes;
    #[cfg(gio_2_34)]
    ...
    #[cfg(gio_2_34)]
    pub fn g_input_stream_read_bytes_finish    (stream: *mut GInputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GBytes;
    pub fn g_input_stream_read_finish          (stream: *mut GInputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_input_stream_set_pending          (stream: *mut GInputStream, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_input_stream_skip                 (stream: *mut GInputStream, count: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    ...
    pub fn g_input_stream_skip_finish          (stream: *mut GInputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> ssize_t;
    ...
    #[cfg(gio_2_44)]
    pub fn g_list_store_insert_sorted          (store: *mut GListStore, item: gpointer, compare_func: glib_ffi::GCompareDataFunc, user_data: gpointer) -> c_uint;
    #[cfg(gio_2_44)]
    ...
    #[cfg(gio_2_34)]
    pub fn g_memory_input_stream_new_from_bytes(bytes: *mut glib_ffi::GBytes) -> *mut GInputStream;
    pub fn g_memory_input_stream_new_from_data (data: *mut u8, len: ssize_t, destroy: glib_ffi::GDestroyNotify) -> *mut GInputStream;
    #[cfg(gio_2_34)]
    pub fn g_memory_input_stream_add_bytes     (stream: *mut GMemoryInputStream, bytes: *mut glib_ffi::GBytes);
    pub fn g_memory_input_stream_add_data      (stream: *mut GMemoryInputStream, data: *mut u8, len: ssize_t, destroy: glib_ffi::GDestroyNotify);

    //=========================================================================
    // GMemoryOutputStream
    //=========================================================================
    pub fn g_memory_output_stream_get_type     () -> GType;
    pub fn g_memory_output_stream_new          (data: gpointer, size: size_t, realloc_function: GReallocFunc, destroy_function: glib_ffi::GDestroyNotify) -> *mut GOutputStream;
    #[cfg(gio_2_36)]
    ...
    #[cfg(gio_2_34)]
    pub fn g_memory_output_stream_steal_as_bytes(ostream: *mut GMemoryOutputStream) -> *mut glib_ffi::GBytes;
    ...
    #[cfg(gio_2_32)]
    pub fn g_menu_attribute_iter_get_next      (iter: *mut GMenuAttributeIter, out_name: *mut *const c_char, value: *mut *mut glib_ffi::GVariant) -> gboolean;
    #[cfg(gio_2_32)]
    pub fn g_menu_attribute_iter_get_value     (iter: *mut GMenuAttributeIter) -> *mut glib_ffi::GVariant;
    #[cfg(gio_2_32)]
    ...
    #[cfg(gio_2_34)]
    pub fn g_menu_item_get_attribute_value     (menu_item: *mut GMenuItem, attribute: *const c_char, expected_type: *const glib_ffi::GVariantType) -> *mut glib_ffi::GVariant;
    #[cfg(gio_2_34)]
    ...
    #[cfg(gio_2_32)]
    pub fn g_menu_item_set_action_and_target_value(menu_item: *mut GMenuItem, action: *const c_char, target_value: *mut glib_ffi::GVariant);
    #[cfg(gio_2_32)]
    pub fn g_menu_item_set_attribute           (menu_item: *mut GMenuItem, attribute: *const c_char, format_string: *const c_char, ...);
    #[cfg(gio_2_32)]
    pub fn g_menu_item_set_attribute_value     (menu_item: *mut GMenuItem, attribute: *const c_char, value: *mut glib_ffi::GVariant);
    #[cfg(gio_2_32)]
    ...
    #[cfg(gio_2_32)]
    pub fn g_menu_model_get_item_attribute_value(model: *mut GMenuModel, item_index: c_int, attribute: *const c_char, expected_type: *const glib_ffi::GVariantType) -> *mut glib_ffi::GVariant;
    #[cfg(gio_2_32)]
    ...
    pub fn g_network_address_new               (hostname: *const c_char, port: u16) -> *mut GSocketConnectable;
    #[cfg(gio_2_44)]
    pub fn g_network_address_new_loopback      (port: u16) -> *mut GSocketConnectable;
    pub fn g_network_address_parse             (host_and_port: *const c_char, default_port: u16, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnectable;
    pub fn g_network_address_parse_uri         (uri: *const c_char, default_port: u16, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnectable;
    ...
    pub fn g_network_service_new               (service: *const c_char, protocol: *const c_char, domain: *const c_char) -> *mut GSocketConnectable;
    ...
    #[cfg(gio_2_40)]
    pub fn g_notification_add_button_with_target_value(notification: *mut GNotification, label: *const c_char, action: *const c_char, target: *mut glib_ffi::GVariant);
    #[cfg(gio_2_40)]
    ...
    #[cfg(gio_2_40)]
    pub fn g_notification_set_default_action_and_target_value(notification: *mut GNotification, action: *const c_char, target: *mut glib_ffi::GVariant);
    #[cfg(gio_2_40)]
    ...
    pub fn g_output_stream_close               (stream: *mut GOutputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_output_stream_close_finish        (stream: *mut GOutputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_output_stream_flush               (stream: *mut GOutputStream, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_output_stream_flush_finish        (stream: *mut GOutputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_40)]
    pub fn g_output_stream_printf              (stream: *mut GOutputStream, bytes_written: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError, format: *const c_char, ...) -> gboolean;
    pub fn g_output_stream_set_pending         (stream: *mut GOutputStream, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_output_stream_splice              (stream: *mut GOutputStream, source: *mut GInputStream, flags: GOutputStreamSpliceFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    ...
    pub fn g_output_stream_splice_finish       (stream: *mut GOutputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> ssize_t;
    //#[cfg(gio_2_40)]
    //pub fn g_output_stream_vprintf             (stream: *mut GOutputStream, bytes_written: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError, format: *const c_char, args: [Unsupported type va_list]) -> gboolean;
    pub fn g_output_stream_write               (stream: *mut GOutputStream, buffer: *mut u8, count: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_output_stream_write_all           (stream: *mut GOutputStream, buffer: *mut u8, count: size_t, bytes_written: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_44)]
    ...
    #[cfg(gio_2_44)]
    pub fn g_output_stream_write_all_finish    (stream: *mut GOutputStream, result: *mut GAsyncResult, bytes_written: *mut size_t, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_output_stream_write_bytes         (stream: *mut GOutputStream, bytes: *mut glib_ffi::GBytes, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_output_stream_write_bytes_async   (stream: *mut GOutputStream, bytes: *mut glib_ffi::GBytes, io_priority: c_int, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_output_stream_write_bytes_finish  (stream: *mut GOutputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_output_stream_write_finish        (stream: *mut GOutputStream, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> ssize_t;

    //=========================================================================
    // GPermission
    //=========================================================================
    pub fn g_permission_get_type               () -> GType;
    pub fn g_permission_acquire                (permission: *mut GPermission, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_permission_acquire_finish         (permission: *mut GPermission, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_permission_release                (permission: *mut GPermission, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_permission_release_finish         (permission: *mut GPermission, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_resolver_free_addresses           (addresses: *mut glib_ffi::GList);
    pub fn g_resolver_free_targets             (targets: *mut glib_ffi::GList);
    pub fn g_resolver_get_default              () -> *mut GResolver;
    pub fn g_resolver_lookup_by_address        (resolver: *mut GResolver, address: *mut GInetAddress, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    ...
    pub fn g_resolver_lookup_by_address_finish (resolver: *mut GResolver, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    pub fn g_resolver_lookup_by_name           (resolver: *mut GResolver, hostname: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    ...
    pub fn g_resolver_lookup_by_name_finish    (resolver: *mut GResolver, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    #[cfg(gio_2_34)]
    pub fn g_resolver_lookup_records           (resolver: *mut GResolver, rrname: *const c_char, record_type: GResolverRecordType, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    #[cfg(gio_2_34)]
    ...
    #[cfg(gio_2_34)]
    pub fn g_resolver_lookup_records_finish    (resolver: *mut GResolver, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    pub fn g_resolver_lookup_service           (resolver: *mut GResolver, service: *const c_char, protocol: *const c_char, domain: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    ...
    pub fn g_resolver_lookup_service_finish    (resolver: *mut GResolver, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    ...
    pub fn g_settings_bind_with_mapping        (settings: *mut GSettings, key: *const c_char, object: gpointer, property: *const c_char, flags: GSettingsBindFlags, get_mapping: GSettingsBindGetMapping, set_mapping: GSettingsBindSetMapping, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    #[cfg(gio_2_40)]
    pub fn g_settings_get_default_value        (settings: *mut GSettings, key: *const c_char) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_settings_get_range                (settings: *mut GSettings, key: *const c_char) -> *mut glib_ffi::GVariant;
    ...
    #[cfg(gio_2_40)]
    pub fn g_settings_get_user_value           (settings: *mut GSettings, key: *const c_char) -> *mut glib_ffi::GVariant;
    pub fn g_settings_get_value                (settings: *mut GSettings, key: *const c_char) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_settings_range_check              (settings: *mut GSettings, key: *const c_char, value: *mut glib_ffi::GVariant) -> gboolean;
    ...
    pub fn g_settings_set_value                (settings: *mut GSettings, key: *const c_char, value: *mut glib_ffi::GVariant) -> gboolean;

    //=========================================================================
    // GSimpleAction
    //=========================================================================
    pub fn g_simple_action_get_type            () -> GType;
    pub fn g_simple_action_new                 (name: *const c_char, parameter_type: *const glib_ffi::GVariantType) -> *mut GSimpleAction;
    pub fn g_simple_action_new_stateful        (name: *const c_char, parameter_type: *const glib_ffi::GVariantType, state: *mut glib_ffi::GVariant) -> *mut GSimpleAction;
    pub fn g_simple_action_set_enabled         (simple: *mut GSimpleAction, enabled: gboolean);
    pub fn g_simple_action_set_state           (simple: *mut GSimpleAction, value: *mut glib_ffi::GVariant);
    #[cfg(gio_2_44)]
    pub fn g_simple_action_set_state_hint      (simple: *mut GSimpleAction, state_hint: *mut glib_ffi::GVariant);
    ...
    pub fn g_simple_async_result_new           (source_object: *mut gobject_ffi::GObject, callback: GAsyncReadyCallback, user_data: gpointer, source_tag: gpointer) -> *mut GSimpleAsyncResult;
    pub fn g_simple_async_result_new_error     (source_object: *mut gobject_ffi::GObject, callback: GAsyncReadyCallback, user_data: gpointer, domain: glib_ffi::GQuark, code: c_int, format: *const c_char, ...) -> *mut GSimpleAsyncResult;
    pub fn g_simple_async_result_new_from_error(source_object: *mut gobject_ffi::GObject, callback: GAsyncReadyCallback, user_data: gpointer, error: *const glib_ffi::GError) -> *mut GSimpleAsyncResult;
    pub fn g_simple_async_result_new_take_error(source_object: *mut gobject_ffi::GObject, callback: GAsyncReadyCallback, user_data: gpointer, error: *mut glib_ffi::GError) -> *mut GSimpleAsyncResult;
    pub fn g_simple_async_result_is_valid      (result: *mut GAsyncResult, source: *mut gobject_ffi::GObject, source_tag: gpointer) -> gboolean;
    ...
    pub fn g_simple_async_result_propagate_error(simple: *mut GSimpleAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_simple_async_result_set_error     (simple: *mut GSimpleAsyncResult, domain: glib_ffi::GQuark, code: c_int, format: *const c_char, ...);
    //pub fn g_simple_async_result_set_error_va  (simple: *mut GSimpleAsyncResult, domain: glib_ffi::GQuark, code: c_int, format: *const c_char, args: [Unsupported type va_list]);
    pub fn g_simple_async_result_set_from_error(simple: *mut GSimpleAsyncResult, error: *const glib_ffi::GError);
    ...
    pub fn g_simple_async_result_set_op_res_gpointer(simple: *mut GSimpleAsyncResult, op_res: gpointer, destroy_op_res: glib_ffi::GDestroyNotify);
    pub fn g_simple_async_result_set_op_res_gssize(simple: *mut GSimpleAsyncResult, op_res: ssize_t);
    pub fn g_simple_async_result_take_error    (simple: *mut GSimpleAsyncResult, error: *mut glib_ffi::GError);
    ...
    pub fn g_socket_new                        (family: GSocketFamily, type_: GSocketType, protocol: GSocketProtocol, error: *mut *mut glib_ffi::GError) -> *mut GSocket;
    pub fn g_socket_new_from_fd                (fd: c_int, error: *mut *mut glib_ffi::GError) -> *mut GSocket;
    pub fn g_socket_accept                     (socket: *mut GSocket, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GSocket;
    pub fn g_socket_bind                       (socket: *mut GSocket, address: *mut GSocketAddress, allow_reuse: gboolean, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_check_connect_result       (socket: *mut GSocket, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_close                      (socket: *mut GSocket, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_condition_check            (socket: *mut GSocket, condition: glib_ffi::GIOCondition) -> glib_ffi::GIOCondition;
    #[cfg(gio_2_32)]
    pub fn g_socket_condition_timed_wait       (socket: *mut GSocket, condition: glib_ffi::GIOCondition, timeout: i64, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_condition_wait             (socket: *mut GSocket, condition: glib_ffi::GIOCondition, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_connect                    (socket: *mut GSocket, address: *mut GSocketAddress, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_connection_factory_create_connection(socket: *mut GSocket) -> *mut GSocketConnection;
    pub fn g_socket_create_source              (socket: *mut GSocket, condition: glib_ffi::GIOCondition, cancellable: *mut GCancellable) -> *mut glib_ffi::GSource;
    #[cfg(gio_2_32)]
    ...
    pub fn g_socket_get_credentials            (socket: *mut GSocket, error: *mut *mut glib_ffi::GError) -> *mut GCredentials;
    ...
    pub fn g_socket_get_local_address          (socket: *mut GSocket, error: *mut *mut glib_ffi::GError) -> *mut GSocketAddress;
    #[cfg(gio_2_32)]
    ...
    #[cfg(gio_2_36)]
    pub fn g_socket_get_option                 (socket: *mut GSocket, level: c_int, optname: c_int, value: *mut c_int, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_get_protocol               (socket: *mut GSocket) -> GSocketProtocol;
    pub fn g_socket_get_remote_address         (socket: *mut GSocket, error: *mut *mut glib_ffi::GError) -> *mut GSocketAddress;
    ...
    #[cfg(gio_2_32)]
    pub fn g_socket_join_multicast_group       (socket: *mut GSocket, group: *mut GInetAddress, source_specific: gboolean, iface: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_32)]
    pub fn g_socket_leave_multicast_group      (socket: *mut GSocket, group: *mut GInetAddress, source_specific: gboolean, iface: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_listen                     (socket: *mut GSocket, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_receive                    (socket: *mut GSocket, buffer: *mut u8, size: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_socket_receive_from               (socket: *mut GSocket, address: *mut *mut GSocketAddress, buffer: *mut u8, size: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_socket_receive_message            (socket: *mut GSocket, address: *mut *mut GSocketAddress, vectors: *mut GInputVector, num_vectors: c_int, messages: *mut *mut *mut GSocketControlMessage, num_messages: *mut c_int, flags: *mut c_int, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_socket_receive_with_blocking      (socket: *mut GSocket, buffer: *mut u8, size: size_t, blocking: gboolean, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_socket_send                       (socket: *mut GSocket, buffer: *mut u8, size: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_socket_send_message               (socket: *mut GSocket, address: *mut GSocketAddress, vectors: *mut GOutputVector, num_vectors: c_int, messages: *mut *mut GSocketControlMessage, num_messages: c_int, flags: c_int, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    #[cfg(gio_2_44)]
    pub fn g_socket_send_messages              (socket: *mut GSocket, messages: *mut GOutputMessage, num_messages: c_uint, flags: c_int, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> c_int;
    pub fn g_socket_send_to                    (socket: *mut GSocket, address: *mut GSocketAddress, buffer: *mut u8, size: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    pub fn g_socket_send_with_blocking         (socket: *mut GSocket, buffer: *mut u8, size: size_t, blocking: gboolean, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    ...
    #[cfg(gio_2_36)]
    pub fn g_socket_set_option                 (socket: *mut GSocket, level: c_int, optname: c_int, value: c_int, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_set_timeout                (socket: *mut GSocket, timeout: c_uint);
    #[cfg(gio_2_32)]
    pub fn g_socket_set_ttl                    (socket: *mut GSocket, ttl: c_uint);
    pub fn g_socket_shutdown                   (socket: *mut GSocket, shutdown_read: gboolean, shutdown_write: gboolean, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_socket_address_to_native          (address: *mut GSocketAddress, dest: gpointer, destlen: size_t, error: *mut *mut glib_ffi::GError) -> gboolean;

    //=========================================================================
    // GSocketAddressEnumerator
    //=========================================================================
    pub fn g_socket_address_enumerator_get_type() -> GType;
    pub fn g_socket_address_enumerator_next    (enumerator: *mut GSocketAddressEnumerator, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GSocketAddress;
    ...
    pub fn g_socket_address_enumerator_next_finish(enumerator: *mut GSocketAddressEnumerator, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GSocketAddress;
    ...
    pub fn g_socket_client_connect             (client: *mut GSocketClient, connectable: *mut GSocketConnectable, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    ...
    pub fn g_socket_client_connect_finish      (client: *mut GSocketClient, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    pub fn g_socket_client_connect_to_host     (client: *mut GSocketClient, host_and_port: *const c_char, default_port: u16, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    ...
    pub fn g_socket_client_connect_to_host_finish(client: *mut GSocketClient, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    pub fn g_socket_client_connect_to_service  (client: *mut GSocketClient, domain: *const c_char, service: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    ...
    pub fn g_socket_client_connect_to_service_finish(client: *mut GSocketClient, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    pub fn g_socket_client_connect_to_uri      (client: *mut GSocketClient, uri: *const c_char, default_port: u16, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    ...
    pub fn g_socket_client_connect_to_uri_finish(client: *mut GSocketClient, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    ...
    #[cfg(gio_2_32)]
    pub fn g_socket_connection_connect         (connection: *mut GSocketConnection, address: *mut GSocketAddress, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_32)]
    ...
    #[cfg(gio_2_32)]
    pub fn g_socket_connection_connect_finish  (connection: *mut GSocketConnection, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_connection_get_local_address(connection: *mut GSocketConnection, error: *mut *mut glib_ffi::GError) -> *mut GSocketAddress;
    pub fn g_socket_connection_get_remote_address(connection: *mut GSocketConnection, error: *mut *mut glib_ffi::GError) -> *mut GSocketAddress;
    ...
    pub fn g_socket_listener_accept            (listener: *mut GSocketListener, source_object: *mut *mut gobject_ffi::GObject, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    ...
    pub fn g_socket_listener_accept_finish     (listener: *mut GSocketListener, result: *mut GAsyncResult, source_object: *mut *mut gobject_ffi::GObject, error: *mut *mut glib_ffi::GError) -> *mut GSocketConnection;
    pub fn g_socket_listener_accept_socket     (listener: *mut GSocketListener, source_object: *mut *mut gobject_ffi::GObject, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GSocket;
    ...
    pub fn g_socket_listener_accept_socket_finish(listener: *mut GSocketListener, result: *mut GAsyncResult, source_object: *mut *mut gobject_ffi::GObject, error: *mut *mut glib_ffi::GError) -> *mut GSocket;
    pub fn g_socket_listener_add_address       (listener: *mut GSocketListener, address: *mut GSocketAddress, type_: GSocketType, protocol: GSocketProtocol, source_object: *mut gobject_ffi::GObject, effective_address: *mut *mut GSocketAddress, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_listener_add_any_inet_port (listener: *mut GSocketListener, source_object: *mut gobject_ffi::GObject, error: *mut *mut glib_ffi::GError) -> u16;
    pub fn g_socket_listener_add_inet_port     (listener: *mut GSocketListener, port: u16, source_object: *mut gobject_ffi::GObject, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_socket_listener_add_socket        (listener: *mut GSocketListener, socket: *mut GSocket, source_object: *mut gobject_ffi::GObject, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_40)]
    pub fn g_subprocess_new                    (flags: GSubprocessFlags, error: *mut *mut glib_ffi::GError, argv0: *const c_char, ...) -> *mut GSubprocess;
    #[cfg(gio_2_40)]
    pub fn g_subprocess_newv                   (argv: *mut *mut c_char, flags: GSubprocessFlags, error: *mut *mut glib_ffi::GError) -> *mut GSubprocess;
    #[cfg(gio_2_40)]
    pub fn g_subprocess_communicate            (subprocess: *mut GSubprocess, stdin_buf: *mut glib_ffi::GBytes, cancellable: *mut GCancellable, stdout_buf: *mut *mut glib_ffi::GBytes, stderr_buf: *mut *mut glib_ffi::GBytes, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_subprocess_communicate_async      (subprocess: *mut GSubprocess, stdin_buf: *mut glib_ffi::GBytes, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_subprocess_communicate_finish     (subprocess: *mut GSubprocess, result: *mut GAsyncResult, stdout_buf: *mut *mut glib_ffi::GBytes, stderr_buf: *mut *mut glib_ffi::GBytes, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_subprocess_communicate_utf8       (subprocess: *mut GSubprocess, stdin_buf: *const c_char, cancellable: *mut GCancellable, stdout_buf: *mut *mut c_char, stderr_buf: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_subprocess_communicate_utf8_finish(subprocess: *mut GSubprocess, result: *mut GAsyncResult, stdout_buf: *mut *mut c_char, stderr_buf: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_40)]
    ...
    #[cfg(gio_2_40)]
    pub fn g_subprocess_wait                   (subprocess: *mut GSubprocess, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_40)]
    ...
    #[cfg(gio_2_40)]
    pub fn g_subprocess_wait_check             (subprocess: *mut GSubprocess, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_40)]
    ...
    #[cfg(gio_2_40)]
    pub fn g_subprocess_wait_check_finish      (subprocess: *mut GSubprocess, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_40)]
    pub fn g_subprocess_wait_finish            (subprocess: *mut GSubprocess, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_40)]
    pub fn g_subprocess_launcher_set_child_setup(self_: *mut GSubprocessLauncher, child_setup: glib_ffi::GSpawnChildSetupFunc, user_data: gpointer, destroy_notify: glib_ffi::GDestroyNotify);
    #[cfg(gio_2_40)]
    ...
    #[cfg(gio_2_40)]
    pub fn g_subprocess_launcher_spawn         (self_: *mut GSubprocessLauncher, error: *mut *mut glib_ffi::GError, argv0: *const c_char, ...) -> *mut GSubprocess;
    #[cfg(gio_2_40)]
    pub fn g_subprocess_launcher_spawnv        (self_: *mut GSubprocessLauncher, argv: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> *mut GSubprocess;
    ...
    #[cfg(gio_2_36)]
    pub fn g_task_report_error                 (source_object: gpointer, callback: GAsyncReadyCallback, callback_data: gpointer, source_tag: gpointer, error: *mut glib_ffi::GError);
    #[cfg(gio_2_36)]
    pub fn g_task_report_new_error             (source_object: gpointer, callback: GAsyncReadyCallback, callback_data: gpointer, source_tag: gpointer, domain: glib_ffi::GQuark, code: c_int, format: *const c_char, ...);
    #[cfg(gio_2_36)]
    pub fn g_task_attach_source                (task: *mut GTask, source: *mut glib_ffi::GSource, callback: glib_ffi::GSourceFunc);
    #[cfg(gio_2_36)]
    ...
    #[cfg(gio_2_36)]
    pub fn g_task_get_context                  (task: *mut GTask) -> *mut glib_ffi::GMainContext;
    #[cfg(gio_2_36)]
    ...
    #[cfg(gio_2_36)]
    pub fn g_task_propagate_boolean            (task: *mut GTask, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_36)]
    pub fn g_task_propagate_int                (task: *mut GTask, error: *mut *mut glib_ffi::GError) -> ssize_t;
    #[cfg(gio_2_36)]
    pub fn g_task_propagate_pointer            (task: *mut GTask, error: *mut *mut glib_ffi::GError) -> gpointer;
    #[cfg(gio_2_36)]
    pub fn g_task_return_boolean               (task: *mut GTask, result: gboolean);
    #[cfg(gio_2_36)]
    pub fn g_task_return_error                 (task: *mut GTask, error: *mut glib_ffi::GError);
    #[cfg(gio_2_36)]
    pub fn g_task_return_error_if_cancelled    (task: *mut GTask) -> gboolean;
    #[cfg(gio_2_36)]
    pub fn g_task_return_int                   (task: *mut GTask, result: ssize_t);
    #[cfg(gio_2_36)]
    pub fn g_task_return_new_error             (task: *mut GTask, domain: glib_ffi::GQuark, code: c_int, format: *const c_char, ...);
    #[cfg(gio_2_36)]
    pub fn g_task_return_pointer               (task: *mut GTask, result: gpointer, result_destroy: glib_ffi::GDestroyNotify);
    #[cfg(gio_2_36)]
    ...
    #[cfg(gio_2_36)]
    pub fn g_task_set_task_data                (task: *mut GTask, task_data: gpointer, task_data_destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn g_themed_icon_new                   (iconname: *const c_char) -> *mut GIcon;
    pub fn g_themed_icon_new_from_names        (iconnames: *mut *mut c_char, len: c_int) -> *mut GIcon;
    pub fn g_themed_icon_new_with_default_fallbacks(iconname: *const c_char) -> *mut GIcon;
    ...
    pub fn g_tls_certificate_new_from_file     (file: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GTlsCertificate;
    pub fn g_tls_certificate_new_from_files    (cert_file: *const c_char, key_file: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GTlsCertificate;
    pub fn g_tls_certificate_new_from_pem      (data: *const c_char, length: ssize_t, error: *mut *mut glib_ffi::GError) -> *mut GTlsCertificate;
    pub fn g_tls_certificate_list_new_from_file(file: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    ...
    pub fn g_tls_connection_handshake          (conn: *mut GTlsConnection, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_tls_connection_handshake_finish   (conn: *mut GTlsConnection, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_tls_database_lookup_certificate_for_handle(self_: *mut GTlsDatabase, handle: *const c_char, interaction: *mut GTlsInteraction, flags: GTlsDatabaseLookupFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GTlsCertificate;
    ...
    pub fn g_tls_database_lookup_certificate_for_handle_finish(self_: *mut GTlsDatabase, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GTlsCertificate;
    pub fn g_tls_database_lookup_certificate_issuer(self_: *mut GTlsDatabase, certificate: *mut GTlsCertificate, interaction: *mut GTlsInteraction, flags: GTlsDatabaseLookupFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GTlsCertificate;
    ...
    pub fn g_tls_database_lookup_certificate_issuer_finish(self_: *mut GTlsDatabase, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GTlsCertificate;
    pub fn g_tls_database_lookup_certificates_issued_by(self_: *mut GTlsDatabase, issuer_raw_dn: *mut glib_ffi::GByteArray, interaction: *mut GTlsInteraction, flags: GTlsDatabaseLookupFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    pub fn g_tls_database_lookup_certificates_issued_by_async(self_: *mut GTlsDatabase, issuer_raw_dn: *mut glib_ffi::GByteArray, interaction: *mut GTlsInteraction, flags: GTlsDatabaseLookupFlags, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_tls_database_lookup_certificates_issued_by_finish(self_: *mut GTlsDatabase, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GList;
    pub fn g_tls_database_verify_chain         (self_: *mut GTlsDatabase, chain: *mut GTlsCertificate, purpose: *const c_char, identity: *mut GSocketConnectable, interaction: *mut GTlsInteraction, flags: GTlsDatabaseVerifyFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> GTlsCertificateFlags;
    ...
    pub fn g_tls_database_verify_chain_finish  (self_: *mut GTlsDatabase, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> GTlsCertificateFlags;

    //=========================================================================
    // GTlsInteraction
    //=========================================================================
    pub fn g_tls_interaction_get_type          () -> GType;
    pub fn g_tls_interaction_ask_password      (interaction: *mut GTlsInteraction, password: *mut GTlsPassword, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> GTlsInteractionResult;
    ...
    pub fn g_tls_interaction_ask_password_finish(interaction: *mut GTlsInteraction, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> GTlsInteractionResult;
    pub fn g_tls_interaction_invoke_ask_password(interaction: *mut GTlsInteraction, password: *mut GTlsPassword, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> GTlsInteractionResult;
    #[cfg(gio_2_40)]
    pub fn g_tls_interaction_invoke_request_certificate(interaction: *mut GTlsInteraction, connection: *mut GTlsConnection, flags: GTlsCertificateRequestFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> GTlsInteractionResult;
    #[cfg(gio_2_40)]
    pub fn g_tls_interaction_request_certificate(interaction: *mut GTlsInteraction, connection: *mut GTlsConnection, flags: GTlsCertificateRequestFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> GTlsInteractionResult;
    #[cfg(gio_2_40)]
    ...
    #[cfg(gio_2_40)]
    pub fn g_tls_interaction_request_certificate_finish(interaction: *mut GTlsInteraction, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> GTlsInteractionResult;
    ...
    pub fn g_tls_password_set_value_full       (password: *mut GTlsPassword, value: *mut u8, length: ssize_t, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn g_unix_connection_receive_credentials(connection: *mut GUnixConnection, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GCredentials;
    #[cfg(gio_2_32)]
    ...
    #[cfg(gio_2_32)]
    pub fn g_unix_connection_receive_credentials_finish(connection: *mut GUnixConnection, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GCredentials;
    pub fn g_unix_connection_receive_fd        (connection: *mut GUnixConnection, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> c_int;
    pub fn g_unix_connection_send_credentials  (connection: *mut GUnixConnection, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_32)]
    ...
    #[cfg(gio_2_32)]
    pub fn g_unix_connection_send_credentials_finish(connection: *mut GUnixConnection, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_unix_connection_send_fd           (connection: *mut GUnixConnection, fd: c_int, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_unix_fd_list_append               (list: *mut GUnixFDList, fd: c_int, error: *mut *mut glib_ffi::GError) -> c_int;
    pub fn g_unix_fd_list_get                  (list: *mut GUnixFDList, index_: c_int, error: *mut *mut glib_ffi::GError) -> c_int;
    ...
    pub fn g_unix_fd_message_append_fd         (message: *mut GUnixFDMessage, fd: c_int, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_volume_monitor_get_connected_drives(volume_monitor: *mut GVolumeMonitor) -> *mut glib_ffi::GList;
    pub fn g_volume_monitor_get_mount_for_uuid (volume_monitor: *mut GVolumeMonitor, uuid: *const c_char) -> *mut GMount;
    pub fn g_volume_monitor_get_mounts         (volume_monitor: *mut GVolumeMonitor) -> *mut glib_ffi::GList;
    pub fn g_volume_monitor_get_volume_for_uuid(volume_monitor: *mut GVolumeMonitor, uuid: *const c_char) -> *mut GVolume;
    pub fn g_volume_monitor_get_volumes        (volume_monitor: *mut GVolumeMonitor) -> *mut glib_ffi::GList;
    ...
    #[cfg(gio_2_38)]
    pub fn g_action_parse_detailed_name        (detailed_name: *const c_char, action_name: *mut *mut c_char, target_value: *mut *mut glib_ffi::GVariant, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_38)]
    pub fn g_action_print_detailed_name        (action_name: *const c_char, target_value: *mut glib_ffi::GVariant) -> *mut c_char;
    pub fn g_action_activate                   (action: *mut GAction, parameter: *mut glib_ffi::GVariant);
    pub fn g_action_change_state               (action: *mut GAction, value: *mut glib_ffi::GVariant);
    pub fn g_action_get_enabled                (action: *mut GAction) -> gboolean;
    pub fn g_action_get_name                   (action: *mut GAction) -> *const c_char;
    pub fn g_action_get_parameter_type         (action: *mut GAction) -> *const glib_ffi::GVariantType;
    pub fn g_action_get_state                  (action: *mut GAction) -> *mut glib_ffi::GVariant;
    pub fn g_action_get_state_hint             (action: *mut GAction) -> *mut glib_ffi::GVariant;
    pub fn g_action_get_state_type             (action: *mut GAction) -> *const glib_ffi::GVariantType;
    ...
    pub fn g_action_group_action_state_changed (action_group: *mut GActionGroup, action_name: *const c_char, state: *mut glib_ffi::GVariant);
    pub fn g_action_group_activate_action      (action_group: *mut GActionGroup, action_name: *const c_char, parameter: *mut glib_ffi::GVariant);
    pub fn g_action_group_change_action_state  (action_group: *mut GActionGroup, action_name: *const c_char, value: *mut glib_ffi::GVariant);
    pub fn g_action_group_get_action_enabled   (action_group: *mut GActionGroup, action_name: *const c_char) -> gboolean;
    pub fn g_action_group_get_action_parameter_type(action_group: *mut GActionGroup, action_name: *const c_char) -> *const glib_ffi::GVariantType;
    pub fn g_action_group_get_action_state     (action_group: *mut GActionGroup, action_name: *const c_char) -> *mut glib_ffi::GVariant;
    pub fn g_action_group_get_action_state_hint(action_group: *mut GActionGroup, action_name: *const c_char) -> *mut glib_ffi::GVariant;
    pub fn g_action_group_get_action_state_type(action_group: *mut GActionGroup, action_name: *const c_char) -> *const glib_ffi::GVariantType;
    ...
    #[cfg(gio_2_32)]
    pub fn g_action_group_query_action         (action_group: *mut GActionGroup, action_name: *const c_char, enabled: *mut gboolean, parameter_type: *mut *const glib_ffi::GVariantType, state_type: *mut *const glib_ffi::GVariantType, state_hint: *mut *mut glib_ffi::GVariant, state: *mut *mut glib_ffi::GVariant) -> gboolean;
    ...
    pub fn g_app_info_create_from_commandline  (commandline: *const c_char, application_name: *const c_char, flags: GAppInfoCreateFlags, error: *mut *mut glib_ffi::GError) -> *mut GAppInfo;
    pub fn g_app_info_get_all                  () -> *mut glib_ffi::GList;
    pub fn g_app_info_get_all_for_type         (content_type: *const c_char) -> *mut glib_ffi::GList;
    ...
    pub fn g_app_info_get_fallback_for_type    (content_type: *const c_char) -> *mut glib_ffi::GList;
    pub fn g_app_info_get_recommended_for_type (content_type: *const c_char) -> *mut glib_ffi::GList;
    pub fn g_app_info_launch_default_for_uri   (uri: *const c_char, launch_context: *mut GAppLaunchContext, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_app_info_reset_type_associations  (content_type: *const c_char);
    pub fn g_app_info_add_supports_type        (appinfo: *mut GAppInfo, content_type: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_app_info_launch                   (appinfo: *mut GAppInfo, files: *mut glib_ffi::GList, launch_context: *mut GAppLaunchContext, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_app_info_launch_uris              (appinfo: *mut GAppInfo, uris: *mut glib_ffi::GList, launch_context: *mut GAppLaunchContext, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_app_info_remove_supports_type     (appinfo: *mut GAppInfo, content_type: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_app_info_set_as_default_for_extension(appinfo: *mut GAppInfo, extension: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_app_info_set_as_default_for_type  (appinfo: *mut GAppInfo, content_type: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_app_info_set_as_last_used_for_type(appinfo: *mut GAppInfo, content_type: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    //pub fn g_async_initable_new_valist_async   (object_type: GType, first_property_name: *const c_char, var_args: [Unsupported type va_list], io_priority: c_int, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_async_initable_newv_async         (object_type: GType, n_parameters: c_uint, parameters: *mut gobject_ffi::GParameter, io_priority: c_int, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    ...
    pub fn g_async_initable_init_finish        (initable: *mut GAsyncInitable, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_async_initable_new_finish         (initable: *mut GAsyncInitable, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut gobject_ffi::GObject;

    //=========================================================================
    // GAsyncResult
    //=========================================================================
    pub fn g_async_result_get_type             () -> GType;
    pub fn g_async_result_get_source_object    (res: *mut GAsyncResult) -> *mut gobject_ffi::GObject;
    ...
    #[cfg(gio_2_34)]
    pub fn g_async_result_legacy_propagate_error(res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;

    //=========================================================================
    // GConverter
    //=========================================================================
    pub fn g_converter_get_type                () -> GType;
    pub fn g_converter_convert                 (converter: *mut GConverter, inbuf: *mut u8, inbuf_size: size_t, outbuf: *mut c_void, outbuf_size: size_t, flags: GConverterFlags, bytes_read: *mut size_t, bytes_written: *mut size_t, error: *mut *mut glib_ffi::GError) -> GConverterResult;
    ...
    pub fn g_dbus_object_get_interfaces        (object: *mut GDBusObject) -> *mut glib_ffi::GList;
    ...
    pub fn g_dbus_object_manager_get_objects   (manager: *mut GDBusObjectManager) -> *mut glib_ffi::GList;
    ...
    pub fn g_drive_eject_finish                (drive: *mut GDrive, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_drive_eject_with_operation_finish (drive: *mut GDrive, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_drive_get_volumes                 (drive: *mut GDrive) -> *mut glib_ffi::GList;
    ...
    pub fn g_drive_poll_for_media_finish       (drive: *mut GDrive, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_drive_start_finish                (drive: *mut GDrive, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_drive_stop_finish                 (drive: *mut GDrive, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_32)]
    pub fn g_file_new_tmp                      (tmpl: *mut c_char, iostream: *mut *mut GFileIOStream, error: *mut *mut glib_ffi::GError) -> *mut GFile;
    pub fn g_file_parse_name                   (parse_name: *const c_char) -> *mut GFile;
    pub fn g_file_append_to                    (file: *mut GFile, flags: GFileCreateFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileOutputStream;
    ...
    pub fn g_file_append_to_finish             (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileOutputStream;
    pub fn g_file_copy                         (source: *mut GFile, destination: *mut GFile, flags: GFileCopyFlags, cancellable: *mut GCancellable, progress_callback: GFileProgressCallback, progress_callback_data: gpointer, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_copy_attributes              (source: *mut GFile, destination: *mut GFile, flags: GFileCopyFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_copy_finish                  (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_create                       (file: *mut GFile, flags: GFileCreateFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileOutputStream;
    ...
    pub fn g_file_create_finish                (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileOutputStream;
    pub fn g_file_create_readwrite             (file: *mut GFile, flags: GFileCreateFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileIOStream;
    ...
    pub fn g_file_create_readwrite_finish      (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileIOStream;
    pub fn g_file_delete                       (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_34)]
    ...
    #[cfg(gio_2_34)]
    pub fn g_file_delete_finish                (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_eject_mountable_finish       (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_eject_mountable_with_operation_finish(file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_enumerate_children           (file: *mut GFile, attributes: *const c_char, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileEnumerator;
    ...
    pub fn g_file_enumerate_children_finish    (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileEnumerator;
    pub fn g_file_equal                        (file1: *mut GFile, file2: *mut GFile) -> gboolean;
    pub fn g_file_find_enclosing_mount         (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GMount;
    ...
    pub fn g_file_find_enclosing_mount_finish  (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GMount;
    pub fn g_file_get_basename                 (file: *mut GFile) -> *mut c_char;
    pub fn g_file_get_child                    (file: *mut GFile, name: *const c_char) -> *mut GFile;
    pub fn g_file_get_child_for_display_name   (file: *mut GFile, display_name: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GFile;
    ...
    pub fn g_file_load_contents                (file: *mut GFile, cancellable: *mut GCancellable, contents: *mut *mut u8, length: *mut size_t, etag_out: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_load_contents_finish         (file: *mut GFile, res: *mut GAsyncResult, contents: *mut *mut u8, length: *mut size_t, etag_out: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_load_partial_contents_finish (file: *mut GFile, res: *mut GAsyncResult, contents: *mut *mut u8, length: *mut size_t, etag_out: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_make_directory               (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_38)]
    ...
    #[cfg(gio_2_38)]
    pub fn g_file_make_directory_finish        (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_make_directory_with_parents  (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_make_symbolic_link           (file: *mut GFile, symlink_value: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_38)]
    pub fn g_file_measure_disk_usage           (file: *mut GFile, flags: GFileMeasureFlags, cancellable: *mut GCancellable, progress_callback: GFileMeasureProgressCallback, progress_data: gpointer, disk_usage: *mut u64, num_dirs: *mut u64, num_files: *mut u64, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_38)]
    ...
    #[cfg(gio_2_38)]
    pub fn g_file_measure_disk_usage_finish    (file: *mut GFile, result: *mut GAsyncResult, disk_usage: *mut u64, num_dirs: *mut u64, num_files: *mut u64, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_monitor                      (file: *mut GFile, flags: GFileMonitorFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileMonitor;
    pub fn g_file_monitor_directory            (file: *mut GFile, flags: GFileMonitorFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileMonitor;
    pub fn g_file_monitor_file                 (file: *mut GFile, flags: GFileMonitorFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileMonitor;
    ...
    pub fn g_file_mount_enclosing_volume_finish(location: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_mount_mountable_finish       (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFile;
    pub fn g_file_move                         (source: *mut GFile, destination: *mut GFile, flags: GFileCopyFlags, cancellable: *mut GCancellable, progress_callback: GFileProgressCallback, progress_callback_data: gpointer, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_open_readwrite               (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileIOStream;
    ...
    pub fn g_file_open_readwrite_finish        (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileIOStream;
    pub fn g_file_poll_mountable               (file: *mut GFile, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_file_poll_mountable_finish        (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_query_default_handler        (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GAppInfo;
    ...
    pub fn g_file_query_filesystem_info        (file: *mut GFile, attributes: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_file_query_filesystem_info_finish (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    pub fn g_file_query_info                   (file: *mut GFile, attributes: *const c_char, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    ...
    pub fn g_file_query_info_finish            (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileInfo;
    pub fn g_file_query_settable_attributes    (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileAttributeInfoList;
    pub fn g_file_query_writable_namespaces    (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileAttributeInfoList;
    pub fn g_file_read                         (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileInputStream;
    ...
    pub fn g_file_read_finish                  (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileInputStream;
    pub fn g_file_replace                      (file: *mut GFile, etag: *const c_char, make_backup: gboolean, flags: GFileCreateFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileOutputStream;
    ...
    pub fn g_file_replace_contents             (file: *mut GFile, contents: *mut u8, length: size_t, etag: *const c_char, make_backup: gboolean, flags: GFileCreateFlags, new_etag: *mut *mut c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_40)]
    pub fn g_file_replace_contents_bytes_async (file: *mut GFile, contents: *mut glib_ffi::GBytes, etag: *const c_char, make_backup: gboolean, flags: GFileCreateFlags, cancellable: *mut GCancellable, callback: GAsyncReadyCallback, user_data: gpointer);
    pub fn g_file_replace_contents_finish      (file: *mut GFile, res: *mut GAsyncResult, new_etag: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_replace_finish               (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileOutputStream;
    pub fn g_file_replace_readwrite            (file: *mut GFile, etag: *const c_char, make_backup: gboolean, flags: GFileCreateFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFileIOStream;
    ...
    pub fn g_file_replace_readwrite_finish     (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFileIOStream;
    pub fn g_file_resolve_relative_path        (file: *mut GFile, relative_path: *const c_char) -> *mut GFile;
    pub fn g_file_set_attribute                (file: *mut GFile, attribute: *const c_char, type_: GFileAttributeType, value_p: gpointer, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_set_attribute_byte_string    (file: *mut GFile, attribute: *const c_char, value: *const c_char, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_set_attribute_int32          (file: *mut GFile, attribute: *const c_char, value: i32, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_set_attribute_int64          (file: *mut GFile, attribute: *const c_char, value: i64, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_set_attribute_string         (file: *mut GFile, attribute: *const c_char, value: *const c_char, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_set_attribute_uint32         (file: *mut GFile, attribute: *const c_char, value: u32, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_set_attribute_uint64         (file: *mut GFile, attribute: *const c_char, value: u64, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_set_attributes_finish        (file: *mut GFile, result: *mut GAsyncResult, info: *mut *mut GFileInfo, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_set_attributes_from_info     (file: *mut GFile, info: *mut GFileInfo, flags: GFileQueryInfoFlags, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_set_display_name             (file: *mut GFile, display_name: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GFile;
    ...
    pub fn g_file_set_display_name_finish      (file: *mut GFile, res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GFile;
    ...
    pub fn g_file_start_mountable_finish       (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_stop_mountable_finish        (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_file_supports_thread_contexts     (file: *mut GFile) -> gboolean;
    pub fn g_file_trash                        (file: *mut GFile, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_38)]
    ...
    #[cfg(gio_2_38)]
    pub fn g_file_trash_finish                 (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_unmount_mountable_finish     (file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_file_unmount_mountable_with_operation_finish(file: *mut GFile, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_38)]
    pub fn g_icon_deserialize                  (value: *mut glib_ffi::GVariant) -> *mut GIcon;
    pub fn g_icon_hash                         (icon: gconstpointer) -> c_uint;
    pub fn g_icon_new_for_string               (str: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GIcon;
    pub fn g_icon_equal                        (icon1: *mut GIcon, icon2: *mut GIcon) -> gboolean;
    #[cfg(gio_2_38)]
    pub fn g_icon_serialize                    (icon: *mut GIcon) -> *mut glib_ffi::GVariant;
    ...
    pub fn g_initable_new                      (object_type: GType, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError, first_property_name: *const c_char, ...) -> gpointer;
    //pub fn g_initable_new_valist               (object_type: GType, first_property_name: *const c_char, var_args: [Unsupported type va_list], cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut gobject_ffi::GObject;
    pub fn g_initable_newv                     (object_type: GType, n_parameters: c_uint, parameters: *mut gobject_ffi::GParameter, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gpointer;
    pub fn g_initable_init                     (initable: *mut GInitable, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_44)]
    pub fn g_list_model_get_object             (list: *mut GListModel, position: c_uint) -> *mut gobject_ffi::GObject;
    #[cfg(gio_2_44)]
    ...
    pub fn g_loadable_icon_load                (icon: *mut GLoadableIcon, size: c_int, type_: *mut *mut c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GInputStream;
    ...
    pub fn g_loadable_icon_load_finish         (icon: *mut GLoadableIcon, res: *mut GAsyncResult, type_: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> *mut GInputStream;
    ...
    pub fn g_mount_eject_finish                (mount: *mut GMount, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_mount_eject_with_operation_finish (mount: *mut GMount, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_mount_guess_content_type_finish   (mount: *mut GMount, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut *mut c_char;
    pub fn g_mount_guess_content_type_sync     (mount: *mut GMount, force_rescan: gboolean, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut *mut c_char;
    ...
    pub fn g_mount_remount_finish              (mount: *mut GMount, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_mount_unmount_finish              (mount: *mut GMount, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_mount_unmount_with_operation_finish(mount: *mut GMount, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    #[cfg(gio_2_32)]
    pub fn g_network_monitor_can_reach         (monitor: *mut GNetworkMonitor, connectable: *mut GSocketConnectable, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_network_monitor_can_reach_finish  (monitor: *mut GNetworkMonitor, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_44)]
    ...
    pub fn g_pollable_input_stream_create_source(stream: *mut GPollableInputStream, cancellable: *mut GCancellable) -> *mut glib_ffi::GSource;
    pub fn g_pollable_input_stream_is_readable (stream: *mut GPollableInputStream) -> gboolean;
    pub fn g_pollable_input_stream_read_nonblocking(stream: *mut GPollableInputStream, buffer: *mut u8, count: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    ...
    pub fn g_pollable_output_stream_create_source(stream: *mut GPollableOutputStream, cancellable: *mut GCancellable) -> *mut glib_ffi::GSource;
    pub fn g_pollable_output_stream_is_writable(stream: *mut GPollableOutputStream) -> gboolean;
    pub fn g_pollable_output_stream_write_nonblocking(stream: *mut GPollableOutputStream, buffer: *mut u8, count: size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    ...
    pub fn g_proxy_connect                     (proxy: *mut GProxy, connection: *mut GIOStream, proxy_address: *mut GProxyAddress, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GIOStream;
    ...
    pub fn g_proxy_connect_finish              (proxy: *mut GProxy, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GIOStream;
    ...
    pub fn g_proxy_resolver_lookup             (resolver: *mut GProxyResolver, uri: *const c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut *mut c_char;
    ...
    pub fn g_proxy_resolver_lookup_finish      (resolver: *mut GProxyResolver, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut *mut c_char;
    ...
    #[cfg(gio_2_32)]
    pub fn g_remote_action_group_activate_action_full(remote: *mut GRemoteActionGroup, action_name: *const c_char, parameter: *mut glib_ffi::GVariant, platform_data: *mut glib_ffi::GVariant);
    #[cfg(gio_2_32)]
    pub fn g_remote_action_group_change_action_state_full(remote: *mut GRemoteActionGroup, action_name: *const c_char, value: *mut glib_ffi::GVariant, platform_data: *mut glib_ffi::GVariant);
    ...
    pub fn g_seekable_seek                     (seekable: *mut GSeekable, offset: i64, type_: glib_ffi::GSeekType, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_seekable_tell                     (seekable: *mut GSeekable) -> i64;
    pub fn g_seekable_truncate                 (seekable: *mut GSeekable, offset: i64, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_tls_client_connection_new         (base_io_stream: *mut GIOStream, server_identity: *mut GSocketConnectable, error: *mut *mut glib_ffi::GError) -> *mut GIOStream;
    pub fn g_tls_client_connection_get_accepted_cas(conn: *mut GTlsClientConnection) -> *mut glib_ffi::GList;
    ...
    pub fn g_tls_file_database_new             (anchors: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GTlsDatabase;

    //=========================================================================
    // GTlsServerConnection
    //=========================================================================
    pub fn g_tls_server_connection_get_type    () -> GType;
    pub fn g_tls_server_connection_new         (base_io_stream: *mut GIOStream, certificate: *mut GTlsCertificate, error: *mut *mut glib_ffi::GError) -> *mut GIOStream;
    ...
    pub fn g_volume_eject_finish               (volume: *mut GVolume, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_volume_eject_with_operation_finish(volume: *mut GVolume, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_volume_mount_finish               (volume: *mut GVolume, result: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn g_bus_get_finish                    (res: *mut GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GDBusConnection;
    pub fn g_bus_get_sync                      (bus_type: GBusType, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GDBusConnection;
    pub fn g_bus_own_name                      (bus_type: GBusType, name: *const c_char, flags: GBusNameOwnerFlags, bus_acquired_handler: GBusAcquiredCallback, name_acquired_handler: GBusNameAcquiredCallback, name_lost_handler: GBusNameLostCallback, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify) -> c_uint;
    pub fn g_bus_own_name_on_connection        (connection: *mut GDBusConnection, name: *const c_char, flags: GBusNameOwnerFlags, name_acquired_handler: GBusNameAcquiredCallback, name_lost_handler: GBusNameLostCallback, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify) -> c_uint;
    pub fn g_bus_own_name_on_connection_with_closures(connection: *mut GDBusConnection, name: *const c_char, flags: GBusNameOwnerFlags, name_acquired_closure: *mut gobject_ffi::GClosure, name_lost_closure: *mut gobject_ffi::GClosure) -> c_uint;
    pub fn g_bus_own_name_with_closures        (bus_type: GBusType, name: *const c_char, flags: GBusNameOwnerFlags, bus_acquired_closure: *mut gobject_ffi::GClosure, name_acquired_closure: *mut gobject_ffi::GClosure, name_lost_closure: *mut gobject_ffi::GClosure) -> c_uint;
    pub fn g_bus_unown_name                    (owner_id: c_uint);
    pub fn g_bus_unwatch_name                  (watcher_id: c_uint);
    pub fn g_bus_watch_name                    (bus_type: GBusType, name: *const c_char, flags: GBusNameWatcherFlags, name_appeared_handler: GBusNameAppearedCallback, name_vanished_handler: GBusNameVanishedCallback, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify) -> c_uint;
    pub fn g_bus_watch_name_on_connection      (connection: *mut GDBusConnection, name: *const c_char, flags: GBusNameWatcherFlags, name_appeared_handler: GBusNameAppearedCallback, name_vanished_handler: GBusNameVanishedCallback, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify) -> c_uint;
    pub fn g_bus_watch_name_on_connection_with_closures(connection: *mut GDBusConnection, name: *const c_char, flags: GBusNameWatcherFlags, name_appeared_closure: *mut gobject_ffi::GClosure, name_vanished_closure: *mut gobject_ffi::GClosure) -> c_uint;
    pub fn g_bus_watch_name_with_closures      (bus_type: GBusType, name: *const c_char, flags: GBusNameWatcherFlags, name_appeared_closure: *mut gobject_ffi::GClosure, name_vanished_closure: *mut gobject_ffi::GClosure) -> c_uint;
    ...
    pub fn g_content_types_get_registered      () -> *mut glib_ffi::GList;
    #[cfg(gio_2_36)]
    pub fn g_dbus_address_escape_value         (string: *const c_char) -> *mut c_char;
    pub fn g_dbus_address_get_for_bus_sync     (bus_type: GBusType, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut c_char;
    ...
    pub fn g_dbus_address_get_stream_finish    (res: *mut GAsyncResult, out_guid: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> *mut GIOStream;
    pub fn g_dbus_address_get_stream_sync      (address: *const c_char, out_guid: *mut *mut c_char, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GIOStream;
    pub fn g_dbus_generate_guid                () -> *mut c_char;
    pub fn g_dbus_gvalue_to_gvariant           (gvalue: *const gobject_ffi::GValue, type_: *const glib_ffi::GVariantType) -> *mut glib_ffi::GVariant;
    pub fn g_dbus_gvariant_to_gvalue           (value: *mut glib_ffi::GVariant, out_gvalue: *mut gobject_ffi::GValue);
    ...
    pub fn g_dbus_is_supported_address         (string: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn g_dbus_is_unique_name               (string: *const c_char) -> gboolean;
    pub fn g_io_error_from_errno               (err_no: c_int) -> GIOErrorEnum;
    pub fn g_io_error_quark                    () -> glib_ffi::GQuark;
    pub fn g_io_modules_load_all_in_directory  (dirname: *const c_char) -> *mut glib_ffi::GList;
    pub fn g_io_modules_load_all_in_directory_with_scope(dirname: *const c_char, scope: *mut GIOModuleScope) -> *mut glib_ffi::GList;
    ...
    pub fn g_io_scheduler_push_job             (job_func: GIOSchedulerJobFunc, user_data: gpointer, notify: glib_ffi::GDestroyNotify, io_priority: c_int, cancellable: *mut GCancellable);
    #[cfg(gio_2_36)]
    pub fn g_networking_init                   ();
    pub fn g_pollable_source_new               (pollable_stream: *mut gobject_ffi::GObject) -> *mut glib_ffi::GSource;
    #[cfg(gio_2_34)]
    pub fn g_pollable_source_new_full          (pollable_stream: gpointer, child_source: *mut glib_ffi::GSource, cancellable: *mut GCancellable) -> *mut glib_ffi::GSource;
    #[cfg(gio_2_34)]
    pub fn g_pollable_stream_read              (stream: *mut GInputStream, buffer: *mut u8, count: size_t, blocking: gboolean, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    #[cfg(gio_2_34)]
    pub fn g_pollable_stream_write             (stream: *mut GOutputStream, buffer: *mut u8, count: size_t, blocking: gboolean, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> ssize_t;
    #[cfg(gio_2_34)]
    pub fn g_pollable_stream_write_all         (stream: *mut GOutputStream, buffer: *mut u8, count: size_t, blocking: gboolean, bytes_written: *mut size_t, cancellable: *mut GCancellable, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_32)]
    pub fn g_resources_enumerate_children      (path: *const c_char, lookup_flags: GResourceLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut *mut c_char;
    #[cfg(gio_2_32)]
    pub fn g_resources_get_info                (path: *const c_char, lookup_flags: GResourceLookupFlags, size: *mut size_t, flags: *mut u32, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gio_2_32)]
    pub fn g_resources_lookup_data             (path: *const c_char, lookup_flags: GResourceLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut glib_ffi::GBytes;
    #[cfg(gio_2_32)]
    pub fn g_resources_open_stream             (path: *const c_char, lookup_flags: GResourceLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut GInputStream;
    #[cfg(gio_2_32)]
    pub fn g_resources_register                (resource: *mut GResource);
    #[cfg(gio_2_32)]
    pub fn g_resources_unregister              (resource: *mut GResource);
    pub fn g_simple_async_report_error_in_idle (object: *mut gobject_ffi::GObject, callback: GAsyncReadyCallback, user_data: gpointer, domain: glib_ffi::GQuark, code: c_int, format: *const c_char, ...);
    pub fn g_simple_async_report_gerror_in_idle(object: *mut gobject_ffi::GObject, callback: GAsyncReadyCallback, user_data: gpointer, error: *const glib_ffi::GError);
    pub fn g_simple_async_report_take_gerror_in_idle(object: *mut gobject_ffi::GObject, callback: GAsyncReadyCallback, user_data: gpointer, error: *mut glib_ffi::GError);
    ...
    pub fn g_unix_mount_points_get             (time_read: *mut u64) -> *mut glib_ffi::GList;
    pub fn g_unix_mounts_changed_since         (time: u64) -> gboolean;
    pub fn g_unix_mounts_get                   (time_read: *mut u64) -> *mut glib_ffi::GList;
