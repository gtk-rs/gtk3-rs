...
//pub const PANGO_GLYPH_EMPTY: Unknown rust type: "Glyph" = 268435455;
//pub const PANGO_GLYPH_INVALID_INPUT: Unknown rust type: "Glyph" = 4294967295;
//pub const PANGO_GLYPH_UNKNOWN_FLAG: Unknown rust type: "Glyph" = 268435456;
...
pub struct PangoAnalysis {
    ...
    pub extra_attrs: *mut glib_ffi::GSList,
}
...
pub struct PangoAttrShape {
    ...
    pub destroy_func: glib_ffi::GDestroyNotify,
}
...
#[repr(C)]
pub struct PangoFontsetSimpleClass;
...
pub struct PangoIncludedModule {
    ...
    pub init: Option<unsafe extern "C" fn(*mut gobject_ffi::GTypeModule)>,
...
extern "C" {
    ...
    pub fn pango_attr_iterator_get_attrs       (iterator: *mut PangoAttrIterator) -> *mut glib_ffi::GSList;
    pub fn pango_attr_iterator_get_font        (iterator: *mut PangoAttrIterator, desc: *mut PangoFontDescription, language: *mut *mut PangoLanguage, extra_attrs: *mut *mut glib_ffi::GSList);
    ...
    pub fn pango_attr_shape_new_with_data      (ink_rect: *const PangoRectangle, logical_rect: *const PangoRectangle, data: gpointer, copy_func: PangoAttrDataCopyFunc, destroy_func: glib_ffi::GDestroyNotify) -> *mut PangoAttribute;
    ...
    pub fn pango_glyph_item_apply_attrs        (glyph_item: *mut PangoGlyphItem, text: *const c_char, list: *mut PangoAttrList) -> *mut glib_ffi::GSList;
    ...
    pub fn pango_map_get_engines               (map: *mut PangoMap, script: PangoScript, exact_engines: *mut *mut glib_ffi::GSList, fallback_engines: *mut *mut glib_ffi::GSList);
    ...
    pub fn pango_layout_get_lines              (layout: *mut PangoLayout) -> *mut glib_ffi::GSList;
    pub fn pango_layout_get_lines_readonly     (layout: *mut PangoLayout) -> *mut glib_ffi::GSList;
    ...
    pub fn pango_itemize                       (context: *mut PangoContext, text: *const c_char, start_index: c_int, length: c_int, attrs: *mut PangoAttrList, cached_iter: *mut PangoAttrIterator) -> *mut glib_ffi::GList;
    pub fn pango_itemize_with_base_dir         (context: *mut PangoContext, base_dir: PangoDirection, text: *const c_char, start_index: c_int, length: c_int, attrs: *mut PangoAttrList, cached_iter: *mut PangoAttrIterator) -> *mut glib_ffi::GList;
    ...
    #[cfg(pango_1_31)]
    pub fn pango_markup_parser_finish          (context: *mut glib_ffi::GMarkupParseContext, attr_list: *mut *mut PangoAttrList, text: *mut *mut c_char, accel_char: *mut u32, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(pango_1_31)]
    pub fn pango_markup_parser_new             (accel_marker: u32) -> *mut glib_ffi::GMarkupParseContext;
    ...
    pub fn pango_parse_markup                  (markup_text: *const c_char, length: c_int, accel_marker: u32, attr_list: *mut *mut PangoAttrList, text: *mut *mut c_char, accel_char: *mut u32, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn pango_read_line                     (stream: *mut FILE, str: *mut glib_ffi::GString) -> c_int;
    pub fn pango_reorder_items                 (logical_items: *mut glib_ffi::GList) -> *mut glib_ffi::GList;
    pub fn pango_scan_int                      (pos: *mut *const c_char, out: *mut c_int) -> gboolean;
    pub fn pango_scan_string                   (pos: *mut *const c_char, out: *mut glib_ffi::GString) -> gboolean;
    pub fn pango_scan_word                     (pos: *mut *const c_char, out: *mut glib_ffi::GString) -> gboolean;
