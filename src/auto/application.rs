...
pub trait ApplicationExt {
    ...
    fn connect_property_action_group_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_application_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_flags_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_inactivity_timeout_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v2_44")]
    fn connect_property_is_busy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_is_registered_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_is_remote_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_resource_base_path_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
