...
impl Application {
    pub fn new<'a, P: Into<Option<&'a str>>>(application_id: P, flags: ApplicationFlags) -> Application {
        ...
        let application_id = application_id.to_glib_none().0;
        unsafe {
            from_glib_full(ffi::g_application_new(application_id, flags.to_glib()))
        }
    }
...
impl<O: IsA<Application> + IsA<Object>> ApplicationExt for O {
    ...
    fn set_action_group<'a, P: IsA<ActionGroup> + 'a, Q: Into<Option<&'a P>>>(&self, action_group: Q) {
        ...
        let action_group = action_group.to_glib_none().0;
        unsafe {
            ffi::g_application_set_action_group(self.to_glib_none().0, action_group);
        }
    }
    ...
    fn set_application_id<'a, P: Into<Option<&'a str>>>(&self, application_id: P) {
        ...
        let application_id = application_id.to_glib_none().0;
        unsafe {
            ffi::g_application_set_application_id(self.to_glib_none().0, application_id);
        }
    }
    ...
    fn set_resource_base_path<'a, P: Into<Option<&'a str>>>(&self, resource_path: P) {
        ...
        unsafe {
            ffi::g_application_set_resource_base_path(self.to_glib_none().0, resource_path);
        }
    }
