...
glib_wrapper! {
    ...
    match fn {
        copy => |ptr| gobject_ffi::g_boxed_copy(ffi::graphene_triangle_get_type(), ptr as *mut _) as *mut ffi::graphene_triangle_t,
        free => |ptr| gobject_ffi::g_boxed_free(ffi::graphene_triangle_get_type(), ptr as *mut _),
...
impl Triangle {
    ...
    fn equal(&self, b: &Triangle) -> bool {
        unsafe {
            from_glib(ffi::graphene_triangle_equal(self.to_glib_none().0, b.to_glib_none().0))
        }
    }

    pub fn get_area(&self) -> f32 {
        unsafe {
            ffi::graphene_triangle_get_area(self.to_glib_none().0)
        }
    }
    ...
    pub fn get_barycoords(&self, p: Option<&Point3D>) -> Option<Vec2> {
        unsafe {
            ...
            let ret = from_glib(ffi::graphene_triangle_get_barycoords(self.to_glib_none().0, p.to_glib_none().0, res.to_glib_none_mut().0));
    ...
    pub fn get_bounding_box(&self) -> Box {
        unsafe {
            ...
            ffi::graphene_triangle_get_bounding_box(self.to_glib_none().0, res.to_glib_none_mut().0);
            res
        }
    }
    ...
    pub fn get_points(&self) -> (Point3D, Point3D, Point3D) {
        unsafe {
            ...
            ffi::graphene_triangle_get_points(self.to_glib_none().0, a.to_glib_none_mut().0, b.to_glib_none_mut().0, c.to_glib_none_mut().0);
            (a, b, c)
        }
    }
    ...
    pub fn get_vertices(&self) -> (Vec3, Vec3, Vec3) {
        unsafe {
            ...
            ffi::graphene_triangle_get_vertices(self.to_glib_none().0, a.to_glib_none_mut().0, b.to_glib_none_mut().0, c.to_glib_none_mut().0);
            (a, b, c)
        }
    }
