...
pub trait DataInputStreamExt {
    ...
    fn read_line_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<usize, Error>) + Send + Sync + 'static>(&self, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn read_until_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<usize, Error>) + Send + Sync + 'static>(&self, stop_chars: &str, io_priority: i32, cancellable: P, callback: Q);

    fn read_upto<'a, P: Into<Option<&'a Cancellable>>>(&self, stop_chars: &str, cancellable: P) -> Result<(String, usize), Error>;

    fn read_upto_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<usize, Error>) + Send + Sync + 'static>(&self, stop_chars: &str, io_priority: i32, cancellable: P, callback: Q);
...
impl<O: IsA<DataInputStream> + IsA<glib::object::Object>> DataInputStreamExt for O {
    ...
    fn read_line_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<usize, Error>) + Send + Sync + 'static>(&self, io_priority: i32, cancellable: P, callback: Q) {
        ...
        extern "C" fn read_line_async_trampoline(_source_object: *mut gobject_ffi::GObject, res: *mut ffi::GAsyncResult, user_data: glib_ffi::gpointer)
        {
            callback_guard!();
            unsafe {
                let mut error = ptr::null_mut();
        ...
        let callback = read_line_async_trampoline;
        unsafe {
    ...
    fn read_until_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<usize, Error>) + Send + Sync + 'static>(&self, stop_chars: &str, io_priority: i32, cancellable: P, callback: Q) {
        ...
        let cancellable = cancellable.to_glib_none();
        let user_data: Box<Box<Fn(Result<usize, Error>) + Send + Sync + 'static>> = Box::new(Box::new(callback));
        extern "C" fn read_until_async_trampoline(_source_object: *mut gobject_ffi::GObject, res: *mut ffi::GAsyncResult, user_data: glib_ffi::gpointer)
        {
            callback_guard!();
            unsafe {
                let mut error = ptr::null_mut();
        ...
        let callback = read_until_async_trampoline;
        unsafe {
    ...
    fn read_upto_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<usize, Error>) + Send + Sync + 'static>(&self, stop_chars: &str, io_priority: i32, cancellable: P, callback: Q) {
        ...
        let stop_chars_len = stop_chars.len() as isize;
        let user_data: Box<Box<Fn(Result<usize, Error>) + Send + Sync + 'static>> = Box::new(Box::new(callback));
        extern "C" fn read_upto_async_trampoline(_source_object: *mut gobject_ffi::GObject, res: *mut ffi::GAsyncResult, user_data: glib_ffi::gpointer)
        {
            callback_guard!();
            unsafe {
                let mut error = ptr::null_mut();
        ...
        let callback = read_upto_async_trampoline;
        unsafe {
