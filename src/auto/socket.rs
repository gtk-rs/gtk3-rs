...
impl Socket {
    pub fn new(family: SocketFamily, type_: SocketType, protocol: SocketProtocol) -> Result<Socket, Error> {
        unsafe {
            ...
            let ret = gio_sys::g_socket_new(family.to_glib(), type_.to_glib(), protocol.to_glib(), &mut error);
...
impl<O: IsA<Socket>> SocketExt for O {
    fn accept<P: IsA<Cancellable>>(&self, cancellable: Option<&P>) -> Result<Socket, Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = gio_sys::g_socket_accept(self.as_ref().to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, &mut error);
            if error.is_null() { Ok(from_glib_full(ret)) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn bind<P: IsA<SocketAddress>>(&self, address: &P, allow_reuse: bool) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_bind(self.as_ref().to_glib_none().0, address.as_ref().to_glib_none().0, allow_reuse.to_glib(), &mut error);
    ...
    fn check_connect_result(&self) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_check_connect_result(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn condition_check(&self, condition: glib::IOCondition) -> glib::IOCondition {
        unsafe {
            from_glib(gio_sys::g_socket_condition_check(self.as_ref().to_glib_none().0, condition.to_glib()))
        }
    }
    ...
    fn condition_timed_wait<P: IsA<Cancellable>>(&self, condition: glib::IOCondition, timeout: i64, cancellable: Option<&P>) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_condition_timed_wait(self.as_ref().to_glib_none().0, condition.to_glib(), timeout, cancellable.map(|p| p.as_ref()).to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn condition_wait<P: IsA<Cancellable>>(&self, condition: glib::IOCondition, cancellable: Option<&P>) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_condition_wait(self.as_ref().to_glib_none().0, condition.to_glib(), cancellable.map(|p| p.as_ref()).to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn connect<P: IsA<SocketAddress>, Q: IsA<Cancellable>>(&self, address: &P, cancellable: Option<&Q>) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_connect(self.as_ref().to_glib_none().0, address.as_ref().to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn connection_factory_create_connection(&self) -> Option<SocketConnection> {
        unsafe {
            from_glib_full(gio_sys::g_socket_connection_factory_create_connection(self.as_ref().to_glib_none().0))
        }
    }

    fn get_available_bytes(&self) -> isize {
        unsafe {
            gio_sys::g_socket_get_available_bytes(self.as_ref().to_glib_none().0)
        }
    }

    fn get_blocking(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_socket_get_blocking(self.as_ref().to_glib_none().0))
        }
    }

    fn get_broadcast(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_socket_get_broadcast(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_family(&self) -> SocketFamily {
        unsafe {
            from_glib(gio_sys::g_socket_get_family(self.as_ref().to_glib_none().0))
        }
    }

    fn get_keepalive(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_socket_get_keepalive(self.as_ref().to_glib_none().0))
        }
    }

    fn get_listen_backlog(&self) -> i32 {
        unsafe {
            gio_sys::g_socket_get_listen_backlog(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_local_address(&self) -> Result<SocketAddress, Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = gio_sys::g_socket_get_local_address(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() { Ok(from_glib_full(ret)) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn get_multicast_loopback(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_socket_get_multicast_loopback(self.as_ref().to_glib_none().0))
        }
    }

    fn get_multicast_ttl(&self) -> u32 {
        unsafe {
            gio_sys::g_socket_get_multicast_ttl(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_option(&self, level: i32, optname: i32) -> Result<i32, Error> {
        unsafe {
            ...
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_get_option(self.as_ref().to_glib_none().0, level, optname, &mut value, &mut error);
    ...
    fn get_protocol(&self) -> SocketProtocol {
        unsafe {
            from_glib(gio_sys::g_socket_get_protocol(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_remote_address(&self) -> Result<SocketAddress, Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let ret = gio_sys::g_socket_get_remote_address(self.as_ref().to_glib_none().0, &mut error);
            if error.is_null() { Ok(from_glib_full(ret)) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn get_socket_type(&self) -> SocketType {
        unsafe {
            from_glib(gio_sys::g_socket_get_socket_type(self.as_ref().to_glib_none().0))
        }
    }

    fn get_timeout(&self) -> u32 {
        unsafe {
            gio_sys::g_socket_get_timeout(self.as_ref().to_glib_none().0)
        }
    }

    fn get_ttl(&self) -> u32 {
        unsafe {
            gio_sys::g_socket_get_ttl(self.as_ref().to_glib_none().0)
        }
    }

    fn is_closed(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_socket_is_closed(self.as_ref().to_glib_none().0))
        }
    }

    fn is_connected(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_socket_is_connected(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn join_multicast_group<P: IsA<InetAddress>>(&self, group: &P, source_specific: bool, iface: Option<&str>) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_join_multicast_group(self.as_ref().to_glib_none().0, group.as_ref().to_glib_none().0, source_specific.to_glib(), iface.to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn join_multicast_group_ssm<P: IsA<InetAddress>, Q: IsA<InetAddress>>(&self, group: &P, source_specific: Option<&Q>, iface: Option<&str>) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_join_multicast_group_ssm(self.as_ref().to_glib_none().0, group.as_ref().to_glib_none().0, source_specific.map(|p| p.as_ref()).to_glib_none().0, iface.to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn leave_multicast_group<P: IsA<InetAddress>>(&self, group: &P, source_specific: bool, iface: Option<&str>) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_leave_multicast_group(self.as_ref().to_glib_none().0, group.as_ref().to_glib_none().0, source_specific.to_glib(), iface.to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn leave_multicast_group_ssm<P: IsA<InetAddress>, Q: IsA<InetAddress>>(&self, group: &P, source_specific: Option<&Q>, iface: Option<&str>) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_leave_multicast_group_ssm(self.as_ref().to_glib_none().0, group.as_ref().to_glib_none().0, source_specific.map(|p| p.as_ref()).to_glib_none().0, iface.to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn set_multicast_loopback(&self, loopback: bool) {
        unsafe {
            gio_sys::g_socket_set_multicast_loopback(self.as_ref().to_glib_none().0, loopback.to_glib());
        }
    }
    ...
    fn set_option(&self, level: i32, optname: i32, value: i32) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_set_option(self.as_ref().to_glib_none().0, level, optname, value, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn shutdown(&self, shutdown_read: bool, shutdown_write: bool) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_socket_shutdown(self.as_ref().to_glib_none().0, shutdown_read.to_glib(), shutdown_write.to_glib(), &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn speaks_ipv4(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_socket_speaks_ipv4(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn connect_property_blocking_notify<F: Fn(&Self) + Send + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::blocking\0".as_ptr() as *const _,
                Some(transmute(notify_blocking_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_property_broadcast_notify<F: Fn(&Self) + Send + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::broadcast\0".as_ptr() as *const _,
                Some(transmute(notify_broadcast_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_property_keepalive_notify<F: Fn(&Self) + Send + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::keepalive\0".as_ptr() as *const _,
                Some(transmute(notify_keepalive_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_property_multicast_loopback_notify<F: Fn(&Self) + Send + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::multicast-loopback\0".as_ptr() as *const _,
                Some(transmute(notify_multicast_loopback_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_property_multicast_ttl_notify<F: Fn(&Self) + Send + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::multicast-ttl\0".as_ptr() as *const _,
                Some(transmute(notify_multicast_ttl_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_property_remote_address_notify<F: Fn(&Self) + Send + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::remote-address\0".as_ptr() as *const _,
                Some(transmute(notify_remote_address_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
