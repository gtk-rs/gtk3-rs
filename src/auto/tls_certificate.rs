...
pub trait TlsCertificateExt {
    ...
    fn connect_property_certificate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_certificate_pem_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_issuer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_private_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_private_key_pem_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<TlsCertificate> {
    ...
    f(&TlsCertificate::from_glib_none(this).downcast_unchecked())
}
