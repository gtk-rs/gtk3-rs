...
pub trait ActionExt {
    ...
    fn connect_property_enabled_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_parameter_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_state_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_state_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<Action> {
    ...
    f(&Action::from_glib_none(this).downcast_unchecked())
}
