...
glib_wrapper! {
    ...
    match fn {
        copy => |ptr| gobject_ffi::g_boxed_copy(ffi::graphene_box_get_type(), ptr as *mut _) as *mut ffi::graphene_box_t,
        free => |ptr| gobject_ffi::g_boxed_free(ffi::graphene_box_get_type(), ptr as *mut _),
...
impl Box {
    ...
    pub fn expand(&self, point: &Point3D) -> Box {
        unsafe {
            ...
            ffi::graphene_box_expand(self.to_glib_none().0, point.to_glib_none().0, res.to_glib_none_mut().0);
            res
        }
    }
    ...
    pub fn expand_scalar(&self, scalar: f32) -> Box {
        unsafe {
            let mut res = Box::uninitialized();
            ffi::graphene_box_expand_scalar(self.to_glib_none().0, scalar, res.to_glib_none_mut().0);
            res
        }
    }
    ...
    pub fn expand_vec3(&self, vec: &Vec3) -> Box {
        unsafe {
            let mut res = Box::uninitialized();
            ffi::graphene_box_expand_vec3(self.to_glib_none().0, vec.to_glib_none().0, res.to_glib_none_mut().0);
            res
        }
    }
    ...
    pub fn get_bounding_sphere(&self) -> Sphere {
        unsafe {
            ...
            ffi::graphene_box_get_bounding_sphere(self.to_glib_none().0, sphere.to_glib_none_mut().0);
            sphere
        }
    }
    ...
    pub fn intersection(&self, b: &Box) -> Option<Box> {
        unsafe {
            let mut res = Box::uninitialized();
            let ret = from_glib(ffi::graphene_box_intersection(self.to_glib_none().0, b.to_glib_none().0, res.to_glib_none_mut().0));
    ...
    pub fn union(&self, b: &Box) -> Box {
        unsafe {
            let mut res = Box::uninitialized();
            ffi::graphene_box_union(self.to_glib_none().0, b.to_glib_none().0, res.to_glib_none_mut().0);
            res
        }
    }
