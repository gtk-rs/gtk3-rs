...
impl LayoutLine {
    ...
    pub fn get_x_ranges(&self, start_index: i32, end_index: i32) -> Vec<i32> {
        unsafe {
            ...
            pango_sys::pango_layout_line_get_x_ranges(self.to_glib_none().0, start_index, end_index, &mut ranges, &mut n_ranges);
    ...
    pub fn index_to_x(&self, index_: i32, trailing: bool) -> i32 {
        unsafe {
            ...
            pango_sys::pango_layout_line_index_to_x(self.to_glib_none().0, index_, trailing.to_glib(), &mut x_pos);
            x_pos
        }
    }
    ...
    pub fn x_to_index(&self, x_pos: i32) -> Option<(i32, i32)> {
        unsafe {
            ...
            let ret = from_glib(pango_sys::pango_layout_line_x_to_index(self.to_glib_none().0, x_pos, &mut index_, &mut trailing));
