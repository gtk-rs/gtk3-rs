...
glib_wrapper! {
    pub struct FileInfo(Object<ffi::GFileInfo>);
...
pub trait FileInfoExt {
    ...
    //fn get_attribute_data(&self, attribute: &str, type_: /*Ignored*/&mut FileAttributeType, value_pp: /*Unimplemented*/&mut Fundamental: Pointer) -> Option<(/*Ignored*/FileAttributeType, /*Ignored*/FileAttributeStatus)>;
