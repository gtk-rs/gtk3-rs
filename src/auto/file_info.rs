...
impl FileInfo {
    ...
    pub fn clear_status(&self) {
        unsafe {
            gio_sys::g_file_info_clear_status(self.to_glib_none().0);
        }
    }

    pub fn copy_into(&self, dest_info: &FileInfo) {
        unsafe {
            gio_sys::g_file_info_copy_into(self.to_glib_none().0, dest_info.to_glib_none().0);
        }
    }
    ...
    pub fn set_edit_name(&self, edit_name: &str) {
        unsafe {
            gio_sys::g_file_info_set_edit_name(self.to_glib_none().0, edit_name.to_glib_none().0);
        }
    }

    pub fn set_file_type(&self, type_: FileType) {
        unsafe {
            gio_sys::g_file_info_set_file_type(self.to_glib_none().0, type_.to_glib());
        }
    }

    pub fn set_icon<P: IsA<Icon>>(&self, icon: &P) {
        unsafe {
            gio_sys::g_file_info_set_icon(self.to_glib_none().0, icon.as_ref().to_glib_none().0);
        }
    }

    pub fn set_is_hidden(&self, is_hidden: bool) {
        unsafe {
            gio_sys::g_file_info_set_is_hidden(self.to_glib_none().0, is_hidden.to_glib());
        }
    }

    pub fn set_is_symlink(&self, is_symlink: bool) {
        unsafe {
            gio_sys::g_file_info_set_is_symlink(self.to_glib_none().0, is_symlink.to_glib());
        }
    }
    ...
    pub fn set_name<P: AsRef<std::path::Path>>(&self, name: P) {
        unsafe {
            gio_sys::g_file_info_set_name(self.to_glib_none().0, name.as_ref().to_glib_none().0);
        }
    }

    pub fn set_size(&self, size: i64) {
        unsafe {
            gio_sys::g_file_info_set_size(self.to_glib_none().0, size);
        }
    }

    pub fn set_sort_order(&self, sort_order: i32) {
        unsafe {
            gio_sys::g_file_info_set_sort_order(self.to_glib_none().0, sort_order);
        }
    }
    ...
    pub fn unset_attribute_mask(&self) {
        unsafe {
            gio_sys::g_file_info_unset_attribute_mask(self.to_glib_none().0);
        }
    }
}
