...
impl<O: IsA<Device> + IsA<glib::object::Object>> DeviceExt for O {
    ...
    fn get_property_device_manager(&self) -> Option<DeviceManager> {
        unsafe {
            ...
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <DeviceManager as StaticType>::static_type().to_glib());
    ...
    fn get_property_input_mode(&self) -> InputMode {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <InputMode as StaticType>::static_type().to_glib());
    ...
    fn get_property_input_source(&self) -> InputSource {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <InputSource as StaticType>::static_type().to_glib());
    ...
    fn get_property_tool(&self) -> Option<DeviceTool> {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <DeviceTool as StaticType>::static_type().to_glib());
    ...
    fn get_property_type(&self) -> DeviceType {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <DeviceType as StaticType>::static_type().to_glib());
