...
impl Device {
    ...
    //pub fn get_axis_value(&self, axes: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 21 }, axis_label: /*Ignored*/&Atom) -> Option<f64> {
    ...
    //pub fn list_axes(&self) -> /*Ignored*/Vec<Atom> {
    //    unsafe { TODO: call ffi::gdk_device_list_axes() }
    //}
    ...
    pub fn set_property_device_manager(&self, device_manager: Option<&DeviceManager>) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "device-manager".to_glib_none().0, Value::from(device_manager).to_glib_none().0);
        }
    }
    ...
    pub fn set_property_has_cursor(&self, has_cursor: bool) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "has-cursor".to_glib_none().0, Value::from(&has_cursor).to_glib_none().0);
        }
    }
    ...
    pub fn set_property_input_source(&self, input_source: InputSource) {
        let input_source = input_source.to_glib() as i32;
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "input-source".to_glib_none().0, Value::from(&input_source).to_glib_none().0);
        }
    }
    ...
    #[cfg(feature = "v3_20")]
    pub fn set_property_num_touches(&self, num_touches: u32) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "num-touches".to_glib_none().0, Value::from(&num_touches).to_glib_none().0);
        }
    }

    #[cfg(feature = "v3_16")]
    pub fn set_property_product_id(&self, product_id: Option<&str>) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "product-id".to_glib_none().0, Value::from(product_id).to_glib_none().0);
        }
    }
    ...
    pub fn set_property_type(&self, type_: DeviceType) {
    ...
    #[cfg(feature = "v3_16")]
    pub fn set_property_vendor_id(&self, vendor_id: Option<&str>) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "vendor-id".to_glib_none().0, Value::from(vendor_id).to_glib_none().0);
        }
    }
