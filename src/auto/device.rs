...
pub trait DeviceExt {
    ...
    fn connect_property_associated_device_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_axes_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_device_manager_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_display_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_cursor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_input_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_input_source_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_n_axes_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_20")]
    fn connect_property_num_touches_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_product_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_20")]
    fn connect_property_seat_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_tool_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_vendor_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
