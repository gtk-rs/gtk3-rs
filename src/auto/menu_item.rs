...
impl MenuItem {
    pub fn new<'a, T: Into<Option<&'a str>>, U: Into<Option<&'a str>>>(label: T, detailed_action: U) -> MenuItem {
        unsafe {
    ...
    //pub fn set_action_and_target<'a, T: Into<Option<&'a str>>, U: Into<Option<&'a str>>>(&self, action: T, format_string: U, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) {
