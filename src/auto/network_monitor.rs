...
impl NetworkMonitor {
    pub fn get_default() -> Option<NetworkMonitor> {
        unsafe {
            from_glib_none(gio_sys::g_network_monitor_get_default())
        }
    }
}
...
impl<O: IsA<NetworkMonitor>> NetworkMonitorExt for O {
    fn can_reach<P: IsA<SocketConnectable>, Q: IsA<Cancellable>>(&self, connectable: &P, cancellable: Option<&Q>) -> Result<(), Error> {
        unsafe {
            ...
            let _ = gio_sys::g_network_monitor_can_reach(self.as_ref().to_glib_none().0, connectable.as_ref().to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, &mut error);
    ...
    fn can_reach_async<P: IsA<SocketConnectable>, Q: IsA<Cancellable>, R: FnOnce(Result<(), Error>) + Send + 'static>(&self, connectable: &P, cancellable: Option<&Q>, callback: R) {
        ...
        unsafe extern "C" fn can_reach_async_trampoline<R: FnOnce(Result<(), Error>) + Send + 'static>(_source_object: *mut gobject_sys::GObject, res: *mut gio_sys::GAsyncResult, user_data: glib_sys::gpointer) {
            let mut error = ptr::null_mut();
            let _ = gio_sys::g_network_monitor_can_reach_finish(_source_object as *mut _, res, &mut error);
        ...
        unsafe {
            gio_sys::g_network_monitor_can_reach_async(self.as_ref().to_glib_none().0, connectable.as_ref().to_glib_none().0, cancellable.map(|p| p.as_ref()).to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn get_connectivity(&self) -> NetworkConnectivity {
        unsafe {
            from_glib(gio_sys::g_network_monitor_get_connectivity(self.as_ref().to_glib_none().0))
        }
    }

    fn get_network_available(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_network_monitor_get_network_available(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_network_metered(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_network_monitor_get_network_metered(self.as_ref().to_glib_none().0))
        }
    }
...
unsafe extern "C" fn network_changed_trampoline<P, F: Fn(&P, bool) + 'static>(this: *mut gio_sys::GNetworkMonitor, network_available: glib_sys::gboolean, f: glib_sys::gpointer)
...
#[cfg(any(feature = "v2_44", feature = "dox"))]
unsafe extern "C" fn notify_connectivity_trampoline<P, F: Fn(&P) + 'static>(this: *mut gio_sys::GNetworkMonitor, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<NetworkMonitor> {
    let f: &F = &*(f as *const F);
    f(&NetworkMonitor::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_network_available_trampoline<P, F: Fn(&P) + 'static>(this: *mut gio_sys::GNetworkMonitor, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<NetworkMonitor> {
    let f: &F = &*(f as *const F);
    f(&NetworkMonitor::from_glib_borrow(this).unsafe_cast())
}
...
#[cfg(any(feature = "v2_46", feature = "dox"))]
unsafe extern "C" fn notify_network_metered_trampoline<P, F: Fn(&P) + 'static>(this: *mut gio_sys::GNetworkMonitor, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<NetworkMonitor> {
    let f: &F = &*(f as *const F);
    f(&NetworkMonitor::from_glib_borrow(this).unsafe_cast())
}
