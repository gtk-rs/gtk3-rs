...
impl Display {
    ...
    pub fn get_default_cursor_size(&self) -> u32 {
        unsafe {
            gdk_sys::gdk_display_get_default_cursor_size(self.to_glib_none().0)
        }
    }
    ...
    pub fn get_default_screen(&self) -> Screen {
        unsafe {
            from_glib_none(gdk_sys::gdk_display_get_default_screen(self.to_glib_none().0))
        }
    }
    ...
    pub fn get_device_manager(&self) -> Option<DeviceManager> {
        unsafe {
            from_glib_none(gdk_sys::gdk_display_get_device_manager(self.to_glib_none().0))
        }
    }
    ...
    pub fn get_maximal_cursor_size(&self) -> (u32, u32) {
        unsafe {
            ...
            gdk_sys::gdk_display_get_maximal_cursor_size(self.to_glib_none().0, &mut width, &mut height);
            (width, height)
        }
    }
    ...
    pub fn get_monitor_at_window<P: IsA<Window>>(&self, window: &P) -> Option<Monitor> {
        unsafe {
            from_glib_none(gdk_sys::gdk_display_get_monitor_at_window(self.to_glib_none().0, window.as_ref().to_glib_none().0))
        }
    }
    ...
    pub fn get_screen(&self, screen_num: i32) -> Screen {
        unsafe {
            from_glib_none(gdk_sys::gdk_display_get_screen(self.to_glib_none().0, screen_num))
        }
    }
    ...
    pub fn request_selection_notification(&self, selection: &Atom) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_display_request_selection_notification(self.to_glib_none().0, selection.to_glib_none().0))
        }
    }
    ...
    pub fn store_clipboard<P: IsA<Window>>(&self, clipboard_window: &P, time_: u32, targets: &[&Atom]) {
        ...
        unsafe {
            gdk_sys::gdk_display_store_clipboard(self.to_glib_none().0, clipboard_window.as_ref().to_glib_none().0, time_, targets.to_glib_none().0, n_targets);
        }
    }

    pub fn supports_clipboard_persistence(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_display_supports_clipboard_persistence(self.to_glib_none().0))
        }
    }
    ...
    pub fn supports_composite(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_display_supports_composite(self.to_glib_none().0))
        }
    }

    pub fn supports_cursor_alpha(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_display_supports_cursor_alpha(self.to_glib_none().0))
        }
    }

    pub fn supports_cursor_color(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_display_supports_cursor_color(self.to_glib_none().0))
        }
    }
    ...
    pub fn supports_selection_notification(&self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_display_supports_selection_notification(self.to_glib_none().0))
        }
    }
    ...
    pub fn open_default_libgtk_only() -> Option<Display> {
        assert_initialized_main_thread!();
        unsafe {
            from_glib_none(gdk_sys::gdk_display_open_default_libgtk_only())
        }
    }
