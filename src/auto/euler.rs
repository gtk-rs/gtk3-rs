...
glib_wrapper! {
    ...
    match fn {
        copy => |ptr| gobject_ffi::g_boxed_copy(ffi::graphene_euler_get_type(), ptr as *mut _) as *mut ffi::graphene_euler_t,
        free => |ptr| gobject_ffi::g_boxed_free(ffi::graphene_euler_get_type(), ptr as *mut _),
...
impl Euler {
    ...
    pub fn get_order(&self) -> EulerOrder {
        unsafe {
            from_glib(ffi::graphene_euler_get_order(self.to_glib_none().0))
        }
    }

    pub fn get_x(&self) -> f32 {
        unsafe {
            ffi::graphene_euler_get_x(self.to_glib_none().0)
        }
    }

    pub fn get_y(&self) -> f32 {
        unsafe {
            ffi::graphene_euler_get_y(self.to_glib_none().0)
        }
    }

    pub fn get_z(&self) -> f32 {
        unsafe {
            ffi::graphene_euler_get_z(self.to_glib_none().0)
        }
    }
    ...
    pub fn reorder(&self, order: EulerOrder) -> Euler {
        unsafe {
            ...
            ffi::graphene_euler_reorder(self.to_glib_none().0, order.to_glib(), res.to_glib_none_mut().0);
            res
        }
    }
