...
pub trait FileOutputStreamExt {
    ...
    fn query_info_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, attributes: &str, io_priority: i32, cancellable: P, callback: Q);
}
...
impl<O: IsA<FileOutputStream>> FileOutputStreamExt for O {
    ...
    fn query_info_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, attributes: &str, io_priority: i32, cancellable: P, callback: Q) {
        ...
        extern "C" fn query_info_async_trampoline(_source_object: *mut gobject_ffi::GObject, res: *mut ffi::GAsyncResult, user_data: glib_ffi::gpointer)
        {
            ...
            unsafe {
                let mut error = ptr::null_mut();
                let _ = ffi::g_file_output_stream_query_info_finish(_source_object as *mut _, res, &mut error);
