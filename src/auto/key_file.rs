...
impl KeyFile {
    ...
    //pub fn get_double_list(&self, group_name: &str, key: &str) -> Result</*Unimplemented*/CArray TypeId { ns_id: 0, id: 21 }, Error> {
    ...
    //pub fn get_integer_list(&self, group_name: &str, key: &str) -> Result</*Unimplemented*/CArray TypeId { ns_id: 0, id: 14 }, Error> {
    ...
    pub fn get_locale_string_list<'a, P: Into<Option<&'a str>>>(&self, group_name: &str, key: &str, locale: P) -> Result<Vec<String>, Error> {
        ...
        unsafe {
            ...
            if error.is_null() { Ok(FromGlibPtrContainer::from_glib_full_num(ret, length as usize)) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    //pub fn set_double_list(&self, group_name: &str, key: &str, list: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 21 }) {
    ...
    //pub fn set_integer_list(&self, group_name: &str, key: &str, list: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }) {
