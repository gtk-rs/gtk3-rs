...
impl KeyFile {
    ...
    //pub fn get_boolean_list(&self, group_name: &str, key: &str) -> Result<(/*Unimplemented*/CArray TypeId { ns_id: 0, id: 1 }, usize), Error> {
    ...
    //pub fn get_double_list(&self, group_name: &str, key: &str) -> Result<(/*Unimplemented*/CArray TypeId { ns_id: 0, id: 21 }, usize), Error> {
    ...
    //pub fn get_integer_list(&self, group_name: &str, key: &str) -> Result<(/*Unimplemented*/CArray TypeId { ns_id: 0, id: 14 }, usize), Error> {
    ...
    pub fn get_locale_string_list<'a, P: Into<Option<&'a str>>>(&self, group_name: &str, key: &str, locale: P) -> Result<(Vec<String>, usize), Error> {
        let locale = locale.into();
        let locale = locale.to_glib_none();
        unsafe {
            let mut length = mem::uninitialized();
    ...
    //pub fn set_double_list(&self, group_name: &str, key: &str, list: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 21 }, length: usize) {
    ...
    //pub fn set_integer_list(&self, group_name: &str, key: &str, list: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }, length: usize) {
