...
pub trait FileExt {
    ...
    //fn load_contents<'a, P: Into<Option<&'a Cancellable>>>(&self, cancellable: P, contents: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }) -> Result<(usize, String), Error>;
    ...
    //fn load_contents_finish<P: IsA</*Ignored*/AsyncResult>>(&self, res: &P, contents: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }) -> Result<(usize, String), Error>;
    ...
    //fn load_partial_contents_finish<P: IsA</*Ignored*/AsyncResult>>(&self, res: &P, contents: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }) -> Result<(usize, String), Error>;
    ...
    //fn replace_contents<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b Cancellable>>>(&self, contents: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, etag: P, make_backup: bool, flags: FileCreateFlags, cancellable: Q) -> Result<String, Error>;
