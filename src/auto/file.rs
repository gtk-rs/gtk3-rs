...
pub trait FileExt {
    ...
    fn delete_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn enumerate_children_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, attributes: &str, flags: FileQueryInfoFlags, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn find_enclosing_mount_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn load_contents_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(Vec<u8>, String), Error>) + Send + Sync + 'static>(&self, cancellable: P, callback: Q);

    //fn load_partial_contents_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(Vec<u8>, String), Error>) + Send + Sync + 'static>(&self, cancellable: P, read_more_callback: /*Unknown conversion*//*Unimplemented*/FileReadMoreCallback, callback: Q);

    fn make_directory<'a, P: Into<Option<&'a Cancellable>>>(&self, cancellable: P) -> Result<(), Error>;

    #[cfg(any(feature = "v2_38", feature = "dox"))]
    fn make_directory_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn query_filesystem_info_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, attributes: &str, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn query_info_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, attributes: &str, flags: FileQueryInfoFlags, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn replace_contents_async<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b Cancellable>>, R: Fn(Result<String, Error>) + Send + Sync + 'static>(&self, contents: &[u8], etag: P, make_backup: bool, flags: FileCreateFlags, cancellable: Q, callback: R);
    ...
    fn set_attributes_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<FileInfo, Error>) + Send + Sync + 'static>(&self, info: &FileInfo, flags: FileQueryInfoFlags, io_priority: i32, cancellable: P, callback: Q);
    ...
    fn set_display_name_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, display_name: &str, io_priority: i32, cancellable: P, callback: Q);
    ...
    #[cfg(any(feature = "v2_38", feature = "dox"))]
    fn trash_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, io_priority: i32, cancellable: P, callback: Q);
...
impl<O: IsA<File>> FileExt for O {
    ...
    fn enumerate_children_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, attributes: &str, flags: FileQueryInfoFlags, io_priority: i32, cancellable: P, callback: Q) {
        ...
        unsafe {
            ffi::g_file_enumerate_children_async(self.to_glib_none().0, attributes.to_glib_none().0, flags.to_glib(), io_priority, cancellable.0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn find_enclosing_mount_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(), Error>) + Send + Sync + 'static>(&self, io_priority: i32, cancellable: P, callback: Q) {
        ...
        unsafe {
            ffi::g_file_find_enclosing_mount_async(self.to_glib_none().0, io_priority, cancellable.0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
    }
    ...
    fn load_contents_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(Vec<u8>, String), Error>) + Send + Sync + 'static>(&self, cancellable: P, callback: Q) {
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
        let user_data: Box<Box<Fn(Result<(Vec<u8>, String), Error>) + Send + Sync + 'static>> = Box::new(Box::new(callback));
        extern "C" fn load_contents_async_trampoline(_source_object: *mut gobject_ffi::GObject, res: *mut ffi::GAsyncResult, user_data: glib_ffi::gpointer)
        {
            ...
            unsafe {
                ...
                let callback: &&(Fn(Result<(Vec<u8>, String), Error>) + Send + Sync + 'static) = transmute(user_data);
                callback(result);
            }
        }
    ...
    fn replace_contents_async<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b Cancellable>>, R: Fn(Result<String, Error>) + Send + Sync + 'static>(&self, contents: &[u8], etag: P, make_backup: bool, flags: FileCreateFlags, cancellable: Q, callback: R) {
        ...
        let cancellable = cancellable.to_glib_none();
        let length = contents.len() as usize;
        let user_data: Box<Box<Fn(Result<String, Error>) + Send + Sync + 'static>> = Box::new(Box::new(callback));
        extern "C" fn replace_contents_async_trampoline(_source_object: *mut gobject_ffi::GObject, res: *mut ffi::GAsyncResult, user_data: glib_ffi::gpointer)
        {
            ...
            unsafe {
                ...
                let callback: &&(Fn(Result<String, Error>) + Send + Sync + 'static) = transmute(user_data);
                callback(result);
            }
        }
