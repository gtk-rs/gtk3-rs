...
pub trait FileExt {
    ...
    fn append_to_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, flags: FileCreateFlags, io_priority: i32, callback: P) -> Cancellable;
    ...
    //fn copy_async<'a, P: IsA<File>, Q: Into<Option<&'a /*Unimplemented*/FileProgressCallback>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>, S: Fn(Result<(), Error>) + Send + Sync>(&self, destination: &P, flags: /*Ignored*/FileCopyFlags, io_priority: i32, progress_callback: Q, progress_callback_data: R, callback: S) -> Cancellable;
    ...
    fn create_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, flags: FileCreateFlags, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn create_readwrite_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, flags: FileCreateFlags, io_priority: i32, callback: P) -> Cancellable;

    fn delete<'a, P: Into<Option<&'a Cancellable>>>(&self, cancellable: P) -> Result<(), Error>;

    #[cfg(any(feature = "v2_34", feature = "dox"))]
    fn delete_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn enumerate_children_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, attributes: &str, flags: FileQueryInfoFlags, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn find_enclosing_mount_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn load_contents_async<P: Fn(Result<(Vec<u8>, String), Error>) + Send + Sync>(&self, callback: P) -> Cancellable;

    //fn load_partial_contents_async<P: Fn(Result<(Vec<u8>, String), Error>) + Send + Sync>(&self, read_more_callback: /*Unknown conversion*//*Unimplemented*/FileReadMoreCallback, callback: P) -> Cancellable;

    fn make_directory<'a, P: Into<Option<&'a Cancellable>>>(&self, cancellable: P) -> Result<(), Error>;

    #[cfg(any(feature = "v2_38", feature = "dox"))]
    fn make_directory_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable;
    ...
    //#[cfg(any(feature = "v2_38", feature = "dox"))]
    //fn measure_disk_usage_async<'a, P: Into<Option<&'a /*Unimplemented*/FileMeasureProgressCallback>>, Q: Into<Option</*Unimplemented*/Fundamental: Pointer>>, R: Fn(Result<(u64, u64, u64), Error>) + Send + Sync>(&self, flags: /*Ignored*/FileMeasureFlags, io_priority: i32, progress_callback: P, progress_data: Q, callback: R) -> Cancellable;
    ...
    fn open_readwrite_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn query_filesystem_info_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, attributes: &str, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn query_info_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, attributes: &str, flags: FileQueryInfoFlags, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn read_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn replace_async<'a, P: Into<Option<&'a str>>, Q: Fn(Result<(), Error>) + Send + Sync>(&self, etag: P, make_backup: bool, flags: FileCreateFlags, io_priority: i32, callback: Q) -> Cancellable;
    ...
    fn replace_contents_async<'a, P: Into<Option<&'a str>>, Q: Fn(Result<String, Error>) + Send + Sync>(&self, contents: &[u8], etag: P, make_backup: bool, flags: FileCreateFlags, callback: Q) -> Cancellable;

    //#[cfg(any(feature = "v2_40", feature = "dox"))]
    //fn replace_contents_bytes_async<'a, P: Into<Option<&'a str>>, Q: /*Unimplemented*/AsyncReadyCallback>(&self, contents: &glib::Bytes, etag: P, make_backup: bool, flags: FileCreateFlags, callback: Q) -> Cancellable;
    ...
    fn replace_readwrite_async<'a, P: Into<Option<&'a str>>, Q: Fn(Result<(), Error>) + Send + Sync>(&self, etag: P, make_backup: bool, flags: FileCreateFlags, io_priority: i32, callback: Q) -> Cancellable;
    ...
    fn set_attributes_async<P: Fn(Result<FileInfo, Error>) + Send + Sync>(&self, info: &FileInfo, flags: FileQueryInfoFlags, io_priority: i32, callback: P) -> Cancellable;
    ...
    fn set_display_name_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, display_name: &str, io_priority: i32, callback: P) -> Cancellable;
    ...
    #[cfg(any(feature = "v2_38", feature = "dox"))]
    fn trash_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable;
...
impl<O: IsA<File>> FileExt for O {
    ...
    fn append_to_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, flags: FileCreateFlags, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_append_to_async(self.to_glib_none().0, flags.to_glib(), io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn create_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, flags: FileCreateFlags, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_create_async(self.to_glib_none().0, flags.to_glib(), io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn create_readwrite_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, flags: FileCreateFlags, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_create_readwrite_async(self.to_glib_none().0, flags.to_glib(), io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn delete_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable {
        ...
        let callback = delete_async_trampoline;
        unsafe {
            ffi::g_file_delete_async(self.to_glib_none().0, io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn enumerate_children_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, attributes: &str, flags: FileQueryInfoFlags, io_priority: i32, callback: P) -> Cancellable {
        ...
        let callback = enumerate_children_async_trampoline;
        unsafe {
            ffi::g_file_enumerate_children_async(self.to_glib_none().0, attributes.to_glib_none().0, flags.to_glib(), io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn find_enclosing_mount_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable {
        ...
        let callback = find_enclosing_mount_async_trampoline;
        unsafe {
            ffi::g_file_find_enclosing_mount_async(self.to_glib_none().0, io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn load_contents_async<P: Fn(Result<(Vec<u8>, String), Error>) + Send + Sync>(&self, callback: P) -> Cancellable {
        ...
        let callback = load_contents_async_trampoline;
        unsafe {
            ffi::g_file_load_contents_async(self.to_glib_none().0, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn make_directory_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_make_directory_async(self.to_glib_none().0, io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn open_readwrite_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_open_readwrite_async(self.to_glib_none().0, io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn query_filesystem_info_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, attributes: &str, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_query_filesystem_info_async(self.to_glib_none().0, attributes.to_glib_none().0, io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn query_info_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, attributes: &str, flags: FileQueryInfoFlags, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_query_info_async(self.to_glib_none().0, attributes.to_glib_none().0, flags.to_glib(), io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn read_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_read_async(self.to_glib_none().0, io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn replace_async<'a, P: Into<Option<&'a str>>, Q: Fn(Result<(), Error>) + Send + Sync>(&self, etag: P, make_backup: bool, flags: FileCreateFlags, io_priority: i32, callback: Q) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_replace_async(self.to_glib_none().0, etag.0, make_backup.to_glib(), flags.to_glib(), io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn replace_contents_async<'a, P: Into<Option<&'a str>>, Q: Fn(Result<String, Error>) + Send + Sync>(&self, contents: &[u8], etag: P, make_backup: bool, flags: FileCreateFlags, callback: Q) -> Cancellable {
        ...
        let callback = replace_contents_async_trampoline;
        unsafe {
            ffi::g_file_replace_contents_async(self.to_glib_none().0, contents.to_glib_none().0, length, etag.0, make_backup.to_glib(), flags.to_glib(), cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn replace_readwrite_async<'a, P: Into<Option<&'a str>>, Q: Fn(Result<(), Error>) + Send + Sync>(&self, etag: P, make_backup: bool, flags: FileCreateFlags, io_priority: i32, callback: Q) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_replace_readwrite_async(self.to_glib_none().0, etag.0, make_backup.to_glib(), flags.to_glib(), io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn set_attributes_async<P: Fn(Result<FileInfo, Error>) + Send + Sync>(&self, info: &FileInfo, flags: FileQueryInfoFlags, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_set_attributes_async(self.to_glib_none().0, info.to_glib_none().0, flags.to_glib(), io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn set_display_name_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, display_name: &str, io_priority: i32, callback: P) -> Cancellable {
        ...
        unsafe {
            ffi::g_file_set_display_name_async(self.to_glib_none().0, display_name.to_glib_none().0, io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
    ...
    fn trash_async<P: Fn(Result<(), Error>) + Send + Sync>(&self, io_priority: i32, callback: P) -> Cancellable {
        ...
        let callback = trash_async_trampoline;
        unsafe {
            ffi::g_file_trash_async(self.to_glib_none().0, io_priority, cancellable.to_glib_none().0, Some(callback), Box::into_raw(user_data) as *mut _);
        }
        cancellable
    }
