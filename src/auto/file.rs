// This file was generated by gir (f71e698+) from gir-files (469db10)
// DO NOT EDIT
...
pub trait FileExt {
    ...
    //fn load_partial_contents_async<'a, P: Into<Option<&'a Cancellable>>, Q: Fn(Result<(Vec<u8>, String), Error>) + Send + Sync>(&self, cancellable: P, read_more_callback: /*Unknown conversion*//*Unimplemented*/FileReadMoreCallback, callback: Q);
    ...
    fn replace_async<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b Cancellable>>, R: Fn(Result<(), Error>) + Send + Sync>(&self, etag: P, make_backup: bool, flags: FileCreateFlags, io_priority: i32, cancellable: Q, callback: R);
    ...
    fn replace_contents_async<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b Cancellable>>, R: Fn(Result<String, Error>) + Send + Sync>(&self, contents: &[u8], etag: P, make_backup: bool, flags: FileCreateFlags, cancellable: Q, callback: R);
    ...
    fn replace_readwrite_async<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b Cancellable>>, R: Fn(Result<(), Error>) + Send + Sync>(&self, etag: P, make_backup: bool, flags: FileCreateFlags, io_priority: i32, cancellable: Q, callback: R);
