...
impl Settings {
    ...
    pub fn bind<P: IsA<glib::Object>>(&self, key: &str, object: &P, property: &str, flags: SettingsBindFlags) {
        unsafe {
    ...
    pub fn bind_writable<P: IsA<glib::Object>>(&self, key: &str, object: &P, property: &str, inverted: bool) {
        unsafe {
    ...
    //pub fn get_mapped<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, key: &str, mapping: /*Unknown conversion*//*Unimplemented*/SettingsGetMapping, user_data: P) -> /*Unimplemented*/Option<Fundamental: Pointer> {
    ...
    //pub fn get_property_settings_schema(&self) -> /*Ignored*/Option<SettingsSchema> {
