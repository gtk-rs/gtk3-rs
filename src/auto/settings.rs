...
impl Settings {
    pub fn new(schema_id: &str) -> Settings {
        unsafe {
            from_glib_full(gio_sys::g_settings_new(schema_id.to_glib_none().0))
        }
    }

    pub fn new_full<P: IsA<SettingsBackend>>(schema: &SettingsSchema, backend: Option<&P>, path: Option<&str>) -> Settings {
        unsafe {
            from_glib_full(gio_sys::g_settings_new_full(schema.to_glib_none().0, backend.map(|p| p.as_ref()).to_glib_none().0, path.to_glib_none().0))
        }
    }

    pub fn new_with_backend<P: IsA<SettingsBackend>>(schema_id: &str, backend: &P) -> Settings {
        unsafe {
            from_glib_full(gio_sys::g_settings_new_with_backend(schema_id.to_glib_none().0, backend.as_ref().to_glib_none().0))
        }
    }

    pub fn new_with_backend_and_path<P: IsA<SettingsBackend>>(schema_id: &str, backend: &P, path: &str) -> Settings {
        unsafe {
            from_glib_full(gio_sys::g_settings_new_with_backend_and_path(schema_id.to_glib_none().0, backend.as_ref().to_glib_none().0, path.to_glib_none().0))
        }
    }

    pub fn new_with_path(schema_id: &str, path: &str) -> Settings {
        unsafe {
            from_glib_full(gio_sys::g_settings_new_with_path(schema_id.to_glib_none().0, path.to_glib_none().0))
        }
    }
...
impl<O: IsA<Settings>> SettingsExt for O {
    ...
    fn bind<P: IsA<glib::Object>>(&self, key: &str, object: &P, property: &str, flags: SettingsBindFlags) {
        unsafe {
            gio_sys::g_settings_bind(self.as_ref().to_glib_none().0, key.to_glib_none().0, object.as_ref().to_glib_none().0, property.to_glib_none().0, flags.to_glib());
        }
    }
    ...
    fn bind_writable<P: IsA<glib::Object>>(&self, key: &str, object: &P, property: &str, inverted: bool) {
        unsafe {
            gio_sys::g_settings_bind_writable(self.as_ref().to_glib_none().0, key.to_glib_none().0, object.as_ref().to_glib_none().0, property.to_glib_none().0, inverted.to_glib());
        }
    }

    fn create_action(&self, key: &str) -> Option<Action> {
        unsafe {
            from_glib_full(gio_sys::g_settings_create_action(self.as_ref().to_glib_none().0, key.to_glib_none().0))
        }
    }
    ...
    fn get_boolean(&self, key: &str) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_get_boolean(self.as_ref().to_glib_none().0, key.to_glib_none().0))
        }
    }

    fn get_child(&self, name: &str) -> Option<Settings> {
        unsafe {
            from_glib_full(gio_sys::g_settings_get_child(self.as_ref().to_glib_none().0, name.to_glib_none().0))
        }
    }

    fn get_default_value(&self, key: &str) -> Option<glib::Variant> {
        unsafe {
            from_glib_full(gio_sys::g_settings_get_default_value(self.as_ref().to_glib_none().0, key.to_glib_none().0))
        }
    }
    ...
    fn get_has_unapplied(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_get_has_unapplied(self.as_ref().to_glib_none().0))
        }
    }

    fn get_int(&self, key: &str) -> i32 {
        unsafe {
            gio_sys::g_settings_get_int(self.as_ref().to_glib_none().0, key.to_glib_none().0)
        }
    }
    ...
    fn get_string(&self, key: &str) -> Option<GString> {
        unsafe {
            from_glib_full(gio_sys::g_settings_get_string(self.as_ref().to_glib_none().0, key.to_glib_none().0))
        }
    }

    fn get_strv(&self, key: &str) -> Vec<GString> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(gio_sys::g_settings_get_strv(self.as_ref().to_glib_none().0, key.to_glib_none().0))
        }
    }
    ...
    fn get_user_value(&self, key: &str) -> Option<glib::Variant> {
        unsafe {
            from_glib_full(gio_sys::g_settings_get_user_value(self.as_ref().to_glib_none().0, key.to_glib_none().0))
        }
    }

    fn get_value(&self, key: &str) -> Option<glib::Variant> {
        unsafe {
            from_glib_full(gio_sys::g_settings_get_value(self.as_ref().to_glib_none().0, key.to_glib_none().0))
        }
    }

    fn is_writable(&self, name: &str) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_is_writable(self.as_ref().to_glib_none().0, name.to_glib_none().0))
        }
    }

    fn list_children(&self) -> Vec<GString> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(gio_sys::g_settings_list_children(self.as_ref().to_glib_none().0))
        }
    }

    fn list_keys(&self) -> Vec<GString> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(gio_sys::g_settings_list_keys(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_boolean(&self, key: &str, value: bool) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_boolean(self.as_ref().to_glib_none().0, key.to_glib_none().0, value.to_glib()))
        }
    }

    fn set_double(&self, key: &str, value: f64) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_double(self.as_ref().to_glib_none().0, key.to_glib_none().0, value))
        }
    }

    fn set_enum(&self, key: &str, value: i32) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_enum(self.as_ref().to_glib_none().0, key.to_glib_none().0, value))
        }
    }

    fn set_flags(&self, key: &str, value: u32) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_flags(self.as_ref().to_glib_none().0, key.to_glib_none().0, value))
        }
    }

    fn set_int(&self, key: &str, value: i32) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_int(self.as_ref().to_glib_none().0, key.to_glib_none().0, value))
        }
    }
    ...
    fn set_int64(&self, key: &str, value: i64) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_int64(self.as_ref().to_glib_none().0, key.to_glib_none().0, value))
        }
    }

    fn set_string(&self, key: &str, value: &str) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_string(self.as_ref().to_glib_none().0, key.to_glib_none().0, value.to_glib_none().0))
        }
    }

    fn set_strv(&self, key: &str, value: &[&str]) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_strv(self.as_ref().to_glib_none().0, key.to_glib_none().0, value.to_glib_none().0))
        }
    }

    fn set_uint(&self, key: &str, value: u32) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_uint(self.as_ref().to_glib_none().0, key.to_glib_none().0, value))
        }
    }
    ...
    fn set_uint64(&self, key: &str, value: u64) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_uint64(self.as_ref().to_glib_none().0, key.to_glib_none().0, value))
        }
    }

    fn set_value(&self, key: &str, value: &glib::Variant) -> bool {
        unsafe {
            from_glib(gio_sys::g_settings_set_value(self.as_ref().to_glib_none().0, key.to_glib_none().0, value.to_glib_none().0))
        }
    }
    ...
    fn get_property_backend(&self) -> Option<SettingsBackend> {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"backend\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get()
        }
    }
    ...
    fn get_property_delay_apply(&self) -> bool {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"delay-apply\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn get_property_path(&self) -> Option<GString> {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"path\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get()
        }
    }
    ...
    fn get_property_schema_id(&self) -> Option<GString> {
        unsafe {
            let mut value = Value::from_type(<GString as StaticType>::static_type());
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"schema-id\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get()
        }
    }
    ...
    fn get_property_settings_schema(&self) -> Option<SettingsSchema> {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"settings-schema\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get()
        }
    }
