...
impl Settings {
    ...
    //pub fn new_full(schema: /*Ignored*/&SettingsSchema, backend: /*Ignored*/Option<&mut SettingsBackend>, path: Option<&str>) -> Settings {
    ...
    //pub fn get_mapped(&self, key: &str, mapping: /*Unknown conversion*//*Unimplemented*/SettingsGetMapping, user_data: /*Unimplemented*/Fundamental: Pointer) -> /*Unimplemented*/Option<Fundamental: Pointer> {
    ...
    //    Unimplemented keys: *.CArray TypeId { ns_id: 2, id: 29 }
    //}
...
unsafe extern "C" fn changed_trampoline(this: *mut GSettings, key: *mut c_char, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Settings, &str) + 'static> = transmute(f);
    f(&from_glib_none(this), &String::from_glib_none(key))
}

unsafe extern "C" fn writable_changed_trampoline(this: *mut GSettings, key: *mut c_char, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Settings, &str) + 'static> = transmute(f);
    f(&from_glib_none(this), &String::from_glib_none(key))
}
