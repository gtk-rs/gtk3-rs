...
pub trait TlsDatabaseExt: 'static {
    ...
    #[cfg(feature = "futures")]
    fn lookup_certificate_for_handle_async_future<P: IsA<TlsInteraction> + Clone + 'static>(&self, handle: &str, interaction: Option<&P>, flags: TlsDatabaseLookupFlags) -> Box_<dyn future::Future<Output = Result<TlsCertificate, Error>> + std::marker::Unpin>;
    ...
    #[cfg(feature = "futures")]
    fn lookup_certificate_issuer_async_future<P: IsA<TlsCertificate> + Clone + 'static, Q: IsA<TlsInteraction> + Clone + 'static>(&self, certificate: &P, interaction: Option<&Q>, flags: TlsDatabaseLookupFlags) -> Box_<dyn future::Future<Output = Result<TlsCertificate, Error>> + std::marker::Unpin>;
    ...
    #[cfg(feature = "futures")]
    fn verify_chain_async_future<P: IsA<TlsCertificate> + Clone + 'static, Q: IsA<SocketConnectable> + Clone + 'static, R: IsA<TlsInteraction> + Clone + 'static>(&self, chain: &P, purpose: &str, identity: Option<&Q>, interaction: Option<&R>, flags: TlsDatabaseVerifyFlags) -> Box_<dyn future::Future<Output = Result<TlsCertificateFlags, Error>> + std::marker::Unpin>;
}
