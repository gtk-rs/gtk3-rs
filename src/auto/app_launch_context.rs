...
impl AppLaunchContext {
    ...
    //pub fn get_display<P: IsA<AppInfo>>(&self, info: &P, files: /*Ignored*/&[File]) -> Option<String> {
    ...
    //pub fn get_startup_notify_id<P: IsA<AppInfo>>(&self, info: &P, files: /*Ignored*/&[File]) -> Option<String> {
