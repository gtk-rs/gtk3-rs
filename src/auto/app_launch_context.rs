...
impl AppLaunchContext {
    pub fn new() -> AppLaunchContext {
        unsafe {
            from_glib_full(gio_sys::g_app_launch_context_new())
        }
    }
}
...
impl<O: IsA<AppLaunchContext>> AppLaunchContextExt for O {
    fn get_display<P: IsA<AppInfo>>(&self, info: &P, files: &[File]) -> Option<GString> {
        unsafe {
            from_glib_full(gio_sys::g_app_launch_context_get_display(self.as_ref().to_glib_none().0, info.as_ref().to_glib_none().0, files.to_glib_none().0))
        }
    }

    fn get_environment(&self) -> Vec<std::ffi::OsString> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(gio_sys::g_app_launch_context_get_environment(self.as_ref().to_glib_none().0))
        }
    }

    fn get_startup_notify_id<P: IsA<AppInfo>>(&self, info: &P, files: &[File]) -> Option<GString> {
        unsafe {
            from_glib_full(gio_sys::g_app_launch_context_get_startup_notify_id(self.as_ref().to_glib_none().0, info.as_ref().to_glib_none().0, files.to_glib_none().0))
        }
    }

    fn launch_failed(&self, startup_notify_id: &str) {
        unsafe {
            gio_sys::g_app_launch_context_launch_failed(self.as_ref().to_glib_none().0, startup_notify_id.to_glib_none().0);
        }
    }

    fn setenv<P: AsRef<std::ffi::OsStr>, Q: AsRef<std::ffi::OsStr>>(&self, variable: P, value: Q) {
        unsafe {
            gio_sys::g_app_launch_context_setenv(self.as_ref().to_glib_none().0, variable.as_ref().to_glib_none().0, value.as_ref().to_glib_none().0);
        }
    }

    fn unsetenv<P: AsRef<std::ffi::OsStr>>(&self, variable: P) {
        unsafe {
            gio_sys::g_app_launch_context_unsetenv(self.as_ref().to_glib_none().0, variable.as_ref().to_glib_none().0);
        }
    }

    fn connect_launch_failed<F: Fn(&Self, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn launch_failed_trampoline<P, F: Fn(&P, &str) + 'static>(this: *mut gio_sys::GAppLaunchContext, startup_notify_id: *mut libc::c_char, f: glib_sys::gpointer)
    ...
    fn connect_launched<F: Fn(&Self, &AppInfo, &glib::Variant) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn launched_trampoline<P, F: Fn(&P, &AppInfo, &glib::Variant) + 'static>(this: *mut gio_sys::GAppLaunchContext, info: *mut gio_sys::GAppInfo, platform_data: *mut glib_sys::GVariant, f: glib_sys::gpointer)
            where P: IsA<AppLaunchContext>
        {
            let f: &F = &*(f as *const F);
