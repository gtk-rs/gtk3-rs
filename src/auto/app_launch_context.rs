...
pub trait AppLaunchContextExt {
    //fn get_display<P: IsA<AppInfo>>(&self, info: &P, files: /*Ignored*/&[File]) -> Option<String>;

    fn get_environment(&self) -> Vec<String>;

    //fn get_startup_notify_id<P: IsA<AppInfo>>(&self, info: &P, files: /*Ignored*/&[File]) -> Option<String>;
