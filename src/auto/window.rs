...
impl Window {
    //pub fn add_filter(&self, function: /*Unknown conversion*//*Unimplemented*/FilterFunc, data: /*Unimplemented*/Option<Fundamental: Pointer>) {
    ...
    pub fn begin_move_drag_for_device<T: IsA<Device>>(&self, device: &T, button: i32, root_x: i32, root_y: i32, timestamp: u32) {
        unsafe {
    ...
    pub fn begin_resize_drag_for_device<T: IsA<Device>>(&self, edge: WindowEdge, device: &T, button: i32, root_x: i32, root_y: i32, timestamp: u32) {
        unsafe {
    ...
    pub fn get_device_cursor<T: IsA<Device>>(&self, device: &T) -> Option<Cursor> {
        unsafe {
            from_glib_none(ffi::gdk_window_get_device_cursor(self.to_glib_none().0, device.to_glib_none().0))
        }
    }

    pub fn get_device_events<T: IsA<Device>>(&self, device: &T) -> EventMask {
        unsafe {
            from_glib(ffi::gdk_window_get_device_events(self.to_glib_none().0, device.to_glib_none().0))
        }
    }

    pub fn get_device_position<T: IsA<Device>>(&self, device: &T) -> (Option<Window>, i32, i32, ModifierType) {
        unsafe {
            let mut x = mem::uninitialized();
            let mut y = mem::uninitialized();
    ...
    #[cfg(feature = "v3_10")]
    pub fn get_device_position_double<T: IsA<Device>>(&self, device: &T) -> (Option<Window>, f64, f64, ModifierType) {
        unsafe {
            let mut x = mem::uninitialized();
            let mut y = mem::uninitialized();
            let mut mask = mem::uninitialized();
    ...
    //pub fn invalidate_maybe_recurse(&self, region: /*Ignored*/&cairo::Region, child_func: /*Unknown conversion*//*Unimplemented*/WindowChildFunc, user_data: /*Unimplemented*/Option<Fundamental: Pointer>) {
    ...
    pub fn invalidate_rect(&self, rect: Option<&Rectangle>, invalidate_children: bool) {
        unsafe {
            ffi::gdk_window_invalidate_rect(self.to_glib_none().0, rect.to_glib_none().0, invalidate_children.to_glib());
        }
    }
    ...
    //pub fn remove_filter(&self, function: /*Unknown conversion*//*Unimplemented*/FilterFunc, data: /*Unimplemented*/Option<Fundamental: Pointer>) {
    ...
    pub fn restack(&self, sibling: Option<&Window>, above: bool) {
        unsafe {
            ffi::gdk_window_restack(self.to_glib_none().0, sibling.to_glib_none().0, above.to_glib());
        }
    }
    ...
    //pub fn set_background_pattern(&self, pattern: /*Ignored*/Option<&mut cairo::Pattern>) {
    ...
    pub fn set_device_cursor<T: IsA<Device>>(&self, device: &T, cursor: &Cursor) {
        unsafe {
            ffi::gdk_window_set_device_cursor(self.to_glib_none().0, device.to_glib_none().0, cursor.to_glib_none().0);
        }
    }

    pub fn set_device_events<T: IsA<Device>>(&self, device: &T, event_mask: EventMask) {
        unsafe {
    ...
    pub fn set_icon_name<'a, T: Into<Option<&'a str>>>(&self, name: T) {
        unsafe {
            ffi::gdk_window_set_icon_name(self.to_glib_none().0, name.into().to_glib_none().0);
        }
    }
    ...
    //#[cfg(feature = "v3_10")]
    //pub fn set_opaque_region(&self, region: /*Ignored*/Option<&mut cairo::Region>) {
    ...
    //pub fn set_user_data<T: IsA</*Ignored*/glib::Object>>(&self, user_data: Option<&T>) {
    //    unsafe { TODO: call ffi::gdk_window_set_user_data() }
    //}

    //pub fn shape_combine_region(&self, shape_region: /*Ignored*/Option<&cairo::Region>, offset_x: i32, offset_y: i32) {
