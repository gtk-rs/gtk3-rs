...
impl Seat {
    ...
    //#[cfg(feature = "v3_20")]
    //pub fn grab<'a, 'b, 'c, P: Into<Option<&'a Cursor>>, Q: Into<Option<&'b Event>>, R: Into<Option<&'c /*Unimplemented*/SeatGrabPrepareFunc>>, S: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, window: &Window, capabilities: SeatCapabilities, owner_events: bool, cursor: P, event: Q, prepare_func: R, prepare_func_data: S) -> GrabStatus {
