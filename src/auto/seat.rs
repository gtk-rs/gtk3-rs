...
impl Seat {
    ...
    pub fn get_capabilities(&self) -> SeatCapabilities {
        unsafe {
            from_glib(gdk_sys::gdk_seat_get_capabilities(self.to_glib_none().0))
        }
    }
    ...
    pub fn get_display(&self) -> Option<Display> {
        unsafe {
            from_glib_none(gdk_sys::gdk_seat_get_display(self.to_glib_none().0))
        }
    }
    ...
    pub fn get_keyboard(&self) -> Option<Device> {
        unsafe {
            from_glib_none(gdk_sys::gdk_seat_get_keyboard(self.to_glib_none().0))
        }
    }
    ...
    pub fn get_pointer(&self) -> Option<Device> {
        unsafe {
            from_glib_none(gdk_sys::gdk_seat_get_pointer(self.to_glib_none().0))
        }
    }
    ...
    pub fn get_slaves(&self, capabilities: SeatCapabilities) -> Vec<Device> {
        unsafe {
            FromGlibPtrContainer::from_glib_container(gdk_sys::gdk_seat_get_slaves(self.to_glib_none().0, capabilities.to_glib()))
        }
    }
    ...
    pub fn grab<P: IsA<Window>>(&self, window: &P, capabilities: SeatCapabilities, owner_events: bool, cursor: Option<&Cursor>, event: Option<&Event>, prepare_func: Option<&mut dyn (FnMut(&Seat, &Window))>) -> GrabStatus {
        ...
        unsafe extern "C" fn prepare_func_func<P: IsA<Window>>(seat: *mut gdk_sys::GdkSeat, window: *mut gdk_sys::GdkWindow, user_data: glib_sys::gpointer) {
