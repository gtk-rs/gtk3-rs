...
pub trait MonitorExt {
    ...
    fn connect_property_geometry_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_height_mm_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_manufacturer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_refresh_rate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_scale_factor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_subpixel_layout_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_width_mm_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_workarea_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
