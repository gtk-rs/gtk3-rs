...
impl GlyphString {
    ...
    //pub fn get_logical_widths(&mut self, text: &str, length: i32, embedding_level: i32, logical_widths: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }) {
    ...
    //pub fn index_to_x(&mut self, text: &str, length: i32, analysis: /*Ignored*/&mut Analysis, index_: i32, trailing: bool) -> i32 {
    ...
    //pub fn x_to_index(&mut self, text: &str, length: i32, analysis: /*Ignored*/&mut Analysis, x_pos: i32) -> (i32, i32) {
