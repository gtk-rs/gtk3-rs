...
//pub fn compute_checksum_for_data(checksum_type: /*Ignored*/ChecksumType, data: &[u8]) -> Option<String> {
//    unsafe { TODO: call ffi::g_compute_checksum_for_data() }
//}

//pub fn compute_checksum_for_string(checksum_type: /*Ignored*/ChecksumType, str: &str) -> Option<String> {
...
//pub fn compute_hmac_for_data(digest_type: /*Ignored*/ChecksumType, key: &[u8], data: &[u8]) -> Option<String> {
//    unsafe { TODO: call ffi::g_compute_hmac_for_data() }
//}

//pub fn compute_hmac_for_string(digest_type: /*Ignored*/ChecksumType, key: &[u8], str: &str) -> Option<String> {
