...
//#[cfg(any(feature = "v2_34", feature = "dox"))]
//pub fn pollable_stream_read<'a, P: IsA</*Ignored*/InputStream>, Q: Into<Option<&'a Cancellable>>>(stream: &P, buffer: &[u8], blocking: bool, cancellable: Q) -> Result<isize, Error> {
//    unsafe { TODO: call ffi::g_pollable_stream_read() }
//}

//#[cfg(any(feature = "v2_34", feature = "dox"))]
//pub fn pollable_stream_write<'a, P: IsA</*Ignored*/OutputStream>, Q: Into<Option<&'a Cancellable>>>(stream: &P, buffer: &[u8], blocking: bool, cancellable: Q) -> Result<isize, Error> {
//    unsafe { TODO: call ffi::g_pollable_stream_write() }
//}

//#[cfg(any(feature = "v2_34", feature = "dox"))]
//pub fn pollable_stream_write_all<'a, P: IsA</*Ignored*/OutputStream>, Q: Into<Option<&'a Cancellable>>>(stream: &P, buffer: &[u8], blocking: bool, cancellable: Q) -> Result<usize, Error> {
