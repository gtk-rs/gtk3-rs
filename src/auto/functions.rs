...
pub fn events_get_angle(event1: &mut Event, event2: &mut Event) -> Option<f64> {
    ...
    unsafe {
        ...
        let ret = from_glib(gdk_sys::gdk_events_get_angle(event1.to_glib_none_mut().0, event2.to_glib_none_mut().0, &mut angle));
...
pub fn events_get_center(event1: &mut Event, event2: &mut Event) -> Option<(f64, f64)> {
    ...
    unsafe {
        ...
        let ret = from_glib(gdk_sys::gdk_events_get_center(event1.to_glib_none_mut().0, event2.to_glib_none_mut().0, &mut x, &mut y));
...
pub fn events_get_distance(event1: &mut Event, event2: &mut Event) -> Option<f64> {
    ...
    unsafe {
        ...
        let ret = from_glib(gdk_sys::gdk_events_get_distance(event1.to_glib_none_mut().0, event2.to_glib_none_mut().0, &mut distance));
...
pub fn events_pending() -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(gdk_sys::gdk_events_pending())
    }
}
...
pub fn get_display_arg_name() -> Option<GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_none(gdk_sys::gdk_get_display_arg_name())
    }
}
...
pub fn get_program_class() -> Option<GString> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_none(gdk_sys::gdk_get_program_class())
    }
}
...
pub fn list_visuals() -> Vec<Visual> {
    assert_initialized_main_thread!();
    unsafe {
        FromGlibPtrContainer::from_glib_container(gdk_sys::gdk_list_visuals())
    }
}
...
pub fn pango_context_get() -> Option<pango::Context> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_full(gdk_sys::gdk_pango_context_get())
    }
}
...
pub fn pango_context_get_for_display(display: &Display) -> Option<pango::Context> {
    ...
    unsafe {
        from_glib_full(gdk_sys::gdk_pango_context_get_for_display(display.to_glib_none().0))
    }
}
...
pub fn pango_context_get_for_screen(screen: &Screen) -> Option<pango::Context> {
    skip_assert_initialized!();
    unsafe {
        from_glib_full(gdk_sys::gdk_pango_context_get_for_screen(screen.to_glib_none().0))
    }
}
...
pub fn property_get<P: IsA<Window>>(window: &P, property: &Atom, type_: &Atom, offset: libc::c_ulong, length: libc::c_ulong, pdelete: i32) -> Option<(Atom, i32, Vec<u8>)> {
    ...
    unsafe {
        ...
        let ret = from_glib(gdk_sys::gdk_property_get(window.as_ref().to_glib_none().0, property.to_glib_none().0, type_.to_glib_none().0, offset, length, pdelete, actual_property_type.to_glib_none_mut().0, &mut actual_format, &mut actual_length, &mut data));
...
pub fn selection_convert<P: IsA<Window>>(requestor: &P, selection: &Atom, target: &Atom, time_: u32) {
    skip_assert_initialized!();
    unsafe {
        gdk_sys::gdk_selection_convert(requestor.as_ref().to_glib_none().0, selection.to_glib_none().0, target.to_glib_none().0, time_);
    }
}
...
pub fn selection_owner_get(selection: &Atom) -> Option<Window> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_none(gdk_sys::gdk_selection_owner_get(selection.to_glib_none().0))
    }
}
...
pub fn selection_owner_get_for_display(display: &Display, selection: &Atom) -> Option<Window> {
    skip_assert_initialized!();
    unsafe {
        from_glib_none(gdk_sys::gdk_selection_owner_get_for_display(display.to_glib_none().0, selection.to_glib_none().0))
    }
}
...
pub fn selection_owner_set<P: IsA<Window>>(owner: Option<&P>, selection: &Atom, time_: u32, send_event: bool) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(gdk_sys::gdk_selection_owner_set(owner.map(|p| p.as_ref()).to_glib_none().0, selection.to_glib_none().0, time_, send_event.to_glib()))
    }
}
...
pub fn selection_owner_set_for_display<P: IsA<Window>>(display: &Display, owner: Option<&P>, selection: &Atom, time_: u32, send_event: bool) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(gdk_sys::gdk_selection_owner_set_for_display(display.to_glib_none().0, owner.map(|p| p.as_ref()).to_glib_none().0, selection.to_glib_none().0, time_, send_event.to_glib()))
    }
}
...
pub fn selection_send_notify<P: IsA<Window>>(requestor: &P, selection: &Atom, target: &Atom, property: &Atom, time_: u32) {
    skip_assert_initialized!();
    unsafe {
        gdk_sys::gdk_selection_send_notify(requestor.as_ref().to_glib_none().0, selection.to_glib_none().0, target.to_glib_none().0, property.to_glib_none().0, time_);
    }
}
...
pub fn selection_send_notify_for_display<P: IsA<Window>>(display: &Display, requestor: &P, selection: &Atom, target: &Atom, property: &Atom, time_: u32) {
    skip_assert_initialized!();
    unsafe {
        gdk_sys::gdk_selection_send_notify_for_display(display.to_glib_none().0, requestor.as_ref().to_glib_none().0, selection.to_glib_none().0, target.to_glib_none().0, property.to_glib_none().0, time_);
    }
}
...
pub fn synthesize_window_state<P: IsA<Window>>(window: &P, unset_flags: WindowState, set_flags: WindowState) {
    skip_assert_initialized!();
    unsafe {
        gdk_sys::gdk_synthesize_window_state(window.as_ref().to_glib_none().0, unset_flags.to_glib(), set_flags.to_glib());
    }
}
...
pub fn test_simulate_button<P: IsA<Window>>(window: &P, x: i32, y: i32, button: u32, modifiers: ModifierType, button_pressrelease: EventType) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(gdk_sys::gdk_test_simulate_button(window.as_ref().to_glib_none().0, x, y, button, modifiers.to_glib(), button_pressrelease.to_glib()))
    }
}
...
pub fn test_simulate_key<P: IsA<Window>>(window: &P, x: i32, y: i32, keyval: u32, modifiers: ModifierType, key_pressrelease: EventType) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(gdk_sys::gdk_test_simulate_key(window.as_ref().to_glib_none().0, x, y, keyval, modifiers.to_glib(), key_pressrelease.to_glib()))
    }
}
