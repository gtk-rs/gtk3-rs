// This file was generated by gir (3ad22de) from gir-files (71d73f0)
// DO NOT EDIT
...
pub fn ascii_strncasecmp(s1: &str, s2: &str, n: usize) -> i32 {
    unsafe {
        ffi::g_ascii_strncasecmp(s1.to_glib_none().0, s2.to_glib_none().0, n)
    }
}
...
//pub fn base64_decode(text: &str) -> (/*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }, usize) {
//    unsafe { TODO: call ffi::g_base64_decode() }
//}

//pub fn base64_decode_inplace(text: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }, out_len: &mut usize) -> u8 {
//    unsafe { TODO: call ffi::g_base64_decode_inplace() }
//}

//pub fn base64_decode_step(in_: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, len: usize, out: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }, state: &mut i32, save: &mut u32) -> usize {
//    unsafe { TODO: call ffi::g_base64_decode_step() }
//}

//pub fn base64_encode(data: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, len: usize) -> Option<String> {
//    unsafe { TODO: call ffi::g_base64_encode() }
//}

//pub fn base64_encode_close(break_lines: bool, out: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }, state: &mut i32, save: &mut i32) -> usize {
//    unsafe { TODO: call ffi::g_base64_encode_close() }
//}

//pub fn base64_encode_step(in_: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, len: usize, break_lines: bool, out: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }, state: &mut i32, save: &mut i32) -> usize {
...
//pub fn compute_checksum_for_data(checksum_type: /*Ignored*/ChecksumType, data: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, length: usize) -> Option<String> {
//    unsafe { TODO: call ffi::g_compute_checksum_for_data() }
//}

//pub fn compute_checksum_for_string(checksum_type: /*Ignored*/ChecksumType, str: &str, length: isize) -> Option<String> {
...
//pub fn compute_hmac_for_data(digest_type: /*Ignored*/ChecksumType, key: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, key_len: usize, data: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, length: usize) -> Option<String> {
//    unsafe { TODO: call ffi::g_compute_hmac_for_data() }
//}

//pub fn compute_hmac_for_string(digest_type: /*Ignored*/ChecksumType, key: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, key_len: usize, str: &str, length: isize) -> Option<String> {
//    unsafe { TODO: call ffi::g_compute_hmac_for_string() }
//}

//pub fn convert_with_iconv(str: &str, len: isize, converter: /*Ignored*/&IConv, bytes_read: usize, bytes_written: usize) -> Result<String, Error> {
...
//pub fn file_get_contents<P: AsRef<std::path::Path>>(filename: P, contents: /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }) -> Result<usize, Error> {
...
//pub fn file_set_contents<P: AsRef<std::path::Path>>(filename: P, contents: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, length: isize) -> Result<(), Error> {
...
//pub fn filename_from_utf8(utf8string: &str, len: isize) -> Result<(/*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 }, usize, usize), Error> {
...
//#[cfg(feature = "v2_50")]
//pub fn log_structured_array(log_level: /*Ignored*/LogLevelFlags, fields: /*Ignored*/&[&LogField], n_fields: usize) {
...
//#[cfg(feature = "v2_50")]
//pub fn log_writer_default<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(log_level: /*Ignored*/LogLevelFlags, fields: /*Ignored*/&[&LogField], n_fields: usize, user_data: P) -> /*Ignored*/LogWriterOutput {
//    unsafe { TODO: call ffi::g_log_writer_default() }
//}

//#[cfg(feature = "v2_50")]
//pub fn log_writer_format_fields(log_level: /*Ignored*/LogLevelFlags, fields: /*Ignored*/&[&LogField], n_fields: usize, use_color: bool) -> Option<String> {
...
//#[cfg(feature = "v2_50")]
//pub fn log_writer_journald<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(log_level: /*Ignored*/LogLevelFlags, fields: /*Ignored*/&[&LogField], n_fields: usize, user_data: P) -> /*Ignored*/LogWriterOutput {
//    unsafe { TODO: call ffi::g_log_writer_journald() }
//}

//#[cfg(feature = "v2_50")]
//pub fn log_writer_standard_streams<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(log_level: /*Ignored*/LogLevelFlags, fields: /*Ignored*/&[&LogField], n_fields: usize, user_data: P) -> /*Ignored*/LogWriterOutput {
...
//pub fn string_new_len(init: &str, len: isize) -> /*Ignored*/Option<String> {
//    unsafe { TODO: call ffi::g_string_new_len() }
//}

//pub fn string_sized_new(dfl_size: usize) -> /*Ignored*/Option<String> {
...
//pub fn strnfill(length: usize, fill_char: /*Unimplemented*/Fundamental: Char) -> Option<String> {
...
//pub fn utf8_normalize(str: &str, len: isize, mode: /*Ignored*/NormalizeMode) -> Option<String> {
...
//pub fn utf8_validate(str: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }, max_len: isize, end: /*Unimplemented*/String) -> bool {
