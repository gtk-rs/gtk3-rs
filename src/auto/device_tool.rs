...
pub trait DeviceToolExt {
    ...
    fn connect_property_hardware_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_serial_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_tool_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<DeviceTool> {
    ...
    f(&DeviceTool::from_glib_none(this).downcast_unchecked())
}
