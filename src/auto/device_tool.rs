...
impl<O: IsA<DeviceTool> + IsA<glib::object::Object>> DeviceToolExt for O {
    ...
    fn get_property_axes(&self) -> AxisFlags {
        unsafe {
            ...
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <AxisFlags as StaticType>::static_type().to_glib());
    ...
    fn get_property_tool_type(&self) -> DeviceToolType {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <DeviceToolType as StaticType>::static_type().to_glib());
