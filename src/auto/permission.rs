...
pub trait PermissionExt {
    ...
    fn connect_property_allowed_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_can_acquire_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_can_release_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<Permission> {
    ...
    f(&Permission::from_glib_none(this).downcast_unchecked())
}
