...
impl<'a> FromValue<'a> for FileType {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GFileType>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
...
impl<'a> FromValue<'a> for NotificationPriority {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GNotificationPriority>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
...
impl<'a> FromValue<'a> for ResourceError {
    unsafe fn from_value(value: &Value) -> Self {
        from_glib(std::mem::transmute::<i32, ffi::GResourceError>(gobject_ffi::g_value_get_enum(value.to_glib_none().0)))
    }
}
