...
impl<O: IsA<IOStream>> IOStreamExt for O {
    ...
    fn close_async<P: IsA<Cancellable>, Q: FnOnce(Result<(), glib::Error>) + Send + 'static>(
        ...
        unsafe {
            gio_sys::g_io_stream_close_async(
                self.as_ref().to_glib_none().0,
                io_priority.to_glib(),
                cancellable.map(|p| p.as_ref()).to_glib_none().0,
                Some(callback),
    ...
    fn get_input_stream(&self) -> Option<InputStream> {
        unsafe {
            from_glib_none(gio_sys::g_io_stream_get_input_stream(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn get_output_stream(&self) -> Option<OutputStream> {
        unsafe {
            from_glib_none(gio_sys::g_io_stream_get_output_stream(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn has_pending(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_io_stream_has_pending(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
    ...
    fn is_closed(&self) -> bool {
        unsafe {
            from_glib(gio_sys::g_io_stream_is_closed(
                self.as_ref().to_glib_none().0,
            ))
        }
    }
