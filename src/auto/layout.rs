...
impl Layout {
    ...
    //pub fn set_attributes<'a, P: Into<Option<&'a /*Ignored*/AttrList>>>(&self, attrs: P) {
    ...
    pub fn set_font_description<'a, P: Into<Option<&'a FontDescription>>>(&self, desc: P) {
        let desc = desc.into();
        let desc = desc.to_glib_none().0;
        unsafe {
            ffi::pango_layout_set_font_description(self.to_glib_none().0, desc);
        }
    }
    ...
    //pub fn set_tabs<'a, P: Into<Option<&'a /*Ignored*/TabArray>>>(&self, tabs: P) {
