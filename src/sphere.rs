...
impl Sphere {
    pub fn init_from_points(&mut self, points: &[&Point3D], center: Option<&Point3D>) {
        ...
        unsafe {
            ffi::graphene_sphere_init_from_points(self.to_glib_none_mut().0, n, vec.as_ptr(), center.to_glib_none().0);
        }
    }
    ...
    pub fn init_from_vectors(&mut self, vectors: &[&Vec3], center: Option<&Point3D>) {
        ...
        unsafe {
            ffi::graphene_sphere_init_from_vectors(self.to_glib_none_mut().0, n, vec.as_ptr(), center.to_glib_none().0);
        }
    }
