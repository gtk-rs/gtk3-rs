...
impl SurfaceExt for Surface {
    fn create_region(&self) -> Option<Region> {
        unsafe {
            from_glib_full(gdk_sys::gdk_cairo_region_create_from_surface(self.to_glib_none().0))
        }
    }
}
...
impl PixbufExt for Pixbuf {
    fn create_surface(&self, scale: i32, for_window: &Window) -> Option<Surface> {
        unsafe {
            from_glib_full(gdk_sys::gdk_cairo_surface_create_from_pixbuf(self.to_glib_none().0, scale, for_window.to_glib_none().0))
        }
    }
}
...
impl ContextExt for Context {
    ...
    fn cairo_draw_from_gl(cr: &Context, window: &Window, source: i32, source_type: i32, buffer_scale: i32, x: i32, y: i32, width: i32, height: i32) {
        skip_assert_initialized!();
        unsafe {
            gdk_sys::gdk_cairo_draw_from_gl(mut_override(cr.to_glib_none().0), window.to_glib_none().0, source, source_type, buffer_scale, x, y, width, height);
        }
    }
    ...
    fn cairo_surface_create_from_pixbuf<T: IsA<Window>>(pixbuf: &Pixbuf, scale: i32, for_window: Option<&T>) -> Option<Surface> {
        ...
        unsafe {
            from_glib_full(gdk_sys::gdk_cairo_surface_create_from_pixbuf(pixbuf.to_glib_none().0, scale, for_window.0))
        }
    }
    ...
    fn get_clip_rectangle(&self) -> Option<Rectangle> {
        unsafe {
            ...
            if from_glib(gdk_sys::gdk_cairo_get_clip_rectangle(self.to_glib_none().0,
    ...
    fn set_source_rgba(&self, rgba: &RGBA) {
        unsafe { gdk_sys::gdk_cairo_set_source_rgba(self.to_glib_none().0, rgba.to_glib_none().0); }
    }

    fn set_source_pixbuf(&self, pixbuf: &Pixbuf, x: f64, y: f64) {
        unsafe {
            gdk_sys::gdk_cairo_set_source_pixbuf(self.to_glib_none().0, pixbuf.to_glib_none().0, x, y);
        }
    }

    fn set_source_window(&self, window: &Window, x: f64, y: f64) {
        unsafe {
            gdk_sys::gdk_cairo_set_source_window(self.to_glib_none().0, window.to_glib_none().0, x, y);
        }
    }

    fn rectangle(&self, rectangle: &Rectangle) {
        unsafe { gdk_sys::gdk_cairo_rectangle(self.to_glib_none().0, rectangle.to_glib_none().0); }
    }

    fn add_region(&self, region: &Region) {
        unsafe { gdk_sys::gdk_cairo_region(self.to_glib_none().0, region.to_glib_none().0); }
    }
}
