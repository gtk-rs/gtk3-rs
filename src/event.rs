...
impl Event {
    ...
    pub fn get_axis(&self, axis_use: AxisUse) -> Option<f64> {
        let mut value = 0f64;
        if unsafe {
            from_glib(gdk_sys::gdk_event_get_axis(self.to_glib_none().0,
                                              axis_use.to_glib(),
                                              &mut value))
        } {
            Some(value)
    ...
    pub fn get_button(&self) -> Option<u32> {
        let mut button = 0u32;
        if unsafe {
            from_glib(gdk_sys::gdk_event_get_button(self.to_glib_none().0, &mut button))
        } {
            Some(button)
        } else {
            None
    ...
    pub fn get_click_count(&self) -> Option<u32> {
        ...
        if unsafe {
            from_glib(gdk_sys::gdk_event_get_click_count(self.to_glib_none().0, &mut click_count))
        } {
            Some(click_count)
        } else {
            None
    ...
    pub fn get_coords(&self) -> Option<(f64, f64)> {
        ...
        let mut y_win = 0f64;
        if unsafe {
            from_glib(gdk_sys::gdk_event_get_coords(self.to_glib_none().0, &mut x_win, &mut y_win))
        } {
            Some((x_win, y_win))
        } else {
            None
    ...
    pub fn get_keycode(&self) -> Option<u16> {
        ...
        if unsafe {
            from_glib(gdk_sys::gdk_event_get_keycode(self.to_glib_none().0, &mut keycode))
        } {
            Some(keycode)
        } else {
            None
    ...
    pub fn get_keyval(&self) -> Option<u32> {
        let mut keyval = 0u32;
        if unsafe {
            from_glib(gdk_sys::gdk_event_get_keyval(self.to_glib_none().0, &mut keyval))
        } {
            Some(keyval)
        } else {
            None
    ...
    pub fn get_root_coords(&self) -> Option<(f64, f64)> {
        ...
        let mut y_root = 0f64;
        if unsafe {
            from_glib(gdk_sys::gdk_event_get_root_coords(self.to_glib_none().0,
                                                     &mut x_root,
                                                     &mut y_root))
        } {
            Some((x_root, y_root))
    ...
    pub fn get_scroll_direction(&self) -> Option<ScrollDirection> {
        unsafe {
            ...
            if from_glib(gdk_sys::gdk_event_get_scroll_direction(self.to_glib_none().0,
                                                             &mut direction)) {
    ...
    pub fn get_scroll_deltas(&self) -> Option<(f64, f64)> {
        ...
        if unsafe {
            from_glib(gdk_sys::gdk_event_get_scroll_deltas(self.to_glib_none().0,
                                                       &mut delta_x,
                                                       &mut delta_y))
        } {
    ...
    pub fn get_window(&self) -> Option<Window> {
        unsafe {
            from_glib_none(gdk_sys::gdk_event_get_window(self.to_glib_none().0))
        }
    }
    ...
    pub fn get_scancode(&mut self) -> i32 {
        unsafe {
            gdk_sys::gdk_event_get_scancode(self.to_glib_none_mut().0)
        }
    }
    ...
    pub fn get_pointer_emulated(&mut self) -> bool {
        unsafe {
            from_glib(gdk_sys::gdk_event_get_pointer_emulated(self.to_glib_none_mut().0))
        }
    }

    pub fn set_screen(&mut self, screen: Option<&Screen>) {
        unsafe {
            gdk_sys::gdk_event_set_screen(self.to_glib_none_mut().0, screen.to_glib_none().0)
        }
    }

    pub fn get_screen(&self) -> Option<Screen> {
        unsafe {
            from_glib_none(gdk_sys::gdk_event_get_screen(self.to_glib_none().0))
        }
    }

    pub fn set_device(&mut self, device: Option<&Device>) {
        unsafe {
            gdk_sys::gdk_event_set_device(self.to_glib_none_mut().0, device.to_glib_none().0)
        }
    }
