...
pub const GDK_WINDOW_STATE_TOP_TILED: GdkWindowState = GdkWindowState::TOP_TILED;
pub const GDK_WINDOW_STATE_TOP_RESIZABLE: GdkWindowState = GdkWindowState::TOP_RESIZABLE;
pub const GDK_WINDOW_STATE_RIGHT_TILED: GdkWindowState = GdkWindowState::RIGHT_TILED;
pub const GDK_WINDOW_STATE_RIGHT_RESIZABLE: GdkWindowState = GdkWindowState::RIGHT_RESIZABLE;
pub const GDK_WINDOW_STATE_BOTTOM_TILED: GdkWindowState = GdkWindowState::BOTTOM_TILED;
pub const GDK_WINDOW_STATE_BOTTOM_RESIZABLE: GdkWindowState = GdkWindowState::BOTTOM_RESIZABLE;
pub const GDK_WINDOW_STATE_LEFT_TILED: GdkWindowState = GdkWindowState::LEFT_TILED;
pub const GDK_WINDOW_STATE_LEFT_RESIZABLE: GdkWindowState = GdkWindowState::LEFT_RESIZABLE;
...
impl ::std::fmt::Debug for GdkAtom_ {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        f.debug_struct(&format!("GdkAtom_ @ {:?}", self as *const _))
         .finish()
    }
}
