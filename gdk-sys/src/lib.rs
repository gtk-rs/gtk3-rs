...
pub type GdkRectangle = cairo_ffi::cairo_rectangle_int_t;
...
pub const GDK_2BUTTON_PRESS: GdkEventType = GdkEventType::_2buttonPress;
pub const GDK_DOUBLE_BUTTON_PRESS: GdkEventType = GdkEventType::_2buttonPress;
pub const GDK_3BUTTON_PRESS: GdkEventType = GdkEventType::_3buttonPress;
pub const GDK_TRIPLE_BUTTON_PRESS: GdkEventType = GdkEventType::_3buttonPress;
...
pub const GDK_EVENT_LAST: GdkEventType = GdkEventType::EventLast;
...
pub type GdkWindowInvalidateHandlerFunc = Option<unsafe extern "C" fn(*mut GdkWindow, *mut cairo_ffi::cairo_region_t)>;
...
pub struct GdkEventExpose {
    ...
    pub region: *mut cairo_ffi::cairo_region_t,
    pub count: c_int,
}
...
#[repr(C)]
pub struct GdkFrameClockClass;

#[repr(C)]
pub struct GdkFrameClockPrivate;
...
pub struct GdkWindowClass {
    ...
    pub create_surface: Option<unsafe extern "C" fn(*mut GdkWindow, c_int, c_int) -> *mut cairo_ffi::cairo_surface_t>,
...
extern "C" {
    ...
    pub fn gdk_app_launch_context_set_icon     (context: *mut GdkAppLaunchContext, icon: *mut gio_ffi::GIcon);
    ...
    pub fn gdk_cursor_new_from_pixbuf          (display: *mut GdkDisplay, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf, x: c_int, y: c_int) -> *mut GdkCursor;
    #[cfg(gdk_3_10)]
    pub fn gdk_cursor_new_from_surface         (display: *mut GdkDisplay, surface: *mut cairo_ffi::cairo_surface_t, x: c_double, y: c_double) -> *mut GdkCursor;
    ...
    pub fn gdk_cursor_get_image                (cursor: *mut GdkCursor) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gdk_3_10)]
    pub fn gdk_cursor_get_surface              (cursor: *mut GdkCursor, x_hot: *mut c_double, y_hot: *mut c_double) -> *mut cairo_ffi::cairo_surface_t;
    ...
    pub fn gdk_device_list_axes                (device: *mut GdkDevice) -> *mut glib_ffi::GList;
    pub fn gdk_device_list_slave_devices       (device: *mut GdkDevice) -> *mut glib_ffi::GList;
    ...
    pub fn gdk_device_manager_list_devices     (device_manager: *mut GdkDeviceManager, type_: GdkDeviceType) -> *mut glib_ffi::GList;
    ...
    pub fn gdk_display_list_devices            (display: *mut GdkDisplay) -> *mut glib_ffi::GList;
    ...
    pub fn gdk_display_manager_list_displays   (manager: *mut GdkDisplayManager) -> *mut glib_ffi::GSList;
    ...
    pub fn gdk_drag_context_list_targets       (context: *mut GdkDragContext) -> *mut glib_ffi::GList;
    ...
    #[cfg(gdk_3_16)]
    pub fn gdk_gl_context_realize              (context: *mut GdkGLContext, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gdk_3_16)]
    ...
    pub fn gdk_keymap_get_direction            (keymap: *mut GdkKeymap) -> pango_ffi::PangoDirection;
    ...
    pub fn gdk_screen_get_font_options         (screen: *mut GdkScreen) -> *const cairo_ffi::cairo_font_options_t;
    ...
    pub fn gdk_screen_get_setting              (screen: *mut GdkScreen, name: *const c_char, value: *mut gobject_ffi::GValue) -> gboolean;
    pub fn gdk_screen_get_system_visual        (screen: *mut GdkScreen) -> *mut GdkVisual;
    pub fn gdk_screen_get_toplevel_windows     (screen: *mut GdkScreen) -> *mut glib_ffi::GList;
    pub fn gdk_screen_get_width                (screen: *mut GdkScreen) -> c_int;
    pub fn gdk_screen_get_width_mm             (screen: *mut GdkScreen) -> c_int;
    pub fn gdk_screen_get_window_stack         (screen: *mut GdkScreen) -> *mut glib_ffi::GList;
    pub fn gdk_screen_is_composited            (screen: *mut GdkScreen) -> gboolean;
    pub fn gdk_screen_list_visuals             (screen: *mut GdkScreen) -> *mut glib_ffi::GList;
    pub fn gdk_screen_make_display_name        (screen: *mut GdkScreen) -> *mut c_char;
    pub fn gdk_screen_set_font_options         (screen: *mut GdkScreen, options: *const cairo_ffi::cairo_font_options_t);
    ...
    pub fn gdk_window_begin_paint_region       (window: *mut GdkWindow, region: *const cairo_ffi::cairo_region_t);
    ...
    #[cfg(gdk_3_16)]
    pub fn gdk_window_create_gl_context        (window: *mut GdkWindow, error: *mut *mut glib_ffi::GError) -> *mut GdkGLContext;
    #[cfg(gdk_3_10)]
    pub fn gdk_window_create_similar_image_surface(window: *mut GdkWindow, format: c_int, width: c_int, height: c_int, scale: c_int) -> *mut cairo_ffi::cairo_surface_t;
    pub fn gdk_window_create_similar_surface   (window: *mut GdkWindow, content: cairo_ffi::cairo_content_t, width: c_int, height: c_int) -> *mut cairo_ffi::cairo_surface_t;
    ...
    pub fn gdk_window_get_background_pattern   (window: *mut GdkWindow) -> *mut cairo_ffi::cairo_pattern_t;
    pub fn gdk_window_get_children             (window: *mut GdkWindow) -> *mut glib_ffi::GList;
    #[cfg(gdk_3_10)]
    pub fn gdk_window_get_children_with_user_data(window: *mut GdkWindow, user_data: gpointer) -> *mut glib_ffi::GList;
    pub fn gdk_window_get_clip_region          (window: *mut GdkWindow) -> *mut cairo_ffi::cairo_region_t;
    ...
    pub fn gdk_window_get_update_area          (window: *mut GdkWindow) -> *mut cairo_ffi::cairo_region_t;
    pub fn gdk_window_get_user_data            (window: *mut GdkWindow, data: *mut gpointer);
    pub fn gdk_window_get_visible_region       (window: *mut GdkWindow) -> *mut cairo_ffi::cairo_region_t;
    ...
    pub fn gdk_window_input_shape_combine_region(window: *mut GdkWindow, shape_region: *const cairo_ffi::cairo_region_t, offset_x: c_int, offset_y: c_int);
    pub fn gdk_window_invalidate_maybe_recurse (window: *mut GdkWindow, region: *const cairo_ffi::cairo_region_t, child_func: GdkWindowChildFunc, user_data: gpointer);
    pub fn gdk_window_invalidate_rect          (window: *mut GdkWindow, rect: *const GdkRectangle, invalidate_children: gboolean);
    pub fn gdk_window_invalidate_region        (window: *mut GdkWindow, region: *const cairo_ffi::cairo_region_t, invalidate_children: gboolean);
    ...
    #[cfg(gdk_3_16)]
    pub fn gdk_window_mark_paint_from_clip     (window: *mut GdkWindow, cr: *mut cairo_ffi::cairo_t);
    ...
    pub fn gdk_window_move_region              (window: *mut GdkWindow, region: *const cairo_ffi::cairo_region_t, dx: c_int, dy: c_int);
    pub fn gdk_window_move_resize              (window: *mut GdkWindow, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gdk_window_peek_children            (window: *mut GdkWindow) -> *mut glib_ffi::GList;
    ...
    pub fn gdk_window_set_background_pattern   (window: *mut GdkWindow, pattern: *mut cairo_ffi::cairo_pattern_t);
    ...
    pub fn gdk_window_set_icon_list            (window: *mut GdkWindow, pixbufs: *mut glib_ffi::GList);
    ...
    #[cfg(gdk_3_10)]
    pub fn gdk_window_set_opaque_region        (window: *mut GdkWindow, region: *mut cairo_ffi::cairo_region_t);
    ...
    pub fn gdk_window_shape_combine_region     (window: *mut GdkWindow, shape_region: *const cairo_ffi::cairo_region_t, offset_x: c_int, offset_y: c_int);
    ...
    // Other functions
    //=========================================================================
    pub fn gdk_add_option_entries_libgtk_only  (group: *mut glib_ffi::GOptionGroup);
    pub fn gdk_beep                            ();
    pub fn gdk_cairo_create                    (window: *mut GdkWindow) -> *mut cairo_ffi::cairo_t;
    #[cfg(gdk_3_16)]
    pub fn gdk_cairo_draw_from_gl              (cr: *mut cairo_ffi::cairo_t, window: *mut GdkWindow, source: c_int, source_type: c_int, buffer_scale: c_int, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gdk_cairo_get_clip_rectangle        (cr: *mut cairo_ffi::cairo_t, rect: *mut GdkRectangle) -> gboolean;
    pub fn gdk_cairo_rectangle                 (cr: *mut cairo_ffi::cairo_t, rectangle: *const GdkRectangle);
    pub fn gdk_cairo_region                    (cr: *mut cairo_ffi::cairo_t, region: *const cairo_ffi::cairo_region_t);
    pub fn gdk_cairo_region_create_from_surface(surface: *mut cairo_ffi::cairo_surface_t) -> *mut cairo_ffi::cairo_region_t;
    pub fn gdk_cairo_set_source_color          (cr: *mut cairo_ffi::cairo_t, color: *const GdkColor);
    pub fn gdk_cairo_set_source_pixbuf         (cr: *mut cairo_ffi::cairo_t, pixbuf: *const gdk_pixbuf_ffi::GdkPixbuf, pixbuf_x: c_double, pixbuf_y: c_double);
    pub fn gdk_cairo_set_source_rgba           (cr: *mut cairo_ffi::cairo_t, rgba: *const GdkRGBA);
    pub fn gdk_cairo_set_source_window         (cr: *mut cairo_ffi::cairo_t, window: *mut GdkWindow, x: c_double, y: c_double);
    #[cfg(gdk_3_10)]
    pub fn gdk_cairo_surface_create_from_pixbuf(pixbuf: *const gdk_pixbuf_ffi::GdkPixbuf, scale: c_int, for_window: *mut GdkWindow) -> *mut cairo_ffi::cairo_surface_t;
    pub fn gdk_disable_multidevice             ();
    pub fn gdk_drag_abort                      (context: *mut GdkDragContext, time_: u32);
    pub fn gdk_drag_begin                      (window: *mut GdkWindow, targets: *mut glib_ffi::GList) -> *mut GdkDragContext;
    pub fn gdk_drag_begin_for_device           (window: *mut GdkWindow, device: *mut GdkDevice, targets: *mut glib_ffi::GList) -> *mut GdkDragContext;
    ...
    pub fn gdk_list_visuals                    () -> *mut glib_ffi::GList;
    ...
    pub fn gdk_offscreen_window_get_surface    (window: *mut GdkWindow) -> *mut cairo_ffi::cairo_surface_t;
    pub fn gdk_offscreen_window_set_embedder   (window: *mut GdkWindow, embedder: *mut GdkWindow);
    pub fn gdk_pango_context_get               () -> *mut pango_ffi::PangoContext;
    pub fn gdk_pango_context_get_for_screen    (screen: *mut GdkScreen) -> *mut pango_ffi::PangoContext;
    pub fn gdk_pango_layout_get_clip_region    (layout: *mut pango_ffi::PangoLayout, x_origin: c_int, y_origin: c_int, index_ranges: *const c_int, n_ranges: c_int) -> *mut cairo_ffi::cairo_region_t;
    pub fn gdk_pango_layout_line_get_clip_region(line: *mut pango_ffi::PangoLayoutLine, x_origin: c_int, y_origin: c_int, index_ranges: *mut c_int, n_ranges: c_int) -> *mut cairo_ffi::cairo_region_t;
    pub fn gdk_parse_args                      (argc: *mut c_int, argv: *mut *mut *mut c_char);
    pub fn gdk_pixbuf_get_from_surface         (surface: *mut cairo_ffi::cairo_surface_t, src_x: c_int, src_y: c_int, width: c_int, height: c_int) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gdk_pixbuf_get_from_window          (window: *mut GdkWindow, src_x: c_int, src_y: c_int, width: c_int, height: c_int) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gdk_setting_get                     (name: *const c_char, value: *mut gobject_ffi::GValue) -> gboolean;
    ...
    pub fn gdk_threads_add_idle                (function: glib_ffi::GSourceFunc, data: gpointer) -> c_uint;
    pub fn gdk_threads_add_idle_full           (priority: c_int, function: glib_ffi::GSourceFunc, data: gpointer, notify: glib_ffi::GDestroyNotify) -> c_uint;
    pub fn gdk_threads_add_timeout             (interval: c_uint, function: glib_ffi::GSourceFunc, data: gpointer) -> c_uint;
    pub fn gdk_threads_add_timeout_full        (priority: c_int, interval: c_uint, function: glib_ffi::GSourceFunc, data: gpointer, notify: glib_ffi::GDestroyNotify) -> c_uint;
    pub fn gdk_threads_add_timeout_seconds     (interval: c_uint, function: glib_ffi::GSourceFunc, data: gpointer) -> c_uint;
    pub fn gdk_threads_add_timeout_seconds_full(priority: c_int, interval: c_uint, function: glib_ffi::GSourceFunc, data: gpointer, notify: glib_ffi::GDestroyNotify) -> c_uint;
    pub fn gdk_threads_enter                   ();
    pub fn gdk_threads_init                    ();
    pub fn gdk_threads_leave                   ();
    pub fn gdk_threads_set_lock_functions      (enter_fn: gobject_ffi::GCallback, leave_fn: gobject_ffi::GCallback);
