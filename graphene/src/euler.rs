...
impl Euler {
    pub fn new(x: f32, y: f32, z: f32) -> Euler {
        ...
        unsafe {
            ...
            graphene_sys::graphene_euler_init(alloc, x, y, z);
    ...
    pub fn new_from_euler(src: Option<&Euler>) -> Euler {
        ...
        unsafe {
            let alloc = graphene_sys::graphene_euler_alloc();
            graphene_sys::graphene_euler_init_from_euler(alloc, src.to_glib_none().0);
            from_glib_full(alloc)
        }
    }
    ...
    pub fn new_from_vec3(v: Option<&Vec3>, order: EulerOrder) -> Euler {
        ...
        unsafe {
            let alloc = graphene_sys::graphene_euler_alloc();
            graphene_sys::graphene_euler_init_from_vec3(alloc, v.to_glib_none().0, order.to_glib());
            from_glib_full(alloc)
        }
    }
    ...
    pub fn new_with_order(x: f32, y: f32, z: f32, order: EulerOrder) -> Euler {
        ...
        unsafe {
            let alloc = graphene_sys::graphene_euler_alloc();
            graphene_sys::graphene_euler_init_with_order(alloc, x, y, z, order.to_glib());
            from_glib_full(alloc)
        }
    }
}
