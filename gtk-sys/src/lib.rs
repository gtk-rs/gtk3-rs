...
// Constants
pub const GTK_BINARY_AGE: c_int = 2202;
pub const GTK_INPUT_ERROR: c_int = -1;
pub const GTK_INTERFACE_AGE: c_int = 2;
...
pub const GTK_MICRO_VERSION: c_int = 2;
...
bitflags! {
    #[repr(C)]
    pub flags GtkAccelFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkApplicationInhibitFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkAttachOptions: c_uint {
        const GTK_EXPAND = 1,
        const GTK_SHRINK = 2,
        const GTK_FILL = 4,
    }
...
bitflags! {
    #[repr(C)]
    pub flags GtkCalendarDisplayOptions: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkCellRendererState: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkDestDefaults: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkDialogFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkFileFilterFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkIconLookupFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkInputHints: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkJunctionSides: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkPlacesOpenFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkRecentFilterFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkRegionFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkStateFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkStyleContextPrintFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkTargetFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkTextSearchFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkToolPaletteDragTargets: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkTreeModelFlags: c_uint {
...
bitflags! {
    #[repr(C)]
    pub flags GtkUIManagerItemType: c_uint {
