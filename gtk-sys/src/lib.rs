...
pub const GTK_BINARY_AGE: i32 = 2202;
pub const GTK_INPUT_ERROR: i32 = -1;
pub const GTK_INTERFACE_AGE: i32 = 2;
pub const GTK_LEVEL_BAR_OFFSET_FULL: &'static str = r##"full"##;
...
pub const GTK_MICRO_VERSION: i32 = 2;
pub const GTK_MINOR_VERSION: i32 = 22;
...
bitflags! {
    #[repr(C)]
    flags GtkStyleContextPrintFlags: c_uint {
...
#[repr(C)]
pub struct GtkNativeDialog(c_void);
#[repr(C)]
...
#[repr(C)]
pub struct GtkStackAccessible(c_void);
#[repr(C)]
