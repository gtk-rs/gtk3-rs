// This file was generated by gir (95a023c) from gir-files (11e0e6d)
// DO NOT EDIT
...
pub type GtkAllocation = gdk_ffi::GdkRectangle;
...
pub type GtkAccelGroupActivate = Option<unsafe extern "C" fn(*mut GtkAccelGroup, *mut gobject_ffi::GObject, c_uint, gdk_ffi::GdkModifierType) -> gboolean>;
pub type GtkAccelGroupFindFunc = Option<unsafe extern "C" fn(*mut GtkAccelKey, *mut gobject_ffi::GClosure, gpointer) -> gboolean>;
pub type GtkAccelMapForeach = Option<unsafe extern "C" fn(gpointer, *const c_char, c_uint, gdk_ffi::GdkModifierType, gboolean)>;
pub type GtkAssistantPageFunc = Option<unsafe extern "C" fn(c_int, gpointer) -> c_int>;
pub type GtkBuilderConnectFunc = Option<unsafe extern "C" fn(*mut GtkBuilder, *mut gobject_ffi::GObject, *const c_char, *const c_char, *mut gobject_ffi::GObject, gobject_ffi::GConnectFlags, gpointer)>;
...
pub type GtkCellAllocCallback = Option<unsafe extern "C" fn(*mut GtkCellRenderer, *const gdk_ffi::GdkRectangle, *const gdk_ffi::GdkRectangle, gpointer) -> gboolean>;
...
pub type GtkClipboardImageReceivedFunc = Option<unsafe extern "C" fn(*mut GtkClipboard, *mut gdk_pixbuf_ffi::GdkPixbuf, gpointer)>;
pub type GtkClipboardReceivedFunc = Option<unsafe extern "C" fn(*mut GtkClipboard, *mut GtkSelectionData, gpointer)>;
pub type GtkClipboardRichTextReceivedFunc = Option<unsafe extern "C" fn(*mut GtkClipboard, gdk_ffi::GdkAtom, *mut c_char, size_t, gpointer)>;
pub type GtkClipboardTargetsReceivedFunc = Option<unsafe extern "C" fn(*mut GtkClipboard, *mut gdk_ffi::GdkAtom, c_int, gpointer)>;
...
pub type GtkColorSelectionChangePaletteFunc = Option<unsafe extern "C" fn(*mut gdk_ffi::GdkColor, c_int)>;
pub type GtkColorSelectionChangePaletteWithScreenFunc = Option<unsafe extern "C" fn(*mut gdk_ffi::GdkScreen, *mut gdk_ffi::GdkColor, c_int)>;
...
pub type GtkFontFilterFunc = Option<unsafe extern "C" fn(*const pango_ffi::PangoFontFamily, *const pango_ffi::PangoFontFace, gpointer) -> gboolean>;
pub type GtkIconViewForeachFunc = Option<unsafe extern "C" fn(*mut GtkIconView, *mut GtkTreePath, gpointer)>;
pub type GtkKeySnoopFunc = Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventKey, gpointer) -> c_int>;
...
pub type GtkModuleDisplayInitFunc = Option<unsafe extern "C" fn(*mut gdk_ffi::GdkDisplay)>;
...
pub type GtkRcPropertyParser = Option<unsafe extern "C" fn(*const gobject_ffi::GParamSpec, *const glib_ffi::GString, *mut gobject_ffi::GValue) -> gboolean>;
...
pub type GtkStylePropertyParser = Option<unsafe extern "C" fn(*const c_char, *mut gobject_ffi::GValue, *mut *mut glib_ffi::GError) -> gboolean>;
pub type GtkTextBufferDeserializeFunc = Option<unsafe extern "C" fn(*mut GtkTextBuffer, *mut GtkTextBuffer, *mut GtkTextIter, *mut u8, size_t, gboolean, gpointer, *mut *mut glib_ffi::GError) -> gboolean>;
...
pub type GtkTickCallback = Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkFrameClock, gpointer) -> gboolean>;
...
pub type GtkTreeModelFilterModifyFunc = Option<unsafe extern "C" fn(*mut GtkTreeModel, *mut GtkTreeIter, *mut gobject_ffi::GValue, c_int, gpointer)>;
...
#[repr(C)]
pub struct GtkAboutDialogPrivate;

#[repr(C)]
pub struct GtkAccelGroupClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub accel_changed: Option<unsafe extern "C" fn(*mut GtkAccelGroup, c_uint, gdk_ffi::GdkModifierType, *mut gobject_ffi::GClosure)>,
    pub _gtk_reserved1: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
...
pub struct GtkAccelGroupEntry {
    ...
    pub accel_path_quark: glib_ffi::GQuark,
}

#[repr(C)]
pub struct GtkAccelGroupPrivate;

#[repr(C)]
pub struct GtkAccelKey {
    pub accel_key: c_uint,
    pub accel_mods: gdk_ffi::GdkModifierType,
...
#[repr(C)]
pub struct GtkAccelLabelPrivate;

#[repr(C)]
pub struct GtkAccelMapClass;

#[repr(C)]
pub struct GtkAccessibleClass {
    pub parent_class: atk_ffi::AtkObjectClass,
...
#[repr(C)]
pub struct GtkAccessiblePrivate;
...
#[repr(C)]
pub struct GtkActionBarPrivate;
...
pub struct GtkActionEntry {
    ...
    pub callback: gobject_ffi::GCallback,
}
...
#[repr(C)]
pub struct GtkActionGroupPrivate;

#[repr(C)]
pub struct GtkActionPrivate;

#[repr(C)]
pub struct GtkActionableInterface {
    g_iface: gobject_ffi::GTypeInterface,
    ...
    pub get_action_target_value: Option<unsafe extern "C" fn(*mut GtkActionable) -> *mut glib_ffi::GVariant>,
    pub set_action_target_value: Option<unsafe extern "C" fn(*mut GtkActionable, *mut glib_ffi::GVariant)>,
}
...
pub struct GtkAdjustmentClass {
    pub parent_class: gobject_ffi::GInitiallyUnownedClass,
...
#[repr(C)]
pub struct GtkAdjustmentPrivate;
...
#[repr(C)]
pub struct GtkAlignmentPrivate;
...
#[repr(C)]
pub struct GtkAppChooserButtonPrivate;
...
#[repr(C)]
pub struct GtkAppChooserDialogPrivate;

#[repr(C)]
pub struct GtkAppChooserWidgetClass {
    pub parent_class: GtkBoxClass,
    pub application_selected: Option<unsafe extern "C" fn(*mut GtkAppChooserWidget, *mut gio_ffi::GAppInfo)>,
    pub application_activated: Option<unsafe extern "C" fn(*mut GtkAppChooserWidget, *mut gio_ffi::GAppInfo)>,
    pub populate_popup: Option<unsafe extern "C" fn(*mut GtkAppChooserWidget, *mut GtkMenu, *mut gio_ffi::GAppInfo)>,
    padding: [gpointer; 16],
}

#[repr(C)]
pub struct GtkAppChooserWidgetPrivate;

#[repr(C)]
pub struct GtkApplicationClass {
    pub parent_class: gio_ffi::GApplicationClass,
...
#[repr(C)]
pub struct GtkApplicationPrivate;
...
#[repr(C)]
pub struct GtkApplicationWindowPrivate;
...
#[repr(C)]
pub struct GtkArrowAccessiblePrivate;
...
#[repr(C)]
pub struct GtkAspectFramePrivate;
...
#[repr(C)]
pub struct GtkAssistantPrivate;
...
pub struct GtkBindingEntry {
    pub keyval: c_uint,
    pub modifiers: gdk_ffi::GdkModifierType,
...
pub struct GtkBindingSet {
    ...
    pub priority: c_int,
    pub widget_path_pspecs: *mut glib_ffi::GSList,
    pub widget_class_pspecs: *mut glib_ffi::GSList,
    pub class_branch_pspecs: *mut glib_ffi::GSList,
...
#[repr(C)]
pub struct GtkBooleanCellAccessiblePrivate;
...
pub struct GtkBuildableIface {
    ...
    pub add_child: Option<unsafe extern "C" fn(*mut GtkBuildable, *mut GtkBuilder, *mut gobject_ffi::GObject, *const c_char)>,
    pub set_buildable_property: Option<unsafe extern "C" fn(*mut GtkBuildable, *mut GtkBuilder, *const c_char, *const gobject_ffi::GValue)>,
    pub construct_child: Option<unsafe extern "C" fn(*mut GtkBuildable, *mut GtkBuilder, *const c_char) -> *mut gobject_ffi::GObject>,
    pub custom_tag_start: Option<unsafe extern "C" fn(*mut GtkBuildable, *mut GtkBuilder, *mut gobject_ffi::GObject, *const c_char, *mut glib_ffi::GMarkupParser, *mut gpointer) -> gboolean>,
    pub custom_tag_end: Option<unsafe extern "C" fn(*mut GtkBuildable, *mut GtkBuilder, *mut gobject_ffi::GObject, *const c_char, gpointer)>,
    pub custom_finished: Option<unsafe extern "C" fn(*mut GtkBuildable, *mut GtkBuilder, *mut gobject_ffi::GObject, *const c_char, gpointer)>,
    pub parser_finished: Option<unsafe extern "C" fn(*mut GtkBuildable, *mut GtkBuilder)>,
    pub get_internal_child: Option<unsafe extern "C" fn(*mut GtkBuildable, *mut GtkBuilder, *const c_char) -> *mut gobject_ffi::GObject>,
}
...
#[repr(C)]
pub struct GtkButtonAccessiblePrivate;
...
#[repr(C)]
pub struct GtkButtonBoxPrivate;
...
pub struct GtkCellAccessibleParentIface {
    pub parent: gobject_ffi::GTypeInterface,
    pub get_cell_extents: Option<unsafe extern "C" fn(*mut GtkCellAccessibleParent, *mut GtkCellAccessible, *mut c_int, *mut c_int, *mut c_int, *mut c_int, atk_ffi::AtkCoordType)>,
    pub get_cell_area: Option<unsafe extern "C" fn(*mut GtkCellAccessibleParent, *mut GtkCellAccessible, *mut gdk_ffi::GdkRectangle)>,
    ...
    pub update_relationset: Option<unsafe extern "C" fn(*mut GtkCellAccessibleParent, *mut GtkCellAccessible, *mut atk_ffi::AtkRelationSet)>,
}

#[repr(C)]
pub struct GtkCellAccessiblePrivate;
...
#[repr(C)]
pub struct GtkCellAreaBoxPrivate;

#[repr(C)]
pub struct GtkCellAreaClass {
    parent_class: gobject_ffi::GInitiallyUnownedClass,
    ...
    pub foreach_alloc: Option<unsafe extern "C" fn(*mut GtkCellArea, *mut GtkCellAreaContext, *mut GtkWidget, *const gdk_ffi::GdkRectangle, *const gdk_ffi::GdkRectangle, GtkCellAllocCallback, gpointer)>,
    pub event: Option<unsafe extern "C" fn(*mut GtkCellArea, *mut GtkCellAreaContext, *mut GtkWidget, *mut gdk_ffi::GdkEvent, *const gdk_ffi::GdkRectangle, GtkCellRendererState) -> c_int>,
    pub render: Option<unsafe extern "C" fn(*mut GtkCellArea, *mut GtkCellAreaContext, *mut GtkWidget, *mut cairo_ffi::cairo_t, *const gdk_ffi::GdkRectangle, *const gdk_ffi::GdkRectangle, GtkCellRendererState, gboolean)>,
    ...
    pub set_cell_property: Option<unsafe extern "C" fn(*mut GtkCellArea, *mut GtkCellRenderer, c_uint, *mut gobject_ffi::GValue, *mut gobject_ffi::GParamSpec)>,
    pub get_cell_property: Option<unsafe extern "C" fn(*mut GtkCellArea, *mut GtkCellRenderer, c_uint, *mut gobject_ffi::GValue, *mut gobject_ffi::GParamSpec)>,
    ...
    pub activate: Option<unsafe extern "C" fn(*mut GtkCellArea, *mut GtkCellAreaContext, *mut GtkWidget, *const gdk_ffi::GdkRectangle, GtkCellRendererState, gboolean) -> gboolean>,
    pub _gtk_reserved1: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GtkCellAreaContextPrivate;

#[repr(C)]
pub struct GtkCellAreaPrivate;
...
pub struct GtkCellEditableIface {
    ...
    pub start_editing: Option<unsafe extern "C" fn(*mut GtkCellEditable, *mut gdk_ffi::GdkEvent)>,
}
...
pub struct GtkCellLayoutIface {
    ...
    pub set_cell_data_func: Option<unsafe extern "C" fn(*mut GtkCellLayout, *mut GtkCellRenderer, GtkCellLayoutDataFunc, gpointer, glib_ffi::GDestroyNotify)>,
    ...
    pub get_cells: Option<unsafe extern "C" fn(*mut GtkCellLayout) -> *mut glib_ffi::GList>,
...
pub struct GtkCellRendererAccelClass {
    ...
    pub accel_edited: Option<unsafe extern "C" fn(*mut GtkCellRendererAccel, *const c_char, c_uint, gdk_ffi::GdkModifierType, c_uint)>,
...
#[repr(C)]
pub struct GtkCellRendererAccelPrivate;
...
pub struct GtkCellRendererClass {
    ...
    pub get_aligned_area: Option<unsafe extern "C" fn(*mut GtkCellRenderer, *mut GtkWidget, GtkCellRendererState, *const gdk_ffi::GdkRectangle, *mut gdk_ffi::GdkRectangle)>,
    pub get_size: Option<unsafe extern "C" fn(*mut GtkCellRenderer, *mut GtkWidget, *const gdk_ffi::GdkRectangle, *mut c_int, *mut c_int, *mut c_int, *mut c_int)>,
    pub render: Option<unsafe extern "C" fn(*mut GtkCellRenderer, *mut cairo_ffi::cairo_t, *mut GtkWidget, *const gdk_ffi::GdkRectangle, *const gdk_ffi::GdkRectangle, GtkCellRendererState)>,
    pub activate: Option<unsafe extern "C" fn(*mut GtkCellRenderer, *mut gdk_ffi::GdkEvent, *mut GtkWidget, *const c_char, *const gdk_ffi::GdkRectangle, *const gdk_ffi::GdkRectangle, GtkCellRendererState) -> gboolean>,
    pub start_editing: Option<unsafe extern "C" fn(*mut GtkCellRenderer, *mut gdk_ffi::GdkEvent, *mut GtkWidget, *const c_char, *const gdk_ffi::GdkRectangle, *const gdk_ffi::GdkRectangle, GtkCellRendererState) -> *mut GtkCellEditable>,
...
#[repr(C)]
pub struct GtkCellRendererClassPrivate;
...
#[repr(C)]
pub struct GtkCellRendererComboPrivate;
...
#[repr(C)]
pub struct GtkCellRendererPixbufPrivate;

#[repr(C)]
pub struct GtkCellRendererPrivate;
...
#[repr(C)]
pub struct GtkCellRendererProgressPrivate;
...
#[repr(C)]
pub struct GtkCellRendererSpinPrivate;
...
#[repr(C)]
pub struct GtkCellRendererSpinnerPrivate;
...
#[repr(C)]
pub struct GtkCellRendererTextPrivate;
...
#[repr(C)]
pub struct GtkCellRendererTogglePrivate;
...
#[repr(C)]
pub struct GtkCellViewPrivate;

#[repr(C)]
pub struct GtkCheckButtonClass {
    pub parent_class: GtkToggleButtonClass,
    pub draw_indicator: Option<unsafe extern "C" fn(*mut GtkCheckButton, *mut cairo_ffi::cairo_t)>,
    pub _gtk_reserved1: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GtkCheckMenuItemAccessiblePrivate;
...
pub struct GtkCheckMenuItemClass {
    ...
    pub draw_indicator: Option<unsafe extern "C" fn(*mut GtkCheckMenuItem, *mut cairo_ffi::cairo_t)>,
    pub _gtk_reserved1: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GtkCheckMenuItemPrivate;
...
#[repr(C)]
pub struct GtkColorButtonPrivate;
...
#[repr(C)]
pub struct GtkColorChooserDialogPrivate;

#[repr(C)]
pub struct GtkColorChooserInterface {
    pub base_interface: gobject_ffi::GTypeInterface,
    pub get_rgba: Option<unsafe extern "C" fn(*mut GtkColorChooser, *const gdk_ffi::GdkRGBA)>,
    pub set_rgba: Option<unsafe extern "C" fn(*mut GtkColorChooser, *const gdk_ffi::GdkRGBA)>,
    pub add_palette: Option<unsafe extern "C" fn(*mut GtkColorChooser, GtkOrientation, c_int, c_int, *mut gdk_ffi::GdkRGBA)>,
    pub color_activated: Option<unsafe extern "C" fn(*mut GtkColorChooser, *const gdk_ffi::GdkRGBA)>,
...
#[repr(C)]
pub struct GtkColorChooserWidgetPrivate;
...
#[repr(C)]
pub struct GtkColorSelectionDialogPrivate;

#[repr(C)]
pub struct GtkColorSelectionPrivate;
...
#[repr(C)]
pub struct GtkComboBoxAccessiblePrivate;
...
#[repr(C)]
pub struct GtkComboBoxTextPrivate;
...
#[repr(C)]
pub struct GtkContainerAccessiblePrivate;
...
#[repr(C)]
pub struct GtkContainerCellAccessiblePrivate;
...
pub struct GtkContainerClass {
    ...
    pub set_child_property: Option<unsafe extern "C" fn(*mut GtkContainer, *mut GtkWidget, c_uint, *mut gobject_ffi::GValue, *mut gobject_ffi::GParamSpec)>,
    pub get_child_property: Option<unsafe extern "C" fn(*mut GtkContainer, *mut GtkWidget, c_uint, *mut gobject_ffi::GValue, *mut gobject_ffi::GParamSpec)>,
...
#[repr(C)]
pub struct GtkContainerPrivate;

#[repr(C)]
pub struct GtkCssProviderClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub parsing_error: Option<unsafe extern "C" fn(*mut GtkCssProvider, *mut GtkCssSection, *const glib_ffi::GError)>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
}
...
#[repr(C)]
pub struct GtkCssProviderPrivate;
...
pub struct GtkEditableInterface {
    pub base_iface: gobject_ffi::GTypeInterface,
...
#[repr(C)]
pub struct GtkEntryAccessiblePrivate;
...
#[repr(C)]
pub struct GtkEntryBufferPrivate;
...
#[repr(C)]
pub struct GtkEntryCompletionPrivate;

#[repr(C)]
pub struct GtkEntryPrivate;
...
#[repr(C)]
pub struct GtkEventBoxPrivate;

#[repr(C)]
pub struct GtkEventControllerClass;
...
#[repr(C)]
pub struct GtkExpanderAccessiblePrivate;
...
#[repr(C)]
pub struct GtkFileChooserButtonPrivate;
...
#[repr(C)]
pub struct GtkFileChooserDialogPrivate;
...
#[repr(C)]
pub struct GtkFileChooserWidgetPrivate;
...
#[repr(C)]
pub struct GtkFlowBoxAccessiblePrivate;
...
#[repr(C)]
pub struct GtkFontButtonPrivate;
...
#[repr(C)]
pub struct GtkFontChooserDialogPrivate;

#[repr(C)]
pub struct GtkFontChooserIface {
    pub base_iface: gobject_ffi::GTypeInterface,
    pub get_font_family: Option<unsafe extern "C" fn(*mut GtkFontChooser) -> *mut pango_ffi::PangoFontFamily>,
    pub get_font_face: Option<unsafe extern "C" fn(*mut GtkFontChooser) -> *mut pango_ffi::PangoFontFace>,
    pub get_font_size: Option<unsafe extern "C" fn(*mut GtkFontChooser) -> c_int>,
    pub set_filter_func: Option<unsafe extern "C" fn(*mut GtkFontChooser, GtkFontFilterFunc, gpointer, glib_ffi::GDestroyNotify)>,
...
#[repr(C)]
pub struct GtkFontChooserWidgetPrivate;
...
#[repr(C)]
pub struct GtkFontSelectionDialogPrivate;

#[repr(C)]
pub struct GtkFontSelectionPrivate;
...
#[repr(C)]
pub struct GtkFrameAccessiblePrivate;
...
#[repr(C)]
pub struct GtkFramePrivate;

#[repr(C)]
pub struct GtkGLAreaClass {
    parent_class: GtkWidgetClass,
    pub render: Option<unsafe extern "C" fn(*mut GtkGLArea, *mut gdk_ffi::GdkGLContext) -> gboolean>,
    pub resize: Option<unsafe extern "C" fn(*mut GtkGLArea, c_int, c_int)>,
    pub create_context: Option<unsafe extern "C" fn(*mut GtkGLArea) -> *mut gdk_ffi::GdkGLContext>,
    _padding: [gpointer; 6],
}

#[repr(C)]
pub struct GtkGestureClass;

#[repr(C)]
pub struct GtkGestureDragClass;

#[repr(C)]
pub struct GtkGestureLongPressClass;

#[repr(C)]
pub struct GtkGestureMultiPressClass;

#[repr(C)]
pub struct GtkGesturePanClass;

#[repr(C)]
pub struct GtkGestureRotateClass;

#[repr(C)]
pub struct GtkGestureSingleClass;

#[repr(C)]
pub struct GtkGestureSwipeClass;

#[repr(C)]
pub struct GtkGestureZoomClass;
...
#[repr(C)]
pub struct GtkHandleBoxPrivate;
...
#[repr(C)]
pub struct GtkHeaderBarPrivate;
...
pub struct GtkIMContextClass {
    ...
    pub set_client_window: Option<unsafe extern "C" fn(*mut GtkIMContext, *mut gdk_ffi::GdkWindow)>,
    pub get_preedit_string: Option<unsafe extern "C" fn(*mut GtkIMContext, *mut *mut c_char, *mut *mut pango_ffi::PangoAttrList, *mut c_int)>,
    pub filter_keypress: Option<unsafe extern "C" fn(*mut GtkIMContext, *mut gdk_ffi::GdkEventKey) -> gboolean>,
    ...
    pub set_cursor_location: Option<unsafe extern "C" fn(*mut GtkIMContext, *mut gdk_ffi::GdkRectangle)>,
...
#[repr(C)]
pub struct GtkIMContextSimplePrivate;
...
#[repr(C)]
pub struct GtkIMMulticontextPrivate;
...
#[repr(C)]
pub struct GtkIconFactoryPrivate;

#[repr(C)]
pub struct GtkIconInfoClass;
...
#[repr(C)]
pub struct GtkIconThemePrivate;
...
#[repr(C)]
pub struct GtkIconViewAccessiblePrivate;
...
#[repr(C)]
pub struct GtkImageAccessiblePrivate;
...
#[repr(C)]
pub struct GtkImageCellAccessiblePrivate;
...
#[repr(C)]
pub struct GtkImageMenuItemPrivate;

#[repr(C)]
pub struct GtkImagePrivate;
...
#[repr(C)]
pub struct GtkInvisiblePrivate;
...
#[repr(C)]
pub struct GtkLabelAccessiblePrivate;
...
#[repr(C)]
pub struct GtkLabelPrivate;

#[repr(C)]
pub struct GtkLabelSelectionInfo;
...
#[repr(C)]
pub struct GtkLevelBarAccessiblePrivate;
...
#[repr(C)]
pub struct GtkLinkButtonAccessiblePrivate;
...
#[repr(C)]
pub struct GtkLinkButtonPrivate;
...
#[repr(C)]
pub struct GtkListBoxAccessiblePrivate;
...
#[repr(C)]
pub struct GtkListStorePrivate;
...
#[repr(C)]
pub struct GtkLockButtonAccessiblePrivate;
...
#[repr(C)]
pub struct GtkLockButtonPrivate;
...
#[repr(C)]
pub struct GtkMenuAccessiblePrivate;
...
#[repr(C)]
pub struct GtkMenuButtonAccessiblePrivate;
...
#[repr(C)]
pub struct GtkMenuButtonPrivate;
...
#[repr(C)]
pub struct GtkMenuItemAccessiblePrivate;
...
#[repr(C)]
pub struct GtkMenuItemPrivate;

#[repr(C)]
pub struct GtkMenuPrivate;
...
#[repr(C)]
pub struct GtkMenuShellAccessiblePrivate;
...
#[repr(C)]
pub struct GtkMenuShellPrivate;
...
#[repr(C)]
pub struct GtkMenuToolButtonPrivate;
...
#[repr(C)]
pub struct GtkMessageDialogPrivate;
...
#[repr(C)]
pub struct GtkMiscPrivate;

#[repr(C)]
pub struct GtkMountOperationClass {
    pub parent_class: gio_ffi::GMountOperationClass,
    pub _gtk_reserved1: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GtkMountOperationPrivate;
...
#[repr(C)]
pub struct GtkNotebookAccessiblePrivate;
...
#[repr(C)]
pub struct GtkNotebookPageAccessiblePrivate;

#[repr(C)]
pub struct GtkNotebookPrivate;

#[repr(C)]
pub struct GtkNumerableIconClass {
    pub parent_class: gio_ffi::GEmblemedIconClass,
    pub padding: [gpointer; 16],
}

#[repr(C)]
pub struct GtkNumerableIconPrivate;
...
#[repr(C)]
pub struct GtkPanedAccessiblePrivate;
...
#[repr(C)]
pub struct GtkPanedPrivate;

#[repr(C)]
pub struct GtkPaperSize;

#[repr(C)]
pub struct GtkPlacesSidebarClass;
...
#[repr(C)]
pub struct GtkPrintOperationPrivate;
...
#[repr(C)]
pub struct GtkProgressBarAccessiblePrivate;
...
#[repr(C)]
pub struct GtkProgressBarPrivate;
...
#[repr(C)]
pub struct GtkRadioActionPrivate;
...
#[repr(C)]
pub struct GtkRadioButtonAccessiblePrivate;
...
#[repr(C)]
pub struct GtkRadioButtonPrivate;
...
#[repr(C)]
pub struct GtkRadioMenuItemAccessiblePrivate;
...
#[repr(C)]
pub struct GtkRadioMenuItemPrivate;
...
#[repr(C)]
pub struct GtkRangeAccessiblePrivate;
...
#[repr(C)]
pub struct GtkRangePrivate;

#[repr(C)]
pub struct GtkRcContext;

#[repr(C)]
pub struct GtkRcProperty {
    pub type_name: glib_ffi::GQuark,
    pub property_name: glib_ffi::GQuark,
    pub origin: *mut c_char,
    pub value: gobject_ffi::GValue,
}
...
pub struct GtkRcStyleClass {
    ...
    pub parse: Option<unsafe extern "C" fn(*mut GtkRcStyle, *mut GtkSettings, *mut glib_ffi::GScanner) -> c_uint>,
...
#[repr(C)]
pub struct GtkRecentActionPrivate;
...
#[repr(C)]
pub struct GtkRecentChooserDialogPrivate;

#[repr(C)]
pub struct GtkRecentChooserIface {
    base_iface: gobject_ffi::GTypeInterface,
    pub set_current_uri: Option<unsafe extern "C" fn(*mut GtkRecentChooser, *const c_char, *mut *mut glib_ffi::GError) -> gboolean>,
    pub get_current_uri: Option<unsafe extern "C" fn(*mut GtkRecentChooser) -> *mut c_char>,
    pub select_uri: Option<unsafe extern "C" fn(*mut GtkRecentChooser, *const c_char, *mut *mut glib_ffi::GError) -> gboolean>,
    ...
    pub get_items: Option<unsafe extern "C" fn(*mut GtkRecentChooser) -> *mut glib_ffi::GList>,
    ...
    pub list_filters: Option<unsafe extern "C" fn(*mut GtkRecentChooser) -> *mut glib_ffi::GSList>,
    pub set_sort_func: Option<unsafe extern "C" fn(*mut GtkRecentChooser, GtkRecentSortFunc, gpointer, glib_ffi::GDestroyNotify)>,
...
#[repr(C)]
pub struct GtkRecentChooserMenuPrivate;
...
#[repr(C)]
pub struct GtkRecentChooserWidgetPrivate;
...
#[repr(C)]
pub struct GtkRecentManagerPrivate;
...
#[repr(C)]
pub struct GtkRendererCellAccessiblePrivate;
...
#[repr(C)]
pub struct GtkScaleAccessiblePrivate;
...
#[repr(C)]
pub struct GtkScaleButtonAccessiblePrivate;
...
#[repr(C)]
pub struct GtkScaleButtonPrivate;
...
#[repr(C)]
pub struct GtkScrolledWindowAccessiblePrivate;
...
#[repr(C)]
pub struct GtkScrolledWindowPrivate;
...
#[repr(C)]
pub struct GtkSeparatorPrivate;
...
#[repr(C)]
pub struct GtkSeparatorToolItemPrivate;
...
#[repr(C)]
pub struct GtkSizeGroupPrivate;
...
#[repr(C)]
pub struct GtkSpinButtonAccessiblePrivate;
...
#[repr(C)]
pub struct GtkSpinButtonPrivate;
...
#[repr(C)]
pub struct GtkSpinnerAccessiblePrivate;
...
#[repr(C)]
pub struct GtkStackSidebarPrivate;
...
pub struct GtkStatusIconClass {
    ...
    pub button_press_event: Option<unsafe extern "C" fn(*mut GtkStatusIcon, *mut gdk_ffi::GdkEventButton) -> gboolean>,
    pub button_release_event: Option<unsafe extern "C" fn(*mut GtkStatusIcon, *mut gdk_ffi::GdkEventButton) -> gboolean>,
    pub scroll_event: Option<unsafe extern "C" fn(*mut GtkStatusIcon, *mut gdk_ffi::GdkEventScroll) -> gboolean>,
...
#[repr(C)]
pub struct GtkStatusIconPrivate;
...
#[repr(C)]
pub struct GtkStatusbarAccessiblePrivate;
...
#[repr(C)]
pub struct GtkStatusbarPrivate;

#[repr(C)]
pub struct GtkStockItem {
    pub stock_id: *mut c_char,
    pub label: *mut c_char,
    pub modifier: gdk_ffi::GdkModifierType,
    pub keyval: c_uint,
...
pub struct GtkStyleClass {
    ...
    pub set_background: Option<unsafe extern "C" fn(*mut GtkStyle, *mut gdk_ffi::GdkWindow, GtkStateType)>,
    pub render_icon: Option<unsafe extern "C" fn(*mut GtkStyle, *const GtkIconSource, GtkTextDirection, GtkStateType, c_int, *mut GtkWidget, *const c_char) -> *mut gdk_pixbuf_ffi::GdkPixbuf>,
    pub draw_hline: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, *mut GtkWidget, *const c_char, c_int, c_int, c_int)>,
    pub draw_vline: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, *mut GtkWidget, *const c_char, c_int, c_int, c_int)>,
    pub draw_shadow: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int)>,
    pub draw_arrow: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, GtkArrowType, gboolean, c_int, c_int, c_int, c_int)>,
    pub draw_diamond: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int)>,
    pub draw_box: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int)>,
    pub draw_flat_box: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int)>,
    pub draw_check: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int)>,
    pub draw_option: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int)>,
    pub draw_tab: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int)>,
    pub draw_shadow_gap: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int, GtkPositionType, c_int, c_int)>,
    pub draw_box_gap: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int, GtkPositionType, c_int, c_int)>,
    pub draw_extension: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int, GtkPositionType)>,
    pub draw_focus: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int)>,
    pub draw_slider: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int, GtkOrientation)>,
    pub draw_handle: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, GtkShadowType, *mut GtkWidget, *const c_char, c_int, c_int, c_int, c_int, GtkOrientation)>,
    pub draw_expander: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, *mut GtkWidget, *const c_char, c_int, c_int, GtkExpanderStyle)>,
    pub draw_layout: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, gboolean, *mut GtkWidget, *const c_char, c_int, c_int, *mut pango_ffi::PangoLayout)>,
    pub draw_resize_grip: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, *mut GtkWidget, *const c_char, gdk_ffi::GdkWindowEdge, c_int, c_int, c_int, c_int)>,
    pub draw_spinner: Option<unsafe extern "C" fn(*mut GtkStyle, *mut cairo_ffi::cairo_t, GtkStateType, *mut GtkWidget, *const c_char, c_uint, c_int, c_int, c_int, c_int)>,
    pub _gtk_reserved1: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GtkStyleContextPrivate;
...
#[repr(C)]
pub struct GtkStylePropertiesPrivate;
...
pub struct GtkStyleProviderIface {
    ...
    pub get_style_property: Option<unsafe extern "C" fn(*mut GtkStyleProvider, *mut GtkWidgetPath, GtkStateFlags, *mut gobject_ffi::GParamSpec, *mut gobject_ffi::GValue) -> gboolean>,
...
#[repr(C)]
pub struct GtkSwitchAccessiblePrivate;
...
#[repr(C)]
pub struct GtkTearoffMenuItemPrivate;

#[repr(C)]
pub struct GtkTextAppearance {
    pub bg_color: gdk_ffi::GdkColor,
    pub fg_color: gdk_ffi::GdkColor,
    pub rise: c_int,
    _truncated_record_marker: (),
    //underline: guint: 4,
...
pub struct GtkTextAttributes {
    ...
    pub font: *mut pango_ffi::PangoFontDescription,
    ...
    pub tabs: *mut pango_ffi::PangoTabArray,
    pub wrap_mode: GtkWrapMode,
    pub language: *mut pango_ffi::PangoLanguage,
    pg_bg_color: *mut gdk_ffi::GdkColor,
    _truncated_record_marker: (),
    //invisible: guint: 1,
...
pub struct GtkTextBufferClass {
    ...
    pub insert_pixbuf: Option<unsafe extern "C" fn(*mut GtkTextBuffer, *mut GtkTextIter, *mut gdk_pixbuf_ffi::GdkPixbuf)>,
...
#[repr(C)]
pub struct GtkTextBufferPrivate;
...
#[repr(C)]
pub struct GtkTextCellAccessiblePrivate;
...
pub struct GtkTextTagClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub event: Option<unsafe extern "C" fn(*mut GtkTextTag, *mut gobject_ffi::GObject, *mut gdk_ffi::GdkEvent, *const GtkTextIter) -> gboolean>,
    pub _gtk_reserved1: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GtkTextTagTablePrivate;
...
#[repr(C)]
pub struct GtkTextViewAccessiblePrivate;
...
pub struct GtkTextViewClass {
    ...
    pub draw_layer: Option<unsafe extern "C" fn(*mut GtkTextView, GtkTextViewLayer, *mut cairo_ffi::cairo_t)>,
...
#[repr(C)]
pub struct GtkTextViewPrivate;

#[repr(C)]
pub struct GtkThemeEngine;

#[repr(C)]
pub struct GtkThemingEngineClass {
    pub parent_class: gobject_ffi::GObjectClass,
    pub render_line: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_background: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_frame: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_frame_gap: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double, GtkPositionType, c_double, c_double)>,
    pub render_extension: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double, GtkPositionType)>,
    pub render_check: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_option: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_arrow: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_expander: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_focus: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_layout: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, *mut pango_ffi::PangoLayout)>,
    pub render_slider: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double, GtkOrientation)>,
    pub render_handle: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_activity: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, c_double, c_double, c_double, c_double)>,
    pub render_icon_pixbuf: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *const GtkIconSource, GtkIconSize) -> *mut gdk_pixbuf_ffi::GdkPixbuf>,
    pub render_icon: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, *mut gdk_pixbuf_ffi::GdkPixbuf, c_double, c_double)>,
    pub render_icon_surface: Option<unsafe extern "C" fn(*mut GtkThemingEngine, *mut cairo_ffi::cairo_t, *mut cairo_ffi::cairo_surface_t, c_double, c_double)>,
    padding: [gpointer; 14],
}
...
#[repr(C)]
pub struct GtkToggleActionPrivate;
...
#[repr(C)]
pub struct GtkToggleButtonAccessiblePrivate;
...
#[repr(C)]
pub struct GtkToggleButtonPrivate;
...
#[repr(C)]
pub struct GtkToggleToolButtonPrivate;
...
#[repr(C)]
pub struct GtkToolButtonPrivate;
...
#[repr(C)]
pub struct GtkToolItemGroupPrivate;

#[repr(C)]
pub struct GtkToolItemPrivate;
...
#[repr(C)]
pub struct GtkToolPalettePrivate;
...
pub struct GtkToolShellIface {
    ...
    pub get_ellipsize_mode: Option<unsafe extern "C" fn(*mut GtkToolShell) -> pango_ffi::PangoEllipsizeMode>,
...
#[repr(C)]
pub struct GtkToplevelAccessiblePrivate;
...
pub struct GtkTreeModelFilterClass {
    ...
    pub modify: Option<unsafe extern "C" fn(*mut GtkTreeModelFilter, *mut GtkTreeModel, *mut GtkTreeIter, *mut gobject_ffi::GValue, c_int)>,
    pub _gtk_reserved1: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved2: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved3: Option<unsafe extern "C" fn()>,
    pub _gtk_reserved4: Option<unsafe extern "C" fn()>,
...
#[repr(C)]
pub struct GtkTreeModelFilterPrivate;
...
pub struct GtkTreeModelIface {
    ...
    pub get_value: Option<unsafe extern "C" fn(*mut GtkTreeModel, *mut GtkTreeIter, c_int, *mut gobject_ffi::GValue)>,
...
#[repr(C)]
pub struct GtkTreeModelSortPrivate;
...
#[repr(C)]
pub struct GtkTreeSelectionPrivate;
...
pub struct GtkTreeSortableIface {
    ...
    pub set_sort_func: Option<unsafe extern "C" fn(*mut GtkTreeSortable, c_int, GtkTreeIterCompareFunc, gpointer, glib_ffi::GDestroyNotify)>,
    pub set_default_sort_func: Option<unsafe extern "C" fn(*mut GtkTreeSortable, GtkTreeIterCompareFunc, gpointer, glib_ffi::GDestroyNotify)>,
...
#[repr(C)]
pub struct GtkTreeStorePrivate;
...
#[repr(C)]
pub struct GtkTreeViewAccessiblePrivate;
...
#[repr(C)]
pub struct GtkTreeViewColumnPrivate;

#[repr(C)]
pub struct GtkTreeViewPrivate;
...
#[repr(C)]
pub struct GtkUIManagerPrivate;
...
pub struct GtkWidgetAccessibleClass {
    pub parent_class: GtkAccessibleClass,
    pub notify_gtk: Option<unsafe extern "C" fn(*mut gobject_ffi::GObject, *mut gobject_ffi::GParamSpec)>,
}

#[repr(C)]
pub struct GtkWidgetAccessiblePrivate;
...
pub struct GtkWidgetClass {
    ...
    pub dispatch_child_properties_changed: Option<unsafe extern "C" fn(*mut GtkWidget, c_uint, *mut *mut gobject_ffi::GParamSpec)>,
    ...
    pub child_notify: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gobject_ffi::GParamSpec)>,
    pub draw: Option<unsafe extern "C" fn(*mut GtkWidget, *mut cairo_ffi::cairo_t) -> gboolean>,
    ...
    pub event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEvent) -> gboolean>,
    pub button_press_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventButton) -> gboolean>,
    pub button_release_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventButton) -> gboolean>,
    pub scroll_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventScroll) -> gboolean>,
    pub motion_notify_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventMotion) -> gboolean>,
    pub delete_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventAny) -> gboolean>,
    pub destroy_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventAny) -> gboolean>,
    pub key_press_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventKey) -> gboolean>,
    pub key_release_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventKey) -> gboolean>,
    pub enter_notify_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventCrossing) -> gboolean>,
    pub leave_notify_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventCrossing) -> gboolean>,
    pub configure_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventConfigure) -> gboolean>,
    pub focus_in_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventFocus) -> gboolean>,
    pub focus_out_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventFocus) -> gboolean>,
    pub map_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventAny) -> gboolean>,
    pub unmap_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventAny) -> gboolean>,
    pub property_notify_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventProperty) -> gboolean>,
    pub selection_clear_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventSelection) -> gboolean>,
    pub selection_request_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventSelection) -> gboolean>,
    pub selection_notify_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventSelection) -> gboolean>,
    pub proximity_in_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventProximity) -> gboolean>,
    pub proximity_out_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventProximity) -> gboolean>,
    pub visibility_notify_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventVisibility) -> gboolean>,
    pub window_state_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventWindowState) -> gboolean>,
    pub damage_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventExpose) -> gboolean>,
    pub grab_broken_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventGrabBroken) -> gboolean>,
    ...
    pub drag_begin: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext)>,
    pub drag_end: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext)>,
    pub drag_data_get: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext, *mut GtkSelectionData, c_uint, c_uint)>,
    pub drag_data_delete: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext)>,
    pub drag_leave: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext, c_uint)>,
    pub drag_motion: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext, c_int, c_int, c_uint) -> gboolean>,
    pub drag_drop: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext, c_int, c_int, c_uint) -> gboolean>,
    pub drag_data_received: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext, c_int, c_int, *mut GtkSelectionData, c_uint, c_uint)>,
    pub drag_failed: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkDragContext, GtkDragResult) -> gboolean>,
    ...
    pub get_accessible: Option<unsafe extern "C" fn(*mut GtkWidget) -> *mut atk_ffi::AtkObject>,
    pub screen_changed: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkScreen)>,
    ...
    pub touch_event: Option<unsafe extern "C" fn(*mut GtkWidget, *mut gdk_ffi::GdkEventTouch) -> gboolean>,
    ...
    pub queue_draw_region: Option<unsafe extern "C" fn(*mut GtkWidget, *const cairo_ffi::cairo_region_t)>,
...
#[repr(C)]
pub struct GtkWidgetClassPrivate;

#[repr(C)]
pub struct GtkWidgetPath;

#[repr(C)]
pub struct GtkWidgetPrivate;
...
#[repr(C)]
pub struct GtkWindowAccessiblePrivate;
...
#[repr(C)]
pub struct GtkWindowGeometryInfo;
...
#[repr(C)]
pub struct GtkWindowGroupPrivate;

#[repr(C)]
pub struct GtkWindowPrivate;
...
extern "C" {
    ...
    // GtkBindingEntry
    //=========================================================================
    pub fn gtk_binding_entry_add_signal        (binding_set: *mut GtkBindingSet, keyval: c_uint, modifiers: gdk_ffi::GdkModifierType, signal_name: *const c_char, n_args: c_uint, ...);
    pub fn gtk_binding_entry_add_signal_from_string(binding_set: *mut GtkBindingSet, signal_desc: *const c_char) -> glib_ffi::GTokenType;
    pub fn gtk_binding_entry_add_signall       (binding_set: *mut GtkBindingSet, keyval: c_uint, modifiers: gdk_ffi::GdkModifierType, signal_name: *const c_char, binding_args: *mut glib_ffi::GSList);
    pub fn gtk_binding_entry_remove            (binding_set: *mut GtkBindingSet, keyval: c_uint, modifiers: gdk_ffi::GdkModifierType);
    pub fn gtk_binding_entry_skip              (binding_set: *mut GtkBindingSet, keyval: c_uint, modifiers: gdk_ffi::GdkModifierType);

    //=========================================================================
    // GtkBindingSet
    //=========================================================================
    pub fn gtk_binding_set_activate            (binding_set: *mut GtkBindingSet, keyval: c_uint, modifiers: gdk_ffi::GdkModifierType, object: *mut gobject_ffi::GObject) -> gboolean;
    ...
    // GtkCellAreaClass
    //=========================================================================
    pub fn gtk_cell_area_class_find_cell_property(aclass: *mut GtkCellAreaClass, property_name: *const c_char) -> *mut gobject_ffi::GParamSpec;
    pub fn gtk_cell_area_class_install_cell_property(aclass: *mut GtkCellAreaClass, property_id: c_uint, pspec: *mut gobject_ffi::GParamSpec);
    pub fn gtk_cell_area_class_list_cell_properties(aclass: *mut GtkCellAreaClass, n_properties: *mut c_uint) -> *mut *mut gobject_ffi::GParamSpec;
    ...
    // GtkContainerClass
    //=========================================================================
    //pub fn gtk_container_class_find_child_property(cclass: *mut [c:type mismatch `GObjectClass` != `GtkContainerClass` of `ContainerClass`], property_name: *const c_char) -> *mut gobject_ffi::GParamSpec;
    pub fn gtk_container_class_handle_border_width(klass: *mut GtkContainerClass);
    pub fn gtk_container_class_install_child_property(cclass: *mut GtkContainerClass, property_id: c_uint, pspec: *mut gobject_ffi::GParamSpec);
    //pub fn gtk_container_class_list_child_properties(cclass: *mut [c:type mismatch `GObjectClass` != `GtkContainerClass` of `ContainerClass`], n_properties: *mut c_uint) -> *mut *mut gobject_ffi::GParamSpec;
    ...
    pub fn gtk_css_section_get_file            (section: *const GtkCssSection) -> *mut gio_ffi::GFile;
    ...
    pub fn gtk_gradient_resolve                (gradient: *mut GtkGradient, props: *mut GtkStyleProperties, resolved_gradient: *mut *mut cairo_ffi::cairo_pattern_t) -> gboolean;
    pub fn gtk_gradient_resolve_for_context    (gradient: *mut GtkGradient, context: *mut GtkStyleContext) -> *mut cairo_ffi::cairo_pattern_t;
    ...
    pub fn gtk_icon_set_new_from_pixbuf        (pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf) -> *mut GtkIconSet;
    ...
    pub fn gtk_icon_set_render_icon            (icon_set: *mut GtkIconSet, style: *mut GtkStyle, direction: GtkTextDirection, state: GtkStateType, size: c_int, widget: *mut GtkWidget, detail: *const c_char) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_icon_set_render_icon_pixbuf     (icon_set: *mut GtkIconSet, context: *mut GtkStyleContext, size: c_int) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gtk_3_10)]
    pub fn gtk_icon_set_render_icon_surface    (icon_set: *mut GtkIconSet, context: *mut GtkStyleContext, size: c_int, scale: c_int, for_window: *mut gdk_ffi::GdkWindow) -> *mut cairo_ffi::cairo_surface_t;
    ...
    pub fn gtk_icon_source_get_pixbuf          (source: *const GtkIconSource) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gtk_icon_source_set_pixbuf          (source: *mut GtkIconSource, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    pub fn gtk_paper_size_new_from_key_file    (key_file: *mut glib_ffi::GKeyFile, group_name: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GtkPaperSize;
    ...
    pub fn gtk_paper_size_to_key_file          (size: *mut GtkPaperSize, key_file: *mut glib_ffi::GKeyFile, group_name: *const c_char);
    pub fn gtk_paper_size_get_default          () -> *const c_char;
    pub fn gtk_paper_size_get_paper_sizes      (include_custom: gboolean) -> *mut glib_ffi::GList;

    //=========================================================================
    // GtkRcProperty
    //=========================================================================
    pub fn gtk_rc_property_parse_border        (pspec: *const gobject_ffi::GParamSpec, gstring: *const glib_ffi::GString, property_value: *mut gobject_ffi::GValue) -> gboolean;
    pub fn gtk_rc_property_parse_color         (pspec: *const gobject_ffi::GParamSpec, gstring: *const glib_ffi::GString, property_value: *mut gobject_ffi::GValue) -> gboolean;
    pub fn gtk_rc_property_parse_enum          (pspec: *const gobject_ffi::GParamSpec, gstring: *const glib_ffi::GString, property_value: *mut gobject_ffi::GValue) -> gboolean;
    pub fn gtk_rc_property_parse_flags         (pspec: *const gobject_ffi::GParamSpec, gstring: *const glib_ffi::GString, property_value: *mut gobject_ffi::GValue) -> gboolean;
    pub fn gtk_rc_property_parse_requisition   (pspec: *const gobject_ffi::GParamSpec, gstring: *const glib_ffi::GString, property_value: *mut gobject_ffi::GValue) -> gboolean;

    //=========================================================================
    // GtkRecentInfo
    //=========================================================================
    pub fn gtk_recent_info_get_type            () -> GType;
    pub fn gtk_recent_info_create_app_info     (info: *mut GtkRecentInfo, app_name: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut gio_ffi::GAppInfo;
    ...
    pub fn gtk_recent_info_get_gicon           (info: *mut GtkRecentInfo) -> *mut gio_ffi::GIcon;
    pub fn gtk_recent_info_get_groups          (info: *mut GtkRecentInfo, length: *mut size_t) -> *mut *mut c_char;
    pub fn gtk_recent_info_get_icon            (info: *mut GtkRecentInfo, size: c_int) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gtk_selection_data_get_data_type    (selection_data: *const GtkSelectionData) -> gdk_ffi::GdkAtom;
    pub fn gtk_selection_data_get_data_with_length(selection_data: *const GtkSelectionData, length: *mut c_int) -> *mut u8;
    pub fn gtk_selection_data_get_display      (selection_data: *const GtkSelectionData) -> *mut gdk_ffi::GdkDisplay;
    ...
    pub fn gtk_selection_data_get_pixbuf       (selection_data: *const GtkSelectionData) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_selection_data_get_selection    (selection_data: *const GtkSelectionData) -> gdk_ffi::GdkAtom;
    pub fn gtk_selection_data_get_target       (selection_data: *const GtkSelectionData) -> gdk_ffi::GdkAtom;
    pub fn gtk_selection_data_get_targets      (selection_data: *const GtkSelectionData, targets: *mut *mut gdk_ffi::GdkAtom, n_atoms: *mut c_int) -> gboolean;
    ...
    pub fn gtk_selection_data_set              (selection_data: *mut GtkSelectionData, type_: gdk_ffi::GdkAtom, format: c_int, data: *mut u8, length: c_int);
    pub fn gtk_selection_data_set_pixbuf       (selection_data: *mut GtkSelectionData, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf) -> gboolean;
    ...
    pub fn gtk_symbolic_color_new_literal      (color: *const gdk_ffi::GdkRGBA) -> *mut GtkSymbolicColor;
    ...
    pub fn gtk_symbolic_color_resolve          (color: *mut GtkSymbolicColor, props: *mut GtkStyleProperties, resolved_color: *mut gdk_ffi::GdkRGBA) -> gboolean;
    ...
    pub fn gtk_target_list_add                 (list: *mut GtkTargetList, target: gdk_ffi::GdkAtom, flags: c_uint, info: c_uint);
    ...
    pub fn gtk_target_list_find                (list: *mut GtkTargetList, target: gdk_ffi::GdkAtom, info: *mut c_uint) -> gboolean;
    pub fn gtk_target_list_ref                 (list: *mut GtkTargetList) -> *mut GtkTargetList;
    pub fn gtk_target_list_remove              (list: *mut GtkTargetList, target: gdk_ffi::GdkAtom);
    ...
    pub fn gtk_text_iter_get_language          (iter: *const GtkTextIter) -> *mut pango_ffi::PangoLanguage;
    ...
    pub fn gtk_text_iter_get_marks             (iter: *const GtkTextIter) -> *mut glib_ffi::GSList;
    pub fn gtk_text_iter_get_offset            (iter: *const GtkTextIter) -> c_int;
    pub fn gtk_text_iter_get_pixbuf            (iter: *const GtkTextIter) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_text_iter_get_slice             (start: *const GtkTextIter, end: *const GtkTextIter) -> *mut c_char;
    pub fn gtk_text_iter_get_tags              (iter: *const GtkTextIter) -> *mut glib_ffi::GSList;
    pub fn gtk_text_iter_get_text              (start: *const GtkTextIter, end: *const GtkTextIter) -> *mut c_char;
    pub fn gtk_text_iter_get_toggled_tags      (iter: *const GtkTextIter, toggled_on: gboolean) -> *mut glib_ffi::GSList;
    ...
    pub fn gtk_tree_row_reference_new_proxy    (proxy: *mut gobject_ffi::GObject, model: *mut GtkTreeModel, path: *mut GtkTreePath) -> *mut GtkTreeRowReference;
    ...
    pub fn gtk_tree_row_reference_deleted      (proxy: *mut gobject_ffi::GObject, path: *mut GtkTreePath);
    pub fn gtk_tree_row_reference_inserted     (proxy: *mut gobject_ffi::GObject, path: *mut GtkTreePath);
    pub fn gtk_tree_row_reference_reordered    (proxy: *mut gobject_ffi::GObject, path: *mut GtkTreePath, iter: *mut GtkTreeIter, new_order: *mut c_int);

    //=========================================================================
    // GtkWidgetClass
    //=========================================================================
    #[cfg(gtk_3_10)]
    pub fn gtk_widget_class_bind_template_callback_full(widget_class: *mut GtkWidgetClass, callback_name: *const c_char, callback_symbol: gobject_ffi::GCallback);
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_widget_class_find_style_property(klass: *mut GtkWidgetClass, property_name: *const c_char) -> *mut gobject_ffi::GParamSpec;
    pub fn gtk_widget_class_install_style_property(klass: *mut GtkWidgetClass, pspec: *mut gobject_ffi::GParamSpec);
    pub fn gtk_widget_class_install_style_property_parser(klass: *mut GtkWidgetClass, pspec: *mut gobject_ffi::GParamSpec, parser: GtkRcPropertyParser);
    pub fn gtk_widget_class_list_style_properties(klass: *mut GtkWidgetClass, n_properties: *mut c_uint) -> *mut *mut gobject_ffi::GParamSpec;
    pub fn gtk_widget_class_set_accessible_role(widget_class: *mut GtkWidgetClass, role: atk_ffi::AtkRole);
    pub fn gtk_widget_class_set_accessible_type(widget_class: *mut GtkWidgetClass, type_: GType);
    #[cfg(gtk_3_10)]
    pub fn gtk_widget_class_set_connect_func   (widget_class: *mut GtkWidgetClass, connect_func: GtkBuilderConnectFunc, connect_data: gpointer, connect_data_destroy: glib_ffi::GDestroyNotify);
    #[cfg(gtk_3_10)]
    pub fn gtk_widget_class_set_template       (widget_class: *mut GtkWidgetClass, template_bytes: *mut glib_ffi::GBytes);
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_widget_path_iter_has_qclass     (path: *const GtkWidgetPath, pos: c_int, qname: glib_ffi::GQuark) -> gboolean;
    pub fn gtk_widget_path_iter_has_qname      (path: *const GtkWidgetPath, pos: c_int, qname: glib_ffi::GQuark) -> gboolean;
    pub fn gtk_widget_path_iter_has_qregion    (path: *const GtkWidgetPath, pos: c_int, qname: glib_ffi::GQuark, flags: *mut GtkRegionFlags) -> gboolean;
    ...
    pub fn gtk_widget_path_iter_list_classes   (path: *const GtkWidgetPath, pos: c_int) -> *mut glib_ffi::GSList;
    pub fn gtk_widget_path_iter_list_regions   (path: *const GtkWidgetPath, pos: c_int) -> *mut glib_ffi::GSList;
    ...
    pub fn gtk_about_dialog_get_logo           (about: *mut GtkAboutDialog) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gtk_about_dialog_set_logo           (about: *mut GtkAboutDialog, logo: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    pub fn gtk_accel_group_from_accel_closure  (closure: *mut gobject_ffi::GClosure) -> *mut GtkAccelGroup;
    pub fn gtk_accel_group_activate            (accel_group: *mut GtkAccelGroup, accel_quark: glib_ffi::GQuark, acceleratable: *mut gobject_ffi::GObject, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType) -> gboolean;
    pub fn gtk_accel_group_connect             (accel_group: *mut GtkAccelGroup, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType, accel_flags: GtkAccelFlags, closure: *mut gobject_ffi::GClosure);
    pub fn gtk_accel_group_connect_by_path     (accel_group: *mut GtkAccelGroup, accel_path: *const c_char, closure: *mut gobject_ffi::GClosure);
    pub fn gtk_accel_group_disconnect          (accel_group: *mut GtkAccelGroup, closure: *mut gobject_ffi::GClosure) -> gboolean;
    pub fn gtk_accel_group_disconnect_key      (accel_group: *mut GtkAccelGroup, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType) -> gboolean;
    ...
    pub fn gtk_accel_group_get_modifier_mask   (accel_group: *mut GtkAccelGroup) -> gdk_ffi::GdkModifierType;
    pub fn gtk_accel_group_lock                (accel_group: *mut GtkAccelGroup);
    pub fn gtk_accel_group_query               (accel_group: *mut GtkAccelGroup, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType, n_entries: *mut c_uint) -> *mut GtkAccelGroupEntry;
    ...
    #[cfg(gtk_3_12)]
    pub fn gtk_accel_label_get_accel           (accel_label: *mut GtkAccelLabel, accelerator_key: *mut c_uint, accelerator_mods: *mut gdk_ffi::GdkModifierType);
    ...
    #[cfg(gtk_3_6)]
    pub fn gtk_accel_label_set_accel           (accel_label: *mut GtkAccelLabel, accelerator_key: c_uint, accelerator_mods: gdk_ffi::GdkModifierType);
    pub fn gtk_accel_label_set_accel_closure   (accel_label: *mut GtkAccelLabel, accel_closure: *mut gobject_ffi::GClosure);
    ...
    pub fn gtk_accel_map_add_entry             (accel_path: *const c_char, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType);
    pub fn gtk_accel_map_add_filter            (filter_pattern: *const c_char);
    pub fn gtk_accel_map_change_entry          (accel_path: *const c_char, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType, replace: gboolean) -> gboolean;
    ...
    pub fn gtk_accel_map_load_scanner          (scanner: *mut glib_ffi::GScanner);
    ...
    pub fn gtk_action_get_accel_closure        (action: *mut GtkAction) -> *mut gobject_ffi::GClosure;
    ...
    pub fn gtk_action_get_gicon                (action: *mut GtkAction) -> *mut gio_ffi::GIcon;
    ...
    pub fn gtk_action_get_proxies              (action: *mut GtkAction) -> *mut glib_ffi::GSList;
    ...
    pub fn gtk_action_set_gicon                (action: *mut GtkAction, icon: *mut gio_ffi::GIcon);
    ...
    pub fn gtk_action_group_add_actions_full   (action_group: *mut GtkActionGroup, entries: *mut GtkActionEntry, n_entries: c_uint, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    pub fn gtk_action_group_add_radio_actions  (action_group: *mut GtkActionGroup, entries: *mut GtkRadioActionEntry, n_entries: c_uint, value: c_int, on_change: gobject_ffi::GCallback, user_data: gpointer);
    pub fn gtk_action_group_add_radio_actions_full(action_group: *mut GtkActionGroup, entries: *mut GtkRadioActionEntry, n_entries: c_uint, value: c_int, on_change: gobject_ffi::GCallback, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_action_group_add_toggle_actions_full(action_group: *mut GtkActionGroup, entries: *mut GtkToggleActionEntry, n_entries: c_uint, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    #[cfg(gtk_3_6)]
    ...
    pub fn gtk_action_group_list_actions       (action_group: *mut GtkActionGroup) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_action_group_set_translate_func (action_group: *mut GtkActionGroup, func: GtkTranslateFunc, data: gpointer, notify: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_app_chooser_button_append_custom_item(self_: *mut GtkAppChooserButton, name: *const c_char, label: *const c_char, icon: *mut gio_ffi::GIcon);
    ...
    pub fn gtk_app_chooser_dialog_new          (parent: *mut GtkWindow, flags: GtkDialogFlags, file: *mut gio_ffi::GFile) -> *mut GtkWidget;
    ...
    pub fn gtk_application_new                 (application_id: *const c_char, flags: gio_ffi::GApplicationFlags) -> *mut GtkApplication;
    #[cfg(gtk_3_4)]
    pub fn gtk_application_add_accelerator     (application: *mut GtkApplication, accelerator: *const c_char, action_name: *const c_char, parameter: *mut glib_ffi::GVariant);
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_application_get_app_menu        (application: *mut GtkApplication) -> *mut gio_ffi::GMenuModel;
    #[cfg(gtk_3_14)]
    pub fn gtk_application_get_menu_by_id      (application: *mut GtkApplication, id: *const c_char) -> *mut gio_ffi::GMenu;
    #[cfg(gtk_3_4)]
    pub fn gtk_application_get_menubar         (application: *mut GtkApplication) -> *mut gio_ffi::GMenuModel;
    #[cfg(gtk_3_6)]
    pub fn gtk_application_get_window_by_id    (application: *mut GtkApplication, id: c_uint) -> *mut GtkWindow;
    pub fn gtk_application_get_windows         (application: *mut GtkApplication) -> *mut glib_ffi::GList;
    #[cfg(gtk_3_4)]
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_application_remove_accelerator  (application: *mut GtkApplication, action_name: *const c_char, parameter: *mut glib_ffi::GVariant);
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_application_set_app_menu        (application: *mut GtkApplication, app_menu: *mut gio_ffi::GMenuModel);
    #[cfg(gtk_3_4)]
    pub fn gtk_application_set_menubar         (application: *mut GtkApplication, menubar: *mut gio_ffi::GMenuModel);
    #[cfg(gtk_3_4)]
    ...
    pub fn gtk_assistant_get_page_header_image (assistant: *mut GtkAssistant, page: *mut GtkWidget) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_assistant_get_page_side_image   (assistant: *mut GtkAssistant, page: *mut GtkWidget) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gtk_assistant_set_forward_page_func (assistant: *mut GtkAssistant, page_func: GtkAssistantPageFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    pub fn gtk_assistant_set_page_complete     (assistant: *mut GtkAssistant, page: *mut GtkWidget, complete: gboolean);
    pub fn gtk_assistant_set_page_header_image (assistant: *mut GtkAssistant, page: *mut GtkWidget, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    pub fn gtk_assistant_set_page_side_image   (assistant: *mut GtkAssistant, page: *mut GtkWidget, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_builder_add_callback_symbol     (builder: *mut GtkBuilder, callback_name: *const c_char, callback_symbol: gobject_ffi::GCallback);
    #[cfg(gtk_3_10)]
    pub fn gtk_builder_add_callback_symbols    (builder: *mut GtkBuilder, first_callback_name: *const c_char, first_callback_symbol: gobject_ffi::GCallback, ...);
    pub fn gtk_builder_add_from_file           (builder: *mut GtkBuilder, filename: *const c_char, error: *mut *mut glib_ffi::GError) -> c_uint;
    #[cfg(gtk_3_4)]
    pub fn gtk_builder_add_from_resource       (builder: *mut GtkBuilder, resource_path: *const c_char, error: *mut *mut glib_ffi::GError) -> c_uint;
    pub fn gtk_builder_add_from_string         (builder: *mut GtkBuilder, buffer: *const c_char, length: size_t, error: *mut *mut glib_ffi::GError) -> c_uint;
    pub fn gtk_builder_add_objects_from_file   (builder: *mut GtkBuilder, filename: *const c_char, object_ids: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> c_uint;
    #[cfg(gtk_3_4)]
    pub fn gtk_builder_add_objects_from_resource(builder: *mut GtkBuilder, resource_path: *const c_char, object_ids: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> c_uint;
    pub fn gtk_builder_add_objects_from_string (builder: *mut GtkBuilder, buffer: *const c_char, length: size_t, object_ids: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> c_uint;
    ...
    #[cfg(gtk_3_8)]
    pub fn gtk_builder_expose_object           (builder: *mut GtkBuilder, name: *const c_char, object: *mut gobject_ffi::GObject);
    #[cfg(gtk_3_10)]
    pub fn gtk_builder_get_application         (builder: *mut GtkBuilder) -> *mut GtkApplication;
    pub fn gtk_builder_get_object              (builder: *mut GtkBuilder, name: *const c_char) -> *mut gobject_ffi::GObject;
    pub fn gtk_builder_get_objects             (builder: *mut GtkBuilder) -> *mut glib_ffi::GSList;
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_builder_lookup_callback_symbol  (builder: *mut GtkBuilder, callback_name: *const c_char) -> gobject_ffi::GCallback;
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_builder_value_from_string       (builder: *mut GtkBuilder, pspec: *mut gobject_ffi::GParamSpec, string: *const c_char, value: *mut gobject_ffi::GValue, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_builder_value_from_string_type  (builder: *mut GtkBuilder, type_: GType, string: *const c_char, value: *mut gobject_ffi::GValue, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_button_get_event_window         (button: *mut GtkButton) -> *mut gdk_ffi::GdkWindow;
    ...
    pub fn gtk_calendar_set_detail_func        (calendar: *mut GtkCalendar, func: GtkCalendarDetailFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_cell_area_activate              (area: *mut GtkCellArea, context: *mut GtkCellAreaContext, widget: *mut GtkWidget, cell_area: *const gdk_ffi::GdkRectangle, flags: GtkCellRendererState, edit_only: gboolean) -> gboolean;
    pub fn gtk_cell_area_activate_cell         (area: *mut GtkCellArea, widget: *mut GtkWidget, renderer: *mut GtkCellRenderer, event: *mut gdk_ffi::GdkEvent, cell_area: *const gdk_ffi::GdkRectangle, flags: GtkCellRendererState) -> gboolean;
    ...
    pub fn gtk_cell_area_cell_get_property     (area: *mut GtkCellArea, renderer: *mut GtkCellRenderer, property_name: *const c_char, value: *mut gobject_ffi::GValue);
    ...
    pub fn gtk_cell_area_cell_set_property     (area: *mut GtkCellArea, renderer: *mut GtkCellRenderer, property_name: *const c_char, value: *const gobject_ffi::GValue);
    ...
    pub fn gtk_cell_area_event                 (area: *mut GtkCellArea, context: *mut GtkCellAreaContext, widget: *mut GtkWidget, event: *mut gdk_ffi::GdkEvent, cell_area: *const gdk_ffi::GdkRectangle, flags: GtkCellRendererState) -> c_int;
    ...
    pub fn gtk_cell_area_foreach_alloc         (area: *mut GtkCellArea, context: *mut GtkCellAreaContext, widget: *mut GtkWidget, cell_area: *const gdk_ffi::GdkRectangle, background_area: *const gdk_ffi::GdkRectangle, callback: GtkCellAllocCallback, callback_data: gpointer);
    pub fn gtk_cell_area_get_cell_allocation   (area: *mut GtkCellArea, context: *mut GtkCellAreaContext, widget: *mut GtkWidget, renderer: *mut GtkCellRenderer, cell_area: *const gdk_ffi::GdkRectangle, allocation: *mut gdk_ffi::GdkRectangle);
    pub fn gtk_cell_area_get_cell_at_position  (area: *mut GtkCellArea, context: *mut GtkCellAreaContext, widget: *mut GtkWidget, cell_area: *const gdk_ffi::GdkRectangle, x: c_int, y: c_int, alloc_area: *mut gdk_ffi::GdkRectangle) -> *mut GtkCellRenderer;
    ...
    pub fn gtk_cell_area_get_focus_siblings    (area: *mut GtkCellArea, renderer: *mut GtkCellRenderer) -> *const glib_ffi::GList;
    ...
    pub fn gtk_cell_area_inner_cell_area       (area: *mut GtkCellArea, widget: *mut GtkWidget, cell_area: *const gdk_ffi::GdkRectangle, inner_area: *mut gdk_ffi::GdkRectangle);
    ...
    pub fn gtk_cell_area_render                (area: *mut GtkCellArea, context: *mut GtkCellAreaContext, widget: *mut GtkWidget, cr: *mut cairo_ffi::cairo_t, background_area: *const gdk_ffi::GdkRectangle, cell_area: *const gdk_ffi::GdkRectangle, flags: GtkCellRendererState, paint_focus: gboolean);
    ...
    pub fn gtk_cell_renderer_activate          (cell: *mut GtkCellRenderer, event: *mut gdk_ffi::GdkEvent, widget: *mut GtkWidget, path: *const c_char, background_area: *const gdk_ffi::GdkRectangle, cell_area: *const gdk_ffi::GdkRectangle, flags: GtkCellRendererState) -> gboolean;
    pub fn gtk_cell_renderer_get_aligned_area  (cell: *mut GtkCellRenderer, widget: *mut GtkWidget, flags: GtkCellRendererState, cell_area: *const gdk_ffi::GdkRectangle, aligned_area: *mut gdk_ffi::GdkRectangle);
    ...
    pub fn gtk_cell_renderer_get_size          (cell: *mut GtkCellRenderer, widget: *mut GtkWidget, cell_area: *const gdk_ffi::GdkRectangle, x_offset: *mut c_int, y_offset: *mut c_int, width: *mut c_int, height: *mut c_int);
    ...
    pub fn gtk_cell_renderer_render            (cell: *mut GtkCellRenderer, cr: *mut cairo_ffi::cairo_t, widget: *mut GtkWidget, background_area: *const gdk_ffi::GdkRectangle, cell_area: *const gdk_ffi::GdkRectangle, flags: GtkCellRendererState);
    ...
    pub fn gtk_cell_renderer_start_editing     (cell: *mut GtkCellRenderer, event: *mut gdk_ffi::GdkEvent, widget: *mut GtkWidget, path: *const c_char, background_area: *const gdk_ffi::GdkRectangle, cell_area: *const gdk_ffi::GdkRectangle, flags: GtkCellRendererState) -> *mut GtkCellEditable;
    ...
    pub fn gtk_cell_view_new_with_pixbuf       (pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf) -> *mut GtkWidget;
    ...
    pub fn gtk_cell_view_set_background_color  (cell_view: *mut GtkCellView, color: *const gdk_ffi::GdkColor);
    pub fn gtk_cell_view_set_background_rgba   (cell_view: *mut GtkCellView, rgba: *const gdk_ffi::GdkRGBA);
    ...
    pub fn gtk_clipboard_get                   (selection: gdk_ffi::GdkAtom) -> *mut GtkClipboard;
    #[cfg(gtk_3_16)]
    pub fn gtk_clipboard_get_default           (display: *mut gdk_ffi::GdkDisplay) -> *mut GtkClipboard;
    pub fn gtk_clipboard_get_for_display       (display: *mut gdk_ffi::GdkDisplay, selection: gdk_ffi::GdkAtom) -> *mut GtkClipboard;
    pub fn gtk_clipboard_clear                 (clipboard: *mut GtkClipboard);
    pub fn gtk_clipboard_get_display           (clipboard: *mut GtkClipboard) -> *mut gdk_ffi::GdkDisplay;
    pub fn gtk_clipboard_get_owner             (clipboard: *mut GtkClipboard) -> *mut gobject_ffi::GObject;
    pub fn gtk_clipboard_request_contents      (clipboard: *mut GtkClipboard, target: gdk_ffi::GdkAtom, callback: GtkClipboardReceivedFunc, user_data: gpointer);
    ...
    pub fn gtk_clipboard_set_image             (clipboard: *mut GtkClipboard, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    pub fn gtk_clipboard_set_with_owner        (clipboard: *mut GtkClipboard, targets: *mut GtkTargetEntry, n_targets: c_uint, get_func: GtkClipboardGetFunc, clear_func: GtkClipboardClearFunc, owner: *mut gobject_ffi::GObject) -> gboolean;
    pub fn gtk_clipboard_store                 (clipboard: *mut GtkClipboard);
    pub fn gtk_clipboard_wait_for_contents     (clipboard: *mut GtkClipboard, target: gdk_ffi::GdkAtom) -> *mut GtkSelectionData;
    pub fn gtk_clipboard_wait_for_image        (clipboard: *mut GtkClipboard) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_clipboard_wait_for_rich_text    (clipboard: *mut GtkClipboard, buffer: *mut GtkTextBuffer, format: *mut gdk_ffi::GdkAtom, length: *mut size_t) -> *mut u8;
    pub fn gtk_clipboard_wait_for_targets      (clipboard: *mut GtkClipboard, targets: *mut *mut gdk_ffi::GdkAtom, n_targets: *mut c_int) -> gboolean;
    ...
    pub fn gtk_clipboard_wait_is_target_available(clipboard: *mut GtkClipboard, target: gdk_ffi::GdkAtom) -> gboolean;
    ...
    pub fn gtk_color_button_get_color          (button: *mut GtkColorButton, color: *mut gdk_ffi::GdkColor);
    pub fn gtk_color_button_get_rgba           (button: *mut GtkColorButton, rgba: *mut gdk_ffi::GdkRGBA);
    ...
    pub fn gtk_color_selection_palette_from_string(str: *const c_char, colors: *mut *mut gdk_ffi::GdkColor, n_colors: *mut c_int) -> gboolean;
    pub fn gtk_color_selection_palette_to_string(colors: *mut gdk_ffi::GdkColor, n_colors: c_int) -> *mut c_char;
    ...
    pub fn gtk_color_selection_get_current_color(colorsel: *mut GtkColorSelection, color: *mut gdk_ffi::GdkColor);
    pub fn gtk_color_selection_get_current_rgba(colorsel: *mut GtkColorSelection, rgba: *mut gdk_ffi::GdkRGBA);
    ...
    pub fn gtk_color_selection_get_previous_color(colorsel: *mut GtkColorSelection, color: *mut gdk_ffi::GdkColor);
    pub fn gtk_color_selection_get_previous_rgba(colorsel: *mut GtkColorSelection, rgba: *mut gdk_ffi::GdkRGBA);
    ...
    pub fn gtk_color_selection_set_current_color(colorsel: *mut GtkColorSelection, color: *const gdk_ffi::GdkColor);
    pub fn gtk_color_selection_set_current_rgba(colorsel: *mut GtkColorSelection, rgba: *const gdk_ffi::GdkRGBA);
    ...
    pub fn gtk_color_selection_set_previous_color(colorsel: *mut GtkColorSelection, color: *const gdk_ffi::GdkColor);
    pub fn gtk_color_selection_set_previous_rgba(colorsel: *mut GtkColorSelection, rgba: *const gdk_ffi::GdkRGBA);
    ...
    pub fn gtk_combo_box_get_popup_accessible  (combo_box: *mut GtkComboBox) -> *mut atk_ffi::AtkObject;
    ...
    pub fn gtk_combo_box_popup_for_device      (combo_box: *mut GtkComboBox, device: *mut gdk_ffi::GdkDevice);
    ...
    pub fn gtk_combo_box_set_row_separator_func(combo_box: *mut GtkComboBox, func: GtkTreeViewRowSeparatorFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_container_child_get_property    (container: *mut GtkContainer, child: *mut GtkWidget, property_name: *const c_char, value: *mut gobject_ffi::GValue);
    ...
    pub fn gtk_container_child_set_property    (container: *mut GtkContainer, child: *mut GtkWidget, property_name: *const c_char, value: *const gobject_ffi::GValue);
    ...
    pub fn gtk_container_get_children          (container: *mut GtkContainer) -> *mut glib_ffi::GList;
    pub fn gtk_container_get_focus_chain       (container: *mut GtkContainer, focusable_widgets: *mut *mut glib_ffi::GList) -> gboolean;
    ...
    pub fn gtk_container_propagate_draw        (container: *mut GtkContainer, child: *mut GtkWidget, cr: *mut cairo_ffi::cairo_t);
    ...
    pub fn gtk_container_set_focus_chain       (container: *mut GtkContainer, focusable_widgets: *mut glib_ffi::GList);
    ...
    pub fn gtk_container_cell_accessible_get_children(container: *mut GtkContainerCellAccessible) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_css_provider_load_from_data     (css_provider: *mut GtkCssProvider, data: *mut u8, length: ssize_t, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_css_provider_load_from_file     (css_provider: *mut GtkCssProvider, file: *mut gio_ffi::GFile, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_css_provider_load_from_path     (css_provider: *mut GtkCssProvider, path: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gtk_3_16)]
    ...
    #[cfg(gtk_3_6)]
    pub fn gtk_entry_get_attributes            (entry: *mut GtkEntry) -> *mut pango_ffi::PangoAttrList;
    ...
    pub fn gtk_entry_get_icon_area             (entry: *mut GtkEntry, icon_pos: GtkEntryIconPosition, icon_area: *mut gdk_ffi::GdkRectangle);
    pub fn gtk_entry_get_icon_at_pos           (entry: *mut GtkEntry, x: c_int, y: c_int) -> c_int;
    pub fn gtk_entry_get_icon_gicon            (entry: *mut GtkEntry, icon_pos: GtkEntryIconPosition) -> *mut gio_ffi::GIcon;
    pub fn gtk_entry_get_icon_name             (entry: *mut GtkEntry, icon_pos: GtkEntryIconPosition) -> *const c_char;
    pub fn gtk_entry_get_icon_pixbuf           (entry: *mut GtkEntry, icon_pos: GtkEntryIconPosition) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gtk_entry_get_layout                (entry: *mut GtkEntry) -> *mut pango_ffi::PangoLayout;
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_entry_get_tabs                  (entry: *mut GtkEntry) -> *mut pango_ffi::PangoTabArray;
    pub fn gtk_entry_get_text                  (entry: *mut GtkEntry) -> *const c_char;
    pub fn gtk_entry_get_text_area             (entry: *mut GtkEntry, text_area: *mut gdk_ffi::GdkRectangle);
    ...
    pub fn gtk_entry_im_context_filter_keypress(entry: *mut GtkEntry, event: *mut gdk_ffi::GdkEventKey) -> gboolean;
    ...
    #[cfg(gtk_3_6)]
    pub fn gtk_entry_set_attributes            (entry: *mut GtkEntry, attrs: *mut pango_ffi::PangoAttrList);
    ...
    pub fn gtk_entry_set_icon_drag_source      (entry: *mut GtkEntry, icon_pos: GtkEntryIconPosition, target_list: *mut GtkTargetList, actions: gdk_ffi::GdkDragAction);
    pub fn gtk_entry_set_icon_from_gicon       (entry: *mut GtkEntry, icon_pos: GtkEntryIconPosition, icon: *mut gio_ffi::GIcon);
    pub fn gtk_entry_set_icon_from_icon_name   (entry: *mut GtkEntry, icon_pos: GtkEntryIconPosition, icon_name: *const c_char);
    pub fn gtk_entry_set_icon_from_pixbuf      (entry: *mut GtkEntry, icon_pos: GtkEntryIconPosition, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_entry_set_tabs                  (entry: *mut GtkEntry, tabs: *mut pango_ffi::PangoTabArray);
    ...
    pub fn gtk_entry_completion_set_match_func (completion: *mut GtkEntryCompletion, func: GtkEntryCompletionMatchFunc, func_data: gpointer, func_notify: glib_ffi::GDestroyNotify);
    ...
    #[cfg(gtk_3_14)]
    pub fn gtk_event_controller_handle_event   (controller: *mut GtkEventController, event: *const gdk_ffi::GdkEvent) -> gboolean;
    #[cfg(gtk_3_14)]
    ...
    pub fn gtk_file_filter_add_custom          (filter: *mut GtkFileFilter, needed: GtkFileFilterFlags, func: GtkFileFilterFunc, data: gpointer, notify: glib_ffi::GDestroyNotify);
    ...
    #[cfg(gtk_3_12)]
    pub fn gtk_flow_box_get_selected_children  (box_: *mut GtkFlowBox) -> *mut glib_ffi::GList;
    #[cfg(gtk_3_12)]
    ...
    #[cfg(gtk_3_12)]
    pub fn gtk_flow_box_set_filter_func        (box_: *mut GtkFlowBox, filter_func: GtkFlowBoxFilterFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    #[cfg(gtk_3_12)]
    ...
    #[cfg(gtk_3_12)]
    pub fn gtk_flow_box_set_sort_func          (box_: *mut GtkFlowBox, sort_func: GtkFlowBoxSortFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    #[cfg(gtk_3_12)]
    ...
    pub fn gtk_font_selection_get_face         (fontsel: *mut GtkFontSelection) -> *mut pango_ffi::PangoFontFace;
    pub fn gtk_font_selection_get_face_list    (fontsel: *mut GtkFontSelection) -> *mut GtkWidget;
    pub fn gtk_font_selection_get_family       (fontsel: *mut GtkFontSelection) -> *mut pango_ffi::PangoFontFamily;
    ...
    #[cfg(gtk_3_16)]
    pub fn gtk_gl_area_get_context             (area: *mut GtkGLArea) -> *mut gdk_ffi::GdkGLContext;
    #[cfg(gtk_3_16)]
    pub fn gtk_gl_area_get_error               (area: *mut GtkGLArea) -> *mut glib_ffi::GError;
    #[cfg(gtk_3_16)]
    ...
    #[cfg(gtk_3_16)]
    pub fn gtk_gl_area_set_error               (area: *mut GtkGLArea, error: *const glib_ffi::GError);
    #[cfg(gtk_3_16)]
    ...
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_bounding_box        (gesture: *mut GtkGesture, rect: *mut gdk_ffi::GdkRectangle) -> gboolean;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_bounding_box_center (gesture: *mut GtkGesture, x: *mut c_double, y: *mut c_double) -> gboolean;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_device              (gesture: *mut GtkGesture) -> *mut gdk_ffi::GdkDevice;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_group               (gesture: *mut GtkGesture) -> *mut glib_ffi::GList;
    pub fn gtk_gesture_get_last_event          (gesture: *mut GtkGesture, sequence: *mut gdk_ffi::GdkEventSequence) -> *const gdk_ffi::GdkEvent;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_last_updated_sequence(gesture: *mut GtkGesture) -> *mut gdk_ffi::GdkEventSequence;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_point               (gesture: *mut GtkGesture, sequence: *mut gdk_ffi::GdkEventSequence, x: *mut c_double, y: *mut c_double) -> gboolean;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_sequence_state      (gesture: *mut GtkGesture, sequence: *mut gdk_ffi::GdkEventSequence) -> GtkEventSequenceState;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_sequences           (gesture: *mut GtkGesture) -> *mut glib_ffi::GList;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_get_window              (gesture: *mut GtkGesture) -> *mut gdk_ffi::GdkWindow;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_group                   (group_gesture: *mut GtkGesture, gesture: *mut GtkGesture);
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_handles_sequence        (gesture: *mut GtkGesture, sequence: *mut gdk_ffi::GdkEventSequence) -> gboolean;
    #[cfg(gtk_3_14)]
    ...
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_set_sequence_state      (gesture: *mut GtkGesture, sequence: *mut gdk_ffi::GdkEventSequence, state: GtkEventSequenceState) -> gboolean;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_set_state               (gesture: *mut GtkGesture, state: GtkEventSequenceState) -> gboolean;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_set_window              (gesture: *mut GtkGesture, window: *mut gdk_ffi::GdkWindow);
    #[cfg(gtk_3_14)]
    ...
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_multi_press_get_area    (gesture: *mut GtkGestureMultiPress, rect: *mut gdk_ffi::GdkRectangle) -> gboolean;
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_multi_press_set_area    (gesture: *mut GtkGestureMultiPress, rect: *const gdk_ffi::GdkRectangle);
    ...
    #[cfg(gtk_3_14)]
    pub fn gtk_gesture_single_get_current_sequence(gesture: *mut GtkGestureSingle) -> *mut gdk_ffi::GdkEventSequence;
    #[cfg(gtk_3_14)]
    ...
    pub fn gtk_im_context_filter_keypress      (context: *mut GtkIMContext, event: *mut gdk_ffi::GdkEventKey) -> gboolean;
    pub fn gtk_im_context_focus_in             (context: *mut GtkIMContext);
    pub fn gtk_im_context_focus_out            (context: *mut GtkIMContext);
    pub fn gtk_im_context_get_preedit_string   (context: *mut GtkIMContext, str: *mut *mut c_char, attrs: *mut *mut pango_ffi::PangoAttrList, cursor_pos: *mut c_int);
    ...
    pub fn gtk_im_context_set_client_window    (context: *mut GtkIMContext, window: *mut gdk_ffi::GdkWindow);
    pub fn gtk_im_context_set_cursor_location  (context: *mut GtkIMContext, area: *const gdk_ffi::GdkRectangle);
    ...
    pub fn gtk_icon_info_new_for_pixbuf        (icon_theme: *mut GtkIconTheme, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf) -> *mut GtkIconInfo;
    pub fn gtk_icon_info_copy                  (icon_info: *mut GtkIconInfo) -> *mut GtkIconInfo;
    pub fn gtk_icon_info_free                  (icon_info: *mut GtkIconInfo);
    pub fn gtk_icon_info_get_attach_points     (icon_info: *mut GtkIconInfo, points: *mut *mut gdk_ffi::GdkPoint, n_points: *mut c_int) -> gboolean;
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_icon_info_get_builtin_pixbuf    (icon_info: *mut GtkIconInfo) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_icon_info_get_display_name      (icon_info: *mut GtkIconInfo) -> *const c_char;
    pub fn gtk_icon_info_get_embedded_rect     (icon_info: *mut GtkIconInfo, rectangle: *mut gdk_ffi::GdkRectangle) -> gboolean;
    ...
    pub fn gtk_icon_info_load_icon             (icon_info: *mut GtkIconInfo, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gtk_3_8)]
    pub fn gtk_icon_info_load_icon_async       (icon_info: *mut GtkIconInfo, cancellable: *mut gio_ffi::GCancellable, callback: gio_ffi::GAsyncReadyCallback, user_data: gpointer);
    #[cfg(gtk_3_8)]
    pub fn gtk_icon_info_load_icon_finish      (icon_info: *mut GtkIconInfo, res: *mut gio_ffi::GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gtk_3_10)]
    pub fn gtk_icon_info_load_surface          (icon_info: *mut GtkIconInfo, for_window: *mut gdk_ffi::GdkWindow, error: *mut *mut glib_ffi::GError) -> *mut cairo_ffi::cairo_surface_t;
    pub fn gtk_icon_info_load_symbolic         (icon_info: *mut GtkIconInfo, fg: *const gdk_ffi::GdkRGBA, success_color: *const gdk_ffi::GdkRGBA, warning_color: *const gdk_ffi::GdkRGBA, error_color: *const gdk_ffi::GdkRGBA, was_symbolic: *mut gboolean, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gtk_3_8)]
    pub fn gtk_icon_info_load_symbolic_async   (icon_info: *mut GtkIconInfo, fg: *const gdk_ffi::GdkRGBA, success_color: *const gdk_ffi::GdkRGBA, warning_color: *const gdk_ffi::GdkRGBA, error_color: *const gdk_ffi::GdkRGBA, cancellable: *mut gio_ffi::GCancellable, callback: gio_ffi::GAsyncReadyCallback, user_data: gpointer);
    #[cfg(gtk_3_8)]
    pub fn gtk_icon_info_load_symbolic_finish  (icon_info: *mut GtkIconInfo, res: *mut gio_ffi::GAsyncResult, was_symbolic: *mut gboolean, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_icon_info_load_symbolic_for_context(icon_info: *mut GtkIconInfo, context: *mut GtkStyleContext, was_symbolic: *mut gboolean, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gtk_3_8)]
    pub fn gtk_icon_info_load_symbolic_for_context_async(icon_info: *mut GtkIconInfo, context: *mut GtkStyleContext, cancellable: *mut gio_ffi::GCancellable, callback: gio_ffi::GAsyncReadyCallback, user_data: gpointer);
    #[cfg(gtk_3_8)]
    pub fn gtk_icon_info_load_symbolic_for_context_finish(icon_info: *mut GtkIconInfo, res: *mut gio_ffi::GAsyncResult, was_symbolic: *mut gboolean, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_icon_info_load_symbolic_for_style(icon_info: *mut GtkIconInfo, style: *mut GtkStyle, state: GtkStateType, was_symbolic: *mut gboolean, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gtk_icon_theme_add_builtin_icon     (icon_name: *const c_char, size: c_int, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    pub fn gtk_icon_theme_get_default          () -> *mut GtkIconTheme;
    pub fn gtk_icon_theme_get_for_screen       (screen: *mut gdk_ffi::GdkScreen) -> *mut GtkIconTheme;
    #[cfg(gtk_3_14)]
    ...
    pub fn gtk_icon_theme_list_contexts        (icon_theme: *mut GtkIconTheme) -> *mut glib_ffi::GList;
    pub fn gtk_icon_theme_list_icons           (icon_theme: *mut GtkIconTheme, context: *const c_char) -> *mut glib_ffi::GList;
    pub fn gtk_icon_theme_load_icon            (icon_theme: *mut GtkIconTheme, icon_name: *const c_char, size: c_int, flags: GtkIconLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gtk_3_10)]
    pub fn gtk_icon_theme_load_icon_for_scale  (icon_theme: *mut GtkIconTheme, icon_name: *const c_char, size: c_int, scale: c_int, flags: GtkIconLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gtk_3_10)]
    pub fn gtk_icon_theme_load_surface         (icon_theme: *mut GtkIconTheme, icon_name: *const c_char, size: c_int, scale: c_int, for_window: *mut gdk_ffi::GdkWindow, flags: GtkIconLookupFlags, error: *mut *mut glib_ffi::GError) -> *mut cairo_ffi::cairo_surface_t;
    pub fn gtk_icon_theme_lookup_by_gicon      (icon_theme: *mut GtkIconTheme, icon: *mut gio_ffi::GIcon, size: c_int, flags: GtkIconLookupFlags) -> *mut GtkIconInfo;
    #[cfg(gtk_3_10)]
    pub fn gtk_icon_theme_lookup_by_gicon_for_scale(icon_theme: *mut GtkIconTheme, icon: *mut gio_ffi::GIcon, size: c_int, scale: c_int, flags: GtkIconLookupFlags) -> *mut GtkIconInfo;
    ...
    pub fn gtk_icon_theme_set_screen           (icon_theme: *mut GtkIconTheme, screen: *mut gdk_ffi::GdkScreen);
    ...
    pub fn gtk_icon_view_create_drag_icon      (icon_view: *mut GtkIconView, path: *mut GtkTreePath) -> *mut cairo_ffi::cairo_surface_t;
    pub fn gtk_icon_view_enable_model_drag_dest(icon_view: *mut GtkIconView, targets: *mut GtkTargetEntry, n_targets: c_int, actions: gdk_ffi::GdkDragAction);
    pub fn gtk_icon_view_enable_model_drag_source(icon_view: *mut GtkIconView, start_button_mask: gdk_ffi::GdkModifierType, targets: *mut GtkTargetEntry, n_targets: c_int, actions: gdk_ffi::GdkDragAction);
    #[cfg(gtk_3_8)]
    pub fn gtk_icon_view_get_activate_on_single_click(icon_view: *mut GtkIconView) -> gboolean;
    #[cfg(gtk_3_6)]
    pub fn gtk_icon_view_get_cell_rect         (icon_view: *mut GtkIconView, path: *mut GtkTreePath, cell: *mut GtkCellRenderer, rect: *mut gdk_ffi::GdkRectangle) -> gboolean;
    ...
    pub fn gtk_icon_view_get_selected_items    (icon_view: *mut GtkIconView) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_image_new_from_animation        (animation: *mut gdk_pixbuf_ffi::GdkPixbufAnimation) -> *mut GtkWidget;
    pub fn gtk_image_new_from_file             (filename: *mut c_char) -> *mut GtkWidget;
    pub fn gtk_image_new_from_gicon            (icon: *mut gio_ffi::GIcon, size: c_int) -> *mut GtkWidget;
    ...
    pub fn gtk_image_new_from_pixbuf           (pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf) -> *mut GtkWidget;
    #[cfg(gtk_3_4)]
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_image_new_from_surface          (surface: *mut cairo_ffi::cairo_surface_t) -> *mut GtkWidget;
    pub fn gtk_image_clear                     (image: *mut GtkImage);
    pub fn gtk_image_get_animation             (image: *mut GtkImage) -> *mut gdk_pixbuf_ffi::GdkPixbufAnimation;
    pub fn gtk_image_get_gicon                 (image: *mut GtkImage, gicon: *mut *mut gio_ffi::GIcon, size: *mut c_int);
    ...
    pub fn gtk_image_get_pixbuf                (image: *mut GtkImage) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gtk_image_set_from_animation        (image: *mut GtkImage, animation: *mut gdk_pixbuf_ffi::GdkPixbufAnimation);
    pub fn gtk_image_set_from_file             (image: *mut GtkImage, filename: *mut c_char);
    pub fn gtk_image_set_from_gicon            (image: *mut GtkImage, icon: *mut gio_ffi::GIcon, size: c_int);
    ...
    pub fn gtk_image_set_from_pixbuf           (image: *mut GtkImage, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_image_set_from_surface          (image: *mut GtkImage, surface: *mut cairo_ffi::cairo_surface_t);
    ...
    pub fn gtk_invisible_new_for_screen        (screen: *mut gdk_ffi::GdkScreen) -> *mut GtkWidget;
    pub fn gtk_invisible_get_screen            (invisible: *mut GtkInvisible) -> *mut gdk_ffi::GdkScreen;
    pub fn gtk_invisible_set_screen            (invisible: *mut GtkInvisible, screen: *mut gdk_ffi::GdkScreen);
    ...
    pub fn gtk_label_get_attributes            (label: *mut GtkLabel) -> *mut pango_ffi::PangoAttrList;
    pub fn gtk_label_get_current_uri           (label: *mut GtkLabel) -> *const c_char;
    pub fn gtk_label_get_ellipsize             (label: *mut GtkLabel) -> pango_ffi::PangoEllipsizeMode;
    ...
    pub fn gtk_label_get_layout                (label: *mut GtkLabel) -> *mut pango_ffi::PangoLayout;
    ...
    pub fn gtk_label_get_line_wrap_mode        (label: *mut GtkLabel) -> pango_ffi::PangoWrapMode;
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_label_set_attributes            (label: *mut GtkLabel, attrs: *mut pango_ffi::PangoAttrList);
    pub fn gtk_label_set_ellipsize             (label: *mut GtkLabel, mode: pango_ffi::PangoEllipsizeMode);
    ...
    pub fn gtk_label_set_line_wrap_mode        (label: *mut GtkLabel, wrap_mode: pango_ffi::PangoWrapMode);
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_layout_get_bin_window           (layout: *mut GtkLayout) -> *mut gdk_ffi::GdkWindow;
    ...
    #[cfg(gtk_3_16)]
    pub fn gtk_list_box_bind_model             (box_: *mut GtkListBox, model: *mut gio_ffi::GListModel, create_widget_func: GtkListBoxCreateWidgetFunc, user_data: gpointer, user_data_free_func: glib_ffi::GDestroyNotify);
    #[cfg(gtk_3_10)]
    ...
    #[cfg(gtk_3_14)]
    pub fn gtk_list_box_get_selected_rows      (box_: *mut GtkListBox) -> *mut glib_ffi::GList;
    #[cfg(gtk_3_10)]
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_list_box_set_filter_func        (box_: *mut GtkListBox, filter_func: GtkListBoxFilterFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    #[cfg(gtk_3_10)]
    pub fn gtk_list_box_set_header_func        (box_: *mut GtkListBox, update_header: GtkListBoxUpdateHeaderFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    #[cfg(gtk_3_10)]
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_list_box_set_sort_func          (box_: *mut GtkListBox, sort_func: GtkListBoxSortFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    #[cfg(gtk_3_14)]
    ...
    pub fn gtk_list_store_insert_with_valuesv  (list_store: *mut GtkListStore, iter: *mut GtkTreeIter, position: c_int, columns: *mut c_int, values: *mut gobject_ffi::GValue, n_values: c_int);
    ...
    pub fn gtk_list_store_set_value            (list_store: *mut GtkListStore, iter: *mut GtkTreeIter, column: c_int, value: *mut gobject_ffi::GValue);
    pub fn gtk_list_store_set_valuesv          (list_store: *mut GtkListStore, iter: *mut GtkTreeIter, columns: *mut c_int, values: *mut gobject_ffi::GValue, n_values: c_int);
    ...
    pub fn gtk_lock_button_new                 (permission: *mut gio_ffi::GPermission) -> *mut GtkWidget;
    pub fn gtk_lock_button_get_permission      (button: *mut GtkLockButton) -> *mut gio_ffi::GPermission;
    pub fn gtk_lock_button_set_permission      (button: *mut GtkLockButton, permission: *mut gio_ffi::GPermission);
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_menu_new_from_model             (model: *mut gio_ffi::GMenuModel) -> *mut GtkWidget;
    pub fn gtk_menu_get_for_attach_widget      (widget: *mut GtkWidget) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_menu_popup_for_device           (menu: *mut GtkMenu, device: *mut gdk_ffi::GdkDevice, parent_menu_shell: *mut GtkWidget, parent_menu_item: *mut GtkWidget, func: GtkMenuPositionFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify, button: c_uint, activate_time: u32);
    ...
    pub fn gtk_menu_set_screen                 (menu: *mut GtkMenu, screen: *mut gdk_ffi::GdkScreen);
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_menu_bar_new_from_model         (model: *mut gio_ffi::GMenuModel) -> *mut GtkWidget;
    ...
    #[cfg(gtk_3_6)]
    pub fn gtk_menu_button_get_menu_model      (menu_button: *mut GtkMenuButton) -> *mut gio_ffi::GMenuModel;
    #[cfg(gtk_3_12)]
    ...
    #[cfg(gtk_3_6)]
    pub fn gtk_menu_button_set_menu_model      (menu_button: *mut GtkMenuButton, menu_model: *mut gio_ffi::GMenuModel);
    #[cfg(gtk_3_12)]
    ...
    #[cfg(gtk_3_6)]
    pub fn gtk_menu_shell_bind_model           (menu_shell: *mut GtkMenuShell, model: *mut gio_ffi::GMenuModel, action_namespace: *const c_char, with_separators: gboolean);
    ...
    pub fn gtk_mount_operation_new             (parent: *mut GtkWindow) -> *mut gio_ffi::GMountOperation;
    pub fn gtk_mount_operation_get_parent      (op: *mut GtkMountOperation) -> *mut GtkWindow;
    pub fn gtk_mount_operation_get_screen      (op: *mut GtkMountOperation) -> *mut gdk_ffi::GdkScreen;
    ...
    pub fn gtk_mount_operation_set_screen      (op: *mut GtkMountOperation, screen: *mut gdk_ffi::GdkScreen);
    ...
    pub fn gtk_notebook_page_accessible_new    (notebook: *mut GtkNotebookAccessible, child: *mut GtkWidget) -> *mut atk_ffi::AtkObject;
    ...
    pub fn gtk_numerable_icon_new              (base_icon: *mut gio_ffi::GIcon) -> *mut gio_ffi::GIcon;
    pub fn gtk_numerable_icon_new_with_style_context(base_icon: *mut gio_ffi::GIcon, context: *mut GtkStyleContext) -> *mut gio_ffi::GIcon;
    pub fn gtk_numerable_icon_get_background_gicon(self_: *mut GtkNumerableIcon) -> *mut gio_ffi::GIcon;
    ...
    pub fn gtk_numerable_icon_set_background_gicon(self_: *mut GtkNumerableIcon, icon: *mut gio_ffi::GIcon);
    ...
    pub fn gtk_offscreen_window_get_pixbuf     (offscreen: *mut GtkOffscreenWindow) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_offscreen_window_get_surface    (offscreen: *mut GtkOffscreenWindow) -> *mut cairo_ffi::cairo_surface_t;
    ...
    pub fn gtk_page_setup_new_from_file        (file_name: *mut c_char, error: *mut *mut glib_ffi::GError) -> *mut GtkPageSetup;
    pub fn gtk_page_setup_new_from_key_file    (key_file: *mut glib_ffi::GKeyFile, group_name: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GtkPageSetup;
    ...
    pub fn gtk_page_setup_load_file            (setup: *mut GtkPageSetup, file_name: *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_page_setup_load_key_file        (setup: *mut GtkPageSetup, key_file: *mut glib_ffi::GKeyFile, group_name: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_page_setup_to_file              (setup: *mut GtkPageSetup, file_name: *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_page_setup_to_key_file          (setup: *mut GtkPageSetup, key_file: *mut glib_ffi::GKeyFile, group_name: *const c_char);
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_places_sidebar_add_shortcut     (sidebar: *mut GtkPlacesSidebar, location: *mut gio_ffi::GFile);
    #[cfg(gtk_3_12)]
    pub fn gtk_places_sidebar_get_local_only   (sidebar: *mut GtkPlacesSidebar) -> gboolean;
    #[cfg(gtk_3_10)]
    pub fn gtk_places_sidebar_get_location     (sidebar: *mut GtkPlacesSidebar) -> *mut gio_ffi::GFile;
    #[cfg(gtk_3_10)]
    pub fn gtk_places_sidebar_get_nth_bookmark (sidebar: *mut GtkPlacesSidebar, n: c_int) -> *mut gio_ffi::GFile;
    #[cfg(gtk_3_10)]
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_places_sidebar_list_shortcuts   (sidebar: *mut GtkPlacesSidebar) -> *mut glib_ffi::GSList;
    #[cfg(gtk_3_10)]
    pub fn gtk_places_sidebar_remove_shortcut  (sidebar: *mut GtkPlacesSidebar, location: *mut gio_ffi::GFile);
    #[cfg(gtk_3_12)]
    pub fn gtk_places_sidebar_set_local_only   (sidebar: *mut GtkPlacesSidebar, local_only: gboolean);
    #[cfg(gtk_3_10)]
    pub fn gtk_places_sidebar_set_location     (sidebar: *mut GtkPlacesSidebar, location: *mut gio_ffi::GFile);
    #[cfg(gtk_3_10)]
    ...
    //pub fn gtk_plug_new                        (socket_id: xlib_ffi::Window) -> *mut GtkWidget;
    //pub fn gtk_plug_new_for_display            (display: *mut gdk_ffi::GdkDisplay, socket_id: xlib_ffi::Window) -> *mut GtkWidget;
    //pub fn gtk_plug_construct                  (plug: *mut GtkPlug, socket_id: xlib_ffi::Window);
    //pub fn gtk_plug_construct_for_display      (plug: *mut GtkPlug, display: *mut gdk_ffi::GdkDisplay, socket_id: xlib_ffi::Window);
    pub fn gtk_plug_get_embedded               (plug: *mut GtkPlug) -> gboolean;
    //pub fn gtk_plug_get_id                     (plug: *mut GtkPlug) -> xlib_ffi::Window;
    pub fn gtk_plug_get_socket_window          (plug: *mut GtkPlug) -> *mut gdk_ffi::GdkWindow;
    ...
    #[cfg(gtk_3_12)]
    pub fn gtk_popover_new_from_model          (relative_to: *mut GtkWidget, model: *mut gio_ffi::GMenuModel) -> *mut GtkWidget;
    #[cfg(gtk_3_12)]
    pub fn gtk_popover_bind_model              (popover: *mut GtkPopover, model: *mut gio_ffi::GMenuModel, action_namespace: *const c_char);
    #[cfg(gtk_3_12)]
    pub fn gtk_popover_get_modal               (popover: *mut GtkPopover) -> gboolean;
    pub fn gtk_popover_get_pointing_to         (popover: *mut GtkPopover, rect: *mut gdk_ffi::GdkRectangle) -> gboolean;
    ...
    #[cfg(gtk_3_12)]
    pub fn gtk_popover_set_pointing_to         (popover: *mut GtkPopover, rect: *const gdk_ffi::GdkRectangle);
    #[cfg(gtk_3_12)]
    ...
    pub fn gtk_print_context_create_pango_context(context: *mut GtkPrintContext) -> *mut pango_ffi::PangoContext;
    pub fn gtk_print_context_create_pango_layout(context: *mut GtkPrintContext) -> *mut pango_ffi::PangoLayout;
    pub fn gtk_print_context_get_cairo_context (context: *mut GtkPrintContext) -> *mut cairo_ffi::cairo_t;
    ...
    pub fn gtk_print_context_get_pango_fontmap (context: *mut GtkPrintContext) -> *mut pango_ffi::PangoFontMap;
    pub fn gtk_print_context_get_width         (context: *mut GtkPrintContext) -> c_double;
    pub fn gtk_print_context_set_cairo_context (context: *mut GtkPrintContext, cr: *mut cairo_ffi::cairo_t, dpi_x: c_double, dpi_y: c_double);
    ...
    pub fn gtk_print_operation_get_error       (op: *mut GtkPrintOperation, error: *mut *mut glib_ffi::GError);
    ...
    pub fn gtk_print_operation_run             (op: *mut GtkPrintOperation, action: GtkPrintOperationAction, parent: *mut GtkWindow, error: *mut *mut glib_ffi::GError) -> GtkPrintOperationResult;
    ...
    pub fn gtk_print_settings_new_from_file    (file_name: *mut c_char, error: *mut *mut glib_ffi::GError) -> *mut GtkPrintSettings;
    pub fn gtk_print_settings_new_from_key_file(key_file: *mut glib_ffi::GKeyFile, group_name: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GtkPrintSettings;
    ...
    pub fn gtk_print_settings_load_file        (settings: *mut GtkPrintSettings, file_name: *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_print_settings_load_key_file    (settings: *mut GtkPrintSettings, key_file: *mut glib_ffi::GKeyFile, group_name: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_print_settings_to_file          (settings: *mut GtkPrintSettings, file_name: *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_print_settings_to_key_file      (settings: *mut GtkPrintSettings, key_file: *mut glib_ffi::GKeyFile, group_name: *const c_char);
    ...
    pub fn gtk_progress_bar_get_ellipsize      (pbar: *mut GtkProgressBar) -> pango_ffi::PangoEllipsizeMode;
    ...
    pub fn gtk_progress_bar_set_ellipsize      (pbar: *mut GtkProgressBar, mode: pango_ffi::PangoEllipsizeMode);
    ...
    pub fn gtk_radio_action_get_group          (action: *mut GtkRadioAction) -> *mut glib_ffi::GSList;
    ...
    pub fn gtk_radio_action_set_group          (action: *mut GtkRadioAction, group: *mut glib_ffi::GSList);

    //=========================================================================
    // GtkRadioButton
    //=========================================================================
    pub fn gtk_radio_button_get_type           () -> GType;
    pub fn gtk_radio_button_new                (group: *mut glib_ffi::GSList) -> *mut GtkWidget;
    pub fn gtk_radio_button_new_from_widget    (radio_group_member: *mut GtkRadioButton) -> *mut GtkWidget;
    pub fn gtk_radio_button_new_with_label     (group: *mut glib_ffi::GSList, label: *const c_char) -> *mut GtkWidget;
    ...
    pub fn gtk_radio_button_new_with_mnemonic  (group: *mut glib_ffi::GSList, label: *const c_char) -> *mut GtkWidget;
    ...
    pub fn gtk_radio_button_get_group          (radio_button: *mut GtkRadioButton) -> *mut glib_ffi::GSList;
    pub fn gtk_radio_button_join_group         (radio_button: *mut GtkRadioButton, group_source: *mut GtkRadioButton);
    pub fn gtk_radio_button_set_group          (radio_button: *mut GtkRadioButton, group: *mut glib_ffi::GSList);
    ...
    pub fn gtk_radio_menu_item_new             (group: *mut glib_ffi::GSList) -> *mut GtkWidget;
    pub fn gtk_radio_menu_item_new_from_widget (group: *mut GtkRadioMenuItem) -> *mut GtkWidget;
    pub fn gtk_radio_menu_item_new_with_label  (group: *mut glib_ffi::GSList, label: *const c_char) -> *mut GtkWidget;
    pub fn gtk_radio_menu_item_new_with_label_from_widget(group: *mut GtkRadioMenuItem, label: *const c_char) -> *mut GtkWidget;
    pub fn gtk_radio_menu_item_new_with_mnemonic(group: *mut glib_ffi::GSList, label: *const c_char) -> *mut GtkWidget;
    pub fn gtk_radio_menu_item_new_with_mnemonic_from_widget(group: *mut GtkRadioMenuItem, label: *const c_char) -> *mut GtkWidget;
    pub fn gtk_radio_menu_item_get_group       (radio_menu_item: *mut GtkRadioMenuItem) -> *mut glib_ffi::GSList;
    pub fn gtk_radio_menu_item_set_group       (radio_menu_item: *mut GtkRadioMenuItem, group: *mut glib_ffi::GSList);
    ...
    pub fn gtk_radio_tool_button_new           (group: *mut glib_ffi::GSList) -> *mut GtkToolItem;
    pub fn gtk_radio_tool_button_new_from_stock(group: *mut glib_ffi::GSList, stock_id: *const c_char) -> *mut GtkToolItem;
    ...
    pub fn gtk_radio_tool_button_get_group     (button: *mut GtkRadioToolButton) -> *mut glib_ffi::GSList;
    pub fn gtk_radio_tool_button_set_group     (button: *mut GtkRadioToolButton, group: *mut glib_ffi::GSList);
    ...
    pub fn gtk_range_get_range_rect            (range: *mut GtkRange, range_rect: *mut gdk_ffi::GdkRectangle);
    ...
    pub fn gtk_recent_filter_add_custom        (filter: *mut GtkRecentFilter, needed: GtkRecentFilterFlags, func: GtkRecentFilterFunc, data: gpointer, data_destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_recent_manager_get_items        (manager: *mut GtkRecentManager) -> *mut glib_ffi::GList;
    pub fn gtk_recent_manager_has_item         (manager: *mut GtkRecentManager, uri: *const c_char) -> gboolean;
    pub fn gtk_recent_manager_lookup_item      (manager: *mut GtkRecentManager, uri: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GtkRecentInfo;
    pub fn gtk_recent_manager_move_item        (manager: *mut GtkRecentManager, uri: *const c_char, new_uri: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_recent_manager_purge_items      (manager: *mut GtkRecentManager, error: *mut *mut glib_ffi::GError) -> c_int;
    pub fn gtk_recent_manager_remove_item      (manager: *mut GtkRecentManager, uri: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;

    //=========================================================================
    // GtkRendererCellAccessible
    //=========================================================================
    pub fn gtk_renderer_cell_accessible_get_type() -> GType;
    pub fn gtk_renderer_cell_accessible_new    (renderer: *mut GtkCellRenderer) -> *mut atk_ffi::AtkObject;
    ...
    pub fn gtk_scale_get_layout                (scale: *mut GtkScale) -> *mut pango_ffi::PangoLayout;
    ...
    #[cfg(gtk_3_10)]
    pub fn gtk_search_bar_handle_event         (bar: *mut GtkSearchBar, event: *mut gdk_ffi::GdkEvent) -> gboolean;
    #[cfg(gtk_3_10)]
    ...
    #[cfg(gtk_3_16)]
    pub fn gtk_search_entry_handle_event       (entry: *mut GtkSearchEntry, event: *mut gdk_ffi::GdkEvent) -> gboolean;
    ...
    pub fn gtk_settings_get_for_screen         (screen: *mut gdk_ffi::GdkScreen) -> *mut GtkSettings;
    pub fn gtk_settings_install_property       (pspec: *mut gobject_ffi::GParamSpec);
    pub fn gtk_settings_install_property_parser(pspec: *mut gobject_ffi::GParamSpec, parser: GtkRcPropertyParser);
    ...
    pub fn gtk_size_group_get_widgets          (size_group: *mut GtkSizeGroup) -> *mut glib_ffi::GSList;
    ...
    //pub fn gtk_socket_add_id                   (socket_: *mut GtkSocket, window: xlib_ffi::Window);
    //pub fn gtk_socket_get_id                   (socket_: *mut GtkSocket) -> xlib_ffi::Window;
    pub fn gtk_socket_get_plug_window          (socket_: *mut GtkSocket) -> *mut gdk_ffi::GdkWindow;
    ...
    pub fn gtk_status_icon_new_from_gicon      (icon: *mut gio_ffi::GIcon) -> *mut GtkStatusIcon;
    pub fn gtk_status_icon_new_from_icon_name  (icon_name: *const c_char) -> *mut GtkStatusIcon;
    pub fn gtk_status_icon_new_from_pixbuf     (pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf) -> *mut GtkStatusIcon;
    ...
    pub fn gtk_status_icon_get_geometry        (status_icon: *mut GtkStatusIcon, screen: *mut *mut gdk_ffi::GdkScreen, area: *mut gdk_ffi::GdkRectangle, orientation: *mut GtkOrientation) -> gboolean;
    pub fn gtk_status_icon_get_gicon           (status_icon: *mut GtkStatusIcon) -> *mut gio_ffi::GIcon;
    ...
    pub fn gtk_status_icon_get_pixbuf          (status_icon: *mut GtkStatusIcon) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_status_icon_get_screen          (status_icon: *mut GtkStatusIcon) -> *mut gdk_ffi::GdkScreen;
    ...
    pub fn gtk_status_icon_set_from_gicon      (status_icon: *mut GtkStatusIcon, icon: *mut gio_ffi::GIcon);
    pub fn gtk_status_icon_set_from_icon_name  (status_icon: *mut GtkStatusIcon, icon_name: *const c_char);
    pub fn gtk_status_icon_set_from_pixbuf     (status_icon: *mut GtkStatusIcon, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    pub fn gtk_status_icon_set_screen          (status_icon: *mut GtkStatusIcon, screen: *mut gdk_ffi::GdkScreen);
    ...
    pub fn gtk_style_apply_default_background  (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, window: *mut gdk_ffi::GdkWindow, state_type: GtkStateType, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_style_attach                    (style: *mut GtkStyle, window: *mut gdk_ffi::GdkWindow) -> *mut GtkStyle;
    ...
    pub fn gtk_style_get_style_property        (style: *mut GtkStyle, widget_type: GType, property_name: *const c_char, value: *mut gobject_ffi::GValue);
    ...
    pub fn gtk_style_lookup_color              (style: *mut GtkStyle, color_name: *const c_char, color: *mut gdk_ffi::GdkColor) -> gboolean;
    pub fn gtk_style_lookup_icon_set           (style: *mut GtkStyle, stock_id: *const c_char) -> *mut GtkIconSet;
    pub fn gtk_style_render_icon               (style: *mut GtkStyle, source: *const GtkIconSource, direction: GtkTextDirection, state: GtkStateType, size: c_int, widget: *mut GtkWidget, detail: *const c_char) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_style_set_background            (style: *mut GtkStyle, window: *mut gdk_ffi::GdkWindow, state_type: GtkStateType);
    ...
    pub fn gtk_style_context_add_provider_for_screen(screen: *mut gdk_ffi::GdkScreen, provider: *mut GtkStyleProvider, priority: c_uint);
    pub fn gtk_style_context_remove_provider_for_screen(screen: *mut gdk_ffi::GdkScreen, provider: *mut GtkStyleProvider);
    pub fn gtk_style_context_reset_widgets     (screen: *mut gdk_ffi::GdkScreen);
    ...
    pub fn gtk_style_context_get_background_color(context: *mut GtkStyleContext, state: GtkStateFlags, color: *mut gdk_ffi::GdkRGBA);
    pub fn gtk_style_context_get_border        (context: *mut GtkStyleContext, state: GtkStateFlags, border: *mut GtkBorder);
    pub fn gtk_style_context_get_border_color  (context: *mut GtkStyleContext, state: GtkStateFlags, color: *mut gdk_ffi::GdkRGBA);
    pub fn gtk_style_context_get_color         (context: *mut GtkStyleContext, state: GtkStateFlags, color: *mut gdk_ffi::GdkRGBA);
    pub fn gtk_style_context_get_direction     (context: *mut GtkStyleContext) -> GtkTextDirection;
    pub fn gtk_style_context_get_font          (context: *mut GtkStyleContext, state: GtkStateFlags) -> *const pango_ffi::PangoFontDescription;
    #[cfg(gtk_3_8)]
    pub fn gtk_style_context_get_frame_clock   (context: *mut GtkStyleContext) -> *mut gdk_ffi::GdkFrameClock;
    ...
    pub fn gtk_style_context_get_property      (context: *mut GtkStyleContext, property: *const c_char, state: GtkStateFlags, value: *mut gobject_ffi::GValue);
    #[cfg(gtk_3_10)]
    pub fn gtk_style_context_get_scale         (context: *mut GtkStyleContext) -> c_int;
    pub fn gtk_style_context_get_screen        (context: *mut GtkStyleContext) -> *mut gdk_ffi::GdkScreen;
    ...
    pub fn gtk_style_context_get_style_property(context: *mut GtkStyleContext, property_name: *const c_char, value: *mut gobject_ffi::GValue);
    ...
    pub fn gtk_style_context_list_classes      (context: *mut GtkStyleContext) -> *mut glib_ffi::GList;
    pub fn gtk_style_context_list_regions      (context: *mut GtkStyleContext) -> *mut glib_ffi::GList;
    pub fn gtk_style_context_lookup_color      (context: *mut GtkStyleContext, color_name: *const c_char, color: *mut gdk_ffi::GdkRGBA) -> gboolean;
    pub fn gtk_style_context_lookup_icon_set   (context: *mut GtkStyleContext, stock_id: *const c_char) -> *mut GtkIconSet;
    pub fn gtk_style_context_notify_state_change(context: *mut GtkStyleContext, window: *mut gdk_ffi::GdkWindow, region_id: gpointer, state: GtkStateType, state_value: gboolean);
    ...
    pub fn gtk_style_context_scroll_animations (context: *mut GtkStyleContext, window: *mut gdk_ffi::GdkWindow, dx: c_int, dy: c_int);
    pub fn gtk_style_context_set_background    (context: *mut GtkStyleContext, window: *mut gdk_ffi::GdkWindow);
    pub fn gtk_style_context_set_direction     (context: *mut GtkStyleContext, direction: GtkTextDirection);
    #[cfg(gtk_3_8)]
    pub fn gtk_style_context_set_frame_clock   (context: *mut GtkStyleContext, frame_clock: *mut gdk_ffi::GdkFrameClock);
    ...
    pub fn gtk_style_context_set_screen        (context: *mut GtkStyleContext, screen: *mut gdk_ffi::GdkScreen);
    ...
    pub fn gtk_style_properties_lookup_property(property_name: *const c_char, parse_func: *mut GtkStylePropertyParser, pspec: *mut *mut gobject_ffi::GParamSpec) -> gboolean;
    pub fn gtk_style_properties_register_property(parse_func: GtkStylePropertyParser, pspec: *mut gobject_ffi::GParamSpec);
    ...
    pub fn gtk_style_properties_get_property   (props: *mut GtkStyleProperties, property: *const c_char, state: GtkStateFlags, value: *mut gobject_ffi::GValue) -> gboolean;
    ...
    pub fn gtk_style_properties_set_property   (props: *mut GtkStyleProperties, property: *const c_char, state: GtkStateFlags, value: *const gobject_ffi::GValue);
    ...
    pub fn gtk_text_buffer_deserialize         (register_buffer: *mut GtkTextBuffer, content_buffer: *mut GtkTextBuffer, format: gdk_ffi::GdkAtom, iter: *mut GtkTextIter, data: *mut u8, length: size_t, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_text_buffer_deserialize_get_can_create_tags(buffer: *mut GtkTextBuffer, format: gdk_ffi::GdkAtom) -> gboolean;
    pub fn gtk_text_buffer_deserialize_set_can_create_tags(buffer: *mut GtkTextBuffer, format: gdk_ffi::GdkAtom, can_create_tags: gboolean);
    ...
    pub fn gtk_text_buffer_get_deserialize_formats(buffer: *mut GtkTextBuffer, n_formats: *mut c_int) -> *mut gdk_ffi::GdkAtom;
    ...
    pub fn gtk_text_buffer_get_serialize_formats(buffer: *mut GtkTextBuffer, n_formats: *mut c_int) -> *mut gdk_ffi::GdkAtom;
    ...
    pub fn gtk_text_buffer_insert_pixbuf       (buffer: *mut GtkTextBuffer, iter: *mut GtkTextIter, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    pub fn gtk_text_buffer_register_deserialize_format(buffer: *mut GtkTextBuffer, mime_type: *const c_char, function: GtkTextBufferDeserializeFunc, user_data: gpointer, user_data_destroy: glib_ffi::GDestroyNotify) -> gdk_ffi::GdkAtom;
    pub fn gtk_text_buffer_register_deserialize_tagset(buffer: *mut GtkTextBuffer, tagset_name: *const c_char) -> gdk_ffi::GdkAtom;
    pub fn gtk_text_buffer_register_serialize_format(buffer: *mut GtkTextBuffer, mime_type: *const c_char, function: GtkTextBufferSerializeFunc, user_data: gpointer, user_data_destroy: glib_ffi::GDestroyNotify) -> gdk_ffi::GdkAtom;
    pub fn gtk_text_buffer_register_serialize_tagset(buffer: *mut GtkTextBuffer, tagset_name: *const c_char) -> gdk_ffi::GdkAtom;
    ...
    pub fn gtk_text_buffer_serialize           (register_buffer: *mut GtkTextBuffer, content_buffer: *mut GtkTextBuffer, format: gdk_ffi::GdkAtom, start: *const GtkTextIter, end: *const GtkTextIter, length: *mut size_t) -> *mut u8;
    ...
    pub fn gtk_text_buffer_unregister_deserialize_format(buffer: *mut GtkTextBuffer, format: gdk_ffi::GdkAtom);
    pub fn gtk_text_buffer_unregister_serialize_format(buffer: *mut GtkTextBuffer, format: gdk_ffi::GdkAtom);
    ...
    pub fn gtk_text_child_anchor_get_widgets   (anchor: *mut GtkTextChildAnchor) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_text_tag_event                  (tag: *mut GtkTextTag, event_object: *mut gobject_ffi::GObject, event: *mut gdk_ffi::GdkEvent, iter: *const GtkTextIter) -> gboolean;
    ...
    pub fn gtk_text_view_get_cursor_locations  (text_view: *mut GtkTextView, iter: *const GtkTextIter, strong: *mut gdk_ffi::GdkRectangle, weak: *mut gdk_ffi::GdkRectangle);
    ...
    pub fn gtk_text_view_get_iter_location     (text_view: *mut GtkTextView, iter: *const GtkTextIter, location: *mut gdk_ffi::GdkRectangle);
    ...
    pub fn gtk_text_view_get_tabs              (text_view: *mut GtkTextView) -> *mut pango_ffi::PangoTabArray;
    pub fn gtk_text_view_get_vadjustment       (text_view: *mut GtkTextView) -> *mut GtkAdjustment;
    pub fn gtk_text_view_get_visible_rect      (text_view: *mut GtkTextView, visible_rect: *mut gdk_ffi::GdkRectangle);
    pub fn gtk_text_view_get_window            (text_view: *mut GtkTextView, win: GtkTextWindowType) -> *mut gdk_ffi::GdkWindow;
    pub fn gtk_text_view_get_window_type       (text_view: *mut GtkTextView, window: *mut gdk_ffi::GdkWindow) -> GtkTextWindowType;
    pub fn gtk_text_view_get_wrap_mode         (text_view: *mut GtkTextView) -> GtkWrapMode;
    pub fn gtk_text_view_im_context_filter_keypress(text_view: *mut GtkTextView, event: *mut gdk_ffi::GdkEventKey) -> gboolean;
    ...
    pub fn gtk_text_view_set_tabs              (text_view: *mut GtkTextView, tabs: *mut pango_ffi::PangoTabArray);
    ...
    pub fn gtk_theming_engine_register_property(name_space: *const c_char, parse_func: GtkStylePropertyParser, pspec: *mut gobject_ffi::GParamSpec);
    pub fn gtk_theming_engine_get              (engine: *mut GtkThemingEngine, state: GtkStateFlags, ...);
    pub fn gtk_theming_engine_get_background_color(engine: *mut GtkThemingEngine, state: GtkStateFlags, color: *mut gdk_ffi::GdkRGBA);
    pub fn gtk_theming_engine_get_border       (engine: *mut GtkThemingEngine, state: GtkStateFlags, border: *mut GtkBorder);
    pub fn gtk_theming_engine_get_border_color (engine: *mut GtkThemingEngine, state: GtkStateFlags, color: *mut gdk_ffi::GdkRGBA);
    pub fn gtk_theming_engine_get_color        (engine: *mut GtkThemingEngine, state: GtkStateFlags, color: *mut gdk_ffi::GdkRGBA);
    pub fn gtk_theming_engine_get_direction    (engine: *mut GtkThemingEngine) -> GtkTextDirection;
    pub fn gtk_theming_engine_get_font         (engine: *mut GtkThemingEngine, state: GtkStateFlags) -> *const pango_ffi::PangoFontDescription;
    ...
    pub fn gtk_theming_engine_get_property     (engine: *mut GtkThemingEngine, property: *const c_char, state: GtkStateFlags, value: *mut gobject_ffi::GValue);
    pub fn gtk_theming_engine_get_screen       (engine: *mut GtkThemingEngine) -> *mut gdk_ffi::GdkScreen;
    ...
    pub fn gtk_theming_engine_get_style_property(engine: *mut GtkThemingEngine, property_name: *const c_char, value: *mut gobject_ffi::GValue);
    ...
    pub fn gtk_theming_engine_lookup_color     (engine: *mut GtkThemingEngine, color_name: *const c_char, color: *mut gdk_ffi::GdkRGBA) -> gboolean;
    ...
    pub fn gtk_tool_item_get_ellipsize_mode    (tool_item: *mut GtkToolItem) -> pango_ffi::PangoEllipsizeMode;
    ...
    pub fn gtk_tool_item_group_get_ellipsize   (group: *mut GtkToolItemGroup) -> pango_ffi::PangoEllipsizeMode;
    ...
    pub fn gtk_tool_item_group_set_ellipsize   (group: *mut GtkToolItemGroup, ellipsize: pango_ffi::PangoEllipsizeMode);
    ...
    pub fn gtk_tool_palette_add_drag_dest      (palette: *mut GtkToolPalette, widget: *mut GtkWidget, flags: GtkDestDefaults, targets: GtkToolPaletteDragTargets, actions: gdk_ffi::GdkDragAction);
    ...
    pub fn gtk_tooltip_trigger_tooltip_query   (display: *mut gdk_ffi::GdkDisplay);
    pub fn gtk_tooltip_set_custom              (tooltip: *mut GtkTooltip, custom_widget: *mut GtkWidget);
    pub fn gtk_tooltip_set_icon                (tooltip: *mut GtkTooltip, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    pub fn gtk_tooltip_set_icon_from_gicon     (tooltip: *mut GtkTooltip, gicon: *mut gio_ffi::GIcon, size: c_int);
    ...
    pub fn gtk_tooltip_set_tip_area            (tooltip: *mut GtkTooltip, rect: *const gdk_ffi::GdkRectangle);

    //=========================================================================
    // GtkToplevelAccessible
    //=========================================================================
    pub fn gtk_toplevel_accessible_get_type    () -> GType;
    pub fn gtk_toplevel_accessible_get_children(accessible: *mut GtkToplevelAccessible) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_tree_model_filter_set_modify_func(filter: *mut GtkTreeModelFilter, n_columns: c_int, types: *mut GType, func: GtkTreeModelFilterModifyFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    pub fn gtk_tree_model_filter_set_visible_column(filter: *mut GtkTreeModelFilter, column: c_int);
    pub fn gtk_tree_model_filter_set_visible_func(filter: *mut GtkTreeModelFilter, func: GtkTreeModelFilterVisibleFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_tree_selection_get_selected_rows(selection: *mut GtkTreeSelection, model: *mut *mut GtkTreeModel) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_tree_selection_set_select_function(selection: *mut GtkTreeSelection, func: GtkTreeSelectionFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_tree_store_insert_with_valuesv  (tree_store: *mut GtkTreeStore, iter: *mut GtkTreeIter, parent: *mut GtkTreeIter, position: c_int, columns: *mut c_int, values: *mut gobject_ffi::GValue, n_values: c_int);
    ...
    pub fn gtk_tree_store_set_value            (tree_store: *mut GtkTreeStore, iter: *mut GtkTreeIter, column: c_int, value: *mut gobject_ffi::GValue);
    pub fn gtk_tree_store_set_valuesv          (tree_store: *mut GtkTreeStore, iter: *mut GtkTreeIter, columns: *mut c_int, values: *mut gobject_ffi::GValue, n_values: c_int);
    ...
    pub fn gtk_tree_view_create_row_drag_icon  (tree_view: *mut GtkTreeView, path: *mut GtkTreePath) -> *mut cairo_ffi::cairo_surface_t;
    pub fn gtk_tree_view_enable_model_drag_dest(tree_view: *mut GtkTreeView, targets: *mut GtkTargetEntry, n_targets: c_int, actions: gdk_ffi::GdkDragAction);
    pub fn gtk_tree_view_enable_model_drag_source(tree_view: *mut GtkTreeView, start_button_mask: gdk_ffi::GdkModifierType, targets: *mut GtkTargetEntry, n_targets: c_int, actions: gdk_ffi::GdkDragAction);
    ...
    pub fn gtk_tree_view_get_background_area   (tree_view: *mut GtkTreeView, path: *mut GtkTreePath, column: *mut GtkTreeViewColumn, rect: *mut gdk_ffi::GdkRectangle);
    pub fn gtk_tree_view_get_bin_window        (tree_view: *mut GtkTreeView) -> *mut gdk_ffi::GdkWindow;
    pub fn gtk_tree_view_get_cell_area         (tree_view: *mut GtkTreeView, path: *mut GtkTreePath, column: *mut GtkTreeViewColumn, rect: *mut gdk_ffi::GdkRectangle);
    pub fn gtk_tree_view_get_column            (tree_view: *mut GtkTreeView, n: c_int) -> *mut GtkTreeViewColumn;
    pub fn gtk_tree_view_get_columns           (tree_view: *mut GtkTreeView) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_tree_view_get_visible_rect      (tree_view: *mut GtkTreeView, visible_rect: *mut gdk_ffi::GdkRectangle);
    ...
    pub fn gtk_tree_view_insert_column_with_data_func(tree_view: *mut GtkTreeView, position: c_int, title: *const c_char, cell: *mut GtkCellRenderer, func: GtkTreeCellDataFunc, data: gpointer, dnotify: glib_ffi::GDestroyNotify) -> c_int;
    ...
    pub fn gtk_tree_view_set_column_drag_function(tree_view: *mut GtkTreeView, func: GtkTreeViewColumnDropFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_tree_view_set_destroy_count_func(tree_view: *mut GtkTreeView, func: GtkTreeDestroyCountFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_tree_view_set_row_separator_func(tree_view: *mut GtkTreeView, func: GtkTreeViewRowSeparatorFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_tree_view_set_search_equal_func (tree_view: *mut GtkTreeView, search_equal_func: GtkTreeViewSearchEqualFunc, search_user_data: gpointer, search_destroy: glib_ffi::GDestroyNotify);
    pub fn gtk_tree_view_set_search_position_func(tree_view: *mut GtkTreeView, func: GtkTreeViewSearchPositionFunc, data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_tree_view_column_cell_get_size  (tree_column: *mut GtkTreeViewColumn, cell_area: *const gdk_ffi::GdkRectangle, x_offset: *mut c_int, y_offset: *mut c_int, width: *mut c_int, height: *mut c_int);
    ...
    pub fn gtk_tree_view_column_set_cell_data_func(tree_column: *mut GtkTreeViewColumn, cell_renderer: *mut GtkCellRenderer, func: GtkTreeCellDataFunc, func_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_ui_manager_add_ui_from_file     (manager: *mut GtkUIManager, filename: *mut c_char, error: *mut *mut glib_ffi::GError) -> c_uint;
    #[cfg(gtk_3_4)]
    pub fn gtk_ui_manager_add_ui_from_resource (manager: *mut GtkUIManager, resource_path: *const c_char, error: *mut *mut glib_ffi::GError) -> c_uint;
    pub fn gtk_ui_manager_add_ui_from_string   (manager: *mut GtkUIManager, buffer: *const c_char, length: ssize_t, error: *mut *mut glib_ffi::GError) -> c_uint;
    ...
    pub fn gtk_ui_manager_get_action_groups    (manager: *mut GtkUIManager) -> *mut glib_ffi::GList;
    pub fn gtk_ui_manager_get_add_tearoffs     (manager: *mut GtkUIManager) -> gboolean;
    pub fn gtk_ui_manager_get_toplevels        (manager: *mut GtkUIManager, types: GtkUIManagerItemType) -> *mut glib_ffi::GSList;
    ...
    pub fn gtk_viewport_get_bin_window         (viewport: *mut GtkViewport) -> *mut gdk_ffi::GdkWindow;
    ...
    pub fn gtk_viewport_get_view_window        (viewport: *mut GtkViewport) -> *mut gdk_ffi::GdkWindow;
    ...
    pub fn gtk_widget_add_accelerator          (widget: *mut GtkWidget, accel_signal: *const c_char, accel_group: *mut GtkAccelGroup, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType, accel_flags: GtkAccelFlags);
    pub fn gtk_widget_add_device_events        (widget: *mut GtkWidget, device: *mut gdk_ffi::GdkDevice, events: gdk_ffi::GdkEventMask);
    ...
    #[cfg(gtk_3_8)]
    pub fn gtk_widget_add_tick_callback        (widget: *mut GtkWidget, callback: GtkTickCallback, user_data: gpointer, notify: glib_ffi::GDestroyNotify) -> c_uint;
    ...
    pub fn gtk_widget_create_pango_context     (widget: *mut GtkWidget) -> *mut pango_ffi::PangoContext;
    pub fn gtk_widget_create_pango_layout      (widget: *mut GtkWidget, text: *const c_char) -> *mut pango_ffi::PangoLayout;
    ...
    pub fn gtk_widget_device_is_shadowed       (widget: *mut GtkWidget, device: *mut gdk_ffi::GdkDevice) -> gboolean;
    pub fn gtk_drag_begin                      (widget: *mut GtkWidget, targets: *mut GtkTargetList, actions: gdk_ffi::GdkDragAction, button: c_int, event: *mut gdk_ffi::GdkEvent) -> *mut gdk_ffi::GdkDragContext;
    #[cfg(gtk_3_10)]
    pub fn gtk_drag_begin_with_coordinates     (widget: *mut GtkWidget, targets: *mut GtkTargetList, actions: gdk_ffi::GdkDragAction, button: c_int, event: *mut gdk_ffi::GdkEvent, x: c_int, y: c_int) -> *mut gdk_ffi::GdkDragContext;
    ...
    pub fn gtk_drag_dest_find_target           (widget: *mut GtkWidget, context: *mut gdk_ffi::GdkDragContext, target_list: *mut GtkTargetList) -> gdk_ffi::GdkAtom;
    ...
    pub fn gtk_drag_dest_set                   (widget: *mut GtkWidget, flags: GtkDestDefaults, targets: *mut GtkTargetEntry, n_targets: c_int, actions: gdk_ffi::GdkDragAction);
    pub fn gtk_drag_dest_set_proxy             (widget: *mut GtkWidget, proxy_window: *mut gdk_ffi::GdkWindow, protocol: gdk_ffi::GdkDragProtocol, use_coordinates: gboolean);
    ...
    pub fn gtk_drag_get_data                   (widget: *mut GtkWidget, context: *mut gdk_ffi::GdkDragContext, target: gdk_ffi::GdkAtom, time_: u32);
    ...
    pub fn gtk_drag_source_set                 (widget: *mut GtkWidget, start_button_mask: gdk_ffi::GdkModifierType, targets: *mut GtkTargetEntry, n_targets: c_int, actions: gdk_ffi::GdkDragAction);
    pub fn gtk_drag_source_set_icon_gicon      (widget: *mut GtkWidget, icon: *mut gio_ffi::GIcon);
    pub fn gtk_drag_source_set_icon_name       (widget: *mut GtkWidget, icon_name: *const c_char);
    pub fn gtk_drag_source_set_icon_pixbuf     (widget: *mut GtkWidget, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf);
    ...
    pub fn gtk_widget_draw                     (widget: *mut GtkWidget, cr: *mut cairo_ffi::cairo_t);
    pub fn gtk_widget_ensure_style             (widget: *mut GtkWidget);
    pub fn gtk_widget_error_bell               (widget: *mut GtkWidget);
    pub fn gtk_widget_event                    (widget: *mut GtkWidget, event: *mut gdk_ffi::GdkEvent) -> gboolean;
    pub fn gtk_widget_freeze_child_notify      (widget: *mut GtkWidget);
    pub fn gtk_widget_get_accessible           (widget: *mut GtkWidget) -> *mut atk_ffi::AtkObject;
    #[cfg(gtk_3_16)]
    pub fn gtk_widget_get_action_group         (widget: *mut GtkWidget, prefix: *const c_char) -> *mut gio_ffi::GActionGroup;
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_widget_get_clipboard            (widget: *mut GtkWidget, selection: gdk_ffi::GdkAtom) -> *mut GtkClipboard;
    pub fn gtk_widget_get_composite_name       (widget: *mut GtkWidget) -> *mut c_char;
    pub fn gtk_widget_get_device_enabled       (widget: *mut GtkWidget, device: *mut gdk_ffi::GdkDevice) -> gboolean;
    pub fn gtk_widget_get_device_events        (widget: *mut GtkWidget, device: *mut gdk_ffi::GdkDevice) -> gdk_ffi::GdkEventMask;
    pub fn gtk_widget_get_direction            (widget: *mut GtkWidget) -> GtkTextDirection;
    pub fn gtk_widget_get_display              (widget: *mut GtkWidget) -> *mut gdk_ffi::GdkDisplay;
    ...
    #[cfg(gtk_3_8)]
    pub fn gtk_widget_get_frame_clock          (widget: *mut GtkWidget) -> *mut gdk_ffi::GdkFrameClock;
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_widget_get_modifier_mask        (widget: *mut GtkWidget, intent: gdk_ffi::GdkModifierIntent) -> gdk_ffi::GdkModifierType;
    ...
    pub fn gtk_widget_get_pango_context        (widget: *mut GtkWidget) -> *mut pango_ffi::PangoContext;
    pub fn gtk_widget_get_parent               (widget: *mut GtkWidget) -> *mut GtkWidget;
    pub fn gtk_widget_get_parent_window        (widget: *mut GtkWidget) -> *mut gdk_ffi::GdkWindow;
    ...
    pub fn gtk_widget_get_root_window          (widget: *mut GtkWidget) -> *mut gdk_ffi::GdkWindow;
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_widget_get_template_child       (widget: *mut GtkWidget, widget_type: GType, name: *const c_char) -> *mut gobject_ffi::GObject;
    ...
    pub fn gtk_widget_get_visual               (widget: *mut GtkWidget) -> *mut gdk_ffi::GdkVisual;
    ...
    pub fn gtk_widget_input_shape_combine_region(widget: *mut GtkWidget, region: *mut cairo_ffi::cairo_region_t);
    #[cfg(gtk_3_6)]
    pub fn gtk_widget_insert_action_group      (widget: *mut GtkWidget, name: *const c_char, group: *mut gio_ffi::GActionGroup);
    pub fn gtk_widget_intersect                (widget: *mut GtkWidget, area: *const gdk_ffi::GdkRectangle, intersection: *mut gdk_ffi::GdkRectangle) -> gboolean;
    ...
    pub fn gtk_widget_list_accel_closures      (widget: *mut GtkWidget) -> *mut glib_ffi::GList;
    #[cfg(gtk_3_16)]
    pub fn gtk_widget_list_action_prefixes     (widget: *mut GtkWidget) -> *mut *const c_char;
    pub fn gtk_widget_list_mnemonic_labels     (widget: *mut GtkWidget) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_widget_modify_base              (widget: *mut GtkWidget, state: GtkStateType, color: *const gdk_ffi::GdkColor);
    pub fn gtk_widget_modify_bg                (widget: *mut GtkWidget, state: GtkStateType, color: *const gdk_ffi::GdkColor);
    pub fn gtk_widget_modify_cursor            (widget: *mut GtkWidget, primary: *const gdk_ffi::GdkColor, secondary: *const gdk_ffi::GdkColor);
    pub fn gtk_widget_modify_fg                (widget: *mut GtkWidget, state: GtkStateType, color: *const gdk_ffi::GdkColor);
    pub fn gtk_widget_modify_font              (widget: *mut GtkWidget, font_desc: *mut pango_ffi::PangoFontDescription);
    pub fn gtk_widget_modify_style             (widget: *mut GtkWidget, style: *mut GtkRcStyle);
    pub fn gtk_widget_modify_text              (widget: *mut GtkWidget, state: GtkStateType, color: *const gdk_ffi::GdkColor);
    pub fn gtk_widget_override_background_color(widget: *mut GtkWidget, state: GtkStateFlags, color: *const gdk_ffi::GdkRGBA);
    pub fn gtk_widget_override_color           (widget: *mut GtkWidget, state: GtkStateFlags, color: *const gdk_ffi::GdkRGBA);
    ...
    pub fn gtk_widget_queue_draw_region        (widget: *mut GtkWidget, region: *const cairo_ffi::cairo_region_t);
    ...
    pub fn gtk_widget_region_intersect         (widget: *mut GtkWidget, region: *const cairo_ffi::cairo_region_t) -> *mut cairo_ffi::cairo_region_t;
    #[cfg(gtk_3_8)]
    pub fn gtk_widget_register_window          (widget: *mut GtkWidget, window: *mut gdk_ffi::GdkWindow);
    pub fn gtk_widget_remove_accelerator       (widget: *mut GtkWidget, accel_group: *mut GtkAccelGroup, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType) -> gboolean;
    ...
    pub fn gtk_widget_render_icon              (widget: *mut GtkWidget, stock_id: *const c_char, size: c_int, detail: *const c_char) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_widget_render_icon_pixbuf       (widget: *mut GtkWidget, stock_id: *const c_char, size: c_int) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    ...
    pub fn gtk_widget_send_expose              (widget: *mut GtkWidget, event: *mut gdk_ffi::GdkEvent) -> c_int;
    pub fn gtk_widget_send_focus_change        (widget: *mut GtkWidget, event: *mut gdk_ffi::GdkEvent) -> gboolean;
    ...
    pub fn gtk_widget_set_device_enabled       (widget: *mut GtkWidget, device: *mut gdk_ffi::GdkDevice, enabled: gboolean);
    pub fn gtk_widget_set_device_events        (widget: *mut GtkWidget, device: *mut gdk_ffi::GdkDevice, events: gdk_ffi::GdkEventMask);
    ...
    pub fn gtk_widget_set_visual               (widget: *mut GtkWidget, visual: *mut gdk_ffi::GdkVisual);
    pub fn gtk_widget_set_window               (widget: *mut GtkWidget, window: *mut gdk_ffi::GdkWindow);
    pub fn gtk_widget_shape_combine_region     (widget: *mut GtkWidget, region: *mut cairo_ffi::cairo_region_t);
    ...
    pub fn gtk_widget_style_get_property       (widget: *mut GtkWidget, property_name: *const c_char, value: *mut gobject_ffi::GValue);
    ...
    #[cfg(gtk_3_8)]
    pub fn gtk_widget_unregister_window        (widget: *mut GtkWidget, window: *mut gdk_ffi::GdkWindow);
    ...
    pub fn gtk_window_get_default_icon_list    () -> *mut glib_ffi::GList;
    pub fn gtk_window_get_default_icon_name    () -> *const c_char;
    pub fn gtk_window_list_toplevels           () -> *mut glib_ffi::GList;
    pub fn gtk_window_set_auto_startup_notification(setting: gboolean);
    pub fn gtk_window_set_default_icon         (icon: *mut gdk_pixbuf_ffi::GdkPixbuf);
    pub fn gtk_window_set_default_icon_from_file(filename: *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_window_set_default_icon_list    (list: *mut glib_ffi::GList);
    ...
    pub fn gtk_window_activate_key             (window: *mut GtkWindow, event: *mut gdk_ffi::GdkEventKey) -> gboolean;
    ...
    pub fn gtk_window_begin_resize_drag        (window: *mut GtkWindow, edge: gdk_ffi::GdkWindowEdge, button: c_int, root_x: c_int, root_y: c_int, timestamp: u32);
    #[cfg(gtk_3_10)]
    ...
    pub fn gtk_window_get_gravity              (window: *mut GtkWindow) -> gdk_ffi::GdkGravity;
    ...
    pub fn gtk_window_get_icon                 (window: *mut GtkWindow) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    pub fn gtk_window_get_icon_list            (window: *mut GtkWindow) -> *mut glib_ffi::GList;
    pub fn gtk_window_get_icon_name            (window: *mut GtkWindow) -> *const c_char;
    pub fn gtk_window_get_mnemonic_modifier    (window: *mut GtkWindow) -> gdk_ffi::GdkModifierType;
    ...
    pub fn gtk_window_get_resize_grip_area     (window: *mut GtkWindow, rect: *mut gdk_ffi::GdkRectangle) -> gboolean;
    pub fn gtk_window_get_role                 (window: *mut GtkWindow) -> *const c_char;
    pub fn gtk_window_get_screen               (window: *mut GtkWindow) -> *mut gdk_ffi::GdkScreen;
    ...
    pub fn gtk_window_get_type_hint            (window: *mut GtkWindow) -> gdk_ffi::GdkWindowTypeHint;
    ...
    pub fn gtk_window_mnemonic_activate        (window: *mut GtkWindow, keyval: c_uint, modifier: gdk_ffi::GdkModifierType) -> gboolean;
    ...
    pub fn gtk_window_propagate_key_event      (window: *mut GtkWindow, event: *mut gdk_ffi::GdkEventKey) -> gboolean;
    ...
    pub fn gtk_window_set_geometry_hints       (window: *mut GtkWindow, geometry_widget: *mut GtkWidget, geometry: *mut gdk_ffi::GdkGeometry, geom_mask: gdk_ffi::GdkWindowHints);
    pub fn gtk_window_set_gravity              (window: *mut GtkWindow, gravity: gdk_ffi::GdkGravity);
    ...
    pub fn gtk_window_set_icon                 (window: *mut GtkWindow, icon: *mut gdk_pixbuf_ffi::GdkPixbuf);
    pub fn gtk_window_set_icon_from_file       (window: *mut GtkWindow, filename: *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_window_set_icon_list            (window: *mut GtkWindow, list: *mut glib_ffi::GList);
    ...
    pub fn gtk_window_set_mnemonic_modifier    (window: *mut GtkWindow, modifier: gdk_ffi::GdkModifierType);
    ...
    pub fn gtk_window_set_screen               (window: *mut GtkWindow, screen: *mut gdk_ffi::GdkScreen);
    ...
    pub fn gtk_window_set_type_hint            (window: *mut GtkWindow, hint: gdk_ffi::GdkWindowTypeHint);
    ...
    pub fn gtk_window_group_get_current_device_grab(window_group: *mut GtkWindowGroup, device: *mut gdk_ffi::GdkDevice) -> *mut GtkWidget;
    pub fn gtk_window_group_get_current_grab   (window_group: *mut GtkWindowGroup) -> *mut GtkWidget;
    pub fn gtk_window_group_list_windows       (window_group: *mut GtkWindowGroup) -> *mut glib_ffi::GList;
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_actionable_get_action_target_value(actionable: *mut GtkActionable) -> *mut glib_ffi::GVariant;
    #[cfg(gtk_3_4)]
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_actionable_set_action_target_value(actionable: *mut GtkActionable, target_value: *mut glib_ffi::GVariant);
    #[cfg(gtk_3_4)]
    ...
    pub fn gtk_app_chooser_get_app_info        (self_: *mut GtkAppChooser) -> *mut gio_ffi::GAppInfo;
    ...
    pub fn gtk_buildable_add_child             (buildable: *mut GtkBuildable, builder: *mut GtkBuilder, child: *mut gobject_ffi::GObject, type_: *const c_char);
    pub fn gtk_buildable_construct_child       (buildable: *mut GtkBuildable, builder: *mut GtkBuilder, name: *const c_char) -> *mut gobject_ffi::GObject;
    pub fn gtk_buildable_custom_finished       (buildable: *mut GtkBuildable, builder: *mut GtkBuilder, child: *mut gobject_ffi::GObject, tagname: *const c_char, data: gpointer);
    pub fn gtk_buildable_custom_tag_end        (buildable: *mut GtkBuildable, builder: *mut GtkBuilder, child: *mut gobject_ffi::GObject, tagname: *const c_char, data: *mut gpointer);
    pub fn gtk_buildable_custom_tag_start      (buildable: *mut GtkBuildable, builder: *mut GtkBuilder, child: *mut gobject_ffi::GObject, tagname: *const c_char, parser: *mut glib_ffi::GMarkupParser, data: *mut gpointer) -> gboolean;
    pub fn gtk_buildable_get_internal_child    (buildable: *mut GtkBuildable, builder: *mut GtkBuilder, childname: *const c_char) -> *mut gobject_ffi::GObject;
    ...
    pub fn gtk_buildable_set_buildable_property(buildable: *mut GtkBuildable, builder: *mut GtkBuilder, name: *const c_char, value: *const gobject_ffi::GValue);
    ...
    pub fn gtk_cell_accessible_parent_get_cell_area(parent: *mut GtkCellAccessibleParent, cell: *mut GtkCellAccessible, cell_rect: *mut gdk_ffi::GdkRectangle);
    pub fn gtk_cell_accessible_parent_get_cell_extents(parent: *mut GtkCellAccessibleParent, cell: *mut GtkCellAccessible, x: *mut c_int, y: *mut c_int, width: *mut c_int, height: *mut c_int, coord_type: atk_ffi::AtkCoordType);
    ...
    pub fn gtk_cell_accessible_parent_update_relationset(parent: *mut GtkCellAccessibleParent, cell: *mut GtkCellAccessible, relationset: *mut atk_ffi::AtkRelationSet);
    ...
    pub fn gtk_cell_editable_start_editing     (cell_editable: *mut GtkCellEditable, event: *mut gdk_ffi::GdkEvent);
    ...
    pub fn gtk_cell_layout_get_cells           (cell_layout: *mut GtkCellLayout) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_cell_layout_set_cell_data_func  (cell_layout: *mut GtkCellLayout, cell: *mut GtkCellRenderer, func: GtkCellLayoutDataFunc, func_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    ...
    #[cfg(gtk_3_4)]
    pub fn gtk_color_chooser_add_palette       (chooser: *mut GtkColorChooser, orientation: GtkOrientation, colors_per_line: c_int, n_colors: c_int, colors: *mut gdk_ffi::GdkRGBA);
    #[cfg(gtk_3_4)]
    ...
    pub fn gtk_file_chooser_add_shortcut_folder(chooser: *mut GtkFileChooser, folder: *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_file_chooser_add_shortcut_folder_uri(chooser: *mut GtkFileChooser, uri: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_file_chooser_get_current_folder_file(chooser: *mut GtkFileChooser) -> *mut gio_ffi::GFile;
    ...
    pub fn gtk_file_chooser_get_file           (chooser: *mut GtkFileChooser) -> *mut gio_ffi::GFile;
    pub fn gtk_file_chooser_get_filename       (chooser: *mut GtkFileChooser) -> *mut c_char;
    pub fn gtk_file_chooser_get_filenames      (chooser: *mut GtkFileChooser) -> *mut glib_ffi::GSList;
    pub fn gtk_file_chooser_get_files          (chooser: *mut GtkFileChooser) -> *mut glib_ffi::GSList;
    ...
    pub fn gtk_file_chooser_get_preview_file   (chooser: *mut GtkFileChooser) -> *mut gio_ffi::GFile;
    ...
    pub fn gtk_file_chooser_get_uris           (chooser: *mut GtkFileChooser) -> *mut glib_ffi::GSList;
    pub fn gtk_file_chooser_get_use_preview_label(chooser: *mut GtkFileChooser) -> gboolean;
    pub fn gtk_file_chooser_list_filters       (chooser: *mut GtkFileChooser) -> *mut glib_ffi::GSList;
    pub fn gtk_file_chooser_list_shortcut_folder_uris(chooser: *mut GtkFileChooser) -> *mut glib_ffi::GSList;
    pub fn gtk_file_chooser_list_shortcut_folders(chooser: *mut GtkFileChooser) -> *mut glib_ffi::GSList;
    pub fn gtk_file_chooser_remove_filter      (chooser: *mut GtkFileChooser, filter: *mut GtkFileFilter);
    pub fn gtk_file_chooser_remove_shortcut_folder(chooser: *mut GtkFileChooser, folder: *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_file_chooser_remove_shortcut_folder_uri(chooser: *mut GtkFileChooser, uri: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_file_chooser_select_all         (chooser: *mut GtkFileChooser);
    pub fn gtk_file_chooser_select_file        (chooser: *mut GtkFileChooser, file: *mut gio_ffi::GFile, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_file_chooser_set_current_folder_file(chooser: *mut GtkFileChooser, file: *mut gio_ffi::GFile, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_file_chooser_set_file           (chooser: *mut GtkFileChooser, file: *mut gio_ffi::GFile, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_file_chooser_unselect_file      (chooser: *mut GtkFileChooser, file: *mut gio_ffi::GFile);
    ...
    pub fn gtk_font_chooser_get_font_desc      (fontchooser: *mut GtkFontChooser) -> *mut pango_ffi::PangoFontDescription;
    pub fn gtk_font_chooser_get_font_face      (fontchooser: *mut GtkFontChooser) -> *mut pango_ffi::PangoFontFace;
    pub fn gtk_font_chooser_get_font_family    (fontchooser: *mut GtkFontChooser) -> *mut pango_ffi::PangoFontFamily;
    ...
    pub fn gtk_font_chooser_set_filter_func    (fontchooser: *mut GtkFontChooser, filter: GtkFontFilterFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    pub fn gtk_font_chooser_set_font           (fontchooser: *mut GtkFontChooser, fontname: *const c_char);
    pub fn gtk_font_chooser_set_font_desc      (fontchooser: *mut GtkFontChooser, font_desc: *const pango_ffi::PangoFontDescription);
    ...
    pub fn gtk_recent_chooser_get_items        (chooser: *mut GtkRecentChooser) -> *mut glib_ffi::GList;
    ...
    pub fn gtk_recent_chooser_list_filters     (chooser: *mut GtkRecentChooser) -> *mut glib_ffi::GSList;
    ...
    pub fn gtk_recent_chooser_select_uri       (chooser: *mut GtkRecentChooser, uri: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gtk_recent_chooser_set_current_uri  (chooser: *mut GtkRecentChooser, uri: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_recent_chooser_set_sort_func    (chooser: *mut GtkRecentChooser, sort_func: GtkRecentSortFunc, sort_data: gpointer, data_destroy: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_style_provider_get_style_property(provider: *mut GtkStyleProvider, path: *mut GtkWidgetPath, state: GtkStateFlags, pspec: *mut gobject_ffi::GParamSpec, value: *mut gobject_ffi::GValue) -> gboolean;

    //=========================================================================
    // GtkToolShell
    //=========================================================================
    pub fn gtk_tool_shell_get_type             () -> GType;
    pub fn gtk_tool_shell_get_ellipsize_mode   (shell: *mut GtkToolShell) -> pango_ffi::PangoEllipsizeMode;
    ...
    pub fn gtk_tree_model_get_value            (tree_model: *mut GtkTreeModel, iter: *mut GtkTreeIter, column: c_int, value: *mut gobject_ffi::GValue);
    ...
    pub fn gtk_tree_sortable_set_default_sort_func(sortable: *mut GtkTreeSortable, sort_func: GtkTreeIterCompareFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    pub fn gtk_tree_sortable_set_sort_column_id(sortable: *mut GtkTreeSortable, sort_column_id: c_int, order: GtkSortType);
    pub fn gtk_tree_sortable_set_sort_func     (sortable: *mut GtkTreeSortable, sort_column_id: c_int, sort_func: GtkTreeIterCompareFunc, user_data: gpointer, destroy: glib_ffi::GDestroyNotify);
    pub fn gtk_tree_sortable_sort_column_changed(sortable: *mut GtkTreeSortable);

    //=========================================================================
    // Other functions
    //=========================================================================
    pub fn gtk_accel_groups_activate           (object: *mut gobject_ffi::GObject, accel_key: c_uint, accel_mods: gdk_ffi::GdkModifierType) -> gboolean;
    pub fn gtk_accel_groups_from_object        (object: *mut gobject_ffi::GObject) -> *mut glib_ffi::GSList;
    pub fn gtk_accelerator_get_default_mod_mask() -> gdk_ffi::GdkModifierType;
    pub fn gtk_accelerator_get_label           (accelerator_key: c_uint, accelerator_mods: gdk_ffi::GdkModifierType) -> *mut c_char;
    #[cfg(gtk_3_4)]
    pub fn gtk_accelerator_get_label_with_keycode(display: *mut gdk_ffi::GdkDisplay, accelerator_key: c_uint, keycode: c_uint, accelerator_mods: gdk_ffi::GdkModifierType) -> *mut c_char;
    pub fn gtk_accelerator_name                (accelerator_key: c_uint, accelerator_mods: gdk_ffi::GdkModifierType) -> *mut c_char;
    #[cfg(gtk_3_4)]
    pub fn gtk_accelerator_name_with_keycode   (display: *mut gdk_ffi::GdkDisplay, accelerator_key: c_uint, keycode: c_uint, accelerator_mods: gdk_ffi::GdkModifierType) -> *mut c_char;
    pub fn gtk_accelerator_parse               (accelerator: *const c_char, accelerator_key: *mut c_uint, accelerator_mods: *mut gdk_ffi::GdkModifierType);
    #[cfg(gtk_3_4)]
    pub fn gtk_accelerator_parse_with_keycode  (accelerator: *const c_char, accelerator_key: *mut c_uint, accelerator_codes: *mut *mut c_uint, accelerator_mods: *mut gdk_ffi::GdkModifierType);
    pub fn gtk_accelerator_set_default_mod_mask(default_mod_mask: gdk_ffi::GdkModifierType);
    pub fn gtk_accelerator_valid               (keyval: c_uint, modifiers: gdk_ffi::GdkModifierType) -> gboolean;
    pub fn gtk_alternative_dialog_button_order (screen: *mut gdk_ffi::GdkScreen) -> gboolean;
    pub fn gtk_bindings_activate               (object: *mut gobject_ffi::GObject, keyval: c_uint, modifiers: gdk_ffi::GdkModifierType) -> gboolean;
    pub fn gtk_bindings_activate_event         (object: *mut gobject_ffi::GObject, event: *mut gdk_ffi::GdkEventKey) -> gboolean;
    pub fn gtk_cairo_should_draw_window        (cr: *mut cairo_ffi::cairo_t, window: *mut gdk_ffi::GdkWindow) -> gboolean;
    pub fn gtk_cairo_transform_to_window       (cr: *mut cairo_ffi::cairo_t, widget: *mut GtkWidget, window: *mut gdk_ffi::GdkWindow);
    pub fn gtk_check_version                   (required_major: c_uint, required_minor: c_uint, required_micro: c_uint) -> *const c_char;
    pub fn gtk_device_grab_add                 (widget: *mut GtkWidget, device: *mut gdk_ffi::GdkDevice, block_others: gboolean);
    pub fn gtk_device_grab_remove              (widget: *mut GtkWidget, device: *mut gdk_ffi::GdkDevice);
    ...
    #[cfg(gtk_3_16)]
    pub fn gtk_drag_cancel                     (context: *mut gdk_ffi::GdkDragContext);
    pub fn gtk_drag_finish                     (context: *mut gdk_ffi::GdkDragContext, success: gboolean, del: gboolean, time_: u32);
    pub fn gtk_drag_get_source_widget          (context: *mut gdk_ffi::GdkDragContext) -> *mut GtkWidget;
    pub fn gtk_drag_set_icon_default           (context: *mut gdk_ffi::GdkDragContext);
    pub fn gtk_drag_set_icon_gicon             (context: *mut gdk_ffi::GdkDragContext, icon: *mut gio_ffi::GIcon, hot_x: c_int, hot_y: c_int);
    pub fn gtk_drag_set_icon_name              (context: *mut gdk_ffi::GdkDragContext, icon_name: *const c_char, hot_x: c_int, hot_y: c_int);
    pub fn gtk_drag_set_icon_pixbuf            (context: *mut gdk_ffi::GdkDragContext, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf, hot_x: c_int, hot_y: c_int);
    pub fn gtk_drag_set_icon_stock             (context: *mut gdk_ffi::GdkDragContext, stock_id: *const c_char, hot_x: c_int, hot_y: c_int);
    pub fn gtk_drag_set_icon_surface           (context: *mut gdk_ffi::GdkDragContext, surface: *mut cairo_ffi::cairo_surface_t);
    pub fn gtk_drag_set_icon_widget            (context: *mut gdk_ffi::GdkDragContext, widget: *mut GtkWidget, hot_x: c_int, hot_y: c_int);
    pub fn gtk_draw_insertion_cursor           (widget: *mut GtkWidget, cr: *mut cairo_ffi::cairo_t, location: *const gdk_ffi::GdkRectangle, is_primary: gboolean, direction: GtkTextDirection, draw_arrow: gboolean);
    pub fn gtk_events_pending                  () -> gboolean;
    pub fn gtk_false                           () -> gboolean;
    pub fn gtk_get_binary_age                  () -> c_uint;
    pub fn gtk_get_current_event               () -> *mut gdk_ffi::GdkEvent;
    pub fn gtk_get_current_event_device        () -> *mut gdk_ffi::GdkDevice;
    pub fn gtk_get_current_event_state         (state: *mut gdk_ffi::GdkModifierType) -> gboolean;
    pub fn gtk_get_current_event_time          () -> u32;
    pub fn gtk_get_debug_flags                 () -> c_uint;
    pub fn gtk_get_default_language            () -> *mut pango_ffi::PangoLanguage;
    pub fn gtk_get_event_widget                (event: *mut gdk_ffi::GdkEvent) -> *mut GtkWidget;
    ...
    pub fn gtk_get_option_group                (open_default_display: gboolean) -> *mut glib_ffi::GOptionGroup;
    ...
    pub fn gtk_init_with_args                  (argc: *mut c_int, argv: *mut *mut *mut c_char, parameter_string: *const c_char, entries: *mut glib_ffi::GOptionEntry, translation_domain: *const c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_main                            ();
    pub fn gtk_main_do_event                   (event: *mut gdk_ffi::GdkEvent);
    ...
    pub fn gtk_paint_arrow                     (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, arrow_type: GtkArrowType, fill: gboolean, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_box                       (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_box_gap                   (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int, gap_side: GtkPositionType, gap_x: c_int, gap_width: c_int);
    pub fn gtk_paint_check                     (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_diamond                   (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_expander                  (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, expander_style: GtkExpanderStyle);
    pub fn gtk_paint_extension                 (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int, gap_side: GtkPositionType);
    pub fn gtk_paint_flat_box                  (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_focus                     (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_handle                    (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int, orientation: GtkOrientation);
    pub fn gtk_paint_hline                     (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, widget: *mut GtkWidget, detail: *const c_char, x1: c_int, x2: c_int, y: c_int);
    pub fn gtk_paint_layout                    (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, use_text: gboolean, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, layout: *mut pango_ffi::PangoLayout);
    pub fn gtk_paint_option                    (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_resize_grip               (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, widget: *mut GtkWidget, detail: *const c_char, edge: gdk_ffi::GdkWindowEdge, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_shadow                    (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_shadow_gap                (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int, gap_side: GtkPositionType, gap_x: c_int, gap_width: c_int);
    pub fn gtk_paint_slider                    (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int, orientation: GtkOrientation);
    pub fn gtk_paint_spinner                   (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, widget: *mut GtkWidget, detail: *const c_char, step: c_uint, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_tab                       (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, shadow_type: GtkShadowType, widget: *mut GtkWidget, detail: *const c_char, x: c_int, y: c_int, width: c_int, height: c_int);
    pub fn gtk_paint_vline                     (style: *mut GtkStyle, cr: *mut cairo_ffi::cairo_t, state_type: GtkStateType, widget: *mut GtkWidget, detail: *const c_char, y1_: c_int, y2_: c_int, x: c_int);
    ...
    pub fn gtk_propagate_event                 (widget: *mut GtkWidget, event: *mut gdk_ffi::GdkEvent);
    pub fn gtk_rc_add_default_file             (filename: *mut c_char);
    pub fn gtk_rc_find_module_in_path          (module_file: *const c_char) -> *mut c_char;
    pub fn gtk_rc_find_pixmap_in_path          (settings: *mut GtkSettings, scanner: *mut glib_ffi::GScanner, pixmap_file: *const c_char) -> *mut c_char;
    ...
    pub fn gtk_rc_parse_color                  (scanner: *mut glib_ffi::GScanner, color: *mut gdk_ffi::GdkColor) -> c_uint;
    pub fn gtk_rc_parse_color_full             (scanner: *mut glib_ffi::GScanner, style: *mut GtkRcStyle, color: *mut gdk_ffi::GdkColor) -> c_uint;
    pub fn gtk_rc_parse_priority               (scanner: *mut glib_ffi::GScanner, priority: *mut GtkPathPriorityType) -> c_uint;
    pub fn gtk_rc_parse_state                  (scanner: *mut glib_ffi::GScanner, state: *mut GtkStateType) -> c_uint;
    ...
    pub fn gtk_rc_scanner_new                  () -> *mut glib_ffi::GScanner;
    pub fn gtk_rc_set_default_files            (filenames: *mut *mut c_char);
    pub fn gtk_render_activity                 (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double);
    pub fn gtk_render_arrow                    (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, angle: c_double, x: c_double, y: c_double, size: c_double);
    pub fn gtk_render_background               (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double);
    pub fn gtk_render_check                    (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double);
    pub fn gtk_render_expander                 (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double);
    pub fn gtk_render_extension                (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double, gap_side: GtkPositionType);
    pub fn gtk_render_focus                    (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double);
    pub fn gtk_render_frame                    (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double);
    pub fn gtk_render_frame_gap                (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double, gap_side: GtkPositionType, xy0_gap: c_double, xy1_gap: c_double);
    pub fn gtk_render_handle                   (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double);
    pub fn gtk_render_icon                     (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, pixbuf: *mut gdk_pixbuf_ffi::GdkPixbuf, x: c_double, y: c_double);
    pub fn gtk_render_icon_pixbuf              (context: *mut GtkStyleContext, source: *const GtkIconSource, size: c_int) -> *mut gdk_pixbuf_ffi::GdkPixbuf;
    #[cfg(gtk_3_10)]
    pub fn gtk_render_icon_surface             (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, surface: *mut cairo_ffi::cairo_surface_t, x: c_double, y: c_double);
    #[cfg(gtk_3_4)]
    pub fn gtk_render_insertion_cursor         (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, layout: *mut pango_ffi::PangoLayout, index: c_int, direction: pango_ffi::PangoDirection);
    pub fn gtk_render_layout                   (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, layout: *mut pango_ffi::PangoLayout);
    pub fn gtk_render_line                     (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x0: c_double, y0: c_double, x1: c_double, y1: c_double);
    pub fn gtk_render_option                   (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double);
    pub fn gtk_render_slider                   (context: *mut GtkStyleContext, cr: *mut cairo_ffi::cairo_t, x: c_double, y: c_double, width: c_double, height: c_double, orientation: GtkOrientation);
    pub fn gtk_rgb_to_hsv                      (r: c_double, g: c_double, b: c_double, h: *mut c_double, s: *mut c_double, v: *mut c_double);
    pub fn gtk_selection_add_target            (widget: *mut GtkWidget, selection: gdk_ffi::GdkAtom, target: gdk_ffi::GdkAtom, info: c_uint);
    pub fn gtk_selection_add_targets           (widget: *mut GtkWidget, selection: gdk_ffi::GdkAtom, targets: *mut GtkTargetEntry, ntargets: c_uint);
    pub fn gtk_selection_clear_targets         (widget: *mut GtkWidget, selection: gdk_ffi::GdkAtom);
    pub fn gtk_selection_convert               (widget: *mut GtkWidget, selection: gdk_ffi::GdkAtom, target: gdk_ffi::GdkAtom, time_: u32) -> gboolean;
    pub fn gtk_selection_owner_set             (widget: *mut GtkWidget, selection: gdk_ffi::GdkAtom, time_: u32) -> gboolean;
    pub fn gtk_selection_owner_set_for_display (display: *mut gdk_ffi::GdkDisplay, widget: *mut GtkWidget, selection: gdk_ffi::GdkAtom, time_: u32) -> gboolean;
    ...
    pub fn gtk_show_uri                        (screen: *mut gdk_ffi::GdkScreen, uri: *const c_char, timestamp: u32, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gtk_stock_list_ids                  () -> *mut glib_ffi::GSList;
    pub fn gtk_stock_lookup                    (stock_id: *const c_char, item: *mut GtkStockItem) -> gboolean;
    pub fn gtk_stock_set_translate_func        (domain: *const c_char, func: GtkTranslateFunc, data: gpointer, notify: glib_ffi::GDestroyNotify);
    ...
    pub fn gtk_targets_include_image           (targets: *mut gdk_ffi::GdkAtom, n_targets: c_int, writable: gboolean) -> gboolean;
    pub fn gtk_targets_include_rich_text       (targets: *mut gdk_ffi::GdkAtom, n_targets: c_int, buffer: *mut GtkTextBuffer) -> gboolean;
    pub fn gtk_targets_include_text            (targets: *mut gdk_ffi::GdkAtom, n_targets: c_int) -> gboolean;
    pub fn gtk_targets_include_uri             (targets: *mut gdk_ffi::GdkAtom, n_targets: c_int) -> gboolean;
    ...
    pub fn gtk_test_widget_click               (widget: *mut GtkWidget, button: c_uint, modifiers: gdk_ffi::GdkModifierType) -> gboolean;
    pub fn gtk_test_widget_send_key            (widget: *mut GtkWidget, keyval: c_uint, modifiers: gdk_ffi::GdkModifierType) -> gboolean;
    #[cfg(gtk_3_10)]
