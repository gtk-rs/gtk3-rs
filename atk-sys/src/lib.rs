...
pub type AtkAttributeSet = glib_ffi::GSList;
...
pub struct AtkEditableTextIface {
    pub parent_interface: gobject_ffi::GTypeInterface,
...
pub struct AtkHyperlinkClass {
    pub parent: gobject_ffi::GObjectClass,
...
pub struct AtkObjectFactoryClass {
    ...
    pub create_accessible: Option<unsafe extern "C" fn(*mut gobject_ffi::GObject) -> *mut AtkObject>,
...
pub struct AtkPropertyValues {
    ...
    pub old_value: gobject_ffi::GValue,
    pub new_value: gobject_ffi::GValue,
}
...
pub struct AtkStreamableContentIface {
    ...
    pub get_stream: Option<unsafe extern "C" fn(*mut AtkStreamableContent, *const c_char) -> *mut glib_ffi::GIOChannel>,
...
pub struct AtkTableCellIface {
    ...
    pub get_column_header_cells: Option<unsafe extern "C" fn(*mut AtkTableCell) -> *mut glib_ffi::GPtrArray>,
    ...
    pub get_row_header_cells: Option<unsafe extern "C" fn(*mut AtkTableCell) -> *mut glib_ffi::GPtrArray>,
...
pub struct AtkUtilClass {
    pub parent: gobject_ffi::GObjectClass,
    pub add_global_event_listener: Option<unsafe extern "C" fn(gobject_ffi::GSignalEmissionHook, *const c_char) -> c_uint>,
...
pub struct AtkValueIface {
    pub parent: gobject_ffi::GTypeInterface,
    pub get_current_value: Option<unsafe extern "C" fn(*mut AtkValue, *mut gobject_ffi::GValue)>,
    pub get_maximum_value: Option<unsafe extern "C" fn(*mut AtkValue, *mut gobject_ffi::GValue)>,
    pub get_minimum_value: Option<unsafe extern "C" fn(*mut AtkValue, *mut gobject_ffi::GValue)>,
    pub set_current_value: Option<unsafe extern "C" fn(*mut AtkValue, *const gobject_ffi::GValue) -> gboolean>,
    pub get_minimum_increment: Option<unsafe extern "C" fn(*mut AtkValue, *mut gobject_ffi::GValue)>,
    ...
    pub get_sub_ranges: Option<unsafe extern "C" fn(*mut AtkValue) -> *mut glib_ffi::GSList>,
...
extern "C" {
    ...
    pub fn atk_gobject_accessible_for_object   (obj: *mut gobject_ffi::GObject) -> *mut AtkObject;
    pub fn atk_gobject_accessible_get_object   (obj: *mut AtkGObjectAccessible) -> *mut gobject_ffi::GObject;
    ...
    pub fn atk_no_op_object_new                (obj: *mut gobject_ffi::GObject) -> *mut AtkObject;
    ...
    pub fn atk_object_factory_create_accessible(factory: *mut AtkObjectFactory, obj: *mut gobject_ffi::GObject) -> *mut AtkObject;
    ...
    pub fn atk_relation_get_target             (relation: *mut AtkRelation) -> *mut glib_ffi::GPtrArray;
    ...
    pub fn atk_streamable_content_get_stream   (streamable: *mut AtkStreamableContent, mime_type: *const c_char) -> *mut glib_ffi::GIOChannel;
    ...
    #[cfg(atk_2_12)]
    pub fn atk_table_cell_get_column_header_cells(cell: *mut AtkTableCell) -> *mut glib_ffi::GPtrArray;
    #[cfg(atk_2_12)]
    ...
    #[cfg(atk_2_12)]
    pub fn atk_table_cell_get_row_header_cells (cell: *mut AtkTableCell) -> *mut glib_ffi::GPtrArray;
    #[cfg(atk_2_12)]
    ...
    pub fn atk_value_get_current_value         (obj: *mut AtkValue, value: *mut gobject_ffi::GValue);
    #[cfg(atk_2_12)]
    pub fn atk_value_get_increment             (obj: *mut AtkValue) -> c_double;
    pub fn atk_value_get_maximum_value         (obj: *mut AtkValue, value: *mut gobject_ffi::GValue);
    pub fn atk_value_get_minimum_increment     (obj: *mut AtkValue, value: *mut gobject_ffi::GValue);
    pub fn atk_value_get_minimum_value         (obj: *mut AtkValue, value: *mut gobject_ffi::GValue);
    #[cfg(atk_2_12)]
    pub fn atk_value_get_range                 (obj: *mut AtkValue) -> *mut AtkRange;
    #[cfg(atk_2_12)]
    pub fn atk_value_get_sub_ranges            (obj: *mut AtkValue) -> *mut glib_ffi::GSList;
    #[cfg(atk_2_12)]
    pub fn atk_value_get_value_and_text        (obj: *mut AtkValue, value: *mut c_double, text: *mut *mut c_char);
    pub fn atk_value_set_current_value         (obj: *mut AtkValue, value: *const gobject_ffi::GValue) -> gboolean;
    #[cfg(atk_2_12)]
    ...
    pub fn atk_add_global_event_listener       (listener: gobject_ffi::GSignalEmissionHook, event_type: *const c_char) -> c_uint;
