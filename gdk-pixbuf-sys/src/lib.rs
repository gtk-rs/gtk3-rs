...
pub type GdkPixbufSaveFunc = Option<unsafe extern "C" fn(*mut u8, size_t, *mut *mut glib_ffi::GError, gpointer) -> gboolean>;
...
#[repr(C)]
pub struct GdkPixbufSimpleAnimClass;
...
extern "C" {
    ...
    // GdkPixdata
    //=========================================================================
    pub fn gdk_pixdata_deserialize             (pixdata: *mut GdkPixdata, stream_length: c_uint, stream: *mut u8, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gdk_pixdata_to_csource              (pixdata: *mut GdkPixdata, name: *const c_char, dump_type: GdkPixdataDumpType) -> *mut glib_ffi::GString;
    ...
    #[cfg(gdk_pixbuf_2_32)]
    pub fn gdk_pixbuf_new_from_bytes           (data: *mut glib_ffi::GBytes, colorspace: GdkColorspace, has_alpha: gboolean, bits_per_sample: c_int, width: c_int, height: c_int, rowstride: c_int) -> *mut GdkPixbuf;
    ...
    pub fn gdk_pixbuf_new_from_file            (filename: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_new_from_file_at_scale   (filename: *const c_char, width: c_int, height: c_int, preserve_aspect_ratio: gboolean, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_new_from_file_at_size    (filename: *const c_char, width: c_int, height: c_int, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_new_from_inline          (data_length: c_int, data: *mut u8, copy_pixels: gboolean, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    #[cfg(gdk_pixbuf_2_26)]
    pub fn gdk_pixbuf_new_from_resource        (resource_path: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    #[cfg(gdk_pixbuf_2_26)]
    pub fn gdk_pixbuf_new_from_resource_at_scale(resource_path: *const c_char, width: c_int, height: c_int, preserve_aspect_ratio: gboolean, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_new_from_stream          (stream: *mut gio_ffi::GInputStream, cancellable: *mut gio_ffi::GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_new_from_stream_at_scale (stream: *mut gio_ffi::GInputStream, width: c_int, height: c_int, preserve_aspect_ratio: gboolean, cancellable: *mut gio_ffi::GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_new_from_stream_finish   (async_result: *mut gio_ffi::GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_new_from_xpm_data        (data: *mut *mut c_char) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_from_pixdata             (pixdata: *const GdkPixdata, copy_pixels: gboolean, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbuf;
    pub fn gdk_pixbuf_get_file_info            (filename: *const c_char, width: *mut c_int, height: *mut c_int) -> *mut GdkPixbufFormat;
    #[cfg(gdk_pixbuf_2_32)]
    pub fn gdk_pixbuf_get_file_info_async      (filename: *const c_char, cancellable: *mut gio_ffi::GCancellable, callback: gio_ffi::GAsyncReadyCallback, user_data: gpointer);
    #[cfg(gdk_pixbuf_2_32)]
    pub fn gdk_pixbuf_get_file_info_finish     (async_result: *mut gio_ffi::GAsyncResult, width: *mut c_int, height: *mut c_int, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbufFormat;
    pub fn gdk_pixbuf_get_formats              () -> *mut glib_ffi::GSList;
    pub fn gdk_pixbuf_new_from_stream_async    (stream: *mut gio_ffi::GInputStream, cancellable: *mut gio_ffi::GCancellable, callback: gio_ffi::GAsyncReadyCallback, user_data: gpointer);
    pub fn gdk_pixbuf_new_from_stream_at_scale_async(stream: *mut gio_ffi::GInputStream, width: c_int, height: c_int, preserve_aspect_ratio: gboolean, cancellable: *mut gio_ffi::GCancellable, callback: gio_ffi::GAsyncReadyCallback, user_data: gpointer);
    pub fn gdk_pixbuf_save_to_stream_finish    (async_result: *mut gio_ffi::GAsyncResult, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gdk_pixbuf_add_alpha                (pixbuf: *const GdkPixbuf, substitute_color: gboolean, r: c_char, g: c_char, b: c_char) -> *mut GdkPixbuf;
    ...
    #[cfg(gdk_pixbuf_2_32)]
    pub fn gdk_pixbuf_get_options              (pixbuf: *mut GdkPixbuf) -> *mut glib_ffi::GHashTable;
    ...
    #[cfg(gdk_pixbuf_2_32)]
    pub fn gdk_pixbuf_read_pixel_bytes         (pixbuf: *const GdkPixbuf) -> *mut glib_ffi::GBytes;
    #[cfg(gdk_pixbuf_2_32)]
    ...
    pub fn gdk_pixbuf_save                     (pixbuf: *mut GdkPixbuf, filename: *const c_char, type_: *const c_char, error: *mut *mut glib_ffi::GError, ...) -> gboolean;
    pub fn gdk_pixbuf_save_to_buffer           (pixbuf: *mut GdkPixbuf, buffer: *mut *mut u8, buffer_size: *mut size_t, type_: *const c_char, error: *mut *mut glib_ffi::GError, ...) -> gboolean;
    pub fn gdk_pixbuf_save_to_bufferv          (pixbuf: *mut GdkPixbuf, buffer: *mut *mut u8, buffer_size: *mut size_t, type_: *const c_char, option_keys: *mut *mut c_char, option_values: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gdk_pixbuf_save_to_callback         (pixbuf: *mut GdkPixbuf, save_func: GdkPixbufSaveFunc, user_data: gpointer, type_: *const c_char, error: *mut *mut glib_ffi::GError, ...) -> gboolean;
    pub fn gdk_pixbuf_save_to_callbackv        (pixbuf: *mut GdkPixbuf, save_func: GdkPixbufSaveFunc, user_data: gpointer, type_: *const c_char, option_keys: *mut *mut c_char, option_values: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    pub fn gdk_pixbuf_save_to_stream           (pixbuf: *mut GdkPixbuf, stream: *mut gio_ffi::GOutputStream, type_: *const c_char, cancellable: *mut gio_ffi::GCancellable, error: *mut *mut glib_ffi::GError, ...) -> gboolean;
    pub fn gdk_pixbuf_save_to_stream_async     (pixbuf: *mut GdkPixbuf, stream: *mut gio_ffi::GOutputStream, type_: *const c_char, cancellable: *mut gio_ffi::GCancellable, callback: gio_ffi::GAsyncReadyCallback, user_data: gpointer, ...);
    pub fn gdk_pixbuf_savev                    (pixbuf: *mut GdkPixbuf, filename: *const c_char, type_: *const c_char, option_keys: *mut *mut c_char, option_values: *mut *mut c_char, error: *mut *mut glib_ffi::GError) -> gboolean;
    ...
    pub fn gdk_pixbuf_animation_new_from_file  (filename: *const c_char, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbufAnimation;
    #[cfg(gdk_pixbuf_2_28)]
    ...
    #[cfg(gdk_pixbuf_2_28)]
    pub fn gdk_pixbuf_animation_new_from_stream(stream: *mut gio_ffi::GInputStream, cancellable: *mut gio_ffi::GCancellable, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbufAnimation;
    #[cfg(gdk_pixbuf_2_28)]
    pub fn gdk_pixbuf_animation_new_from_stream_finish(async_result: *mut gio_ffi::GAsyncResult, error: *mut *mut glib_ffi::GError) -> *mut GdkPixbufAnimation;
    #[cfg(gdk_pixbuf_2_28)]
    pub fn gdk_pixbuf_animation_new_from_stream_async(stream: *mut gio_ffi::GInputStream, cancellable: *mut gio_ffi::GCancellable, callback: gio_ffi::GAsyncReadyCallback, user_data: gpointer);
    pub fn gdk_pixbuf_animation_get_height     (animation: *mut GdkPixbufAnimation) -> c_int;
    pub fn gdk_pixbuf_animation_get_iter       (animation: *mut GdkPixbufAnimation, start_time: *const glib_ffi::GTimeVal) -> *mut GdkPixbufAnimationIter;
    ...
    pub fn gdk_pixbuf_animation_iter_advance   (iter: *mut GdkPixbufAnimationIter, current_time: *const glib_ffi::GTimeVal) -> gboolean;
    ...
    pub fn gdk_pixbuf_loader_write             (loader: *mut GdkPixbufLoader, buf: *mut u8, count: size_t, error: *mut *mut glib_ffi::GError) -> gboolean;
    #[cfg(gdk_pixbuf_2_30)]
    pub fn gdk_pixbuf_loader_write_bytes       (loader: *mut GdkPixbufLoader, buffer: *mut glib_ffi::GBytes, error: *mut *mut glib_ffi::GError) -> gboolean;
