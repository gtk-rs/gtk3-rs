...
use crate::{Align, Bin, Buildable, Container, ResizeMode, ToolItem, Widget, ffi};
use glib::{
    prelude::*,
...
pub struct SeparatorToolItemBuilder {
    builder: glib::object::ObjectBuilder<'static, SeparatorToolItem>,
}
...
impl SeparatorToolItemBuilder {
    ...
    pub fn draw(self, draw: bool) -> Self {
        Self {
            builder: self.builder.property("draw", draw),
        }
    }
