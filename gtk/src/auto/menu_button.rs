...
use crate::{
    ...
    ReliefStyle, ResizeMode, ToggleButton, Widget, ffi,
};
use glib::{
    prelude::*,
...
impl MenuButtonBuilder {
    ...
    pub fn align_widget(self, align_widget: &impl IsA<Container>) -> Self {
        Self {
            builder: self
                .builder
                .property("align-widget", align_widget.clone().upcast()),
        }
    }
    ...
    pub fn popup(self, popup: &impl IsA<Menu>) -> Self {
        Self {
            builder: self.builder.property("popup", popup.clone().upcast()),
        }
    }

    pub fn use_popover(self, use_popover: bool) -> Self {
        Self {
            builder: self.builder.property("use-popover", use_popover),
        }
    }
