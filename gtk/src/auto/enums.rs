...
impl IntoGlib for IMPreeditStyle {
    ...
    fn into_glib(self) -> ffi::GtkIMPreeditStyle {
        match self {
            Self::Nothing => ffi::GTK_IM_PREEDIT_NOTHING,
            Self::Callback => ffi::GTK_IM_PREEDIT_CALLBACK,
            Self::None => ffi::GTK_IM_PREEDIT_NONE,
            Self::__Unknown(value) => value,
        }
    }
}
...
impl IntoGlib for IMStatusStyle {
    ...
    fn into_glib(self) -> ffi::GtkIMStatusStyle {
        match self {
            Self::Nothing => ffi::GTK_IM_STATUS_NOTHING,
            Self::Callback => ffi::GTK_IM_STATUS_CALLBACK,
            Self::None => ffi::GTK_IM_STATUS_NONE,
            Self::__Unknown(value) => value,
        }
    }
}
...
impl IntoGlib for StateType {
    ...
    fn into_glib(self) -> ffi::GtkStateType {
        match self {
            Self::Normal => ffi::GTK_STATE_NORMAL,
            Self::Active => ffi::GTK_STATE_ACTIVE,
            Self::Prelight => ffi::GTK_STATE_PRELIGHT,
            Self::Selected => ffi::GTK_STATE_SELECTED,
            Self::Insensitive => ffi::GTK_STATE_INSENSITIVE,
            Self::Inconsistent => ffi::GTK_STATE_INCONSISTENT,
            Self::Focused => ffi::GTK_STATE_FOCUSED,
            Self::__Unknown(value) => value,
        }
    }
}
